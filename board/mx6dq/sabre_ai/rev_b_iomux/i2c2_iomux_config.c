...
void i2c2_iomux_config(void)
{
    ...
    HW_IOMUXC_SW_PAD_CTL_PAD_EIM_EB2_WR(
            ...
            BF_IOMUXC_SW_PAD_CTL_PAD_EIM_EB2_ODE(ODE_ENABLED) | 
            BF_IOMUXC_SW_PAD_CTL_PAD_EIM_EB2_SPEED(SPD_50MHZ) | 
            BF_IOMUXC_SW_PAD_CTL_PAD_EIM_EB2_DSE(DSE_60OHM) | 
    ...
    HW_IOMUXC_SW_PAD_CTL_PAD_KEY_ROW3_WR(
            ...
            BF_IOMUXC_SW_PAD_CTL_PAD_KEY_ROW3_ODE(ODE_ENABLED) | 
            BF_IOMUXC_SW_PAD_CTL_PAD_KEY_ROW3_SPEED(SPD_50MHZ) | 
            BF_IOMUXC_SW_PAD_CTL_PAD_KEY_ROW3_DSE(DSE_60OHM) | 
