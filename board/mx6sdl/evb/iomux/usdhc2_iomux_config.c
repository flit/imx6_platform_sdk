...
void usdhc2_iomux_config(void)
{
    ...
    // HW_IOMUXC_USDHC2_IPP_CARD_CLK_IN_SELECT_INPUT_WR(0x00000001);
    ...
    HW_IOMUXC_USDHC2_IPP_CARD_CLK_IN_SELECT_INPUT_WR(
            BF_IOMUXC_USDHC2_IPP_CARD_CLK_IN_SELECT_INPUT_DAISY(SEL_SD2_CLK_ALT0));
    // Pad Control Register:
