...
void kpp_iomux_config(void)
{
    ...
    HW_IOMUXC_KPP_IPP_IND_COL_7_SELECT_INPUT_WR(
            BF_IOMUXC_KPP_IPP_IND_COL_7_SELECT_INPUT_DAISY(SEL_CSI0_DAT8_ALT3));
    // Pad Control Register:
    ...
    HW_IOMUXC_KPP_IPP_IND_ROW_6_SELECT_INPUT_WR(
            BF_IOMUXC_KPP_IPP_IND_ROW_6_SELECT_INPUT_DAISY(SEL_CSI0_DAT7_ALT3));
    // Pad Control Register:
    ...
    HW_IOMUXC_KPP_IPP_IND_ROW_7_SELECT_INPUT_WR(
            BF_IOMUXC_KPP_IPP_IND_ROW_7_SELECT_INPUT_DAISY(SEL_CSI0_DAT9_ALT3));
    // Pad Control Register:
