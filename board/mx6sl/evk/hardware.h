...
#define DUMMY_VALUE_NOT_USED 0xFF0000FF
...
#define VOLNEG_BUTTON_GOPIO_BASE	GPIO5_BASE_ADDR
#define VOLNEG_BUTTON_GPIO_NUM		14
#endif
#if defined(SMART_DEVICE)
    /* Not available for that board */
#define HOME_BUTTON_GOPIO_BASE	DUMMY_VALUE_NOT_USED
#define HOME_BUTTON_GPIO_NUM	0
#define BACK_BUTTON_GOPIO_BASE	DUMMY_VALUE_NOT_USED
#define BACK_BUTTON_GPIO_NUM	0
#define PROG_BUTTON_GOPIO_BASE	DUMMY_VALUE_NOT_USED
#define PROG_BUTTON_GPIO_NUM	0
    /* used buttons */
#define VOLPLUS_BUTTON_GOPIO_BASE	GPIO7_BASE_ADDR
#define VOLPLUS_BUTTON_GPIO_NUM		13
#define VOLNEG_BUTTON_GOPIO_BASE	GPIO4_BASE_ADDR
#define VOLNEG_BUTTON_GPIO_NUM		5
#endif
