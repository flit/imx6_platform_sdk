...
{
    // Config usb.USB_OTG1_ID to pad EPDC_PWRCOM(B11)
    // HW_IOMUXC_SW_MUX_CTL_PAD_EPDC_PWRCOM_WR(0x00000004);
    ...
    HW_IOMUXC_SW_MUX_CTL_PAD_EPDC_PWRCOM_WR(
            ...
            BF_IOMUXC_SW_MUX_CTL_PAD_EPDC_PWRCOM_MUX_MODE(ALT4));
    // Pad EPDC_PWRCOM is involved in Daisy Chain.
