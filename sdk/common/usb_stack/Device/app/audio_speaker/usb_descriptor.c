...
USB_DESC_CONST USB_ENDPOINTS usb_desc_ep = { 
	AUDIO_DESC_ENDPOINT_COUNT, // 2
	{
		// for data endpoint
		{
			...
			USB_RECV,					// OUT
			AUDIO_ENDPOINT_PACKET_SIZE,	// 256
		},
...
//
  /* Audio class-specific feature unit */    
   ...
   // EP descriptor (class specific isochronous)
   0x07,		// bLength
   ...
   // EP descriptor (standard)
   0x09,		// bLength
   0x05,		// endpoint descriptor type
   _EP01_OUT,	// host->dev, ep 1
   0x05,		// iso + async + data
   0x10,0x00,	// wMaxPacketSize
   0x01,		// interval polling
   0x00,		// bRefresh
   _EP02_IN,	// bSyncAddress



   // EP descriptor (standard) - feedback endpoint
   0x09,		// bLength
   0x05,		// bDescriptorType
   _EP02_IN,	// dev->host, ep 2
   0x15,		// iso + asynch + feedback
   0x03,0x00,	// wMaxPacketSize
   0x01,		// interval polling(1ms)
   0x05,		// bRefresh(32ms)
   0x00,		// bSyncAddress
};
