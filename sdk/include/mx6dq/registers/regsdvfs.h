...
/*
 * i.MX6DQ DVFSC registers defined in this header file.
 *
...
typedef union _hw_dvfsc_dvfsemac
{
    ...
    struct _hw_dvfsc_dvfsemac_bitfields
    {
        ...
        unsigned DVFEN2 : 1; //!< [11] DVFS tracking for core2 enable.
        unsigned DVFEN3 : 1; //!< [12] DVFS tracking for core3 enable.
        ...
        unsigned FSVAI2 : 2; //!< [21:20] DVFS Frequency adjustment status of core 2.
        unsigned FSVAI3 : 2; //!< [23:22] DVFS Frequency adjustment status of core 3.
        ...
        unsigned WFIM2 : 1; //!< [26] DVFS Wait for Interrupt of core 2mask bit
        unsigned WFIM3 : 1; //!< [27] DVFS Wait for Interrupt of core 3 mask bit
        unsigned RESERVED1 : 4; //!< [31:28] Reserved
    } B;
} hw_dvfsc_dvfsemac_t;
#endif
...
/* --- Register HW_DVFSC_DVFSEMAC, field DVFEN1[10] (RW)
 *
...
/* --- Register HW_DVFSC_DVFSEMAC, field DVFEN2[11] (RW)
 *
...
//! @brief Get value of DVFSC_DVFSEMAC_DVFEN2 from a register value.
#define BG_DVFSC_DVFSEMAC_DVFEN2(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_DVFSC_DVFSEMAC_DVFEN2) >> BP_DVFSC_DVFSEMAC_DVFEN2)

//! @brief Format value for bitfield DVFSC_DVFSEMAC_DVFEN2.
#define BF_DVFSC_DVFSEMAC_DVFEN2(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_DVFSC_DVFSEMAC_DVFEN2) & BM_DVFSC_DVFSEMAC_DVFEN2)
...
/* --- Register HW_DVFSC_DVFSEMAC, field DVFEN3[12] (RW)
 *
...
//! @brief Get value of DVFSC_DVFSEMAC_DVFEN3 from a register value.
#define BG_DVFSC_DVFSEMAC_DVFEN3(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_DVFSC_DVFSEMAC_DVFEN3) >> BP_DVFSC_DVFSEMAC_DVFEN3)

//! @brief Format value for bitfield DVFSC_DVFSEMAC_DVFEN3.
#define BF_DVFSC_DVFSEMAC_DVFEN3(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_DVFSC_DVFSEMAC_DVFEN3) & BM_DVFSC_DVFSEMAC_DVFEN3)
...
/* --- Register HW_DVFSC_DVFSEMAC, field FSVAI1[19:18] (RO)
 *
...
/* --- Register HW_DVFSC_DVFSEMAC, field FSVAI2[21:20] (RO)
 *
 * DVFS Frequency adjustment status of core 2. These status bits indicate that frequency should be
 * changed, following load of core 2.
 *
 * Values:
 * 00 - no change
 * 01 - frequency should be increased. Low priority source for interrupt. Interrupt is asserted, if
...
/* --- Register HW_DVFSC_DVFSEMAC, field FSVAI3[23:22] (RO)
 *
 * DVFS Frequency adjustment status of core 3. These status bits indicate that frequency should be
 * changed, following load of core 3.
 *
 * Values:
 * 00 - no change
 * 01 - frequency should be increased. Low priority source for interrupt. Interrupt is asserted, if
...
/* --- Register HW_DVFSC_DVFSEMAC, field WFIM1[25] (RW)
 *
...
/* --- Register HW_DVFSC_DVFSEMAC, field WFIM2[26] (RW)
 *
 * DVFS Wait for Interrupt of core 2mask bit
 *
 * Values:
 * 0 - Wait for interrupt of core 2 isn't masked
...
//! @brief Get value of DVFSC_DVFSEMAC_WFIM2 from a register value.
#define BG_DVFSC_DVFSEMAC_WFIM2(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_DVFSC_DVFSEMAC_WFIM2) >> BP_DVFSC_DVFSEMAC_WFIM2)

//! @brief Format value for bitfield DVFSC_DVFSEMAC_WFIM2.
#define BF_DVFSC_DVFSEMAC_WFIM2(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_DVFSC_DVFSEMAC_WFIM2) & BM_DVFSC_DVFSEMAC_WFIM2)
...
/* --- Register HW_DVFSC_DVFSEMAC, field WFIM3[27] (RW)
 *
 * DVFS Wait for Interrupt of core 3 mask bit
 *
 * Values:
 * 0 - Wait for interrupt of core 3 isn't masked
...
//! @brief Get value of DVFSC_DVFSEMAC_WFIM3 from a register value.
#define BG_DVFSC_DVFSEMAC_WFIM3(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_DVFSC_DVFSEMAC_WFIM3) >> BP_DVFSC_DVFSEMAC_WFIM3)

//! @brief Format value for bitfield DVFSC_DVFSEMAC_WFIM3.
#define BF_DVFSC_DVFSEMAC_WFIM3(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_DVFSC_DVFSEMAC_WFIM3) & BM_DVFSC_DVFSEMAC_WFIM3)
