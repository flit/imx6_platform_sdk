 ...
 * Reset value: 0x00000000
 *
 * Name: Number of Active Data Lanes  Address Offset: 0x004  Size: 2 bits  Default Value:
...
typedef union _hw_mipi_csi_n_lanes
{
    ...
    {
        unsigned N_LANES : 2; //!< [1:0] Number of Active Data Lanes Can only be updated when the PHY lane is in stop state.
 ...
 * Reset value: 0x00000000
 *
 * Name: General settings for all blocks  Address Offset: 0x014  Size: 12 bit  Default Value: 0
...
typedef union _hw_mipi_csi_mask1
{
    ...
    {
        unsigned MASK_PHY_ERRSOTSYNCHS_0 : 1; //!< [0] Mask for phy_errsotsynchs_0.
        unsigned MASK_PHY_ERRSOTSYNCHS_1 : 1; //!< [1] Mask for phy_errsotsynchs_1.
        unsigned MASK_PHY_ERRSOTSYNCHS_2 : 1; //!< [2] Mask for phy_errsotsynchs_2.
        unsigned MASK_PHY_ERRSOTSYNCHS_3 : 1; //!< [3] Mask for phy_errsotsynchs_3.
        unsigned MASK_ERR_F_BNDRY_MATCH_VC0 : 1; //!< [4] Mask for err_f_bndry_match_vc0.
        unsigned MASK_ERR_F_BNDRY_MATCH_VC1 : 1; //!< [5] Mask for err_f_bndry_match_vc1.
        unsigned MASK_ERR_F_BNDRY_MATCH_VC2 : 1; //!< [6] Mask for err_f_bndry_match_vc2.
        unsigned MASK_ERR_F_BNDRY_MATCH_VC3 : 1; //!< [7] Mask for err_f_bndry_match_vc3.
        unsigned MASK_ERR_F_SEQ_VC0 : 1; //!< [8] Mask for err_f_seq_vc0.
        unsigned MASK_ERR_F_SEQ_VC1 : 1; //!< [9] Mask for err_f_seq_vc1.
        unsigned MASK_ERR_F_SEQ_VC2 : 1; //!< [10] Mask for err_f_seq_vc2.
        unsigned MASK_ERR_F_SEQ_VC3 : 1; //!< [11] Mask for err_f_seq_vc3.
        unsigned MASK_ERR_FRAME_DATA_VC0 : 1; //!< [12] Mask for err_frame_data_vc0.
        unsigned MASK_ERR_FRAME_DATA_VC1 : 1; //!< [13] Mask for err_frame_data_vc1.
        unsigned MASK_ERR_FRAME_DATA_VC2 : 1; //!< [14] Mask for err_frame_data_vc2.
        unsigned MASK_ERR_FRAME_DATA_VC3 : 1; //!< [15] Mask for err_frame_data_vc3.
        unsigned MASK_ERR_L_BNDRY_MATCH_DI0 : 1; //!< [16] Mask for err_l_bndry_match_di0.
        unsigned MASK_ERR_L_BNDRY_MATCH_DI1 : 1; //!< [17] Mask for err_l_bndry_match_di1.
        unsigned MASK_ERR_L_BNDRY_MATCH_DI2 : 1; //!< [18] Mask for err_l_bndry_match_di2.
        unsigned MASK_ERR_L_BNDRY_MATCH_DI3 : 1; //!< [19] Mask for err_l_bndry_match_di3.
        unsigned MASK_ERR_L_SEQ_DI0 : 1; //!< [20] Mask for err_l_seq_di0.
        unsigned MASK_ERR_L_SEQ_DI1 : 1; //!< [21] Mask for err_l_seq_di1.
        unsigned MASK_ERR_L_SEQ_DI2 : 1; //!< [22] Mask for err_l_seq_di2.
        unsigned MASK_ERR_L_SEQ_DI3 : 1; //!< [23] Mask for err_l_seq_di3.
        unsigned MASK_VC0_ERR_CRC : 1; //!< [24] Mask for vc0_err_crc.
        unsigned MASK_VC1_ERR_CRC : 1; //!< [25] Mask for vc1_err_crc.
        unsigned MASK_VC2_ERR_CRC : 1; //!< [26] Mask for vc2_err_crc.
        unsigned MASK_VC3_ERR_CRC : 1; //!< [27] Mask for vc3_err_crc.
        unsigned MASK_ERR_ECC_DOUBLE : 1; //!< [28] Mask for err_ecc_double.
        unsigned RESERVED0 : 3; //!< [31:29] Reserved
    } B;
} hw_mipi_csi_mask1_t;
#endif
...
typedef union _hw_mipi_csi_mask2
{
    ...
    struct _hw_mipi_csi_mask2_bitfields
    {
        ...
        unsigned MASK_PHY_ERRESC_2 : 1; //!< [2] Mask for phy_erresc_2.
        unsigned MASK_PHY_ERRESC_3 : 1; //!< [3] Mask for phy_erresc_3.
        unsigned MASK_PHY_ERRSOTHS_0 : 1; //!< [4] Mask for phy_errsoths_0.
        unsigned MASK_PHY_ERRSOTHS_1 : 1; //!< [5] Mask for phy_errsoths_1.
        unsigned MASK_PHY_ERRSOTHS_2 : 1; //!< [6] Mask for phy_errsoths_2.
        unsigned MASK_PHY_ERRSOTHS_3 : 1; //!< [7] Mask for phy_errsoths_3.
        ...
        unsigned MASK_ERR_L_BNDRY_MATCH_DI4 : 1; //!< [16] Mask for err_l_bndry_match_di4.
        unsigned MASK_ERR_L_BNDRY_MATCH_DI5 : 1; //!< [17] Mask for err_l_bndry_match_di5.
        unsigned MASK_ERR_L_BNDRY_MATCH_DI6 : 1; //!< [18] Mask for err_l_bndry_match_di6.
        unsigned MASK_ERR_L_BNDRY_MATCH_DI7 : 1; //!< [19] Mask for err_l_bndry_match_di7.
        unsigned MASK_ERR_L_SEQ_DI4 : 1; //!< [20] Mask for err_l_seq_di4.
        unsigned MASK_ERR_L_SEQ_DI5 : 1; //!< [21] Mask for err_l_seq_di5.
        unsigned MASK_ERR_L_SEQ_DI6 : 1; //!< [22] Mask for err_l_seq_di6.
        unsigned MASK_ERR_L_SEQ_DI7 : 1; //!< [23] Mask for err_l_seq_di7.
        unsigned RESERVED0 : 8; //!< [31:24] Reserved
    } B;
} hw_mipi_csi_mask2_t;
#endif
