...
/*
 * i.MX6SDL USBC registers defined in this header file.
 *
...
/*
 * constants & macros for entire USBC_UOG_ID register
 */
...
/* --- Register HW_USBC_UOG_ID, field ID[5:0] (RO)
 *
...
/* --- Register HW_USBC_UOG_ID, field NID[13:8] (RO)
 *
...
/* --- Register HW_USBC_UOG_ID, field REVISION[23:16] (RO)
 *
...
/*
 * constants & macros for entire USBC_UOG_HWGENERAL register
 */
...
/*
 * constants & macros for entire USBC_UOG_HWHOST register
 */
...
/* --- Register HW_USBC_UOG_HWHOST, field HC[0] (RO)
 *
...
/* --- Register HW_USBC_UOG_HWHOST, field NPORT[3:1] (RO)
 *
...
/* --- Register HW_USBC_UOG_HWDEVICE, field DC[0] (RO)
 *
...
/*
 * constants & macros for entire USBC_UOG_HWTXBUF register
 */
...
/* --- Register HW_USBC_UOG_HWTXBUF, field TXBURST[7:0] (RO)
 *
...
/* --- Register HW_USBC_UOG_HWTXBUF, field TXCHANADD[23:16] (RO)
 *
...
/*
 * constants & macros for entire USBC_UOG_HWRXBUF register
 */
...
/* --- Register HW_USBC_UOG_HWRXBUF, field RXBURST[7:0] (RO)
 *
...
/* --- Register HW_USBC_UOG_HWRXBUF, field RXADD[15:8] (RO)
 *
...
/*
 * constants & macros for entire USBC_UOG_GPTIMER0LD register
 */
...
/* --- Register HW_USBC_UOG_GPTIMER0LD, field GPTLD[23:0] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_GPTIMER0CTRL register
 */
...
/* --- Register HW_USBC_UOG_GPTIMER0CTRL, field GPTCNT[23:0] (RW)
 *
...
/* --- Register HW_USBC_UOG_GPTIMER0CTRL, field GPTMODE[24] (RW)
 *
...
/* --- Register HW_USBC_UOG_GPTIMER0CTRL, field GPTRST[30] (RW)
 *
...
/* --- Register HW_USBC_UOG_GPTIMER0CTRL, field GPTRUN[31] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_GPTIMER1LD register
 */
...
/* --- Register HW_USBC_UOG_GPTIMER1LD, field GPTLD[23:0] (RW)
 *
 * General Purpose Timer Load Value These bit fields are loaded to GPTCNT bits when GPTRST bit is
 * set '1b'. This value represents the time in microseconds minus 1 for the timer duration. Example:
 * for a one millisecond timer, load 1000-1=999 or 0x0003E7. Max value is 0xFFFFFF or 16.777215
...
/*
 * constants & macros for entire USBC_UOG_GPTIMER1CTRL register
 */
...
/* --- Register HW_USBC_UOG_GPTIMER1CTRL, field GPTCNT[23:0] (RW)
 *
 * General Purpose Timer Counter. This field is the count value of the countdown timer.
 */
...
/* --- Register HW_USBC_UOG_GPTIMER1CTRL, field GPTMODE[24] (RW)
 *
 * General Purpose Timer Mode In one shot mode, the timer will count down to zero, generate an
 * interrupt, and stop until the counter is reset by software. In repeat mode, the timer will count
 * down to zero, generate an interrupt and automatically reload the counter value from GPTLD bits to
...
/* --- Register HW_USBC_UOG_GPTIMER1CTRL, field GPTRST[30] (RW)
 *
 * General Purpose Timer Reset
 *
 * Values:
...
/* --- Register HW_USBC_UOG_GPTIMER1CTRL, field GPTRUN[31] (RW)
 *
 * General Purpose Timer Run GPTCNT bits are not effected when setting or clearing this bit.
 *
 * Values:
...
/*
 * constants & macros for entire USBC_UOG_SBUSCFG register
 */
...
/* --- Register HW_USBC_UOG_SBUSCFG, field AHBBRST[2:0] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_CAPLENGTH register
 */
...
/* --- Register HW_USBC_UOG_CAPLENGTH, field CAPLENGTH[7:0] (RO)
 *
...
/*
 * constants & macros for entire USBC_UOG_HCIVERSION register
 */
...
/* --- Register HW_USBC_UOG_HCIVERSION, field HCIVERSION[15:0] (RO)
 *
...
/*
 * constants & macros for entire USBC_UOG_HCSPARAMS register
 */
...
/* --- Register HW_USBC_UOG_HCSPARAMS, field N_PORTS[3:0] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCSPARAMS, field PPC[4] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCSPARAMS, field N_PCC[11:8] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCSPARAMS, field N_CC[15:12] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCSPARAMS, field PI[16] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCSPARAMS, field N_PTT[23:20] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCSPARAMS, field N_TT[27:24] (RO)
 *
...
/*
 * constants & macros for entire USBC_UOG_HCCPARAMS register
 */
...
/* --- Register HW_USBC_UOG_HCCPARAMS, field ADC[0] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCCPARAMS, field PFL[1] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCCPARAMS, field ASP[2] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCCPARAMS, field IST[7:4] (RO)
 *
...
/* --- Register HW_USBC_UOG_HCCPARAMS, field EECP[15:8] (RO)
 *
...
/* --- Register HW_USBC_UOG_DCCPARAMS, field DC[7] (RO)
 *
...
/* --- Register HW_USBC_UOG_DCCPARAMS, field HC[8] (RO)
 *
...
/*
 * constants & macros for entire USBC_UOG_USBCMD register
 */
...
/* --- Register HW_USBC_UOG_USBCMD, field RS[0] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field RST[1] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field FS[3:2] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field PSE[4] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field ASE[5] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field IAA[6] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field ASP[9:8] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field ASPE[11] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field SUTW[13] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field ATDTW[14] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field FS1[15] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBCMD, field ITC[23:16] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_USBSTS register
 */
...
/* --- Register HW_USBC_UOG_USBSTS, field UI[0] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field UEI[1] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field PCI[2] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field FRI[3] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field SEI[4] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field AAI[5] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field URI[6] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field SRI[7] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field SLI[8] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field ULPII[10] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field HCH[12] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field RCL[13] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field PS[14] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field AS[15] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field NAKI[16] (RO)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field TI0[24] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBSTS, field TI1[25] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_USBINTR register
 */
...
/* --- Register HW_USBC_UOG_USBINTR, field UE[0] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field UEE[1] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field PCE[2] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field FRE[3] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field SEE[4] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field AAE[5] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field URE[6] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field SRE[7] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field SLE[8] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field ULPIE[10] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field NAKE[16] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field UAIE[18] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field UPIE[19] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field TIE0[24] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBINTR, field TIE1[25] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_FRINDEX register
 */
...
/* --- Register HW_USBC_UOG_FRINDEX, field FRINDEX[13:0] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_PERIODICLISTBASE register
 */
...
/* --- Register HW_USBC_UOG_PERIODICLISTBASE, field BASEADR[31:12] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_ASYNCLISTADDR register
 */
...
/* --- Register HW_USBC_UOG_ASYNCLISTADDR, field ASYBASE[31:5] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_BURSTSIZE register
 */
...
/* --- Register HW_USBC_UOG_BURSTSIZE, field RXPBURST[7:0] (RW)
 *
...
/* --- Register HW_USBC_UOG_BURSTSIZE, field TXPBURST[16:8] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_TXFILLTUNING register
 */
...
/* --- Register HW_USBC_UOG_TXFILLTUNING, field TXSCHOH[7:0] (RW)
 *
...
/* --- Register HW_USBC_UOG_TXFILLTUNING, field TXSCHHEALTH[12:8] (RW)
 *
...
/* --- Register HW_USBC_UOG_TXFILLTUNING, field TXFIFOTHRES[21:16] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_CONFIGFLAG register
 */
...
/* --- Register HW_USBC_UOG_CONFIGFLAG, field CF[0] (RO)
 *
...
/*
 * constants & macros for entire USBC_UOG_PORTSC1 register
 */
...
/* --- Register HW_USBC_UOG_PORTSC1, field CCS[0] (RO)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field CSC[1] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PE[2] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PEC[3] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field FPR[6] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field SUSP[7] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PR[8] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field HSP[9] (RO)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field LS[11:10] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PP[12] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PO[13] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PIC[15:14] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PTC[19:16] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field WKCN[20] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field WKDC[21] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field WKOC[22] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PHCD[23] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PFSC[24] (RW)
 *
...
/* --- Register HW_USBC_UOG_PORTSC1, field PTS[25] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field VD[0] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field VC[1] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field OT[3] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field DP[4] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field IDPU[5] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field ID[8] (RO)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field AVV[9] (RO)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field ASV[10] (RO)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field BSV[11] (RO)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field BSE[12] (RO)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field _1MST[13] (RO)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field DPS[14] (RO)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field IDIS[16] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field AVVIS[17] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field ASVIS[18] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field BSVIS[19] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field BSEIS[20] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field _1MSS[21] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field DPIS[22] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field IDIE[24] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field AVVIE[25] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field ASVIE[26] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field BSVIE[27] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field BSEIE[28] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field _1MSE[29] (RW)
 *
...
/* --- Register HW_USBC_UOG_OTGSC, field DPIE[30] (RW)
 *
...
/*
 * constants & macros for entire USBC_UOG_USBMODE register
 */
...
/* --- Register HW_USBC_UOG_USBMODE, field CM[1:0] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBMODE, field ES[2] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBMODE, field SLOM[3] (RW)
 *
...
/* --- Register HW_USBC_UOG_USBMODE, field SDIS[4] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL0, field RXS[0] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL0, field RXE[7] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL0, field TXS[16] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL0, field TXE[23] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field RXS[0] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field RXD[1] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field RXI[5] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field RXR[6] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field RXE[7] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field TXS[16] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field TXD[17] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field TXI[21] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field TXR[22] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL1, field TXE[23] (RW)
 *
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field RXS[0] (RW)
 *
 * RX Endpoint Stall - Read/Write 0 End Point OK. [Default] 1 End Point Stalled This bit is set
 * automatically upon receipt of a SETUP request if this Endpoint is not configured as a Control
 * Endpoint. It is cleared automatically upon receipt a SETUP request if this Endpoint is configured
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field RXD[1] (RW)
 *
 * RX Endpoint Data Sink - Read/Write - TBD 0 Dual Port Memory Buffer/DMA Engine [Default] Should
 * always be written as zero.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field RXI[5] (RW)
 *
 * RX Data Toggle Inhibit 0 Disabled [Default] 1 Enabled This bit is only used for test and should
 * always be written as zero. Writing a one to this bit causes this endpoint to ignore the data
 * toggle sequence and always accept data packet regardless of their data PID.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field RXR[6] (RW)
 *
 * RX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field RXE[7] (RW)
 *
 * RX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field TXS[16] (RW)
 *
 * TX Endpoint Stall - Read/Write 0 End Point OK 1 End Point Stalled This bit is set automatically
 * upon receipt of a SETUP request if this Endpoint is not configured as a Control Endpoint. It is
 * cleared automatically upon receipt of a SETUP request if this Endpoint is configured as a Control
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field TXD[17] (RW)
 *
 * TX Endpoint Data Source - Read/Write 0 Dual Port Memory Buffer/DMA Engine [DEFAULT] Should always
 * be written as 0.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field TXI[21] (RW)
 *
 * TX Data Toggle Inhibit 0 PID Sequencing Enabled. [Default] 1 PID Sequencing Disabled. This bit is
 * only used for test and should always be written as zero. Writing a one to this bit causes this
 * endpoint to ignore the data toggle sequence and always transmit DATA0 for a data packet.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field TXR[22] (RW)
 *
 * TX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the Host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL2, field TXE[23] (RW)
 *
 * TX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field RXS[0] (RW)
 *
 * RX Endpoint Stall - Read/Write 0 End Point OK. [Default] 1 End Point Stalled This bit is set
 * automatically upon receipt of a SETUP request if this Endpoint is not configured as a Control
 * Endpoint. It is cleared automatically upon receipt a SETUP request if this Endpoint is configured
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field RXD[1] (RW)
 *
 * RX Endpoint Data Sink - Read/Write - TBD 0 Dual Port Memory Buffer/DMA Engine [Default] Should
 * always be written as zero.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field RXI[5] (RW)
 *
 * RX Data Toggle Inhibit 0 Disabled [Default] 1 Enabled This bit is only used for test and should
 * always be written as zero. Writing a one to this bit causes this endpoint to ignore the data
 * toggle sequence and always accept data packet regardless of their data PID.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field RXR[6] (RW)
 *
 * RX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field RXE[7] (RW)
 *
 * RX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field TXS[16] (RW)
 *
 * TX Endpoint Stall - Read/Write 0 End Point OK 1 End Point Stalled This bit is set automatically
 * upon receipt of a SETUP request if this Endpoint is not configured as a Control Endpoint. It is
 * cleared automatically upon receipt of a SETUP request if this Endpoint is configured as a Control
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field TXD[17] (RW)
 *
 * TX Endpoint Data Source - Read/Write 0 Dual Port Memory Buffer/DMA Engine [DEFAULT] Should always
 * be written as 0.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field TXI[21] (RW)
 *
 * TX Data Toggle Inhibit 0 PID Sequencing Enabled. [Default] 1 PID Sequencing Disabled. This bit is
 * only used for test and should always be written as zero. Writing a one to this bit causes this
 * endpoint to ignore the data toggle sequence and always transmit DATA0 for a data packet.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field TXR[22] (RW)
 *
 * TX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the Host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL3, field TXE[23] (RW)
 *
 * TX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field RXS[0] (RW)
 *
 * RX Endpoint Stall - Read/Write 0 End Point OK. [Default] 1 End Point Stalled This bit is set
 * automatically upon receipt of a SETUP request if this Endpoint is not configured as a Control
 * Endpoint. It is cleared automatically upon receipt a SETUP request if this Endpoint is configured
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field RXD[1] (RW)
 *
 * RX Endpoint Data Sink - Read/Write - TBD 0 Dual Port Memory Buffer/DMA Engine [Default] Should
 * always be written as zero.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field RXI[5] (RW)
 *
 * RX Data Toggle Inhibit 0 Disabled [Default] 1 Enabled This bit is only used for test and should
 * always be written as zero. Writing a one to this bit causes this endpoint to ignore the data
 * toggle sequence and always accept data packet regardless of their data PID.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field RXR[6] (RW)
 *
 * RX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field RXE[7] (RW)
 *
 * RX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field TXS[16] (RW)
 *
 * TX Endpoint Stall - Read/Write 0 End Point OK 1 End Point Stalled This bit is set automatically
 * upon receipt of a SETUP request if this Endpoint is not configured as a Control Endpoint. It is
 * cleared automatically upon receipt of a SETUP request if this Endpoint is configured as a Control
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field TXD[17] (RW)
 *
 * TX Endpoint Data Source - Read/Write 0 Dual Port Memory Buffer/DMA Engine [DEFAULT] Should always
 * be written as 0.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field TXI[21] (RW)
 *
 * TX Data Toggle Inhibit 0 PID Sequencing Enabled. [Default] 1 PID Sequencing Disabled. This bit is
 * only used for test and should always be written as zero. Writing a one to this bit causes this
 * endpoint to ignore the data toggle sequence and always transmit DATA0 for a data packet.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field TXR[22] (RW)
 *
 * TX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the Host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL4, field TXE[23] (RW)
 *
 * TX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field RXS[0] (RW)
 *
 * RX Endpoint Stall - Read/Write 0 End Point OK. [Default] 1 End Point Stalled This bit is set
 * automatically upon receipt of a SETUP request if this Endpoint is not configured as a Control
 * Endpoint. It is cleared automatically upon receipt a SETUP request if this Endpoint is configured
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field RXD[1] (RW)
 *
 * RX Endpoint Data Sink - Read/Write - TBD 0 Dual Port Memory Buffer/DMA Engine [Default] Should
 * always be written as zero.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field RXI[5] (RW)
 *
 * RX Data Toggle Inhibit 0 Disabled [Default] 1 Enabled This bit is only used for test and should
 * always be written as zero. Writing a one to this bit causes this endpoint to ignore the data
 * toggle sequence and always accept data packet regardless of their data PID.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field RXR[6] (RW)
 *
 * RX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field RXE[7] (RW)
 *
 * RX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field TXS[16] (RW)
 *
 * TX Endpoint Stall - Read/Write 0 End Point OK 1 End Point Stalled This bit is set automatically
 * upon receipt of a SETUP request if this Endpoint is not configured as a Control Endpoint. It is
 * cleared automatically upon receipt of a SETUP request if this Endpoint is configured as a Control
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field TXD[17] (RW)
 *
 * TX Endpoint Data Source - Read/Write 0 Dual Port Memory Buffer/DMA Engine [DEFAULT] Should always
 * be written as 0.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field TXI[21] (RW)
 *
 * TX Data Toggle Inhibit 0 PID Sequencing Enabled. [Default] 1 PID Sequencing Disabled. This bit is
 * only used for test and should always be written as zero. Writing a one to this bit causes this
 * endpoint to ignore the data toggle sequence and always transmit DATA0 for a data packet.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field TXR[22] (RW)
 *
 * TX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the Host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL5, field TXE[23] (RW)
 *
 * TX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field RXS[0] (RW)
 *
 * RX Endpoint Stall - Read/Write 0 End Point OK. [Default] 1 End Point Stalled This bit is set
 * automatically upon receipt of a SETUP request if this Endpoint is not configured as a Control
 * Endpoint. It is cleared automatically upon receipt a SETUP request if this Endpoint is configured
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field RXD[1] (RW)
 *
 * RX Endpoint Data Sink - Read/Write - TBD 0 Dual Port Memory Buffer/DMA Engine [Default] Should
 * always be written as zero.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field RXI[5] (RW)
 *
 * RX Data Toggle Inhibit 0 Disabled [Default] 1 Enabled This bit is only used for test and should
 * always be written as zero. Writing a one to this bit causes this endpoint to ignore the data
 * toggle sequence and always accept data packet regardless of their data PID.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field RXR[6] (RW)
 *
 * RX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field RXE[7] (RW)
 *
 * RX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field TXS[16] (RW)
 *
 * TX Endpoint Stall - Read/Write 0 End Point OK 1 End Point Stalled This bit is set automatically
 * upon receipt of a SETUP request if this Endpoint is not configured as a Control Endpoint. It is
 * cleared automatically upon receipt of a SETUP request if this Endpoint is configured as a Control
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field TXD[17] (RW)
 *
 * TX Endpoint Data Source - Read/Write 0 Dual Port Memory Buffer/DMA Engine [DEFAULT] Should always
 * be written as 0.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field TXI[21] (RW)
 *
 * TX Data Toggle Inhibit 0 PID Sequencing Enabled. [Default] 1 PID Sequencing Disabled. This bit is
 * only used for test and should always be written as zero. Writing a one to this bit causes this
 * endpoint to ignore the data toggle sequence and always transmit DATA0 for a data packet.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field TXR[22] (RW)
 *
 * TX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the Host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL6, field TXE[23] (RW)
 *
 * TX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field RXS[0] (RW)
 *
 * RX Endpoint Stall - Read/Write 0 End Point OK. [Default] 1 End Point Stalled This bit is set
 * automatically upon receipt of a SETUP request if this Endpoint is not configured as a Control
 * Endpoint. It is cleared automatically upon receipt a SETUP request if this Endpoint is configured
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field RXD[1] (RW)
 *
 * RX Endpoint Data Sink - Read/Write - TBD 0 Dual Port Memory Buffer/DMA Engine [Default] Should
 * always be written as zero.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field RXI[5] (RW)
 *
 * RX Data Toggle Inhibit 0 Disabled [Default] 1 Enabled This bit is only used for test and should
 * always be written as zero. Writing a one to this bit causes this endpoint to ignore the data
 * toggle sequence and always accept data packet regardless of their data PID.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field RXR[6] (RW)
 *
 * RX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field RXE[7] (RW)
 *
 * RX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field TXS[16] (RW)
 *
 * TX Endpoint Stall - Read/Write 0 End Point OK 1 End Point Stalled This bit is set automatically
 * upon receipt of a SETUP request if this Endpoint is not configured as a Control Endpoint. It is
 * cleared automatically upon receipt of a SETUP request if this Endpoint is configured as a Control
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field TXD[17] (RW)
 *
 * TX Endpoint Data Source - Read/Write 0 Dual Port Memory Buffer/DMA Engine [DEFAULT] Should always
 * be written as 0.
 */
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field TXI[21] (RW)
 *
 * TX Data Toggle Inhibit 0 PID Sequencing Enabled. [Default] 1 PID Sequencing Disabled. This bit is
 * only used for test and should always be written as zero. Writing a one to this bit causes this
 * endpoint to ignore the data toggle sequence and always transmit DATA0 for a data packet.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field TXR[22] (RW)
 *
 * TX Data Toggle Reset (WS) Write 1 - Reset PID Sequence Whenever a configuration event is received
 * for this Endpoint, software must write a one to this bit in order to synchronize the data PID's
 * between the Host and device.
...
/* --- Register HW_USBC_UOG_ENDPTCTRL7, field TXE[23] (RW)
 *
 * TX Endpoint Enable 0 Disabled [Default] 1 Enabled An Endpoint should be enabled only after it has
 * been configured.
 */
...
/*
 * constants & macros for entire USBC_UH2_ID register
 */
...
/* --- Register HW_USBC_UH2_ID, field ID[5:0] (RO)
 *
 * Configuration number. This number is set to 0x05 and indicates that the peripheral is USB 2.0
 * High-Speed core.
 */
...
/* --- Register HW_USBC_UH2_ID, field NID[13:8] (RO)
 *
 * Complement version of ID
 */
...
/* --- Register HW_USBC_UH2_ID, field REVISION[23:16] (RO)
 *
 * Revision number of the controller core.
 */
...
/*
 * constants & macros for entire USBC_UH2_HWGENERAL register
 */
...
/*
 * constants & macros for entire USBC_UH2_HWHOST register
 */
...
/* --- Register HW_USBC_UH2_HWHOST, field HC[0] (RO)
 *
 * Host Capable. Indicating whether host operation mode is supported or not.
 *
 * Values:
...
/* --- Register HW_USBC_UH2_HWHOST, field NPORT[3:1] (RO)
 *
 * The Nmber of downstream ports supported by the host controller is (NPORT+1). When these bits
 * value is '000', it indicates a single-port host controller.
 */
...
/*
 * constants & macros for entire USBC_UH2_HWTXBUF register
 */
...
/* --- Register HW_USBC_UH2_HWTXBUF, field TXBURST[7:0] (RO)
 *
 * Default burst size for memory to TX buffer transfer. This is reset value of TXPBURST bits in USB
 * core regsiter USB_n_BURSTSIZE. Please see .
 */
...
/* --- Register HW_USBC_UH2_HWTXBUF, field TXCHANADD[23:16] (RO)
 *
 * TX FIFO Buffer size is: (2^TXCHANADD) * 4 Bytes. These bits are set to '08h', so buffer size is
 * 256*4 Bytes. For the OTG controller operating in device mode, this is the FIFO buffer size per
 * endpoint. As the OTG controller has 8 TX endpoint, there are 8 of these buffers. For the OTG
...
/*
 * constants & macros for entire USBC_UH2_HWRXBUF register
 */
...
/* --- Register HW_USBC_UH2_HWRXBUF, field RXBURST[7:0] (RO)
 *
 * Default burst size for memory to RX buffer transfer. This is reset value of RXPBURST bits in USB
 * core regsiter USB_n_BURSTSIZE. Please see .
 */
...
/* --- Register HW_USBC_UH2_HWRXBUF, field RXADD[15:8] (RO)
 *
 * Buffer total size for all receive endpoints is (2^RXADD). RX Buffer size is: (2^RXADD) * 4 Bytes.
 * These bits are set to '08h', so buffer size is 256*4 Bytes. There is a single Receive FIFO buffer
 * in the USB controller. The buffer is shared for all endpoints for the OTG controller in device
...
/*
 * constants & macros for entire USBC_UH2_GPTIMER0LD register
 */
...
/* --- Register HW_USBC_UH2_GPTIMER0LD, field GPTLD[23:0] (RW)
 *
 * General Purpose Timer Load Value These bit fields are loaded to GPTCNT bits when GPTRST bit is
 * set '1b'. This value represents the time in microseconds minus 1 for the timer duration. Example:
 * for a one millisecond timer, load 1000-1=999 or 0x0003E7. Max value is 0xFFFFFF or 16.777215
...
/*
 * constants & macros for entire USBC_UH2_GPTIMER0CTRL register
 */
...
/* --- Register HW_USBC_UH2_GPTIMER0CTRL, field GPTCNT[23:0] (RW)
 *
 * General Purpose Timer Counter. This field is the count value of the countdown timer.
 */
...
/* --- Register HW_USBC_UH2_GPTIMER0CTRL, field GPTMODE[24] (RW)
 *
 * General Purpose Timer Mode In one shot mode, the timer will count down to zero, generate an
 * interrupt, and stop until the counter is reset by software; In repeat mode, the timer will count
 * down to zero, generate an interrupt and automatically reload the counter value from GPTLD bits to
...
/* --- Register HW_USBC_UH2_GPTIMER0CTRL, field GPTRST[30] (RW)
 *
 * General Purpose Timer Reset
 *
 * Values:
...
/* --- Register HW_USBC_UH2_GPTIMER0CTRL, field GPTRUN[31] (RW)
 *
 * General Purpose Timer Run GPTCNT bits are not effected when setting or clearing this bit.
 *
 * Values:
...
/*
 * constants & macros for entire USBC_UH2_GPTIMER1LD register
 */
...
/* --- Register HW_USBC_UH2_GPTIMER1LD, field GPTLD[23:0] (RW)
 *
 * General Purpose Timer Load Value These bit fields are loaded to GPTCNT bits when GPTRST bit is
 * set '1b'. This value represents the time in microseconds minus 1 for the timer duration. Example:
 * for a one millisecond timer, load 1000-1=999 or 0x0003E7. Max value is 0xFFFFFF or 16.777215
...
/*
 * constants & macros for entire USBC_UH2_GPTIMER1CTRL register
 */
...
/* --- Register HW_USBC_UH2_GPTIMER1CTRL, field GPTCNT[23:0] (RW)
 *
 * General Purpose Timer Counter. This field is the count value of the countdown timer.
 */
...
/* --- Register HW_USBC_UH2_GPTIMER1CTRL, field GPTMODE[24] (RW)
 *
 * General Purpose Timer Mode In one shot mode, the timer will count down to zero, generate an
 * interrupt, and stop until the counter is reset by software. In repeat mode, the timer will count
 * down to zero, generate an interrupt and automatically reload the counter value from GPTLD bits to
...
/* --- Register HW_USBC_UH2_GPTIMER1CTRL, field GPTRST[30] (RW)
 *
 * General Purpose Timer Reset
 *
 * Values:
...
/* --- Register HW_USBC_UH2_GPTIMER1CTRL, field GPTRUN[31] (RW)
 *
 * General Purpose Timer Run GPTCNT bits are not effected when setting or clearing this bit.
 *
 * Values:
...
/*
 * constants & macros for entire USBC_UH2_SBUSCFG register
 */
...
/* --- Register HW_USBC_UH2_SBUSCFG, field AHBBRST[2:0] (RW)
 *
 * AHB master interface Burst configuration These bits control AHB master transfer type sequence (or
 * priority). This register overrides n_BURSTSIZE register when its value is not zero.
 *
...
/*
 * constants & macros for entire USBC_UH2_CAPLENGTH register
 */
...
/* --- Register HW_USBC_UH2_CAPLENGTH, field CAPLENGTH[7:0] (RO)
 *
 * These bits are used as an offset to add to register base to find the beginning of the Operational
 * Register. Default value is '40h'.
 */
...
/*
 * constants & macros for entire USBC_UH2_HCIVERSION register
 */
...
/* --- Register HW_USBC_UH2_HCIVERSION, field HCIVERSION[15:0] (RO)
 *
 * Host Controller Interface Version Number Default value is '10h', which means EHCI rev1.0.
 */
...
/*
 * constants & macros for entire USBC_UH2_HCSPARAMS register
 */
...
/* --- Register HW_USBC_UH2_HCSPARAMS, field N_PORTS[3:0] (RO)
 *
 * Number of downstream ports. This field specifies the number of physical downstream ports
 * implemented on this host controller. The value of this field determines how many port registers
 * are addressable in the Operational Register. Valid values are in the range of 1h to Fh. A zero in
...
/* --- Register HW_USBC_UH2_HCSPARAMS, field PPC[4] (RO)
 *
 * Port Power Control This field indicates whether the host controller implementation includes port
 * power control. A one indicates the ports have port power switches. A zero indicates the ports do
 * not have port power switches. The value of this field affects the functionality of the Port Power
...
/* --- Register HW_USBC_UH2_HCSPARAMS, field N_PCC[11:8] (RO)
 *
 * Number of Ports per Companion Controller This field indicates the number of ports supported per
 * internal Companion Controller. It is used to indicate the port routing configuration to the
 * system software. For example, if N_PORTS has a value of 6 and N_CC has a value of 2 then N_PCC
...
/* --- Register HW_USBC_UH2_HCSPARAMS, field N_CC[15:12] (RO)
 *
 * Number of Companion Controller (N_CC). This field indicates the number of companion controllers
 * associated with this USB2.0 host controller. These bits are '0000b' in all controller core.
 *
...
/* --- Register HW_USBC_UH2_HCSPARAMS, field PI[16] (RO)
 *
 * Port Indicators (P INDICATOR) This bit indicates whether the ports support port indicator
 * control. When set to one, the port status and control registers include a read/writeable field
 * for controlling the state of the port indicator This bit is "1b" in all controller core.
...
/* --- Register HW_USBC_UH2_HCSPARAMS, field N_PTT[23:20] (RO)
 *
 * Number of Ports per Transaction Translator (N_PTT). Default value '0000b' This field indicates
 * the number of ports assigned to each transaction translator within the USB2.0 host controller.
 * These bits would be set to equal N_PORTS for Multi-Port Host, and '0000b' for Single-Port Host.
...
/* --- Register HW_USBC_UH2_HCSPARAMS, field N_TT[27:24] (RO)
 *
 * Number of Transaction Translators (N_TT). Default value '0000b' This field indicates the number
 * of embedded transaction translators associated with the USB2.0 host controller. These bits would
 * be set to '0001b' for Multi-Port Host, and '0000b' for Single-Port Host.
...
/*
 * constants & macros for entire USBC_UH2_HCCPARAMS register
 */
...
/* --- Register HW_USBC_UH2_HCCPARAMS, field ADC[0] (RO)
 *
 * 64-bit Addressing Capability This bit is set '0b' in all controller core, no 64-bit addressing
 * capability is supported.
 */
...
/* --- Register HW_USBC_UH2_HCCPARAMS, field PFL[1] (RO)
 *
 * Programmable Frame List Flag If this bit is set to zero, then the system software must use a
 * frame list length of 1024 elements with this host controller. The USBCMD register Frame List Size
 * field is a read-only register and must be set to zero. If set to a one, then the system software
...
/* --- Register HW_USBC_UH2_HCCPARAMS, field ASP[2] (RO)
 *
 * Asynchronous Schedule Park Capability If this bit is set to a one, then the host controller
 * supports the park feature for high-speed queue heads in the Asynchronous Schedule. The feature
 * can be disabled or enabled and set to a specific level by using the Asynchronous Schedule Park
...
/* --- Register HW_USBC_UH2_HCCPARAMS, field IST[7:4] (RO)
 *
 * Isochronous Scheduling Threshold. This field indicates, relative to the current position of the
 * executing host controller, where software can reliably update the isochronous schedule. When bit
 * [7] is zero, the value of the least significant 3 bits indicates the number of micro-frames a
...
/* --- Register HW_USBC_UH2_HCCPARAMS, field EECP[15:8] (RO)
 *
 * EHCI Extended Capabilities Pointer. This field indicates the existence of a capabilities list. A
 * value of 00h indicates no extended capabilities are implemented. A non-zero value in this
 * register indicates the offset in PCI configuration space of the first EHCI extended capability.
...
/*
 * constants & macros for entire USBC_UH2_USBCMD register
 */
...
/* --- Register HW_USBC_UH2_USBCMD, field RS[0] (RW)
 *
 * Run/Stop (RS) - Read/Write. Default 0b. 1=Run. 0=Stop. Host operation mode: When set to '1b', the
 * Controller proceeds with the execution of the schedule. The Controller continues execution as
 * long as this bit is set to a one. When this bit is set to 0, the Host Controller completes the
...
/* --- Register HW_USBC_UH2_USBCMD, field RST[1] (RW)
 *
 * Controller Reset (RESET) - Read/Write. Software uses this bit to reset the controller. This bit
 * is set to zero by the Host/Device Controller when the reset process is complete. Software cannot
 * terminate the reset process early by writing a zero to this register. Host operation mode: When
...
/* --- Register HW_USBC_UH2_USBCMD, field FS[3:2] (RW)
 *
 * See description at bit 15
 */
...
/* --- Register HW_USBC_UH2_USBCMD, field PSE[4] (RW)
 *
 * Periodic Schedule Enable- Read/Write. Default 0b. This bit controls whether the host controller
 * skips processing the Periodic Schedule. Only the host controller uses this bit. Values Meaning
 *
...
/* --- Register HW_USBC_UH2_USBCMD, field ASE[5] (RW)
 *
 * Asynchronous Schedule Enable - Read/Write. Default 0b. This bit controls whether the host
 * controller skips processing the Asynchronous Schedule. Only the host controller uses this bit.
 * Values Meaning
...
/* --- Register HW_USBC_UH2_USBCMD, field IAA[6] (RW)
 *
 * Interrupt on Async Advance Doorbell - Read/Write. This bit is used as a doorbell by software to
 * tell the host controller to issue an interrupt the next time it advances asynchronous schedule.
 * Software must write a 1 to this bit to ring the doorbell. When the host controller has evicted
...
/* --- Register HW_USBC_UH2_USBCMD, field ASP[9:8] (RW)
 *
 * Asynchronous Schedule Park Mode Count - Read/Write. If the Asynchronous Park Capability bit in
 * the HCCPARAMS register is a one, then this field defaults to 3h and is R/W. Otherwise it defaults
 * to zero and is Read-Only. It contains a count of the number of successive transactions the host
...
/* --- Register HW_USBC_UH2_USBCMD, field ASPE[11] (RW)
 *
 * Asynchronous Schedule Park Mode Enable - Read/Write. If the Asynchronous Park Capability bit in
 * the HCCPARAMS register is a one, then this bit defaults to a 1h and is R/W. Otherwise the bit
 * must be a zero and is RO. Software uses this bit to enable or disable Park mode. When this bit is
...
/* --- Register HW_USBC_UH2_USBCMD, field SUTW[13] (RW)
 *
 * Setup TripWire - Read/Write. [device mode only] This bit is used as a semaphore to ensure that
 * the setup data payload of 8 bytes is extracted from a QH by the DCD without being corrupted. If
 * the setup lockout mode is off (SLOM bit in USB core register n_USBMODE, see ) then there is a
...
/* --- Register HW_USBC_UH2_USBCMD, field ATDTW[14] (RW)
 *
 * Add dTD TripWire - Read/Write. [device mode only] This bit is used as a semaphore to ensure
 * proper addition of a new dTD to an active (primed) endpoint's linked list. This bit is set and
 * cleared by software. This bit would also be cleared by hardware when state machine is hazard
...
/* --- Register HW_USBC_UH2_USBCMD, field FS1[15] (RW)
 *
 * See also bits 3-2 Frame List Size - (Read/Write or Read Only). [host mode only] This field is
 * Read/Write only if Programmable Frame List Flag in the HCCPARAMS registers is set to one. This
 * field specifies the size of the frame list that controls which bits in the Frame Index Register
...
/* --- Register HW_USBC_UH2_USBCMD, field ITC[23:16] (RW)
 *
 * Interrupt Threshold Control -Read/Write. The system software uses this field to set the maximum
 * rate at which the host/device controller will issue interrupts. ITC contains the maximum
 * interrupt interval measured in micro-frames. Valid values are shown below. Value Maximum
...
/*
 * constants & macros for entire USBC_UH2_USBSTS register
 */
...
/* --- Register HW_USBC_UH2_USBSTS, field UI[0] (RW)
 *
 * USB Interrupt (USBINT) - R/WC. This bit is set by the Host/Device Controller when the cause of an
 * interrupt is a completion of a USB transaction where the Transfer Descriptor (TD) has an
 * interrupt on complete (IOC) bit set. This bit is also set by the Host/Device Controller when a
...
/* --- Register HW_USBC_UH2_USBSTS, field UEI[1] (RW)
 *
 * USB Error Interrupt (USBERRINT) - R/WC. When completion of a USB transaction results in an error
 * condition, this bit is set by the Host/Device Controller. This bit is set along with the USBINT
 * bit, if the TD on which the error interrupt occurred also had its interrupt on complete (IOC) bit
...
/* --- Register HW_USBC_UH2_USBSTS, field PCI[2] (RW)
 *
 * Port Change Detect - R/WC. The Host Controller sets this bit to a one when on any port a Connect
 * Status occurs, a Port Enable/Disable Change occurs, or the Force Port Resume bit is set as the
 * result of a J-K transition on the suspended port. The Device Controller sets this bit to a one
...
/* --- Register HW_USBC_UH2_USBSTS, field FRI[3] (RW)
 *
 * Frame List Rollover - R/WC. The Host Controller sets this bit to a one when the Frame List Index
 * rolls over from its maximum value to zero. The exact value at which the rollover occurs depends
 * on the frame list size. For example. If the frame list size (as programmed in the Frame List Size
...
/* --- Register HW_USBC_UH2_USBSTS, field SEI[4] (RW)
 *
 * System Error- R/WC. This bit is will be set to '1b' when an Error response is seen to a read on
 * the system interface.
 */
...
/* --- Register HW_USBC_UH2_USBSTS, field AAI[5] (RW)
 *
 * Interrupt on Async Advance - R/WC. System software can force the host controller to issue an
 * interrupt the next time the host controller advances the asynchronous schedule by writing a one
 * to the Interrupt on Async Advance Doorbell bit in the n_USBCMD register. This status bit
...
/* --- Register HW_USBC_UH2_USBSTS, field URI[6] (RW)
 *
 * USB Reset Received - R/WC. When the device controller detects a USB Reset and enters the default
 * state, this bit will be set to a one. Software can write a 1 to this bit to clear the USB Reset
 * Received status bit. Only used in device operation mode.
...
/* --- Register HW_USBC_UH2_USBSTS, field SRI[7] (RW)
 *
 * SOF Received - R/WC. When the device controller detects a Start Of (micro) Frame, this bit will
 * be set to a one. When a SOF is extremely late, the device controller will automatically set this
 * bit to indicate that an SOF was expected. Therefore, this bit will be set roughly every 1ms in
...
/* --- Register HW_USBC_UH2_USBSTS, field SLI[8] (RW)
 *
 * DCSuspend - R/WC. When a controller enters a suspend state from an active state, this bit will be
 * set to a one. The device controller clears the bit upon exiting from a suspend state. Only used
 * in device operation mode.
...
/* --- Register HW_USBC_UH2_USBSTS, field ULPII[10] (RW)
 *
 * ULPI Interrupt - R/WC. This bit will be set '1b' by hardware when there is an event completion in
 * ULPI viewport. This bit is usable only if the controller support UPLI interface mode.
 */
...
/* --- Register HW_USBC_UH2_USBSTS, field HCH[12] (RW)
 *
 * HCHaIted - Read Only. This bit is a zero whenever the Run/Stop bit is a one. The Controller sets
 * this bit to one after it has stopped executing because of the Run/Stop bit being set to 0, either
 * by software or by the Controller hardware (for example, an internal error). Only used in the host
...
/* --- Register HW_USBC_UH2_USBSTS, field RCL[13] (RW)
 *
 * Reclamation - Read Only. This is a read-only status bit used to detect an empty asynchronous
 * schedule. Only used in the host operation mode.
 */
...
/* --- Register HW_USBC_UH2_USBSTS, field PS[14] (RW)
 *
 * Periodic Schedule Status - Read Only. This bit reports the current real status of the Periodic
 * Schedule. When set to zero the periodic schedule is disabled, and if set to one the status is
 * enabled. The Host Controller is not required to immediately disable or enable the Periodic
...
/* --- Register HW_USBC_UH2_USBSTS, field AS[15] (RW)
 *
 * Asynchronous Schedule Status - Read Only. This bit reports the current real status of the
 * Asynchronous Schedule. When set to zero the asynchronous schedule status is disabled and if set
 * to one the status is enabled. The Host Controller is not required to immediately disable or
...
/* --- Register HW_USBC_UH2_USBSTS, field NAKI[16] (RO)
 *
 * NAK Interrupt Bit--RO. This bit is set by hardware when for a particular endpoint both the TX/RX
 * Endpoint NAK bit and corresponding TX/RX Endpoint NAK Enable bit are set. This bit is
 * automatically cleared by hardware when all Enabled TX/RX Endpoint NAK bits are cleared.
...
/* --- Register HW_USBC_UH2_USBSTS, field TI0[24] (RW)
 *
 * General Purpose Timer Interrupt 0(GPTINT0)--R/WC. This bit is set when the counter in the
 * GPTIMER0CTRL register transitions to zero, writing a one to this bit clears it.
 */
...
/* --- Register HW_USBC_UH2_USBSTS, field TI1[25] (RW)
 *
 * General Purpose Timer Interrupt 1(GPTINT1)--R/WC. This bit is set when the counter in the
 * GPTIMER1CTRL register transitions to zero, writing a one to this bit will clear it.
 */
...
/*
 * constants & macros for entire USBC_UH2_USBINTR register
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field UE[0] (RW)
 *
 * USB Interrupt Enalbe When this bit is one and the UI bit in n_USBSTS register is a one the
 * controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field UEE[1] (RW)
 *
 * USB Error Interrupt Enable When this bit is one and the UEI bit in n_USBSTS register is a one the
 * controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field PCE[2] (RW)
 *
 * Port Change Detect Interrupt Enable When this bit is one and the PCI bit in n_USBSTS register is
 * a one the controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field FRE[3] (RW)
 *
 * Frame List Rollover Interrupt Enable When this bit is one and the FRI bit in n_USBSTS register is
 * a one the controller will issue an interrupt. Only used in host operation mode.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field SEE[4] (RW)
 *
 * System Error Interrupt Enable When this bit is one and the SEI bit in n_USBSTS register is a one
 * the controller will issue an interrupt. Only used in host operation mode.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field AAE[5] (RW)
 *
 * Async Advance Interrupt Enable When this bit is one and the AAI bit in n_USBSTS register is a one
 * the controller will issue an interrupt. Only used in host operation mode.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field URE[6] (RW)
 *
 * USB Reset Interrupt Enable When this bit is one and the URI bit in n_USBSTS register is a one the
 * controller will issue an interrupt. Only used in device operation mode.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field SRE[7] (RW)
 *
 * SOF Received Interrupt Enable When this bit is one and the SRI bit in n_USBSTS register is a one
 * the controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field SLE[8] (RW)
 *
 * Sleep Interrupt Enable When this bit is one and the SLI bit in n_n_USBSTS register is a one the
 * controller will issue an interrupt. Only used in device operation mode.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field ULPIE[10] (RW)
 *
 * ULPI Interrupt Enable When this bit is one and the UPLII bit in n_USBSTS register is a one the
 * controller will issue an interrupt. This bit is usable only if the controller support UPLI
 * interface mode.
...
/* --- Register HW_USBC_UH2_USBINTR, field NAKE[16] (RW)
 *
 * NAK Interrupt Enable When this bit is one and the NAKI bit in n_USBSTS register is a one the
 * controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field UAIE[18] (RW)
 *
 * USB Host Asynchronous Interrupt Enable When this bit is one, and the UAI bit in the n_USBSTS
 * register is one, host controller will issue an interrupt at the next interrupt threshold.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field UPIE[19] (RW)
 *
 * USB Host Periodic Interrupt Enable When this bit is one, and the UPI bit in the n_USBSTS register
 * is one, host controller will issue an interrupt at the next interrupt threshold.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field TIE0[24] (RW)
 *
 * General Purpose Timer #0 Interrupt Enable When this bit is one and the TI0 bit in n_USBSTS
 * register is a one the controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH2_USBINTR, field TIE1[25] (RW)
 *
 * General Purpose Timer #1 Interrupt Enable When this bit is one and the TI1 bit in n_USBSTS
 * register is a one the controller will issue an interrupt.
 */
...
/*
 * constants & macros for entire USBC_UH2_FRINDEX register
 */
...
/* --- Register HW_USBC_UH2_FRINDEX, field FRINDEX[13:0] (RW)
 *
 * Frame Index. The value, in this register, increments at the end of each time frame (micro-frame).
 * Bits [N: 3] are used for the Frame List current index. This means that each location of the frame
 * list is accessed 8 times (frames or micro-frames) before moving to the next index. The following
...
/*
 * constants & macros for entire USBC_UH2_PERIODICLISTBASE register
 */
...
/* --- Register HW_USBC_UH2_PERIODICLISTBASE, field BASEADR[31:12] (RW)
 *
 * Base Address (Low). These bits correspond to memory address signals [31:12], respectively. Only
 * used by the host controller.
 */
...
/*
 * constants & macros for entire USBC_UH2_ASYNCLISTADDR register
 */
...
/* --- Register HW_USBC_UH2_ASYNCLISTADDR, field ASYBASE[31:5] (RW)
 *
 * Link Pointer Low (LPL). These bits correspond to memory address signals [31:5], respectively.
 * This field may only reference a Queue Head (QH). Only used by the host controller.
 */
...
/*
 * constants & macros for entire USBC_UH2_BURSTSIZE register
 */
...
/* --- Register HW_USBC_UH2_BURSTSIZE, field RXPBURST[7:0] (RW)
 *
 * Programmable RX Burst Size. Default value is determined by TXBURST bits in n_HWRXBUF. This
 * register represents the maximum length of a the burst in 32-bit words while moving data from the
 * USB bus to system memory.
...
/* --- Register HW_USBC_UH2_BURSTSIZE, field TXPBURST[16:8] (RW)
 *
 * Programmable TX Burst Size. Default value is determined by TXBURST bits in n_HWTXBUF. This
 * register represents the maximum length of a the burst in 32-bit words while moving data from
 * system memory to the USB bus.
...
/*
 * constants & macros for entire USBC_UH2_TXFILLTUNING register
 */
...
/* --- Register HW_USBC_UH2_TXFILLTUNING, field TXSCHOH[7:0] (RW)
 *
 * Scheduler Overhead. (Read/Write) [Default = 0] This register adds an additional fixed offset to
 * the schedule time estimator described above as Tff. As an approximation, the value chosen for
 * this register should limit the number of back-off events captured in the TXSCHHEALTH to less than
...
/* --- Register HW_USBC_UH2_TXFILLTUNING, field TXSCHHEALTH[12:8] (RW)
 *
 * Scheduler Health Counter. (Read/Write To Clear) This register increments when the host controller
 * fails to fill the TX latency FIFO to the level programmed by TXFIFOTHRES before running out of
 * time to send the packet before the next Start-Of-Frame. This health counter measures the number
...
/* --- Register HW_USBC_UH2_TXFILLTUNING, field TXFIFOTHRES[21:16] (RW)
 *
 * FIFO Burst Threshold. (Read/Write) This register controls the number of data bursts that are
 * posted to the TX latency FIFO in host mode before the packet begins on to the bus. The minimum
 * value is 2 and this value should be a low as possible to maximize USB performance. A higher value
...
/*
 * constants & macros for entire USBC_UH2_CONFIGFLAG register
 */
...
/* --- Register HW_USBC_UH2_CONFIGFLAG, field CF[0] (RO)
 *
 * Configure Flag Host software sets this bit as the last action in its process of configuring the
 * Host Controller. This bit controls the default port-routing control logic.
 *
...
/*
 * constants & macros for entire USBC_UH2_PORTSC1 register
 */
...
/* --- Register HW_USBC_UH2_PORTSC1, field CCS[0] (RO)
 *
 * Current Connect Status-Read Only. In Host Mode: 1=Device is present on port. 0=No device is
 * present. Default = 0. This value reflects the current state of the port, and may not correspond
 * directly to the event that caused the Connect Status Change bit (Bit 1) to be set. This field is
...
/* --- Register HW_USBC_UH2_PORTSC1, field CSC[1] (RW)
 *
 * Connect Status Change-R/WC. 1 =Change in Current Connect Status. 0=No change. Default 0. In Host
 * Mode: Indicates a change has occurred in the port's Current Connect Status. The host/device
 * controller sets this bit for all changes to the port device connect status, even if system
...
/* --- Register HW_USBC_UH2_PORTSC1, field PE[2] (RW)
 *
 * Port Enabled/Disabled-Read/Write. 1=Enable. 0=Disable. Default 0. In Host Mode: Ports can only be
 * enabled by the host controller as a part of the reset and enable. Software cannot enable a port
 * by writing a one to this field. Ports can be disabled by either a fault condition (disconnect
...
/* --- Register HW_USBC_UH2_PORTSC1, field PEC[3] (RW)
 *
 * Port Enable/Disable Change-R/WC. 1=Port enabled/disabled status has changed. 0=No change. Default
 * = 0. In Host Mode: For the root hub, this bit is set to a one only when a port is disabled due to
 * disconnect on the port or due to the appropriate conditions existing at the EOF2 point (See
...
/* --- Register HW_USBC_UH2_PORTSC1, field FPR[6] (RW)
 *
 * Force Port Resume -Read/Write. 1= Resume detected/driven on port. 0=No resume (K-state)
 * detected/driven on port. Default = 0. In Host Mode: Software sets this bit to one to drive resume
 * signaling. The Host Controller sets this bit to one if a J-to-K transition is detected while the
...
/* --- Register HW_USBC_UH2_PORTSC1, field SUSP[7] (RW)
 *
 * Suspend - Read/Write or Read Only. Default = 0b. 1=Port in suspend state. 0=Port not in suspend
 * state. In Host Mode: Read/Write. Port Enabled Bit and Suspend bit of this register define the
 * port states as follows: Bits [Port Enabled, Suspend] Port State 0x Disable 10 Enable 11 Suspend
...
/* --- Register HW_USBC_UH2_PORTSC1, field PR[8] (RW)
 *
 * Port Reset - Read/Write or Read Only. Default = 0b. In Host Mode: Read/Write. 1=Port is in Reset.
 * 0=Port is not in Reset. Default 0. When software writes a one to this bit the bus-reset sequence
 * as defined in the USB Specification Revision 2.0 is started. This bit will automatically change
...
/* --- Register HW_USBC_UH2_PORTSC1, field HSP[9] (RO)
 *
 * High-Speed Port - Read Only. Default = 0b. When the bit is one, the host/device connected to the
 * port is in high-speed mode and if set to zero, the host/device connected to the port is not in a
 * high-speed mode. HSP is redundant with PSPD(bit 27, 26) but remained for compatibility.
...
/* --- Register HW_USBC_UH2_PORTSC1, field LS[11:10] (RW)
 *
 * Line Status-Read Only. These bits reflect the current logical levels of the D+ (bit 11) and D-
 * (bit 10) signal lines. In host mode, the use of linestate by the host controller driver is not
 * necessary (unlike EHCI), because the port controller state machine and the port routing manage
...
/* --- Register HW_USBC_UH2_PORTSC1, field PP[12] (RW)
 *
 * Port Power (PP)-Read/Write or Read Only. The function of this bit depends on the value of the
 * Port Power Switching (PPC) field in the HCSPARAMS register. The behavior is as follows: PPC PP
 * Operation 0 1b Read Only - Host controller does not have port power control switches. Each port
...
/* --- Register HW_USBC_UH2_PORTSC1, field PO[13] (RW)
 *
 * Port Owner-Read/Write. Default = 0. This bit unconditionally goes to a 0 when the configured bit
 * in the CONFIGFLAG register makes a 0 to 1 transition. This bit unconditionally goes to 1 whenever
 * the Configured bit is zero System software uses this field to release ownership of the port to a
...
/* --- Register HW_USBC_UH2_PORTSC1, field PIC[15:14] (RW)
 *
 * Port Indicator Control - Read/Write. Default = Ob. Writing to this field has no effect if the
 * P_INDICATOR bit in the HCSPARAMS register is a zero. Refer to the USB Specification Revision 2.0
 * for a description on how these bits are to be used. This field is zero if Port Power is zero. Bit
...
/* --- Register HW_USBC_UH2_PORTSC1, field PTC[19:16] (RW)
 *
 * Port Test Control - Read/Write. Default = 0000b. Refer to for the operational model for using
 * these test modes and the USB Specification Revision 2.0, Chapter 7 for details on each test mode.
 * The FORCE_ENABLE_FS and FORCE ENABLE_LS are extensions to the test mode support specified in the
...
/* --- Register HW_USBC_UH2_PORTSC1, field WKCN[20] (RW)
 *
 * Wake on Connect Enable (WKCNNT_E) - Read/Write. Default=0b. Writing this bit to a one enables the
 * port to be sensitive to device connects as wake-up events. This field is zero if Port Power( ) is
 * zero or in device mode.
...
/* --- Register HW_USBC_UH2_PORTSC1, field WKDC[21] (RW)
 *
 * Wake on Disconnect Enable (WKDSCNNT_E) - Read/Write. Default=0b. Writing this bit to a one
 * enables the port to be sensitive to device disconnects as wake-up events. This field is zero if
 * Port Power( ) is zero or in device mode.
...
/* --- Register HW_USBC_UH2_PORTSC1, field WKOC[22] (RW)
 *
 * Wake on Over-current Enable (WKOC_E) - Read/Write. Default = 0b. Writing this bit to a one
 * enables the port to be sensitive to over-current conditions as wake-up events. This field is zero
 * if Port Power( ) is zero.
...
/* --- Register HW_USBC_UH2_PORTSC1, field PHCD[23] (RW)
 *
 * PHY Low Power Suspend - Clock Disable (PLPSCD) - Read/Write. Default = 0b. When this bit is set
 * to '1b', the PHY clock is disabled. Reading this bit will indicate the status of the PHY clock.
 * The PHY clock cannot be disabled if it is being used as the system clock. In device mode, The PHY
...
/* --- Register HW_USBC_UH2_PORTSC1, field PFSC[24] (RW)
 *
 * Port Force Full Speed Connect - Read/Write. Default = 0b. When this bit is set to '1b', the port
 * will be forced to only connect at Full Speed, It disables the chirp sequence that allows the port
 * to identify itself as High Speed.
...
/* --- Register HW_USBC_UH2_PORTSC1, field PTS[25] (RW)
 *
 * See description at bits 31-30
 */
...
/*
 * constants & macros for entire USBC_UH2_USBMODE register
 */
...
/* --- Register HW_USBC_UH2_USBMODE, field CM[1:0] (RW)
 *
 * Controller Mode - R/WO. Controller mode is defaulted to the proper mode for host only and device
 * only implementations. For those designs that contain both host & device capability, the
 * controller defaults to an idle state and needs to be initialized to the desired operating mode
...
/* --- Register HW_USBC_UH2_USBMODE, field ES[2] (RW)
 *
 * Endian Select - Read/Write. This bit can change the byte alignment of the transfer buffers to
 * match the host microprocessor. The bit fields in the microprocessor interface and the data
 * structures are unaffected by the value of this bit because they are based upon the 32-bit word.
...
/* --- Register HW_USBC_UH2_USBMODE, field SLOM[3] (RW)
 *
 * Setup Lockout Mode. In device mode, this bit controls behavior of the setup lock mechanism. See .
 *
 * Values:
...
/* --- Register HW_USBC_UH2_USBMODE, field SDIS[4] (RW)
 *
 * Stream Disable Mode. (0 - Inactive [default]; 1 - Active) Device Mode: Setting to a '1' disables
 * double priming on both RX and TX for low bandwidth systems. This mode ensures that when the RX
 * and TX buffers are sufficient to contain an entire packet that the standard double buffering
...
/*
 * constants & macros for entire USBC_UH3_ID register
 */
...
/* --- Register HW_USBC_UH3_ID, field ID[5:0] (RO)
 *
 * Configuration number. This number is set to 0x05 and indicates that the peripheral is USB 2.0
 * High-Speed core.
 */
...
/* --- Register HW_USBC_UH3_ID, field NID[13:8] (RO)
 *
 * Complement version of ID
 */
...
/* --- Register HW_USBC_UH3_ID, field REVISION[23:16] (RO)
 *
 * Revision number of the controller core.
 */
...
/*
 * constants & macros for entire USBC_UH3_HWGENERAL register
 */
...
/*
 * constants & macros for entire USBC_UH3_HWHOST register
 */
...
/* --- Register HW_USBC_UH3_HWHOST, field HC[0] (RO)
 *
 * Host Capable. Indicating whether host operation mode is supported or not.
 *
 * Values:
...
/* --- Register HW_USBC_UH3_HWHOST, field NPORT[3:1] (RO)
 *
 * The Nmber of downstream ports supported by the host controller is (NPORT+1). When these bits
 * value is '000', it indicates a single-port host controller.
 */
...
/*
 * constants & macros for entire USBC_UH3_HWTXBUF register
 */
...
/* --- Register HW_USBC_UH3_HWTXBUF, field TXBURST[7:0] (RO)
 *
 * Default burst size for memory to TX buffer transfer. This is reset value of TXPBURST bits in USB
 * core regsiter USB_n_BURSTSIZE. Please see .
 */
...
/* --- Register HW_USBC_UH3_HWTXBUF, field TXCHANADD[23:16] (RO)
 *
 * TX FIFO Buffer size is: (2^TXCHANADD) * 4 Bytes. These bits are set to '08h', so buffer size is
 * 256*4 Bytes. For the OTG controller operating in device mode, this is the FIFO buffer size per
 * endpoint. As the OTG controller has 8 TX endpoint, there are 8 of these buffers. For the OTG
...
/*
 * constants & macros for entire USBC_UH3_HWRXBUF register
 */
...
/* --- Register HW_USBC_UH3_HWRXBUF, field RXBURST[7:0] (RO)
 *
 * Default burst size for memory to RX buffer transfer. This is reset value of RXPBURST bits in USB
 * core regsiter USB_n_BURSTSIZE. Please see .
 */
...
/* --- Register HW_USBC_UH3_HWRXBUF, field RXADD[15:8] (RO)
 *
 * Buffer total size for all receive endpoints is (2^RXADD). RX Buffer size is: (2^RXADD) * 4 Bytes.
 * These bits are set to '08h', so buffer size is 256*4 Bytes. There is a single Receive FIFO buffer
 * in the USB controller. The buffer is shared for all endpoints for the OTG controller in device
...
/*
 * constants & macros for entire USBC_UH3_GPTIMER0LD register
 */
...
/* --- Register HW_USBC_UH3_GPTIMER0LD, field GPTLD[23:0] (RW)
 *
 * General Purpose Timer Load Value These bit fields are loaded to GPTCNT bits when GPTRST bit is
 * set '1b'. This value represents the time in microseconds minus 1 for the timer duration. Example:
 * for a one millisecond timer, load 1000-1=999 or 0x0003E7. Max value is 0xFFFFFF or 16.777215
...
/*
 * constants & macros for entire USBC_UH3_GPTIMER0CTRL register
 */
...
/* --- Register HW_USBC_UH3_GPTIMER0CTRL, field GPTCNT[23:0] (RW)
 *
 * General Purpose Timer Counter. This field is the count value of the countdown timer.
 */
...
/* --- Register HW_USBC_UH3_GPTIMER0CTRL, field GPTMODE[24] (RW)
 *
 * General Purpose Timer Mode In one shot mode, the timer will count down to zero, generate an
 * interrupt, and stop until the counter is reset by software; In repeat mode, the timer will count
 * down to zero, generate an interrupt and automatically reload the counter value from GPTLD bits to
...
/* --- Register HW_USBC_UH3_GPTIMER0CTRL, field GPTRST[30] (RW)
 *
 * General Purpose Timer Reset
 *
 * Values:
...
/* --- Register HW_USBC_UH3_GPTIMER0CTRL, field GPTRUN[31] (RW)
 *
 * General Purpose Timer Run GPTCNT bits are not effected when setting or clearing this bit.
 *
 * Values:
...
/*
 * constants & macros for entire USBC_UH3_GPTIMER1LD register
 */
...
/* --- Register HW_USBC_UH3_GPTIMER1LD, field GPTLD[23:0] (RW)
 *
 * General Purpose Timer Load Value These bit fields are loaded to GPTCNT bits when GPTRST bit is
 * set '1b'. This value represents the time in microseconds minus 1 for the timer duration. Example:
 * for a one millisecond timer, load 1000-1=999 or 0x0003E7. Max value is 0xFFFFFF or 16.777215
...
/*
 * constants & macros for entire USBC_UH3_GPTIMER1CTRL register
 */
...
/* --- Register HW_USBC_UH3_GPTIMER1CTRL, field GPTCNT[23:0] (RW)
 *
 * General Purpose Timer Counter. This field is the count value of the countdown timer.
 */
...
/* --- Register HW_USBC_UH3_GPTIMER1CTRL, field GPTMODE[24] (RW)
 *
 * General Purpose Timer Mode In one shot mode, the timer will count down to zero, generate an
 * interrupt, and stop until the counter is reset by software. In repeat mode, the timer will count
 * down to zero, generate an interrupt and automatically reload the counter value from GPTLD bits to
...
/* --- Register HW_USBC_UH3_GPTIMER1CTRL, field GPTRST[30] (RW)
 *
 * General Purpose Timer Reset
 *
 * Values:
...
/* --- Register HW_USBC_UH3_GPTIMER1CTRL, field GPTRUN[31] (RW)
 *
 * General Purpose Timer Run GPTCNT bits are not effected when setting or clearing this bit.
 *
 * Values:
...
/*
 * constants & macros for entire USBC_UH3_SBUSCFG register
 */
...
/* --- Register HW_USBC_UH3_SBUSCFG, field AHBBRST[2:0] (RW)
 *
 * AHB master interface Burst configuration These bits control AHB master transfer type sequence (or
 * priority). This register overrides n_BURSTSIZE register when its value is not zero.
 *
...
/*
 * constants & macros for entire USBC_UH3_CAPLENGTH register
 */
...
/* --- Register HW_USBC_UH3_CAPLENGTH, field CAPLENGTH[7:0] (RO)
 *
 * These bits are used as an offset to add to register base to find the beginning of the Operational
 * Register. Default value is '40h'.
 */
...
/*
 * constants & macros for entire USBC_UH3_HCIVERSION register
 */
...
/* --- Register HW_USBC_UH3_HCIVERSION, field HCIVERSION[15:0] (RO)
 *
 * Host Controller Interface Version Number Default value is '10h', which means EHCI rev1.0.
 */
...
/*
 * constants & macros for entire USBC_UH3_HCSPARAMS register
 */
...
/* --- Register HW_USBC_UH3_HCSPARAMS, field N_PORTS[3:0] (RO)
 *
 * Number of downstream ports. This field specifies the number of physical downstream ports
 * implemented on this host controller. The value of this field determines how many port registers
 * are addressable in the Operational Register. Valid values are in the range of 1h to Fh. A zero in
...
/* --- Register HW_USBC_UH3_HCSPARAMS, field PPC[4] (RO)
 *
 * Port Power Control This field indicates whether the host controller implementation includes port
 * power control. A one indicates the ports have port power switches. A zero indicates the ports do
 * not have port power switches. The value of this field affects the functionality of the Port Power
...
/* --- Register HW_USBC_UH3_HCSPARAMS, field N_PCC[11:8] (RO)
 *
 * Number of Ports per Companion Controller This field indicates the number of ports supported per
 * internal Companion Controller. It is used to indicate the port routing configuration to the
 * system software. For example, if N_PORTS has a value of 6 and N_CC has a value of 2 then N_PCC
...
/* --- Register HW_USBC_UH3_HCSPARAMS, field N_CC[15:12] (RO)
 *
 * Number of Companion Controller (N_CC). This field indicates the number of companion controllers
 * associated with this USB2.0 host controller. These bits are '0000b' in all controller core.
 *
...
/* --- Register HW_USBC_UH3_HCSPARAMS, field PI[16] (RO)
 *
 * Port Indicators (P INDICATOR) This bit indicates whether the ports support port indicator
 * control. When set to one, the port status and control registers include a read/writeable field
 * for controlling the state of the port indicator This bit is "1b" in all controller core.
...
/* --- Register HW_USBC_UH3_HCSPARAMS, field N_PTT[23:20] (RO)
 *
 * Number of Ports per Transaction Translator (N_PTT). Default value '0000b' This field indicates
 * the number of ports assigned to each transaction translator within the USB2.0 host controller.
 * These bits would be set to equal N_PORTS for Multi-Port Host, and '0000b' for Single-Port Host.
...
/* --- Register HW_USBC_UH3_HCSPARAMS, field N_TT[27:24] (RO)
 *
 * Number of Transaction Translators (N_TT). Default value '0000b' This field indicates the number
 * of embedded transaction translators associated with the USB2.0 host controller. These bits would
 * be set to '0001b' for Multi-Port Host, and '0000b' for Single-Port Host.
...
/*
 * constants & macros for entire USBC_UH3_HCCPARAMS register
 */
...
/* --- Register HW_USBC_UH3_HCCPARAMS, field ADC[0] (RO)
 *
 * 64-bit Addressing Capability This bit is set '0b' in all controller core, no 64-bit addressing
 * capability is supported.
 */
...
/* --- Register HW_USBC_UH3_HCCPARAMS, field PFL[1] (RO)
 *
 * Programmable Frame List Flag If this bit is set to zero, then the system software must use a
 * frame list length of 1024 elements with this host controller. The USBCMD register Frame List Size
 * field is a read-only register and must be set to zero. If set to a one, then the system software
...
/* --- Register HW_USBC_UH3_HCCPARAMS, field ASP[2] (RO)
 *
 * Asynchronous Schedule Park Capability If this bit is set to a one, then the host controller
 * supports the park feature for high-speed queue heads in the Asynchronous Schedule. The feature
 * can be disabled or enabled and set to a specific level by using the Asynchronous Schedule Park
...
/* --- Register HW_USBC_UH3_HCCPARAMS, field IST[7:4] (RO)
 *
 * Isochronous Scheduling Threshold. This field indicates, relative to the current position of the
 * executing host controller, where software can reliably update the isochronous schedule. When bit
 * [7] is zero, the value of the least significant 3 bits indicates the number of micro-frames a
...
/* --- Register HW_USBC_UH3_HCCPARAMS, field EECP[15:8] (RO)
 *
 * EHCI Extended Capabilities Pointer. This field indicates the existence of a capabilities list. A
 * value of 00h indicates no extended capabilities are implemented. A non-zero value in this
 * register indicates the offset in PCI configuration space of the first EHCI extended capability.
...
/*
 * constants & macros for entire USBC_UH3_USBCMD register
 */
...
/* --- Register HW_USBC_UH3_USBCMD, field RS[0] (RW)
 *
 * Run/Stop (RS) - Read/Write. Default 0b. 1=Run. 0=Stop. Host operation mode: When set to '1b', the
 * Controller proceeds with the execution of the schedule. The Controller continues execution as
 * long as this bit is set to a one. When this bit is set to 0, the Host Controller completes the
...
/* --- Register HW_USBC_UH3_USBCMD, field RST[1] (RW)
 *
 * Controller Reset (RESET) - Read/Write. Software uses this bit to reset the controller. This bit
 * is set to zero by the Host/Device Controller when the reset process is complete. Software cannot
 * terminate the reset process early by writing a zero to this register. Host operation mode: When
...
/* --- Register HW_USBC_UH3_USBCMD, field FS[3:2] (RW)
 *
 * See description at bit 15
 */
...
/* --- Register HW_USBC_UH3_USBCMD, field PSE[4] (RW)
 *
 * Periodic Schedule Enable- Read/Write. Default 0b. This bit controls whether the host controller
 * skips processing the Periodic Schedule. Only the host controller uses this bit. Values Meaning
 *
...
/* --- Register HW_USBC_UH3_USBCMD, field ASE[5] (RW)
 *
 * Asynchronous Schedule Enable - Read/Write. Default 0b. This bit controls whether the host
 * controller skips processing the Asynchronous Schedule. Only the host controller uses this bit.
 * Values Meaning
...
/* --- Register HW_USBC_UH3_USBCMD, field IAA[6] (RW)
 *
 * Interrupt on Async Advance Doorbell - Read/Write. This bit is used as a doorbell by software to
 * tell the host controller to issue an interrupt the next time it advances asynchronous schedule.
 * Software must write a 1 to this bit to ring the doorbell. When the host controller has evicted
...
/* --- Register HW_USBC_UH3_USBCMD, field ASP[9:8] (RW)
 *
 * Asynchronous Schedule Park Mode Count - Read/Write. If the Asynchronous Park Capability bit in
 * the HCCPARAMS register is a one, then this field defaults to 3h and is R/W. Otherwise it defaults
 * to zero and is Read-Only. It contains a count of the number of successive transactions the host
...
/* --- Register HW_USBC_UH3_USBCMD, field ASPE[11] (RW)
 *
 * Asynchronous Schedule Park Mode Enable - Read/Write. If the Asynchronous Park Capability bit in
 * the HCCPARAMS register is a one, then this bit defaults to a 1h and is R/W. Otherwise the bit
 * must be a zero and is RO. Software uses this bit to enable or disable Park mode. When this bit is
...
/* --- Register HW_USBC_UH3_USBCMD, field SUTW[13] (RW)
 *
 * Setup TripWire - Read/Write. [device mode only] This bit is used as a semaphore to ensure that
 * the setup data payload of 8 bytes is extracted from a QH by the DCD without being corrupted. If
 * the setup lockout mode is off (SLOM bit in USB core register n_USBMODE, see ) then there is a
...
/* --- Register HW_USBC_UH3_USBCMD, field ATDTW[14] (RW)
 *
 * Add dTD TripWire - Read/Write. [device mode only] This bit is used as a semaphore to ensure
 * proper addition of a new dTD to an active (primed) endpoint's linked list. This bit is set and
 * cleared by software. This bit would also be cleared by hardware when state machine is hazard
...
/* --- Register HW_USBC_UH3_USBCMD, field FS1[15] (RW)
 *
 * See also bits 3-2 Frame List Size - (Read/Write or Read Only). [host mode only] This field is
 * Read/Write only if Programmable Frame List Flag in the HCCPARAMS registers is set to one. This
 * field specifies the size of the frame list that controls which bits in the Frame Index Register
...
/* --- Register HW_USBC_UH3_USBCMD, field ITC[23:16] (RW)
 *
 * Interrupt Threshold Control -Read/Write. The system software uses this field to set the maximum
 * rate at which the host/device controller will issue interrupts. ITC contains the maximum
 * interrupt interval measured in micro-frames. Valid values are shown below. Value Maximum
...
/*
 * constants & macros for entire USBC_UH3_USBSTS register
 */
...
/* --- Register HW_USBC_UH3_USBSTS, field UI[0] (RW)
 *
 * USB Interrupt (USBINT) - R/WC. This bit is set by the Host/Device Controller when the cause of an
 * interrupt is a completion of a USB transaction where the Transfer Descriptor (TD) has an
 * interrupt on complete (IOC) bit set. This bit is also set by the Host/Device Controller when a
...
/* --- Register HW_USBC_UH3_USBSTS, field UEI[1] (RW)
 *
 * USB Error Interrupt (USBERRINT) - R/WC. When completion of a USB transaction results in an error
 * condition, this bit is set by the Host/Device Controller. This bit is set along with the USBINT
 * bit, if the TD on which the error interrupt occurred also had its interrupt on complete (IOC) bit
...
/* --- Register HW_USBC_UH3_USBSTS, field PCI[2] (RW)
 *
 * Port Change Detect - R/WC. The Host Controller sets this bit to a one when on any port a Connect
 * Status occurs, a Port Enable/Disable Change occurs, or the Force Port Resume bit is set as the
 * result of a J-K transition on the suspended port. The Device Controller sets this bit to a one
...
/* --- Register HW_USBC_UH3_USBSTS, field FRI[3] (RW)
 *
 * Frame List Rollover - R/WC. The Host Controller sets this bit to a one when the Frame List Index
 * rolls over from its maximum value to zero. The exact value at which the rollover occurs depends
 * on the frame list size. For example. If the frame list size (as programmed in the Frame List Size
...
/* --- Register HW_USBC_UH3_USBSTS, field SEI[4] (RW)
 *
 * System Error- R/WC. This bit is will be set to '1b' when an Error response is seen to a read on
 * the system interface.
 */
...
/* --- Register HW_USBC_UH3_USBSTS, field AAI[5] (RW)
 *
 * Interrupt on Async Advance - R/WC. System software can force the host controller to issue an
 * interrupt the next time the host controller advances the asynchronous schedule by writing a one
 * to the Interrupt on Async Advance Doorbell bit in the n_USBCMD register. This status bit
...
/* --- Register HW_USBC_UH3_USBSTS, field URI[6] (RW)
 *
 * USB Reset Received - R/WC. When the device controller detects a USB Reset and enters the default
 * state, this bit will be set to a one. Software can write a 1 to this bit to clear the USB Reset
 * Received status bit. Only used in device operation mode.
...
/* --- Register HW_USBC_UH3_USBSTS, field SRI[7] (RW)
 *
 * SOF Received - R/WC. When the device controller detects a Start Of (micro) Frame, this bit will
 * be set to a one. When a SOF is extremely late, the device controller will automatically set this
 * bit to indicate that an SOF was expected. Therefore, this bit will be set roughly every 1ms in
...
/* --- Register HW_USBC_UH3_USBSTS, field SLI[8] (RW)
 *
 * DCSuspend - R/WC. When a controller enters a suspend state from an active state, this bit will be
 * set to a one. The device controller clears the bit upon exiting from a suspend state. Only used
 * in device operation mode.
...
/* --- Register HW_USBC_UH3_USBSTS, field ULPII[10] (RW)
 *
 * ULPI Interrupt - R/WC. This bit will be set '1b' by hardware when there is an event completion in
 * ULPI viewport. This bit is usable only if the controller support UPLI interface mode.
 */
...
/* --- Register HW_USBC_UH3_USBSTS, field HCH[12] (RW)
 *
 * HCHaIted - Read Only. This bit is a zero whenever the Run/Stop bit is a one. The Controller sets
 * this bit to one after it has stopped executing because of the Run/Stop bit being set to 0, either
 * by software or by the Controller hardware (for example, an internal error). Only used in the host
...
/* --- Register HW_USBC_UH3_USBSTS, field RCL[13] (RW)
 *
 * Reclamation - Read Only. This is a read-only status bit used to detect an empty asynchronous
 * schedule. Only used in the host operation mode.
 */
...
/* --- Register HW_USBC_UH3_USBSTS, field PS[14] (RW)
 *
 * Periodic Schedule Status - Read Only. This bit reports the current real status of the Periodic
 * Schedule. When set to zero the periodic schedule is disabled, and if set to one the status is
 * enabled. The Host Controller is not required to immediately disable or enable the Periodic
...
/* --- Register HW_USBC_UH3_USBSTS, field AS[15] (RW)
 *
 * Asynchronous Schedule Status - Read Only. This bit reports the current real status of the
 * Asynchronous Schedule. When set to zero the asynchronous schedule status is disabled and if set
 * to one the status is enabled. The Host Controller is not required to immediately disable or
...
/* --- Register HW_USBC_UH3_USBSTS, field NAKI[16] (RO)
 *
 * NAK Interrupt Bit--RO. This bit is set by hardware when for a particular endpoint both the TX/RX
 * Endpoint NAK bit and corresponding TX/RX Endpoint NAK Enable bit are set. This bit is
 * automatically cleared by hardware when all Enabled TX/RX Endpoint NAK bits are cleared.
...
/* --- Register HW_USBC_UH3_USBSTS, field TI0[24] (RW)
 *
 * General Purpose Timer Interrupt 0(GPTINT0)--R/WC. This bit is set when the counter in the
 * GPTIMER0CTRL register transitions to zero, writing a one to this bit clears it.
 */
...
/* --- Register HW_USBC_UH3_USBSTS, field TI1[25] (RW)
 *
 * General Purpose Timer Interrupt 1(GPTINT1)--R/WC. This bit is set when the counter in the
 * GPTIMER1CTRL register transitions to zero, writing a one to this bit will clear it.
 */
...
/*
 * constants & macros for entire USBC_UH3_USBINTR register
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field UE[0] (RW)
 *
 * USB Interrupt Enalbe When this bit is one and the UI bit in n_USBSTS register is a one the
 * controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field UEE[1] (RW)
 *
 * USB Error Interrupt Enable When this bit is one and the UEI bit in n_USBSTS register is a one the
 * controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field PCE[2] (RW)
 *
 * Port Change Detect Interrupt Enable When this bit is one and the PCI bit in n_USBSTS register is
 * a one the controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field FRE[3] (RW)
 *
 * Frame List Rollover Interrupt Enable When this bit is one and the FRI bit in n_USBSTS register is
 * a one the controller will issue an interrupt. Only used in host operation mode.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field SEE[4] (RW)
 *
 * System Error Interrupt Enable When this bit is one and the SEI bit in n_USBSTS register is a one
 * the controller will issue an interrupt. Only used in host operation mode.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field AAE[5] (RW)
 *
 * Async Advance Interrupt Enable When this bit is one and the AAI bit in n_USBSTS register is a one
 * the controller will issue an interrupt. Only used in host operation mode.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field URE[6] (RW)
 *
 * USB Reset Interrupt Enable When this bit is one and the URI bit in n_USBSTS register is a one the
 * controller will issue an interrupt. Only used in device operation mode.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field SRE[7] (RW)
 *
 * SOF Received Interrupt Enable When this bit is one and the SRI bit in n_USBSTS register is a one
 * the controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field SLE[8] (RW)
 *
 * Sleep Interrupt Enable When this bit is one and the SLI bit in n_n_USBSTS register is a one the
 * controller will issue an interrupt. Only used in device operation mode.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field ULPIE[10] (RW)
 *
 * ULPI Interrupt Enable When this bit is one and the UPLII bit in n_USBSTS register is a one the
 * controller will issue an interrupt. This bit is usable only if the controller support UPLI
 * interface mode.
...
/* --- Register HW_USBC_UH3_USBINTR, field NAKE[16] (RW)
 *
 * NAK Interrupt Enable When this bit is one and the NAKI bit in n_USBSTS register is a one the
 * controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field UAIE[18] (RW)
 *
 * USB Host Asynchronous Interrupt Enable When this bit is one, and the UAI bit in the n_USBSTS
 * register is one, host controller will issue an interrupt at the next interrupt threshold.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field UPIE[19] (RW)
 *
 * USB Host Periodic Interrupt Enable When this bit is one, and the UPI bit in the n_USBSTS register
 * is one, host controller will issue an interrupt at the next interrupt threshold.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field TIE0[24] (RW)
 *
 * General Purpose Timer #0 Interrupt Enable When this bit is one and the TI0 bit in n_USBSTS
 * register is a one the controller will issue an interrupt.
 */
...
/* --- Register HW_USBC_UH3_USBINTR, field TIE1[25] (RW)
 *
 * General Purpose Timer #1 Interrupt Enable When this bit is one and the TI1 bit in n_USBSTS
 * register is a one the controller will issue an interrupt.
 */
...
/*
 * constants & macros for entire USBC_UH3_FRINDEX register
 */
...
/* --- Register HW_USBC_UH3_FRINDEX, field FRINDEX[13:0] (RW)
 *
 * Frame Index. The value, in this register, increments at the end of each time frame (micro-frame).
 * Bits [N: 3] are used for the Frame List current index. This means that each location of the frame
 * list is accessed 8 times (frames or micro-frames) before moving to the next index. The following
...
/*
 * constants & macros for entire USBC_UH3_PERIODICLISTBASE register
 */
...
/* --- Register HW_USBC_UH3_PERIODICLISTBASE, field BASEADR[31:12] (RW)
 *
 * Base Address (Low). These bits correspond to memory address signals [31:12], respectively. Only
 * used by the host controller.
 */
...
/*
 * constants & macros for entire USBC_UH3_ASYNCLISTADDR register
 */
...
/* --- Register HW_USBC_UH3_ASYNCLISTADDR, field ASYBASE[31:5] (RW)
 *
 * Link Pointer Low (LPL). These bits correspond to memory address signals [31:5], respectively.
 * This field may only reference a Queue Head (QH). Only used by the host controller.
 */
...
/*
 * constants & macros for entire USBC_UH3_BURSTSIZE register
 */
...
/* --- Register HW_USBC_UH3_BURSTSIZE, field RXPBURST[7:0] (RW)
 *
 * Programmable RX Burst Size. Default value is determined by TXBURST bits in n_HWRXBUF. This
 * register represents the maximum length of a the burst in 32-bit words while moving data from the
 * USB bus to system memory.
...
/* --- Register HW_USBC_UH3_BURSTSIZE, field TXPBURST[16:8] (RW)
 *
 * Programmable TX Burst Size. Default value is determined by TXBURST bits in n_HWTXBUF. This
 * register represents the maximum length of a the burst in 32-bit words while moving data from
 * system memory to the USB bus.
...
/*
 * constants & macros for entire USBC_UH3_TXFILLTUNING register
 */
...
/* --- Register HW_USBC_UH3_TXFILLTUNING, field TXSCHOH[7:0] (RW)
 *
 * Scheduler Overhead. (Read/Write) [Default = 0] This register adds an additional fixed offset to
 * the schedule time estimator described above as Tff. As an approximation, the value chosen for
 * this register should limit the number of back-off events captured in the TXSCHHEALTH to less than
...
/* --- Register HW_USBC_UH3_TXFILLTUNING, field TXSCHHEALTH[12:8] (RW)
 *
 * Scheduler Health Counter. (Read/Write To Clear) This register increments when the host controller
 * fails to fill the TX latency FIFO to the level programmed by TXFIFOTHRES before running out of
 * time to send the packet before the next Start-Of-Frame. This health counter measures the number
...
/* --- Register HW_USBC_UH3_TXFILLTUNING, field TXFIFOTHRES[21:16] (RW)
 *
 * FIFO Burst Threshold. (Read/Write) This register controls the number of data bursts that are
 * posted to the TX latency FIFO in host mode before the packet begins on to the bus. The minimum
 * value is 2 and this value should be a low as possible to maximize USB performance. A higher value
...
/*
 * constants & macros for entire USBC_UH3_CONFIGFLAG register
 */
...
/* --- Register HW_USBC_UH3_CONFIGFLAG, field CF[0] (RO)
 *
 * Configure Flag Host software sets this bit as the last action in its process of configuring the
 * Host Controller. This bit controls the default port-routing control logic.
 *
...
/*
 * constants & macros for entire USBC_UH3_PORTSC1 register
 */
...
/* --- Register HW_USBC_UH3_PORTSC1, field CCS[0] (RO)
 *
 * Current Connect Status-Read Only. In Host Mode: 1=Device is present on port. 0=No device is
 * present. Default = 0. This value reflects the current state of the port, and may not correspond
 * directly to the event that caused the Connect Status Change bit (Bit 1) to be set. This field is
...
/* --- Register HW_USBC_UH3_PORTSC1, field CSC[1] (RW)
 *
 * Connect Status Change-R/WC. 1 =Change in Current Connect Status. 0=No change. Default 0. In Host
 * Mode: Indicates a change has occurred in the port's Current Connect Status. The host/device
 * controller sets this bit for all changes to the port device connect status, even if system
...
/* --- Register HW_USBC_UH3_PORTSC1, field PE[2] (RW)
 *
 * Port Enabled/Disabled-Read/Write. 1=Enable. 0=Disable. Default 0. In Host Mode: Ports can only be
 * enabled by the host controller as a part of the reset and enable. Software cannot enable a port
 * by writing a one to this field. Ports can be disabled by either a fault condition (disconnect
...
/* --- Register HW_USBC_UH3_PORTSC1, field PEC[3] (RW)
 *
 * Port Enable/Disable Change-R/WC. 1=Port enabled/disabled status has changed. 0=No change. Default
 * = 0. In Host Mode: For the root hub, this bit is set to a one only when a port is disabled due to
 * disconnect on the port or due to the appropriate conditions existing at the EOF2 point (See
...
/* --- Register HW_USBC_UH3_PORTSC1, field FPR[6] (RW)
 *
 * Force Port Resume -Read/Write. 1= Resume detected/driven on port. 0=No resume (K-state)
 * detected/driven on port. Default = 0. In Host Mode: Software sets this bit to one to drive resume
 * signaling. The Host Controller sets this bit to one if a J-to-K transition is detected while the
...
/* --- Register HW_USBC_UH3_PORTSC1, field SUSP[7] (RW)
 *
 * Suspend - Read/Write or Read Only. Default = 0b. 1=Port in suspend state. 0=Port not in suspend
 * state. In Host Mode: Read/Write. Port Enabled Bit and Suspend bit of this register define the
 * port states as follows: Bits [Port Enabled, Suspend] Port State 0x Disable 10 Enable 11 Suspend
...
/* --- Register HW_USBC_UH3_PORTSC1, field PR[8] (RW)
 *
 * Port Reset - Read/Write or Read Only. Default = 0b. In Host Mode: Read/Write. 1=Port is in Reset.
 * 0=Port is not in Reset. Default 0. When software writes a one to this bit the bus-reset sequence
 * as defined in the USB Specification Revision 2.0 is started. This bit will automatically change
...
/* --- Register HW_USBC_UH3_PORTSC1, field HSP[9] (RO)
 *
 * High-Speed Port - Read Only. Default = 0b. When the bit is one, the host/device connected to the
 * port is in high-speed mode and if set to zero, the host/device connected to the port is not in a
 * high-speed mode. HSP is redundant with PSPD(bit 27, 26) but remained for compatibility.
...
/* --- Register HW_USBC_UH3_PORTSC1, field LS[11:10] (RW)
 *
 * Line Status-Read Only. These bits reflect the current logical levels of the D+ (bit 11) and D-
 * (bit 10) signal lines. In host mode, the use of linestate by the host controller driver is not
 * necessary (unlike EHCI), because the port controller state machine and the port routing manage
...
/* --- Register HW_USBC_UH3_PORTSC1, field PP[12] (RW)
 *
 * Port Power (PP)-Read/Write or Read Only. The function of this bit depends on the value of the
 * Port Power Switching (PPC) field in the HCSPARAMS register. The behavior is as follows: PPC PP
 * Operation 0 1b Read Only - Host controller does not have port power control switches. Each port
...
/* --- Register HW_USBC_UH3_PORTSC1, field PO[13] (RW)
 *
 * Port Owner-Read/Write. Default = 0. This bit unconditionally goes to a 0 when the configured bit
 * in the CONFIGFLAG register makes a 0 to 1 transition. This bit unconditionally goes to 1 whenever
 * the Configured bit is zero System software uses this field to release ownership of the port to a
...
/* --- Register HW_USBC_UH3_PORTSC1, field PIC[15:14] (RW)
 *
 * Port Indicator Control - Read/Write. Default = Ob. Writing to this field has no effect if the
 * P_INDICATOR bit in the HCSPARAMS register is a zero. Refer to the USB Specification Revision 2.0
 * for a description on how these bits are to be used. This field is zero if Port Power is zero. Bit
...
/* --- Register HW_USBC_UH3_PORTSC1, field PTC[19:16] (RW)
 *
 * Port Test Control - Read/Write. Default = 0000b. Refer to for the operational model for using
 * these test modes and the USB Specification Revision 2.0, Chapter 7 for details on each test mode.
 * The FORCE_ENABLE_FS and FORCE ENABLE_LS are extensions to the test mode support specified in the
...
/* --- Register HW_USBC_UH3_PORTSC1, field WKCN[20] (RW)
 *
 * Wake on Connect Enable (WKCNNT_E) - Read/Write. Default=0b. Writing this bit to a one enables the
 * port to be sensitive to device connects as wake-up events. This field is zero if Port Power( ) is
 * zero or in device mode.
...
/* --- Register HW_USBC_UH3_PORTSC1, field WKDC[21] (RW)
 *
 * Wake on Disconnect Enable (WKDSCNNT_E) - Read/Write. Default=0b. Writing this bit to a one
 * enables the port to be sensitive to device disconnects as wake-up events. This field is zero if
 * Port Power( ) is zero or in device mode.
...
/* --- Register HW_USBC_UH3_PORTSC1, field WKOC[22] (RW)
 *
 * Wake on Over-current Enable (WKOC_E) - Read/Write. Default = 0b. Writing this bit to a one
 * enables the port to be sensitive to over-current conditions as wake-up events. This field is zero
 * if Port Power( ) is zero.
...
/* --- Register HW_USBC_UH3_PORTSC1, field PHCD[23] (RW)
 *
 * PHY Low Power Suspend - Clock Disable (PLPSCD) - Read/Write. Default = 0b. When this bit is set
 * to '1b', the PHY clock is disabled. Reading this bit will indicate the status of the PHY clock.
 * The PHY clock cannot be disabled if it is being used as the system clock. In device mode, The PHY
...
/* --- Register HW_USBC_UH3_PORTSC1, field PFSC[24] (RW)
 *
 * Port Force Full Speed Connect - Read/Write. Default = 0b. When this bit is set to '1b', the port
 * will be forced to only connect at Full Speed, It disables the chirp sequence that allows the port
 * to identify itself as High Speed.
...
/* --- Register HW_USBC_UH3_PORTSC1, field PTS[25] (RW)
 *
 * See description at bits 31-30
 */
...
/*
 * constants & macros for entire USBC_UH3_USBMODE register
 */
...
/* --- Register HW_USBC_UH3_USBMODE, field CM[1:0] (RW)
 *
 * Controller Mode - R/WO. Controller mode is defaulted to the proper mode for host only and device
 * only implementations. For those designs that contain both host & device capability, the
 * controller defaults to an idle state and needs to be initialized to the desired operating mode
...
/* --- Register HW_USBC_UH3_USBMODE, field ES[2] (RW)
 *
 * Endian Select - Read/Write. This bit can change the byte alignment of the transfer buffers to
 * match the host microprocessor. The bit fields in the microprocessor interface and the data
 * structures are unaffected by the value of this bit because they are based upon the 32-bit word.
...
/* --- Register HW_USBC_UH3_USBMODE, field SLOM[3] (RW)
 *
 * Setup Lockout Mode. In device mode, this bit controls behavior of the setup lock mechanism. See .
 *
 * Values:
...
/* --- Register HW_USBC_UH3_USBMODE, field SDIS[4] (RW)
 *
 * Stream Disable Mode. (0 - Inactive [default]; 1 - Active) Device Mode: Setting to a '1' disables
 * double priming on both RX and TX for low bandwidth systems. This mode ensures that when the RX
 * and TX buffers are sufficient to contain an entire packet that the standard double buffering
