...
/*
 * constants & macros for entire SPDC_DISP_TRIGGER register
 */
...
/* --- Register HW_SPDC_DISP_TRIGGER, field DISP_TRIG[0] (RW)
 *
...
/* --- Register HW_SPDC_DISP_TRIGGER, field EPD_MODE[3:1] (RW)
 *
...
/* --- Register HW_SPDC_DISP_TRIGGER, field FLASH_SET[4] (RW)
 *
...
/*
 * constants & macros for entire SPDC_UPDATE_X_Y register
 */
...
/* --- Register HW_SPDC_UPDATE_X_Y, field COORDINATE_Y[11:0] (RW)
 *
...
/* --- Register HW_SPDC_UPDATE_X_Y, field COORDINATE_X[27:16] (RW)
 *
...
/*
 * constants & macros for entire SPDC_UPDATE_W_H register
 */
...
/* --- Register HW_SPDC_UPDATE_W_H, field HEIGHT[11:0] (RW)
 *
...
/* --- Register HW_SPDC_UPDATE_W_H, field WIDTH[27:16] (RW)
 *
...
/*
 * constants & macros for entire SPDC_LUT_PARA_UPDATE register
 */
...
/* --- Register HW_SPDC_LUT_PARA_UPDATE, field LUT_PARAMETER_UPDATED_VALUE[7:0] (RW)
 *
...
/* --- Register HW_SPDC_LUT_PARA_UPDATE, field LUT_PARAMETER_UPDATED_ADDR[15:8] (RW)
 *
...
/*
 * constants & macros for entire SPDC_OPERATE register
 */
...
/* --- Register HW_SPDC_OPERATE, field DISP_REFRESH[0] (RW)
 *
...
/* --- Register HW_SPDC_OPERATE, field DEEP_REFRESH[1] (RW)
 *
...
/* --- Register HW_SPDC_OPERATE, field DISP_RESET[2] (RW)
 *
...
/* --- Register HW_SPDC_OPERATE, field SW_TCON_RESET[31] (RW)
 *
...
typedef union _hw_spdc_panel_init_set
{
    ...
    {
        unsigned YOE_POL : 1; //!< [0] Set the YOE signal's polarity of gate driver IC 0x0 LOW_ENABLE -Gate pulse outputs low enable.
        unsigned DUAL_GATE : 1; //!< [1] Set to enable the panel type of dual gate driver 0x0 SINGLE_GATE -Single gate driver (support gate driver K7900).
        ...
        unsigned DATA_FILTER_N : 1; //!< [9] Automatic filter input image pixel data base on the display mode 0x0 ENABLE_AUTO_DATA_FILTER -Filter input data 16-step gray to 4-step gray data for mode 2 and mode 3.
        ...
        unsigned HBURST_LEN_EN : 1; //!< [13] HBURST length enable 0x0 DISABLE_HBURST - AHB2AXI gasket ignores the HBURST_LEN[3:0].
...
/*
 * constants & macros for entire SPDC_PANEL_INIT_SET register
 */
...
/* --- Register HW_SPDC_PANEL_INIT_SET, field YOE_POL[0] (RW)
 *
...
/* --- Register HW_SPDC_PANEL_INIT_SET, field DUAL_GATE[1] (RW)
 *
...
/* --- Register HW_SPDC_PANEL_INIT_SET, field RESOLUTION[6:2] (RW)
 *
...
/* --- Register HW_SPDC_PANEL_INIT_SET, field UD[7] (RW)
 *
...
/* --- Register HW_SPDC_PANEL_INIT_SET, field RL[8] (RW)
 *
...
/* --- Register HW_SPDC_PANEL_INIT_SET, field DATA_FILTER_N[9] (RW)
 *
...
/* --- Register HW_SPDC_PANEL_INIT_SET, field POWER_READY[10] (RW)
 *
...
/* --- Register HW_SPDC_PANEL_INIT_SET, field RGBW_MODE_EN[11] (RW)
 *
...
/* --- Register HW_SPDC_PANEL_INIT_SET, field HBURST_LEN_EN[13] (RW)
 *
...
typedef union _hw_spdc_temper_setting
{
    ...
    {
        unsigned TEMPERATURE : 9; //!< [8:0] Update TCON temperature information Temperature Information is used to indicate the temperature of operating environment.
...
/*
 * constants & macros for entire SPDC_TEMPER_SETTING register
 */
...
/* --- Register HW_SPDC_TEMPER_SETTING, field TEMPERATURE[8:0] (RW)
 *
...
/*
 * constants & macros for entire SPDC_NEXT_BUF register
 */
...
/* --- Register HW_SPDC_NEXT_BUF, field NEXT_FRAME_MEMORY_ADDR[31:0] (RW)
 *
...
/*
 * constants & macros for entire SPDC_CURRENT_BUF register
 */
...
/* --- Register HW_SPDC_CURRENT_BUF, field CURRENT_FRAME_MEMORY_ADDR[31:0] (RW)
 *
...
/*
 * constants & macros for entire SPDC_PREVIOUS_BUFF register
 */
...
/* --- Register HW_SPDC_PREVIOUS_BUFF, field PREVIOUS_FRAME_MEMORY_ADDR[31:0] (RW)
 *
...
/*
 * constants & macros for entire SPDC_FRM_CNT_BUFF register
 */
...
/* --- Register HW_SPDC_FRM_CNT_BUFF, field COUNTER_FRAME_MEMORY_ADDR[31:0] (RW)
 *
...
/*
 * constants & macros for entire SPDC_LUT_BUFF register
 */
...
/* --- Register HW_SPDC_LUT_BUFF, field LUT_MEMORY_ADDR[31:0] (RW)
 *
...
/*
 * constants & macros for entire SPDC_INT_EN register
 */
...
/* --- Register HW_SPDC_INT_EN, field UPDATE_FINISH_INT_EN[0] (RW)
 *
...
/* --- Register HW_SPDC_INT_EN, field TCON_INIT_FINISH_INT_EN[1] (RW)
 *
...
/* --- Register HW_SPDC_INT_EN, field LUT_DOWNLOAD_FINISH_INT_EN[2] (RW)
 *
...
/* --- Register HW_SPDC_INT_EN, field TCON_ERROR_INT_EN[3] (RW)
 *
...
/*
 * constants & macros for entire SPDC_INT_ST_CLR register
 */
...
/* --- Register HW_SPDC_INT_ST_CLR, field UPDATE_FINISH_INT_CLR[0] (RW)
 *
...
/* --- Register HW_SPDC_INT_ST_CLR, field TCON_INIT_FINISH_INT_CLR[1] (RW)
 *
...
/* --- Register HW_SPDC_INT_ST_CLR, field LUT_DOWNLOAD_FINISH_INT_CLR[2] (RW)
 *
...
/* --- Register HW_SPDC_INT_ST_CLR, field TCON_ERROR_INT_CLR[3] (RW)
 *
...
typedef union _hw_spdc_status
{
    ...
    struct _hw_spdc_status_bitfields
    {
        ...
        unsigned EPD_TCON_STATUS : 4; //!< [7:4] EPD TCON IP status 0x0 RST_STATUS - EPD TCON during reset phase 0x1 WAIT_FOR_CHECKSUM_AND_POWER_READY_STATUS - EPD TCON is hold for waiting checksum pass and driver IC power ready 0x2 CHECKSUM_FAIL_BUT_POWER_READY_STATUS - EPD TCON checksum fail but driver IC power ready.
...
/*
 * constants & macros for entire SPDC_STATUS register
 */
...
/* --- Register HW_SPDC_STATUS, field EPD_TCON_BUSY_N[0] (RO)
 *
...
/* --- Register HW_SPDC_STATUS, field LUT_CHECKSUM[3] (RO)
 *
...
/* --- Register HW_SPDC_STATUS, field EPD_TCON_STATUS[7:4] (RO)
 *
...
/*
 * constants & macros for entire SPDC_PANEL_TYPE_VER register
 */
...
/* --- Register HW_SPDC_PANEL_TYPE_VER, field PRODUCT_AND_DRIVER_ID[15:0] (RO)
 *
...
/* --- Register HW_SPDC_PANEL_TYPE_VER, field LUT_VERSION[23:16] (RO)
 *
...
/* --- Register HW_SPDC_PANEL_TYPE_VER, field EPD_PANEL_TYPE[31:24] (RO)
 *
...
/*
 * constants & macros for entire SPDC_TCON_VER register
 */
...
/* --- Register HW_SPDC_TCON_VER, field EPD_TCON_VERSION[7:0] (RO)
 *
...
/*
 * constants & macros for entire SPDC_SW_GATE_CLK register
 */
...
/* --- Register HW_SPDC_SW_GATE_CLK, field GATING_ALL_CLK_EN[0] (RW)
 *
