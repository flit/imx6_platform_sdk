...
{
    // Config i2c2.SCL to pad EIM_EB2(Y3)
    // HW_IOMUXC_SW_MUX_CTL_PAD_EIM_EB2_WR(0x00000005);
    // HW_IOMUXC_I2C2_IPP_SCL_IN_SELECT_INPUT_WR(0x00000000);
    // HW_IOMUXC_SW_PAD_CTL_PAD_EIM_EB2_WR(0x000001E4);
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_EIM_EB2(0x53FA8114)
    ...
    //                    Select 1 of 6 iomux modes to be used for pad: EIM_EB2.
    //     ALT0 (0) - Select mux mode: ALT0 mux port: WEIM_EB[2] of instance: emi.
    //     ALT1 (1) - Select mux mode: ALT1 mux port: GPIO[30] of instance: gpio2.
    ...
    //     ALT3 (3) - Select mux mode: ALT3 mux port: SER_DISP1_CS of instance: ipu.
    //     ALT4 (4) - Select mux mode: ALT4 mux port: SS0 of instance: ecspi1.
    //                NOTE: - Config Register IOMUXC_ECSPI1_IPP_IND_SS_B_0_SELECT_INPUT for mode ALT4.
    //     ALT5 (5) - Select mux mode: ALT5 mux port: SCL of instance: i2c2.
    //                NOTE: - Config Register IOMUXC_I2C2_IPP_SCL_IN_SELECT_INPUT for mode ALT5.
    HW_IOMUXC_SW_MUX_CTL_PAD_EIM_EB2_WR(
            BF_IOMUXC_SW_MUX_CTL_PAD_EIM_EB2_SION(SION_DISABLED) | 
            BF_IOMUXC_SW_MUX_CTL_PAD_EIM_EB2_MUX_MODE(ALT5));
    ...
    // IOMUXC_SW_PAD_CTL_PAD_EIM_EB2(0x53FA845C)
    ...
    HW_IOMUXC_SW_PAD_CTL_PAD_EIM_EB2_WR(
            ...
            BF_IOMUXC_SW_PAD_CTL_PAD_EIM_EB2_DSE(DSE_120OHM));
