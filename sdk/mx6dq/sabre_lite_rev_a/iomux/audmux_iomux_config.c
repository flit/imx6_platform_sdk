...
void audmux_iomux_config(void)
{
    ...
    HW_IOMUXC_AUDMUX_P4_INPUT_DA_AMX_SELECT_INPUT_WR(
            BF_IOMUXC_AUDMUX_P4_INPUT_DA_AMX_SELECT_INPUT_DAISY(SEL_SD2_DAT0_ALT3));
    ...
    HW_IOMUXC_AUDMUX_P4_INPUT_DB_AMX_SELECT_INPUT_WR(
            BF_IOMUXC_AUDMUX_P4_INPUT_DB_AMX_SELECT_INPUT_DAISY(SEL_SD2_DAT2_ALT3));
    // Pad Control Register:
    ...
    HW_IOMUXC_AUDMUX_P4_INPUT_TXFS_AMX_SELECT_INPUT_WR(
            BF_IOMUXC_AUDMUX_P4_INPUT_TXFS_AMX_SELECT_INPUT_DAISY(SEL_SD2_DAT1_ALT3));
    // Pad Control Register:
