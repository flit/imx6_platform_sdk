...
void spdif_iomux_config(void)
{
    ...
    writel((SEL_GPIO_16_ALT4 & 0x3), IOMUXC_SPDIF_SPDIF_IN1_SELECT_INPUT);
    ...
    // Config spdif.OUT1 to pad GPIO_17(R1)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT4 & 0x7), IOMUXC_SW_MUX_CTL_PAD_GPIO_17);
    // Pad Control Register:
    ...
    writel((HYS_DISABLED & 0x1) << 16 | (PUS_100KOHM_PD & 0x3) << 14 | (PUE_KEEP & 0x1) << 13 |
           ...
           (DSE_40OHM & 0x7) << 3 | (SRE_FAST & 0x1), IOMUXC_SW_PAD_CTL_PAD_GPIO_17);
    ...
    writel((SEL_ENET_CRS_DV_ALT3 & 0x1), IOMUXC_SPDIF_TX_CLK2_SELECT_INPUT);
    // Pad Control Register:
    ...
    //     DSE_40OHM (6) - 40 Ohm
    //     DSE_34OHM (7) - 34 Ohm
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           (DDR_INPUT_CMOS & 0x1) << 17 | (HYS_DISABLED & 0x1) << 16 | (PUS_100KOHM_PD & 0x3) << 14
           | (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 |
           (DSE_DISABLED & 0x7) << 3, IOMUXC_SW_PAD_CTL_PAD_RGMII_TXC);
