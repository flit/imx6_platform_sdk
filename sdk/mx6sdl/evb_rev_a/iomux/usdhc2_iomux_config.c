...
{
    // Config usdhc2.CD to pad GPIO_4(R6)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT6 & 0x7), IOMUXC_SW_MUX_CTL_PAD_GPIO_4);
    ...
    // IOMUXC_USDHC2_IPP_CARD_CLK_IN_SELECT_INPUT(0x020E0930)
    //   DAISY (0) Reset: SEL_NANDF_CS3_ALT8
    //               Selecting Pads Involved in Daisy Chain.
    //               NOTE: Instance: usdhc2,   In Pin: ipp_card_clk_in
    //     SEL_NANDF_CS3_ALT8 (0) - Selecting Pad: NANDF_CS3 for Mode: ALT8.
    //     SEL_SD2_CLK_ALT0 (1) - Selecting Pad: SD2_CLK for Mode: ALT0.
    writel((SEL_NANDF_CS3_ALT8 & 0x1), IOMUXC_USDHC2_IPP_CARD_CLK_IN_SELECT_INPUT);
    // Pad Control Register:
