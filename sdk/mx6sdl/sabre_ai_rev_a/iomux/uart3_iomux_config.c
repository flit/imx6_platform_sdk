...
void uart3_iomux_config(void)
{
    ...
    // HW_IOMUXC_UART3_IPP_UART_RTS_B_SELECT_INPUT_WR(0x00000001);
    ...
    HW_IOMUXC_UART3_IPP_UART_RTS_B_SELECT_INPUT_WR(
            BF_IOMUXC_UART3_IPP_UART_RTS_B_SELECT_INPUT_DAISY(SEL_EIM_D30_ALT4));
    ...
    // HW_IOMUXC_UART3_IPP_UART_RXD_MUX_SELECT_INPUT_WR(0x00000003);
    ...
    HW_IOMUXC_UART3_IPP_UART_RXD_MUX_SELECT_INPUT_WR(
            BF_IOMUXC_UART3_IPP_UART_RXD_MUX_SELECT_INPUT_DAISY(SEL_SD4_CMD_ALT2));
    // Pad Control Register:
