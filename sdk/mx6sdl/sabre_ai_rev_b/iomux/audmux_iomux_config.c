...
void audmux_iomux_config(void)
{
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT2 & 0xF), IOMUXC_SW_MUX_CTL_PAD_DI0_PIN4);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT2 & 0xF), IOMUXC_SW_MUX_CTL_PAD_DI0_PIN15);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT2 & 0xF), IOMUXC_SW_MUX_CTL_PAD_DI0_PIN2);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT2 & 0xF), IOMUXC_SW_MUX_CTL_PAD_DI0_PIN3);
    // Pad Control Register:
