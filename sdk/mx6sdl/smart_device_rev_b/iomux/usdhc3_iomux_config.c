...
void usdhc3_iomux_config(void)
{
    ...
    //                NOTE: - Config IOMUXC_USDHC3_IPP_CARD_CLK_IN_SELECT_INPUT for mode ALT0.
    //     ALT1 (1) - Select mux mode: ALT1 mux port: RTS of instance: uart2.
    //                NOTE: - Config IOMUXC_UART2_IPP_UART_RTS_B_SELECT_INPUT for mode ALT1.
    ...
    // IOMUXC_USDHC3_IPP_CARD_CLK_IN_SELECT_INPUT(0x020E0934)
    //   DAISY (0) Reset: SEL_NANDF_ALE_ALT8
    //               Selecting Pads Involved in Daisy Chain.
    //               NOTE: Instance: usdhc3,   In Pin: ipp_card_clk_in
    //     SEL_NANDF_ALE_ALT8 (0) - Selecting Pad: NANDF_ALE for Mode: ALT8.
    //     SEL_SD3_CLK_ALT0 (1) - Selecting Pad: SD3_CLK for Mode: ALT0.
    writel((SEL_NANDF_ALE_ALT8 & 0x1), IOMUXC_USDHC3_IPP_CARD_CLK_IN_SELECT_INPUT);
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD3_DAT0(0x020E0314)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    ...
    //                NOTE: - Config IOMUXC_UART1_IPP_UART_RTS_B_SELECT_INPUT for mode ALT1.
    ...
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD3_DAT0(0x020E06FC)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD3_DAT1(0x020E0318)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    ...
    //                NOTE: - Config IOMUXC_CAN2_IPP_IND_CANRX_SELECT_INPUT for mode ALT2.
    ...
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD3_DAT1(0x020E0700)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD3_DAT2(0x020E031C)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    ...
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD3_DAT2(0x020E0704)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD3_DAT3(0x020E0320)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    ...
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD3_DAT3(0x020E0708)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD3_DAT4(0x020E0324)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    ...
    //                NOTE: - Config IOMUXC_UART2_IPP_UART_RXD_MUX_SELECT_INPUT for mode ALT1.
    ...
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD3_DAT4(0x020E070C)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD3_DAT5(0x020E0328)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    ...
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD3_DAT5(0x020E0710)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
