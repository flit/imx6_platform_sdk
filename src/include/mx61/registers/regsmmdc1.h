 ...
 *
 * - HW_MMDC1_MDCTL - MMDC Core Control Register
 * - HW_MMDC1_MDPDC - MMDC Core Power Down Control Register
 * - HW_MMDC1_MDOTC - MMDC Core ODT Timing Control Register
 * - HW_MMDC1_MDCFG0 - MMDC Core Timing Configuration Register 0
 * - HW_MMDC1_MDCFG1 - MMDC Core Timing Configuration Register 1
 * - HW_MMDC1_MDCFG2 - MMDC Core Timing Configuration Register 2
 * - HW_MMDC1_MDMISC - MMDC Core Miscellaneous Register
 * - HW_MMDC1_MDSCR - MMDC Core Special Command Register
 * - HW_MMDC1_MDREF - MMDC Core Refresh Control Register
 * - HW_MMDC1_MDRWD - MMDC Core Read/Write Command Delay Register
 * - HW_MMDC1_MDOR - MMDC Core Out of Reset Delays Register
 * - HW_MMDC1_MDMRR - MMDC Core MRR Data Register
 * - HW_MMDC1_MDCFG3LP - MMDC Core Timing Configuration Register 3
 * - HW_MMDC1_MDMR4 - MMDC Core MR4 Derating Register
 * - HW_MMDC1_MDASP - MMDC Core Address Space Partition Register
 * - HW_MMDC1_MAARCR - MMDC Core AXI Reordering Control Regsiter
 * - HW_MMDC1_MAPSR - MMDC Core Power Saving Control and Status Register
 * - HW_MMDC1_MAEXIDR0 - MMDC Core Exclusive ID Monitor Register0
 * - HW_MMDC1_MAEXIDR1 - MMDC Core Exclusive ID Monitor Register1
 * - HW_MMDC1_MADPCR0 - MMDC Core Debug and Profiling Control Register 0
 * - HW_MMDC1_MADPCR1 - MMDC Core Debug and Profiling Control Register 1
 * - HW_MMDC1_MADPSR0 - MMDC Core Debug and Profiling Status Register 0
 * - HW_MMDC1_MADPSR1 - MMDC Core Debug and Profiling Status Register 1
 * - HW_MMDC1_MADPSR2 - MMDC Core Debug and Profiling Status Register 2
 * - HW_MMDC1_MADPSR3 - MMDC Core Debug and Profiling Status Register 3
 * - HW_MMDC1_MADPSR4 - MMDC Core Debug and Profiling Status Register 4
 * - HW_MMDC1_MADPSR5 - MMDC Core Debug and Profiling Status Register 5
 * - HW_MMDC1_MASBS0 - MMDC Core Step By Step Address Register
 * - HW_MMDC1_MASBS1 - MMDC Core Step By Step Address Attributes Register
 * - HW_MMDC1_MAGENP - MMDC Core General Purpose Register
 * - HW_MMDC1_MPZQHWCTRL - MMDC PHY ZQ HW control register
 * - HW_MMDC1_MPZQSWCTRL - MMDC PHY ZQ SW control register
 * - HW_MMDC1_MPWLGCR - MMDC PHY Write Leveling Configuration and Error Status Register
 * - HW_MMDC1_MPWLDECTRL0 - MMDC PHY Write Leveling Delay Control Register 0
 * - HW_MMDC1_MPWLDECTRL1 - MMDC PHY Write Leveling Delay Control Register 1
 * - HW_MMDC1_MPWLDLST - MMDC PHY Write Leveling delay-line Status Register
 * - HW_MMDC1_MPODTCTRL - MMDC PHY ODT control register
 * - HW_MMDC1_MPRDDQBY0DL - MMDC PHY Read DQ Byte0 Delay Register
 * - HW_MMDC1_MPRDDQBY1DL - MMDC PHY Read DQ Byte1 Delay Register
 * - HW_MMDC1_MPRDDQBY2DL - MMDC PHY Read DQ Byte2 Delay Register
 * - HW_MMDC1_MPRDDQBY3DL - MMDC PHY Read DQ Byte3 Delay Register
 * - HW_MMDC1_MPWRDQBY0DL - MMDC PHY Write DQ Byte0 Delay Register
 * - HW_MMDC1_MPWRDQBY1DL - MMDC PHY Write DQ Byte1 Delay Register
 * - HW_MMDC1_MPWRDQBY2DL - MMDC PHY Write DQ Byte2 Delay Register
 * - HW_MMDC1_MPWRDQBY3DL - MMDC PHY Write DQ Byte3 Delay Register
 * - HW_MMDC1_MPDGCTRL0 - MMDC PHY Read DQS Gating Control Register 0
 * - HW_MMDC1_MPDGCTRL1 - MMDC PHY Read DQS Gating Control Register 1
 * - HW_MMDC1_MPDGDLST0 - MMDC PHY Read DQS Gating delay-line Status Register
 * - HW_MMDC1_MPRDDLCTL - MMDC PHY Read delay-lines Configuration Register
 * - HW_MMDC1_MPRDDLST - MMDC PHY Read delay-lines Status Register
 * - HW_MMDC1_MPWRDLCTL - MMDC PHY Write delay-lines Configuration Register
 * - HW_MMDC1_MPWRDLST - MMDC PHY Write delay-lines Status Register
 * - HW_MMDC1_MPSDCTRL - MMDC PHY CK Control Register
 * - HW_MMDC1_MPZQLP2CTL - MMDC ZQ LPDDR2 HW Control Register
 * - HW_MMDC1_MPRDDLHWCTL - MMDC PHY Read Delay HW Calibration Control Register
 * - HW_MMDC1_MPWRDLHWCTL - MMDC PHY Write Delay HW Calibration Control Register
 * - HW_MMDC1_MPRDDLHWST0 - MMDC PHY Read Delay HW Calibration Status Register 0
 * - HW_MMDC1_MPRDDLHWST1 - MMDC PHY Read Delay HW Calibration Status Register 1
 * - HW_MMDC1_MPWRDLHWST0 - MMDC PHY Write Delay HW Calibration Status Register 0
 * - HW_MMDC1_MPWRDLHWST1 - MMDC PHY Write Delay HW Calibration Status Register 1
 * - HW_MMDC1_MPWLHWERR - MMDC PHY Write Leveling HW Error Register
 * - HW_MMDC1_MPDGHWST0 - MMDC PHY Read DQS Gating HW Status Register 0
 * - HW_MMDC1_MPDGHWST1 - MMDC PHY Read DQS Gating HW Status Register 1
 * - HW_MMDC1_MPDGHWST2 - MMDC PHY Read DQS Gating HW Status Register 2
 * - HW_MMDC1_MPDGHWST3 - MMDC PHY Read DQS Gating HW Status Register 3
 * - HW_MMDC1_MPPDCMPR1 - MMDC PHY Pre-defined Compare Register 1
 * - HW_MMDC1_MPPDCMPR2 - MMDC PHY Pre-defined Compare and CA delay-line Configuration Register
 * - HW_MMDC1_MPSWDAR0 - MMDC PHY SW Dummy Access Register
 * - HW_MMDC1_MPSWDRDR0 - MMDC PHY SW Dummy Read Data Register 0
 * - HW_MMDC1_MPSWDRDR1 - MMDC PHY SW Dummy Read Data Register 1
 * - HW_MMDC1_MPSWDRDR2 - MMDC PHY SW Dummy Read Data Register 2
 * - HW_MMDC1_MPSWDRDR3 - MMDC PHY SW Dummy Read Data Register 3
 * - HW_MMDC1_MPSWDRDR4 - MMDC PHY SW Dummy Read Data Register 4
 * - HW_MMDC1_MPSWDRDR5 - MMDC PHY SW Dummy Read Data Register 5
 * - HW_MMDC1_MPSWDRDR6 - MMDC PHY SW Dummy Read Data Register 6
 * - HW_MMDC1_MPSWDRDR7 - MMDC PHY SW Dummy Read Data Register 7
 * - HW_MMDC1_MPMUR0 - MMDC PHY Measure Unit Register
 * - HW_MMDC1_MPWRCADL - MMDC Write CA delay-line controller
 * - HW_MMDC1_MPDCCR - MMDC Duty Cycle Control Register
 *
 * hw_mmdc1_t - Struct containing all module registers.
 */

//! @name Module base addresses
//@{
#ifndef REGS_MMDC1_BASE
#define REGS_MMDC10_BASE (0x021b0000) //!< Base address for MMDC1 instance number 0.
#define REGS_MMDC11_BASE (0x021b4000) //!< Base address for MMDC1 instance number 1.

//! @brief Get the base address of MMDC1 by instance number.
//! @param x MMDC1 instance number, from 0 through 2.
#define REGS_MMDC1_BASE(x) ( x == 0 ? REGS_MMDC10_BASE : x == 1 ? REGS_MMDC11_BASE : 0xffff0000)
#endif
//@}

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDCTL - MMDC Core Control Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDCTL register
 */
#define HW_MMDC1_MDCTL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x0)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDCTL(x)           (*(volatile hw_mmdc1_mdctl_t *) HW_MMDC1_MDCTL_ADDR(x))
#define HW_MMDC1_MDCTL_RD(x)        (HW_MMDC1_MDCTL(x).U)
#define HW_MMDC1_MDCTL_WR(x, v)     (HW_MMDC1_MDCTL(x).U = (v))
#define HW_MMDC1_MDCTL_SET(x, v)    (HW_MMDC1_MDCTL_WR(x, HW_MMDC1_MDCTL_RD(x) |  (v)))
#define HW_MMDC1_MDCTL_CLR(x, v)    (HW_MMDC1_MDCTL_WR(x, HW_MMDC1_MDCTL_RD(x) & ~(v)))
#define HW_MMDC1_MDCTL_TOG(x, v)    (HW_MMDC1_MDCTL_WR(x, HW_MMDC1_MDCTL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDCTL bitfields
 */

/* --- Register HW_MMDC1_MDCTL, field DSIZ (RW)
 *
...
#define BP_MMDC1_MDCTL_DSIZ      16
#define BM_MMDC1_MDCTL_DSIZ      0x00030000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCTL_DSIZ(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDCTL_DSIZ)
#else
#define BF_MMDC1_MDCTL_DSIZ(v)   (((v) << 16) & BM_MMDC1_MDCTL_DSIZ)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DSIZ field to a new value.
#define BW_MMDC1_MDCTL_DSIZ(v)   BF_CS1(MMDC1_MDCTL, DSIZ, v)
#endif


/* --- Register HW_MMDC1_MDCTL, field BL (RW)
 *
...
#define BP_MMDC1_MDCTL_BL      19
#define BM_MMDC1_MDCTL_BL      0x00080000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCTL_BL(v)   ((((reg32_t) v) << 19) & BM_MMDC1_MDCTL_BL)
#else
#define BF_MMDC1_MDCTL_BL(v)   (((v) << 19) & BM_MMDC1_MDCTL_BL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the BL field to a new value.
#define BW_MMDC1_MDCTL_BL(v)   BF_CS1(MMDC1_MDCTL, BL, v)
#endif


/* --- Register HW_MMDC1_MDCTL, field COL (RW)
 *
...
#define BP_MMDC1_MDCTL_COL      20
#define BM_MMDC1_MDCTL_COL      0x00700000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCTL_COL(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MDCTL_COL)
#else
#define BF_MMDC1_MDCTL_COL(v)   (((v) << 20) & BM_MMDC1_MDCTL_COL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the COL field to a new value.
#define BW_MMDC1_MDCTL_COL(v)   BF_CS1(MMDC1_MDCTL, COL, v)
#endif


/* --- Register HW_MMDC1_MDCTL, field ROW (RW)
 *
...
#define BP_MMDC1_MDCTL_ROW      24
#define BM_MMDC1_MDCTL_ROW      0x07000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCTL_ROW(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MDCTL_ROW)
#else
#define BF_MMDC1_MDCTL_ROW(v)   (((v) << 24) & BM_MMDC1_MDCTL_ROW)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ROW field to a new value.
#define BW_MMDC1_MDCTL_ROW(v)   BF_CS1(MMDC1_MDCTL, ROW, v)
#endif


/* --- Register HW_MMDC1_MDCTL, field SDE_1 (RW)
 *
...
#define BP_MMDC1_MDCTL_SDE_1      30
#define BM_MMDC1_MDCTL_SDE_1      0x40000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCTL_SDE_1(v)   ((((reg32_t) v) << 30) & BM_MMDC1_MDCTL_SDE_1)
#else
#define BF_MMDC1_MDCTL_SDE_1(v)   (((v) << 30) & BM_MMDC1_MDCTL_SDE_1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SDE_1 field to a new value.
#define BW_MMDC1_MDCTL_SDE_1(v)   BF_CS1(MMDC1_MDCTL, SDE_1, v)
#endif


/* --- Register HW_MMDC1_MDCTL, field SDE_0 (RW)
 *
...
#define BP_MMDC1_MDCTL_SDE_0      31
#define BM_MMDC1_MDCTL_SDE_0      0x80000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCTL_SDE_0(v)   ((((reg32_t) v) << 31) & BM_MMDC1_MDCTL_SDE_0)
#else
#define BF_MMDC1_MDCTL_SDE_0(v)   (((v) << 31) & BM_MMDC1_MDCTL_SDE_0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SDE_0 field to a new value.
#define BW_MMDC1_MDCTL_SDE_0(v)   BF_CS1(MMDC1_MDCTL, SDE_0, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDPDC - MMDC Core Power Down Control Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDPDC register
 */
#define HW_MMDC1_MDPDC_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x4)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDPDC(x)           (*(volatile hw_mmdc1_mdpdc_t *) HW_MMDC1_MDPDC_ADDR(x))
#define HW_MMDC1_MDPDC_RD(x)        (HW_MMDC1_MDPDC(x).U)
#define HW_MMDC1_MDPDC_WR(x, v)     (HW_MMDC1_MDPDC(x).U = (v))
#define HW_MMDC1_MDPDC_SET(x, v)    (HW_MMDC1_MDPDC_WR(x, HW_MMDC1_MDPDC_RD(x) |  (v)))
#define HW_MMDC1_MDPDC_CLR(x, v)    (HW_MMDC1_MDPDC_WR(x, HW_MMDC1_MDPDC_RD(x) & ~(v)))
#define HW_MMDC1_MDPDC_TOG(x, v)    (HW_MMDC1_MDPDC_WR(x, HW_MMDC1_MDPDC_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDPDC bitfields
 */

/* --- Register HW_MMDC1_MDPDC, field TCKSRE (RW)
 *
...
#define BP_MMDC1_MDPDC_TCKSRE      0
#define BM_MMDC1_MDPDC_TCKSRE      0x00000007

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDPDC_TCKSRE(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDPDC_TCKSRE)
#else
#define BF_MMDC1_MDPDC_TCKSRE(v)   (((v) << 0) & BM_MMDC1_MDPDC_TCKSRE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TCKSRE field to a new value.
#define BW_MMDC1_MDPDC_TCKSRE(v)   BF_CS1(MMDC1_MDPDC, TCKSRE, v)
#endif


/* --- Register HW_MMDC1_MDPDC, field TCKSRX (RW)
 *
...
#define BP_MMDC1_MDPDC_TCKSRX      3
#define BM_MMDC1_MDPDC_TCKSRX      0x00000038

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDPDC_TCKSRX(v)   ((((reg32_t) v) << 3) & BM_MMDC1_MDPDC_TCKSRX)
#else
#define BF_MMDC1_MDPDC_TCKSRX(v)   (((v) << 3) & BM_MMDC1_MDPDC_TCKSRX)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TCKSRX field to a new value.
#define BW_MMDC1_MDPDC_TCKSRX(v)   BF_CS1(MMDC1_MDPDC, TCKSRX, v)
#endif


/* --- Register HW_MMDC1_MDPDC, field BOTH_CS_PD (RW)
 *
...
#define BP_MMDC1_MDPDC_BOTH_CS_PD      6
#define BM_MMDC1_MDPDC_BOTH_CS_PD      0x00000040

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDPDC_BOTH_CS_PD(v)   ((((reg32_t) v) << 6) & BM_MMDC1_MDPDC_BOTH_CS_PD)
#else
#define BF_MMDC1_MDPDC_BOTH_CS_PD(v)   (((v) << 6) & BM_MMDC1_MDPDC_BOTH_CS_PD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the BOTH_CS_PD field to a new value.
#define BW_MMDC1_MDPDC_BOTH_CS_PD(v)   BF_CS1(MMDC1_MDPDC, BOTH_CS_PD, v)
#endif


/* --- Register HW_MMDC1_MDPDC, field SLOW_PD (RW)
 *
...
#define BP_MMDC1_MDPDC_SLOW_PD      7
#define BM_MMDC1_MDPDC_SLOW_PD      0x00000080

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDPDC_SLOW_PD(v)   ((((reg32_t) v) << 7) & BM_MMDC1_MDPDC_SLOW_PD)
#else
#define BF_MMDC1_MDPDC_SLOW_PD(v)   (((v) << 7) & BM_MMDC1_MDPDC_SLOW_PD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SLOW_PD field to a new value.
#define BW_MMDC1_MDPDC_SLOW_PD(v)   BF_CS1(MMDC1_MDPDC, SLOW_PD, v)
#endif


/* --- Register HW_MMDC1_MDPDC, field PWDT_0 (RW)
 *
...
#define BP_MMDC1_MDPDC_PWDT_0      8
#define BM_MMDC1_MDPDC_PWDT_0      0x00000f00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDPDC_PWDT_0(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MDPDC_PWDT_0)
#else
#define BF_MMDC1_MDPDC_PWDT_0(v)   (((v) << 8) & BM_MMDC1_MDPDC_PWDT_0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PWDT_0 field to a new value.
#define BW_MMDC1_MDPDC_PWDT_0(v)   BF_CS1(MMDC1_MDPDC, PWDT_0, v)
#endif

/* --- Register HW_MMDC1_MDPDC, field PWDT_1 (RW)
 *
...
#define BP_MMDC1_MDPDC_PWDT_1      12
#define BM_MMDC1_MDPDC_PWDT_1      0x0000f000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDPDC_PWDT_1(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MDPDC_PWDT_1)
#else
#define BF_MMDC1_MDPDC_PWDT_1(v)   (((v) << 12) & BM_MMDC1_MDPDC_PWDT_1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PWDT_1 field to a new value.
#define BW_MMDC1_MDPDC_PWDT_1(v)   BF_CS1(MMDC1_MDPDC, PWDT_1, v)
#endif

/* --- Register HW_MMDC1_MDPDC, field TCKE (RW)
 *
...
#define BP_MMDC1_MDPDC_TCKE      16
#define BM_MMDC1_MDPDC_TCKE      0x00070000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDPDC_TCKE(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDPDC_TCKE)
#else
#define BF_MMDC1_MDPDC_TCKE(v)   (((v) << 16) & BM_MMDC1_MDPDC_TCKE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TCKE field to a new value.
#define BW_MMDC1_MDPDC_TCKE(v)   BF_CS1(MMDC1_MDPDC, TCKE, v)
#endif


/* --- Register HW_MMDC1_MDPDC, field PRCT_0 (RW)
 *
...
#define BP_MMDC1_MDPDC_PRCT_0      24
#define BM_MMDC1_MDPDC_PRCT_0      0x07000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDPDC_PRCT_0(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MDPDC_PRCT_0)
#else
#define BF_MMDC1_MDPDC_PRCT_0(v)   (((v) << 24) & BM_MMDC1_MDPDC_PRCT_0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PRCT_0 field to a new value.
#define BW_MMDC1_MDPDC_PRCT_0(v)   BF_CS1(MMDC1_MDPDC, PRCT_0, v)
#endif

/* --- Register HW_MMDC1_MDPDC, field PRCT_1 (RW)
 *
...
#define BP_MMDC1_MDPDC_PRCT_1      28
#define BM_MMDC1_MDPDC_PRCT_1      0x70000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDPDC_PRCT_1(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MDPDC_PRCT_1)
#else
#define BF_MMDC1_MDPDC_PRCT_1(v)   (((v) << 28) & BM_MMDC1_MDPDC_PRCT_1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PRCT_1 field to a new value.
#define BW_MMDC1_MDPDC_PRCT_1(v)   BF_CS1(MMDC1_MDPDC, PRCT_1, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDOTC - MMDC Core ODT Timing Control Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDOTC register
 */
#define HW_MMDC1_MDOTC_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDOTC(x)           (*(volatile hw_mmdc1_mdotc_t *) HW_MMDC1_MDOTC_ADDR(x))
#define HW_MMDC1_MDOTC_RD(x)        (HW_MMDC1_MDOTC(x).U)
#define HW_MMDC1_MDOTC_WR(x, v)     (HW_MMDC1_MDOTC(x).U = (v))
#define HW_MMDC1_MDOTC_SET(x, v)    (HW_MMDC1_MDOTC_WR(x, HW_MMDC1_MDOTC_RD(x) |  (v)))
#define HW_MMDC1_MDOTC_CLR(x, v)    (HW_MMDC1_MDOTC_WR(x, HW_MMDC1_MDOTC_RD(x) & ~(v)))
#define HW_MMDC1_MDOTC_TOG(x, v)    (HW_MMDC1_MDOTC_WR(x, HW_MMDC1_MDOTC_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDOTC bitfields
 */

/* --- Register HW_MMDC1_MDOTC, field TODT_IDLE_OFF (RW)
 *
...
#define BP_MMDC1_MDOTC_TODT_IDLE_OFF      4
#define BM_MMDC1_MDOTC_TODT_IDLE_OFF      0x000001f0

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDOTC_TODT_IDLE_OFF(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MDOTC_TODT_IDLE_OFF)
#else
#define BF_MMDC1_MDOTC_TODT_IDLE_OFF(v)   (((v) << 4) & BM_MMDC1_MDOTC_TODT_IDLE_OFF)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TODT_IDLE_OFF field to a new value.
#define BW_MMDC1_MDOTC_TODT_IDLE_OFF(v)   BF_CS1(MMDC1_MDOTC, TODT_IDLE_OFF, v)
#endif


/* --- Register HW_MMDC1_MDOTC, field TODTLON (RW)
 *
...
#define BP_MMDC1_MDOTC_TODTLON      12
#define BM_MMDC1_MDOTC_TODTLON      0x00007000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDOTC_TODTLON(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MDOTC_TODTLON)
#else
#define BF_MMDC1_MDOTC_TODTLON(v)   (((v) << 12) & BM_MMDC1_MDOTC_TODTLON)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TODTLON field to a new value.
#define BW_MMDC1_MDOTC_TODTLON(v)   BF_CS1(MMDC1_MDOTC, TODTLON, v)
#endif


/* --- Register HW_MMDC1_MDOTC, field TAXPD (RW)
 *
...
#define BP_MMDC1_MDOTC_TAXPD      16
#define BM_MMDC1_MDOTC_TAXPD      0x000f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDOTC_TAXPD(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDOTC_TAXPD)
#else
#define BF_MMDC1_MDOTC_TAXPD(v)   (((v) << 16) & BM_MMDC1_MDOTC_TAXPD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TAXPD field to a new value.
#define BW_MMDC1_MDOTC_TAXPD(v)   BF_CS1(MMDC1_MDOTC, TAXPD, v)
#endif


/* --- Register HW_MMDC1_MDOTC, field TANPD (RW)
 *
...
#define BP_MMDC1_MDOTC_TANPD      20
#define BM_MMDC1_MDOTC_TANPD      0x00f00000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDOTC_TANPD(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MDOTC_TANPD)
#else
#define BF_MMDC1_MDOTC_TANPD(v)   (((v) << 20) & BM_MMDC1_MDOTC_TANPD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TANPD field to a new value.
#define BW_MMDC1_MDOTC_TANPD(v)   BF_CS1(MMDC1_MDOTC, TANPD, v)
#endif


/* --- Register HW_MMDC1_MDOTC, field TAONPD (RW)
 *
...
#define BP_MMDC1_MDOTC_TAONPD      24
#define BM_MMDC1_MDOTC_TAONPD      0x07000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDOTC_TAONPD(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MDOTC_TAONPD)
#else
#define BF_MMDC1_MDOTC_TAONPD(v)   (((v) << 24) & BM_MMDC1_MDOTC_TAONPD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TAONPD field to a new value.
#define BW_MMDC1_MDOTC_TAONPD(v)   BF_CS1(MMDC1_MDOTC, TAONPD, v)
#endif


/* --- Register HW_MMDC1_MDOTC, field TAOFPD (RW)
 *
...
#define BP_MMDC1_MDOTC_TAOFPD      27
#define BM_MMDC1_MDOTC_TAOFPD      0x38000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDOTC_TAOFPD(v)   ((((reg32_t) v) << 27) & BM_MMDC1_MDOTC_TAOFPD)
#else
#define BF_MMDC1_MDOTC_TAOFPD(v)   (((v) << 27) & BM_MMDC1_MDOTC_TAOFPD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TAOFPD field to a new value.
#define BW_MMDC1_MDOTC_TAOFPD(v)   BF_CS1(MMDC1_MDOTC, TAOFPD, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDCFG0 - MMDC Core Timing Configuration Register 0 (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MDCFG0 register
 */
#define HW_MMDC1_MDCFG0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0xc)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDCFG0(x)           (*(volatile hw_mmdc1_mdcfg0_t *) HW_MMDC1_MDCFG0_ADDR(x))
#define HW_MMDC1_MDCFG0_RD(x)        (HW_MMDC1_MDCFG0(x).U)
#define HW_MMDC1_MDCFG0_WR(x, v)     (HW_MMDC1_MDCFG0(x).U = (v))
#define HW_MMDC1_MDCFG0_SET(x, v)    (HW_MMDC1_MDCFG0_WR(x, HW_MMDC1_MDCFG0_RD(x) |  (v)))
#define HW_MMDC1_MDCFG0_CLR(x, v)    (HW_MMDC1_MDCFG0_WR(x, HW_MMDC1_MDCFG0_RD(x) & ~(v)))
#define HW_MMDC1_MDCFG0_TOG(x, v)    (HW_MMDC1_MDCFG0_WR(x, HW_MMDC1_MDCFG0_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDCFG0 bitfields
 */

/* --- Register HW_MMDC1_MDCFG0, field TCL (RW)
 *
...
#define BP_MMDC1_MDCFG0_TCL      0
#define BM_MMDC1_MDCFG0_TCL      0x0000000f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG0_TCL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDCFG0_TCL)
#else
#define BF_MMDC1_MDCFG0_TCL(v)   (((v) << 0) & BM_MMDC1_MDCFG0_TCL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TCL field to a new value.
#define BW_MMDC1_MDCFG0_TCL(v)   BF_CS1(MMDC1_MDCFG0, TCL, v)
#endif


/* --- Register HW_MMDC1_MDCFG0, field TFAW (RW)
 *
...
#define BP_MMDC1_MDCFG0_TFAW      4
#define BM_MMDC1_MDCFG0_TFAW      0x000001f0

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG0_TFAW(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MDCFG0_TFAW)
#else
#define BF_MMDC1_MDCFG0_TFAW(v)   (((v) << 4) & BM_MMDC1_MDCFG0_TFAW)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TFAW field to a new value.
#define BW_MMDC1_MDCFG0_TFAW(v)   BF_CS1(MMDC1_MDCFG0, TFAW, v)
#endif


/* --- Register HW_MMDC1_MDCFG0, field TXPDLL (RW)
 *
...
#define BP_MMDC1_MDCFG0_TXPDLL      9
#define BM_MMDC1_MDCFG0_TXPDLL      0x00001e00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG0_TXPDLL(v)   ((((reg32_t) v) << 9) & BM_MMDC1_MDCFG0_TXPDLL)
#else
#define BF_MMDC1_MDCFG0_TXPDLL(v)   (((v) << 9) & BM_MMDC1_MDCFG0_TXPDLL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TXPDLL field to a new value.
#define BW_MMDC1_MDCFG0_TXPDLL(v)   BF_CS1(MMDC1_MDCFG0, TXPDLL, v)
#endif


/* --- Register HW_MMDC1_MDCFG0, field TXP (RW)
 *
...
#define BP_MMDC1_MDCFG0_TXP      13
#define BM_MMDC1_MDCFG0_TXP      0x0000e000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG0_TXP(v)   ((((reg32_t) v) << 13) & BM_MMDC1_MDCFG0_TXP)
#else
#define BF_MMDC1_MDCFG0_TXP(v)   (((v) << 13) & BM_MMDC1_MDCFG0_TXP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TXP field to a new value.
#define BW_MMDC1_MDCFG0_TXP(v)   BF_CS1(MMDC1_MDCFG0, TXP, v)
#endif


/* --- Register HW_MMDC1_MDCFG0, field TXS (RW)
 *
...
#define BP_MMDC1_MDCFG0_TXS      16
#define BM_MMDC1_MDCFG0_TXS      0x00ff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG0_TXS(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDCFG0_TXS)
#else
#define BF_MMDC1_MDCFG0_TXS(v)   (((v) << 16) & BM_MMDC1_MDCFG0_TXS)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TXS field to a new value.
#define BW_MMDC1_MDCFG0_TXS(v)   BF_CS1(MMDC1_MDCFG0, TXS, v)
#endif


/* --- Register HW_MMDC1_MDCFG0, field TRFC (RW)
 *
...
#define BP_MMDC1_MDCFG0_TRFC      24
#define BM_MMDC1_MDCFG0_TRFC      0xff000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG0_TRFC(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MDCFG0_TRFC)
#else
#define BF_MMDC1_MDCFG0_TRFC(v)   (((v) << 24) & BM_MMDC1_MDCFG0_TRFC)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRFC field to a new value.
#define BW_MMDC1_MDCFG0_TRFC(v)   BF_CS1(MMDC1_MDCFG0, TRFC, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDCFG1 - MMDC Core Timing Configuration Register 1 (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MDCFG1 register
 */
#define HW_MMDC1_MDCFG1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x10)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDCFG1(x)           (*(volatile hw_mmdc1_mdcfg1_t *) HW_MMDC1_MDCFG1_ADDR(x))
#define HW_MMDC1_MDCFG1_RD(x)        (HW_MMDC1_MDCFG1(x).U)
#define HW_MMDC1_MDCFG1_WR(x, v)     (HW_MMDC1_MDCFG1(x).U = (v))
#define HW_MMDC1_MDCFG1_SET(x, v)    (HW_MMDC1_MDCFG1_WR(x, HW_MMDC1_MDCFG1_RD(x) |  (v)))
#define HW_MMDC1_MDCFG1_CLR(x, v)    (HW_MMDC1_MDCFG1_WR(x, HW_MMDC1_MDCFG1_RD(x) & ~(v)))
#define HW_MMDC1_MDCFG1_TOG(x, v)    (HW_MMDC1_MDCFG1_WR(x, HW_MMDC1_MDCFG1_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDCFG1 bitfields
 */

/* --- Register HW_MMDC1_MDCFG1, field TCWL (RW)
 *
...
#define BP_MMDC1_MDCFG1_TCWL      0
#define BM_MMDC1_MDCFG1_TCWL      0x00000007

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG1_TCWL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDCFG1_TCWL)
#else
#define BF_MMDC1_MDCFG1_TCWL(v)   (((v) << 0) & BM_MMDC1_MDCFG1_TCWL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TCWL field to a new value.
#define BW_MMDC1_MDCFG1_TCWL(v)   BF_CS1(MMDC1_MDCFG1, TCWL, v)
#endif


/* --- Register HW_MMDC1_MDCFG1, field TMRD (RW)
 *
...
#define BP_MMDC1_MDCFG1_TMRD      5
#define BM_MMDC1_MDCFG1_TMRD      0x000001e0

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG1_TMRD(v)   ((((reg32_t) v) << 5) & BM_MMDC1_MDCFG1_TMRD)
#else
#define BF_MMDC1_MDCFG1_TMRD(v)   (((v) << 5) & BM_MMDC1_MDCFG1_TMRD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TMRD field to a new value.
#define BW_MMDC1_MDCFG1_TMRD(v)   BF_CS1(MMDC1_MDCFG1, TMRD, v)
#endif


/* --- Register HW_MMDC1_MDCFG1, field TWR (RW)
 *
...
#define BP_MMDC1_MDCFG1_TWR      9
#define BM_MMDC1_MDCFG1_TWR      0x00000e00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG1_TWR(v)   ((((reg32_t) v) << 9) & BM_MMDC1_MDCFG1_TWR)
#else
#define BF_MMDC1_MDCFG1_TWR(v)   (((v) << 9) & BM_MMDC1_MDCFG1_TWR)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TWR field to a new value.
#define BW_MMDC1_MDCFG1_TWR(v)   BF_CS1(MMDC1_MDCFG1, TWR, v)
#endif


/* --- Register HW_MMDC1_MDCFG1, field TRPA (RW)
 *
...
#define BP_MMDC1_MDCFG1_TRPA      15
#define BM_MMDC1_MDCFG1_TRPA      0x00008000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG1_TRPA(v)   ((((reg32_t) v) << 15) & BM_MMDC1_MDCFG1_TRPA)
#else
#define BF_MMDC1_MDCFG1_TRPA(v)   (((v) << 15) & BM_MMDC1_MDCFG1_TRPA)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRPA field to a new value.
#define BW_MMDC1_MDCFG1_TRPA(v)   BF_CS1(MMDC1_MDCFG1, TRPA, v)
#endif


/* --- Register HW_MMDC1_MDCFG1, field TRAS (RW)
 *
...
#define BP_MMDC1_MDCFG1_TRAS      16
#define BM_MMDC1_MDCFG1_TRAS      0x001f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG1_TRAS(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDCFG1_TRAS)
#else
#define BF_MMDC1_MDCFG1_TRAS(v)   (((v) << 16) & BM_MMDC1_MDCFG1_TRAS)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRAS field to a new value.
#define BW_MMDC1_MDCFG1_TRAS(v)   BF_CS1(MMDC1_MDCFG1, TRAS, v)
#endif


/* --- Register HW_MMDC1_MDCFG1, field TRC (RW)
 *
...
#define BP_MMDC1_MDCFG1_TRC      21
#define BM_MMDC1_MDCFG1_TRC      0x03e00000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG1_TRC(v)   ((((reg32_t) v) << 21) & BM_MMDC1_MDCFG1_TRC)
#else
#define BF_MMDC1_MDCFG1_TRC(v)   (((v) << 21) & BM_MMDC1_MDCFG1_TRC)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRC field to a new value.
#define BW_MMDC1_MDCFG1_TRC(v)   BF_CS1(MMDC1_MDCFG1, TRC, v)
#endif


/* --- Register HW_MMDC1_MDCFG1, field TRP (RW)
 *
...
#define BP_MMDC1_MDCFG1_TRP      26
#define BM_MMDC1_MDCFG1_TRP      0x1c000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG1_TRP(v)   ((((reg32_t) v) << 26) & BM_MMDC1_MDCFG1_TRP)
#else
#define BF_MMDC1_MDCFG1_TRP(v)   (((v) << 26) & BM_MMDC1_MDCFG1_TRP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRP field to a new value.
#define BW_MMDC1_MDCFG1_TRP(v)   BF_CS1(MMDC1_MDCFG1, TRP, v)
#endif


/* --- Register HW_MMDC1_MDCFG1, field TRCD (RW)
 *
...
#define BP_MMDC1_MDCFG1_TRCD      29
#define BM_MMDC1_MDCFG1_TRCD      0xe0000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG1_TRCD(v)   ((((reg32_t) v) << 29) & BM_MMDC1_MDCFG1_TRCD)
#else
#define BF_MMDC1_MDCFG1_TRCD(v)   (((v) << 29) & BM_MMDC1_MDCFG1_TRCD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRCD field to a new value.
#define BW_MMDC1_MDCFG1_TRCD(v)   BF_CS1(MMDC1_MDCFG1, TRCD, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDCFG2 - MMDC Core Timing Configuration Register 2 (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MDCFG2 register
 */
#define HW_MMDC1_MDCFG2_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x14)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDCFG2(x)           (*(volatile hw_mmdc1_mdcfg2_t *) HW_MMDC1_MDCFG2_ADDR(x))
#define HW_MMDC1_MDCFG2_RD(x)        (HW_MMDC1_MDCFG2(x).U)
#define HW_MMDC1_MDCFG2_WR(x, v)     (HW_MMDC1_MDCFG2(x).U = (v))
#define HW_MMDC1_MDCFG2_SET(x, v)    (HW_MMDC1_MDCFG2_WR(x, HW_MMDC1_MDCFG2_RD(x) |  (v)))
#define HW_MMDC1_MDCFG2_CLR(x, v)    (HW_MMDC1_MDCFG2_WR(x, HW_MMDC1_MDCFG2_RD(x) & ~(v)))
#define HW_MMDC1_MDCFG2_TOG(x, v)    (HW_MMDC1_MDCFG2_WR(x, HW_MMDC1_MDCFG2_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDCFG2 bitfields
 */

/* --- Register HW_MMDC1_MDCFG2, field TRRD (RW)
 *
...
#define BP_MMDC1_MDCFG2_TRRD      0
#define BM_MMDC1_MDCFG2_TRRD      0x00000007

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG2_TRRD(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDCFG2_TRRD)
#else
#define BF_MMDC1_MDCFG2_TRRD(v)   (((v) << 0) & BM_MMDC1_MDCFG2_TRRD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRRD field to a new value.
#define BW_MMDC1_MDCFG2_TRRD(v)   BF_CS1(MMDC1_MDCFG2, TRRD, v)
#endif


/* --- Register HW_MMDC1_MDCFG2, field TWTR (RW)
 *
...
#define BP_MMDC1_MDCFG2_TWTR      3
#define BM_MMDC1_MDCFG2_TWTR      0x00000038

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG2_TWTR(v)   ((((reg32_t) v) << 3) & BM_MMDC1_MDCFG2_TWTR)
#else
#define BF_MMDC1_MDCFG2_TWTR(v)   (((v) << 3) & BM_MMDC1_MDCFG2_TWTR)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TWTR field to a new value.
#define BW_MMDC1_MDCFG2_TWTR(v)   BF_CS1(MMDC1_MDCFG2, TWTR, v)
#endif


/* --- Register HW_MMDC1_MDCFG2, field TRTP (RW)
 *
...
#define BP_MMDC1_MDCFG2_TRTP      6
#define BM_MMDC1_MDCFG2_TRTP      0x000001c0

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG2_TRTP(v)   ((((reg32_t) v) << 6) & BM_MMDC1_MDCFG2_TRTP)
#else
#define BF_MMDC1_MDCFG2_TRTP(v)   (((v) << 6) & BM_MMDC1_MDCFG2_TRTP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRTP field to a new value.
#define BW_MMDC1_MDCFG2_TRTP(v)   BF_CS1(MMDC1_MDCFG2, TRTP, v)
#endif


/* --- Register HW_MMDC1_MDCFG2, field TDLLK (RW)
 *
...
#define BP_MMDC1_MDCFG2_TDLLK      16
#define BM_MMDC1_MDCFG2_TDLLK      0x01ff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG2_TDLLK(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDCFG2_TDLLK)
#else
#define BF_MMDC1_MDCFG2_TDLLK(v)   (((v) << 16) & BM_MMDC1_MDCFG2_TDLLK)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TDLLK field to a new value.
#define BW_MMDC1_MDCFG2_TDLLK(v)   BF_CS1(MMDC1_MDCFG2, TDLLK, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDMISC - MMDC Core Miscellaneous Register (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MDMISC register
 */
#define HW_MMDC1_MDMISC_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x18)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDMISC(x)           (*(volatile hw_mmdc1_mdmisc_t *) HW_MMDC1_MDMISC_ADDR(x))
#define HW_MMDC1_MDMISC_RD(x)        (HW_MMDC1_MDMISC(x).U)
#define HW_MMDC1_MDMISC_WR(x, v)     (HW_MMDC1_MDMISC(x).U = (v))
#define HW_MMDC1_MDMISC_SET(x, v)    (HW_MMDC1_MDMISC_WR(x, HW_MMDC1_MDMISC_RD(x) |  (v)))
#define HW_MMDC1_MDMISC_CLR(x, v)    (HW_MMDC1_MDMISC_WR(x, HW_MMDC1_MDMISC_RD(x) & ~(v)))
#define HW_MMDC1_MDMISC_TOG(x, v)    (HW_MMDC1_MDMISC_WR(x, HW_MMDC1_MDMISC_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDMISC bitfields
 */

/* --- Register HW_MMDC1_MDMISC, field RST (RW)
 *
...
#define BP_MMDC1_MDMISC_RST      1
#define BM_MMDC1_MDMISC_RST      0x00000002

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_RST(v)   ((((reg32_t) v) << 1) & BM_MMDC1_MDMISC_RST)
#else
#define BF_MMDC1_MDMISC_RST(v)   (((v) << 1) & BM_MMDC1_MDMISC_RST)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RST field to a new value.
#define BW_MMDC1_MDMISC_RST(v)   BF_CS1(MMDC1_MDMISC, RST, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field LPDDR2_2CH (RW)
 *
...
#define BP_MMDC1_MDMISC_LPDDR2_2CH      2
#define BM_MMDC1_MDMISC_LPDDR2_2CH      0x00000004

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_LPDDR2_2CH(v)   ((((reg32_t) v) << 2) & BM_MMDC1_MDMISC_LPDDR2_2CH)
#else
#define BF_MMDC1_MDMISC_LPDDR2_2CH(v)   (((v) << 2) & BM_MMDC1_MDMISC_LPDDR2_2CH)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the LPDDR2_2CH field to a new value.
#define BW_MMDC1_MDMISC_LPDDR2_2CH(v)   BF_CS1(MMDC1_MDMISC, LPDDR2_2CH, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field DDR_TYPE (RW)
 *
...
#define BP_MMDC1_MDMISC_DDR_TYPE      3
#define BM_MMDC1_MDMISC_DDR_TYPE      0x00000018

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_DDR_TYPE(v)   ((((reg32_t) v) << 3) & BM_MMDC1_MDMISC_DDR_TYPE)
#else
#define BF_MMDC1_MDMISC_DDR_TYPE(v)   (((v) << 3) & BM_MMDC1_MDMISC_DDR_TYPE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DDR_TYPE field to a new value.
#define BW_MMDC1_MDMISC_DDR_TYPE(v)   BF_CS1(MMDC1_MDMISC, DDR_TYPE, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field DDR_4_BANK (RW)
 *
...
#define BP_MMDC1_MDMISC_DDR_4_BANK      5
#define BM_MMDC1_MDMISC_DDR_4_BANK      0x00000020

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_DDR_4_BANK(v)   ((((reg32_t) v) << 5) & BM_MMDC1_MDMISC_DDR_4_BANK)
#else
#define BF_MMDC1_MDMISC_DDR_4_BANK(v)   (((v) << 5) & BM_MMDC1_MDMISC_DDR_4_BANK)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DDR_4_BANK field to a new value.
#define BW_MMDC1_MDMISC_DDR_4_BANK(v)   BF_CS1(MMDC1_MDMISC, DDR_4_BANK, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field RALAT (RW)
 *
...
#define BP_MMDC1_MDMISC_RALAT      6
#define BM_MMDC1_MDMISC_RALAT      0x000001c0

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_RALAT(v)   ((((reg32_t) v) << 6) & BM_MMDC1_MDMISC_RALAT)
#else
#define BF_MMDC1_MDMISC_RALAT(v)   (((v) << 6) & BM_MMDC1_MDMISC_RALAT)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RALAT field to a new value.
#define BW_MMDC1_MDMISC_RALAT(v)   BF_CS1(MMDC1_MDMISC, RALAT, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field MIF3_MODE (RW)
 *
...
#define BP_MMDC1_MDMISC_MIF3_MODE      9
#define BM_MMDC1_MDMISC_MIF3_MODE      0x00000600

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_MIF3_MODE(v)   ((((reg32_t) v) << 9) & BM_MMDC1_MDMISC_MIF3_MODE)
#else
#define BF_MMDC1_MDMISC_MIF3_MODE(v)   (((v) << 9) & BM_MMDC1_MDMISC_MIF3_MODE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the MIF3_MODE field to a new value.
#define BW_MMDC1_MDMISC_MIF3_MODE(v)   BF_CS1(MMDC1_MDMISC, MIF3_MODE, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field LPDDR2_S2 (RW)
 *
...
#define BP_MMDC1_MDMISC_LPDDR2_S2      11
#define BM_MMDC1_MDMISC_LPDDR2_S2      0x00000800

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_LPDDR2_S2(v)   ((((reg32_t) v) << 11) & BM_MMDC1_MDMISC_LPDDR2_S2)
#else
#define BF_MMDC1_MDMISC_LPDDR2_S2(v)   (((v) << 11) & BM_MMDC1_MDMISC_LPDDR2_S2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the LPDDR2_S2 field to a new value.
#define BW_MMDC1_MDMISC_LPDDR2_S2(v)   BF_CS1(MMDC1_MDMISC, LPDDR2_S2, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field BI_ON (RW)
 *
...
#define BP_MMDC1_MDMISC_BI_ON      12
#define BM_MMDC1_MDMISC_BI_ON      0x00001000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_BI_ON(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MDMISC_BI_ON)
#else
#define BF_MMDC1_MDMISC_BI_ON(v)   (((v) << 12) & BM_MMDC1_MDMISC_BI_ON)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the BI_ON field to a new value.
#define BW_MMDC1_MDMISC_BI_ON(v)   BF_CS1(MMDC1_MDMISC, BI_ON, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field WALAT (RW)
 *
...
#define BP_MMDC1_MDMISC_WALAT      16
#define BM_MMDC1_MDMISC_WALAT      0x00030000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_WALAT(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDMISC_WALAT)
#else
#define BF_MMDC1_MDMISC_WALAT(v)   (((v) << 16) & BM_MMDC1_MDMISC_WALAT)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WALAT field to a new value.
#define BW_MMDC1_MDMISC_WALAT(v)   BF_CS1(MMDC1_MDMISC, WALAT, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field LHD (RW)
 *
...
#define BP_MMDC1_MDMISC_LHD      18
#define BM_MMDC1_MDMISC_LHD      0x00040000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_LHD(v)   ((((reg32_t) v) << 18) & BM_MMDC1_MDMISC_LHD)
#else
#define BF_MMDC1_MDMISC_LHD(v)   (((v) << 18) & BM_MMDC1_MDMISC_LHD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the LHD field to a new value.
#define BW_MMDC1_MDMISC_LHD(v)   BF_CS1(MMDC1_MDMISC, LHD, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field ADDR_MIRROR (RW)
 *
...
#define BP_MMDC1_MDMISC_ADDR_MIRROR      19
#define BM_MMDC1_MDMISC_ADDR_MIRROR      0x00080000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_ADDR_MIRROR(v)   ((((reg32_t) v) << 19) & BM_MMDC1_MDMISC_ADDR_MIRROR)
#else
#define BF_MMDC1_MDMISC_ADDR_MIRROR(v)   (((v) << 19) & BM_MMDC1_MDMISC_ADDR_MIRROR)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ADDR_MIRROR field to a new value.
#define BW_MMDC1_MDMISC_ADDR_MIRROR(v)   BF_CS1(MMDC1_MDMISC, ADDR_MIRROR, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field CALIB_PER_CS (RW)
 *
...
#define BP_MMDC1_MDMISC_CALIB_PER_CS      20
#define BM_MMDC1_MDMISC_CALIB_PER_CS      0x00100000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMISC_CALIB_PER_CS(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MDMISC_CALIB_PER_CS)
#else
#define BF_MMDC1_MDMISC_CALIB_PER_CS(v)   (((v) << 20) & BM_MMDC1_MDMISC_CALIB_PER_CS)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the CALIB_PER_CS field to a new value.
#define BW_MMDC1_MDMISC_CALIB_PER_CS(v)   BF_CS1(MMDC1_MDMISC, CALIB_PER_CS, v)
#endif


/* --- Register HW_MMDC1_MDMISC, field CS1_RDY (RO)
 *
...
#define BP_MMDC1_MDMISC_CS1_RDY      30
#define BM_MMDC1_MDMISC_CS1_RDY      0x40000000


/* --- Register HW_MMDC1_MDMISC, field CS0_RDY (RO)
 *
...
#define BP_MMDC1_MDMISC_CS0_RDY      31
#define BM_MMDC1_MDMISC_CS0_RDY      0x80000000


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDSCR - MMDC Core Special Command Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDSCR register
 */
#define HW_MMDC1_MDSCR_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x1c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDSCR(x)           (*(volatile hw_mmdc1_mdscr_t *) HW_MMDC1_MDSCR_ADDR(x))
#define HW_MMDC1_MDSCR_RD(x)        (HW_MMDC1_MDSCR(x).U)
#define HW_MMDC1_MDSCR_WR(x, v)     (HW_MMDC1_MDSCR(x).U = (v))
#define HW_MMDC1_MDSCR_SET(x, v)    (HW_MMDC1_MDSCR_WR(x, HW_MMDC1_MDSCR_RD(x) |  (v)))
#define HW_MMDC1_MDSCR_CLR(x, v)    (HW_MMDC1_MDSCR_WR(x, HW_MMDC1_MDSCR_RD(x) & ~(v)))
#define HW_MMDC1_MDSCR_TOG(x, v)    (HW_MMDC1_MDSCR_WR(x, HW_MMDC1_MDSCR_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDSCR bitfields
 */

/* --- Register HW_MMDC1_MDSCR, field CMD_BA (RW)
 *
...
#define BP_MMDC1_MDSCR_CMD_BA      0
#define BM_MMDC1_MDSCR_CMD_BA      0x00000007

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDSCR_CMD_BA(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDSCR_CMD_BA)
#else
#define BF_MMDC1_MDSCR_CMD_BA(v)   (((v) << 0) & BM_MMDC1_MDSCR_CMD_BA)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the CMD_BA field to a new value.
#define BW_MMDC1_MDSCR_CMD_BA(v)   BF_CS1(MMDC1_MDSCR, CMD_BA, v)
#endif


/* --- Register HW_MMDC1_MDSCR, field CMD_CS (RW)
 *
...
#define BP_MMDC1_MDSCR_CMD_CS      3
#define BM_MMDC1_MDSCR_CMD_CS      0x00000008

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDSCR_CMD_CS(v)   ((((reg32_t) v) << 3) & BM_MMDC1_MDSCR_CMD_CS)
#else
#define BF_MMDC1_MDSCR_CMD_CS(v)   (((v) << 3) & BM_MMDC1_MDSCR_CMD_CS)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the CMD_CS field to a new value.
#define BW_MMDC1_MDSCR_CMD_CS(v)   BF_CS1(MMDC1_MDSCR, CMD_CS, v)
#endif


/* --- Register HW_MMDC1_MDSCR, field CMD (RW)
 *
...
#define BP_MMDC1_MDSCR_CMD      4
#define BM_MMDC1_MDSCR_CMD      0x00000070

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDSCR_CMD(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MDSCR_CMD)
#else
#define BF_MMDC1_MDSCR_CMD(v)   (((v) << 4) & BM_MMDC1_MDSCR_CMD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the CMD field to a new value.
#define BW_MMDC1_MDSCR_CMD(v)   BF_CS1(MMDC1_MDSCR, CMD, v)
#endif


/* --- Register HW_MMDC1_MDSCR, field WL_EN (RW)
 *
...
#define BP_MMDC1_MDSCR_WL_EN      9
#define BM_MMDC1_MDSCR_WL_EN      0x00000200

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDSCR_WL_EN(v)   ((((reg32_t) v) << 9) & BM_MMDC1_MDSCR_WL_EN)
#else
#define BF_MMDC1_MDSCR_WL_EN(v)   (((v) << 9) & BM_MMDC1_MDSCR_WL_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_EN field to a new value.
#define BW_MMDC1_MDSCR_WL_EN(v)   BF_CS1(MMDC1_MDSCR, WL_EN, v)
#endif


/* --- Register HW_MMDC1_MDSCR, field MRR_READ_DATA_VALID (RO)
 *
...
#define BP_MMDC1_MDSCR_MRR_READ_DATA_VALID      10
#define BM_MMDC1_MDSCR_MRR_READ_DATA_VALID      0x00000400


/* --- Register HW_MMDC1_MDSCR, field CON_ACK (RO)
 *
...
#define BP_MMDC1_MDSCR_CON_ACK      14
#define BM_MMDC1_MDSCR_CON_ACK      0x00004000


/* --- Register HW_MMDC1_MDSCR, field CON_REQ (RW)
 *
...
#define BP_MMDC1_MDSCR_CON_REQ      15
#define BM_MMDC1_MDSCR_CON_REQ      0x00008000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDSCR_CON_REQ(v)   ((((reg32_t) v) << 15) & BM_MMDC1_MDSCR_CON_REQ)
#else
#define BF_MMDC1_MDSCR_CON_REQ(v)   (((v) << 15) & BM_MMDC1_MDSCR_CON_REQ)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the CON_REQ field to a new value.
#define BW_MMDC1_MDSCR_CON_REQ(v)   BF_CS1(MMDC1_MDSCR, CON_REQ, v)
#endif


/* --- Register HW_MMDC1_MDSCR, field CMD_ADDR_LSB (RW)
 *
...
#define BP_MMDC1_MDSCR_CMD_ADDR_LSB      16
#define BM_MMDC1_MDSCR_CMD_ADDR_LSB      0x00ff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDSCR_CMD_ADDR_LSB(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDSCR_CMD_ADDR_LSB)
#else
#define BF_MMDC1_MDSCR_CMD_ADDR_LSB(v)   (((v) << 16) & BM_MMDC1_MDSCR_CMD_ADDR_LSB)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the CMD_ADDR_LSB field to a new value.
#define BW_MMDC1_MDSCR_CMD_ADDR_LSB(v)   BF_CS1(MMDC1_MDSCR, CMD_ADDR_LSB, v)
#endif

/* --- Register HW_MMDC1_MDSCR, field CMD_ADDR_MSB (RW)
 *
 * Command/Address MSB. This field indicates the MSB of the command/Address. In LPDDR2 this field
 * indicates the MRW operand
 */

#define BP_MMDC1_MDSCR_CMD_ADDR_MSB      24
#define BM_MMDC1_MDSCR_CMD_ADDR_MSB      0xff000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDSCR_CMD_ADDR_MSB(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MDSCR_CMD_ADDR_MSB)
#else
#define BF_MMDC1_MDSCR_CMD_ADDR_MSB(v)   (((v) << 24) & BM_MMDC1_MDSCR_CMD_ADDR_MSB)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the CMD_ADDR_MSB field to a new value.
#define BW_MMDC1_MDSCR_CMD_ADDR_MSB(v)   BF_CS1(MMDC1_MDSCR, CMD_ADDR_MSB, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDREF - MMDC Core Refresh Control Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDREF register
 */
#define HW_MMDC1_MDREF_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x20)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDREF(x)           (*(volatile hw_mmdc1_mdref_t *) HW_MMDC1_MDREF_ADDR(x))
#define HW_MMDC1_MDREF_RD(x)        (HW_MMDC1_MDREF(x).U)
#define HW_MMDC1_MDREF_WR(x, v)     (HW_MMDC1_MDREF(x).U = (v))
#define HW_MMDC1_MDREF_SET(x, v)    (HW_MMDC1_MDREF_WR(x, HW_MMDC1_MDREF_RD(x) |  (v)))
#define HW_MMDC1_MDREF_CLR(x, v)    (HW_MMDC1_MDREF_WR(x, HW_MMDC1_MDREF_RD(x) & ~(v)))
#define HW_MMDC1_MDREF_TOG(x, v)    (HW_MMDC1_MDREF_WR(x, HW_MMDC1_MDREF_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDREF bitfields
 */

/* --- Register HW_MMDC1_MDREF, field START_REF (RW)
 *
...
#define BP_MMDC1_MDREF_START_REF      0
#define BM_MMDC1_MDREF_START_REF      0x00000001

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDREF_START_REF(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDREF_START_REF)
#else
#define BF_MMDC1_MDREF_START_REF(v)   (((v) << 0) & BM_MMDC1_MDREF_START_REF)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the START_REF field to a new value.
#define BW_MMDC1_MDREF_START_REF(v)   BF_CS1(MMDC1_MDREF, START_REF, v)
#endif


/* --- Register HW_MMDC1_MDREF, field REFR (RW)
 *
...
#define BP_MMDC1_MDREF_REFR      11
#define BM_MMDC1_MDREF_REFR      0x00003800

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDREF_REFR(v)   ((((reg32_t) v) << 11) & BM_MMDC1_MDREF_REFR)
#else
#define BF_MMDC1_MDREF_REFR(v)   (((v) << 11) & BM_MMDC1_MDREF_REFR)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the REFR field to a new value.
#define BW_MMDC1_MDREF_REFR(v)   BF_CS1(MMDC1_MDREF, REFR, v)
#endif


/* --- Register HW_MMDC1_MDREF, field REF_SEL (RW)
 *
...
#define BP_MMDC1_MDREF_REF_SEL      14
#define BM_MMDC1_MDREF_REF_SEL      0x0000c000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDREF_REF_SEL(v)   ((((reg32_t) v) << 14) & BM_MMDC1_MDREF_REF_SEL)
#else
#define BF_MMDC1_MDREF_REF_SEL(v)   (((v) << 14) & BM_MMDC1_MDREF_REF_SEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the REF_SEL field to a new value.
#define BW_MMDC1_MDREF_REF_SEL(v)   BF_CS1(MMDC1_MDREF, REF_SEL, v)
#endif


/* --- Register HW_MMDC1_MDREF, field REF_CNT (RW)
 *
...
#define BP_MMDC1_MDREF_REF_CNT      16
#define BM_MMDC1_MDREF_REF_CNT      0xffff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDREF_REF_CNT(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDREF_REF_CNT)
#else
#define BF_MMDC1_MDREF_REF_CNT(v)   (((v) << 16) & BM_MMDC1_MDREF_REF_CNT)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the REF_CNT field to a new value.
#define BW_MMDC1_MDREF_REF_CNT(v)   BF_CS1(MMDC1_MDREF, REF_CNT, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDRWD - MMDC Core Read/Write Command Delay Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDRWD register
 */
#define HW_MMDC1_MDRWD_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x2c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDRWD(x)           (*(volatile hw_mmdc1_mdrwd_t *) HW_MMDC1_MDRWD_ADDR(x))
#define HW_MMDC1_MDRWD_RD(x)        (HW_MMDC1_MDRWD(x).U)
#define HW_MMDC1_MDRWD_WR(x, v)     (HW_MMDC1_MDRWD(x).U = (v))
#define HW_MMDC1_MDRWD_SET(x, v)    (HW_MMDC1_MDRWD_WR(x, HW_MMDC1_MDRWD_RD(x) |  (v)))
#define HW_MMDC1_MDRWD_CLR(x, v)    (HW_MMDC1_MDRWD_WR(x, HW_MMDC1_MDRWD_RD(x) & ~(v)))
#define HW_MMDC1_MDRWD_TOG(x, v)    (HW_MMDC1_MDRWD_WR(x, HW_MMDC1_MDRWD_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDRWD bitfields
 */

/* --- Register HW_MMDC1_MDRWD, field RTR_DIFF (RW)
 *
...
#define BP_MMDC1_MDRWD_RTR_DIFF      0
#define BM_MMDC1_MDRWD_RTR_DIFF      0x00000007

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDRWD_RTR_DIFF(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDRWD_RTR_DIFF)
#else
#define BF_MMDC1_MDRWD_RTR_DIFF(v)   (((v) << 0) & BM_MMDC1_MDRWD_RTR_DIFF)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RTR_DIFF field to a new value.
#define BW_MMDC1_MDRWD_RTR_DIFF(v)   BF_CS1(MMDC1_MDRWD, RTR_DIFF, v)
#endif


/* --- Register HW_MMDC1_MDRWD, field RTW_DIFF (RW)
 *
...
#define BP_MMDC1_MDRWD_RTW_DIFF      3
#define BM_MMDC1_MDRWD_RTW_DIFF      0x00000038

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDRWD_RTW_DIFF(v)   ((((reg32_t) v) << 3) & BM_MMDC1_MDRWD_RTW_DIFF)
#else
#define BF_MMDC1_MDRWD_RTW_DIFF(v)   (((v) << 3) & BM_MMDC1_MDRWD_RTW_DIFF)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RTW_DIFF field to a new value.
#define BW_MMDC1_MDRWD_RTW_DIFF(v)   BF_CS1(MMDC1_MDRWD, RTW_DIFF, v)
#endif


/* --- Register HW_MMDC1_MDRWD, field WTW_DIFF (RW)
 *
...
#define BP_MMDC1_MDRWD_WTW_DIFF      6
#define BM_MMDC1_MDRWD_WTW_DIFF      0x000001c0

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDRWD_WTW_DIFF(v)   ((((reg32_t) v) << 6) & BM_MMDC1_MDRWD_WTW_DIFF)
#else
#define BF_MMDC1_MDRWD_WTW_DIFF(v)   (((v) << 6) & BM_MMDC1_MDRWD_WTW_DIFF)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WTW_DIFF field to a new value.
#define BW_MMDC1_MDRWD_WTW_DIFF(v)   BF_CS1(MMDC1_MDRWD, WTW_DIFF, v)
#endif


/* --- Register HW_MMDC1_MDRWD, field WTR_DIFF (RW)
 *
...
#define BP_MMDC1_MDRWD_WTR_DIFF      9
#define BM_MMDC1_MDRWD_WTR_DIFF      0x00000e00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDRWD_WTR_DIFF(v)   ((((reg32_t) v) << 9) & BM_MMDC1_MDRWD_WTR_DIFF)
#else
#define BF_MMDC1_MDRWD_WTR_DIFF(v)   (((v) << 9) & BM_MMDC1_MDRWD_WTR_DIFF)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WTR_DIFF field to a new value.
#define BW_MMDC1_MDRWD_WTR_DIFF(v)   BF_CS1(MMDC1_MDRWD, WTR_DIFF, v)
#endif


/* --- Register HW_MMDC1_MDRWD, field RTW_SAME (RW)
 *
...
#define BP_MMDC1_MDRWD_RTW_SAME      12
#define BM_MMDC1_MDRWD_RTW_SAME      0x00007000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDRWD_RTW_SAME(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MDRWD_RTW_SAME)
#else
#define BF_MMDC1_MDRWD_RTW_SAME(v)   (((v) << 12) & BM_MMDC1_MDRWD_RTW_SAME)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RTW_SAME field to a new value.
#define BW_MMDC1_MDRWD_RTW_SAME(v)   BF_CS1(MMDC1_MDRWD, RTW_SAME, v)
#endif


/* --- Register HW_MMDC1_MDRWD, field TDAI (RW)
 *
...
#define BP_MMDC1_MDRWD_TDAI      16
#define BM_MMDC1_MDRWD_TDAI      0x1fff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDRWD_TDAI(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDRWD_TDAI)
#else
#define BF_MMDC1_MDRWD_TDAI(v)   (((v) << 16) & BM_MMDC1_MDRWD_TDAI)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TDAI field to a new value.
#define BW_MMDC1_MDRWD_TDAI(v)   BF_CS1(MMDC1_MDRWD, TDAI, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDOR - MMDC Core Out of Reset Delays Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDOR register
 */
#define HW_MMDC1_MDOR_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x30)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDOR(x)           (*(volatile hw_mmdc1_mdor_t *) HW_MMDC1_MDOR_ADDR(x))
#define HW_MMDC1_MDOR_RD(x)        (HW_MMDC1_MDOR(x).U)
#define HW_MMDC1_MDOR_WR(x, v)     (HW_MMDC1_MDOR(x).U = (v))
#define HW_MMDC1_MDOR_SET(x, v)    (HW_MMDC1_MDOR_WR(x, HW_MMDC1_MDOR_RD(x) |  (v)))
#define HW_MMDC1_MDOR_CLR(x, v)    (HW_MMDC1_MDOR_WR(x, HW_MMDC1_MDOR_RD(x) & ~(v)))
#define HW_MMDC1_MDOR_TOG(x, v)    (HW_MMDC1_MDOR_WR(x, HW_MMDC1_MDOR_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDOR bitfields
 */

/* --- Register HW_MMDC1_MDOR, field RST_TO_CKE (RW)
 *
...
#define BP_MMDC1_MDOR_RST_TO_CKE      0
#define BM_MMDC1_MDOR_RST_TO_CKE      0x0000003f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDOR_RST_TO_CKE(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDOR_RST_TO_CKE)
#else
#define BF_MMDC1_MDOR_RST_TO_CKE(v)   (((v) << 0) & BM_MMDC1_MDOR_RST_TO_CKE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RST_TO_CKE field to a new value.
#define BW_MMDC1_MDOR_RST_TO_CKE(v)   BF_CS1(MMDC1_MDOR, RST_TO_CKE, v)
#endif


/* --- Register HW_MMDC1_MDOR, field SDE_TO_RST (RW)
 *
...
#define BP_MMDC1_MDOR_SDE_TO_RST      8
#define BM_MMDC1_MDOR_SDE_TO_RST      0x00003f00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDOR_SDE_TO_RST(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MDOR_SDE_TO_RST)
#else
#define BF_MMDC1_MDOR_SDE_TO_RST(v)   (((v) << 8) & BM_MMDC1_MDOR_SDE_TO_RST)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SDE_TO_RST field to a new value.
#define BW_MMDC1_MDOR_SDE_TO_RST(v)   BF_CS1(MMDC1_MDOR, SDE_TO_RST, v)
#endif


/* --- Register HW_MMDC1_MDOR, field TXPR (RW)
 *
...
#define BP_MMDC1_MDOR_TXPR      16
#define BM_MMDC1_MDOR_TXPR      0x00ff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDOR_TXPR(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDOR_TXPR)
#else
#define BF_MMDC1_MDOR_TXPR(v)   (((v) << 16) & BM_MMDC1_MDOR_TXPR)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TXPR field to a new value.
#define BW_MMDC1_MDOR_TXPR(v)   BF_CS1(MMDC1_MDOR, TXPR, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDMRR - MMDC Core MRR Data Register (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDMRR register
 */
#define HW_MMDC1_MDMRR_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x34)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDMRR(x)           (*(volatile hw_mmdc1_mdmrr_t *) HW_MMDC1_MDMRR_ADDR(x))
#define HW_MMDC1_MDMRR_RD(x)        (HW_MMDC1_MDMRR(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MDMRR bitfields
 */

/* --- Register HW_MMDC1_MDMRR, field MRR_READ_DATA0 (RO)
 *
 * MRR DATA that arrived on DQ[7:0]
 */

#define BP_MMDC1_MDMRR_MRR_READ_DATA0      0
#define BM_MMDC1_MDMRR_MRR_READ_DATA0      0x000000ff

/* --- Register HW_MMDC1_MDMRR, field MRR_READ_DATA1 (RO)
 *
 * MRR DATA that arrived on DQ[15:8]
 */

#define BP_MMDC1_MDMRR_MRR_READ_DATA1      8
#define BM_MMDC1_MDMRR_MRR_READ_DATA1      0x0000ff00

/* --- Register HW_MMDC1_MDMRR, field MRR_READ_DATA2 (RO)
 *
 * MRR DATA that arrived on DQ[23:16]
 */

#define BP_MMDC1_MDMRR_MRR_READ_DATA2      16
#define BM_MMDC1_MDMRR_MRR_READ_DATA2      0x00ff0000

/* --- Register HW_MMDC1_MDMRR, field MRR_READ_DATA3 (RO)
 *
 * MRR DATA that arrived on DQ[31:24]
 */

#define BP_MMDC1_MDMRR_MRR_READ_DATA3      24
#define BM_MMDC1_MDMRR_MRR_READ_DATA3      0xff000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDCFG3LP - MMDC Core Timing Configuration Register 3 (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDCFG3LP register
 */
#define HW_MMDC1_MDCFG3LP_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x38)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDCFG3LP(x)           (*(volatile hw_mmdc1_mdcfg3lp_t *) HW_MMDC1_MDCFG3LP_ADDR(x))
#define HW_MMDC1_MDCFG3LP_RD(x)        (HW_MMDC1_MDCFG3LP(x).U)
#define HW_MMDC1_MDCFG3LP_WR(x, v)     (HW_MMDC1_MDCFG3LP(x).U = (v))
#define HW_MMDC1_MDCFG3LP_SET(x, v)    (HW_MMDC1_MDCFG3LP_WR(x, HW_MMDC1_MDCFG3LP_RD(x) |  (v)))
#define HW_MMDC1_MDCFG3LP_CLR(x, v)    (HW_MMDC1_MDCFG3LP_WR(x, HW_MMDC1_MDCFG3LP_RD(x) & ~(v)))
#define HW_MMDC1_MDCFG3LP_TOG(x, v)    (HW_MMDC1_MDCFG3LP_WR(x, HW_MMDC1_MDCFG3LP_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDCFG3LP bitfields
 */

/* --- Register HW_MMDC1_MDCFG3LP, field TRPAB_LP (RW)
 *
...
#define BP_MMDC1_MDCFG3LP_TRPAB_LP      0
#define BM_MMDC1_MDCFG3LP_TRPAB_LP      0x0000000f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG3LP_TRPAB_LP(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDCFG3LP_TRPAB_LP)
#else
#define BF_MMDC1_MDCFG3LP_TRPAB_LP(v)   (((v) << 0) & BM_MMDC1_MDCFG3LP_TRPAB_LP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRPAB_LP field to a new value.
#define BW_MMDC1_MDCFG3LP_TRPAB_LP(v)   BF_CS1(MMDC1_MDCFG3LP, TRPAB_LP, v)
#endif


/* --- Register HW_MMDC1_MDCFG3LP, field TRPPB_LP (RW)
 *
...
#define BP_MMDC1_MDCFG3LP_TRPPB_LP      4
#define BM_MMDC1_MDCFG3LP_TRPPB_LP      0x000000f0

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG3LP_TRPPB_LP(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MDCFG3LP_TRPPB_LP)
#else
#define BF_MMDC1_MDCFG3LP_TRPPB_LP(v)   (((v) << 4) & BM_MMDC1_MDCFG3LP_TRPPB_LP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRPPB_LP field to a new value.
#define BW_MMDC1_MDCFG3LP_TRPPB_LP(v)   BF_CS1(MMDC1_MDCFG3LP, TRPPB_LP, v)
#endif


/* --- Register HW_MMDC1_MDCFG3LP, field TRCD_LP (RW)
 *
 * Active command to internal read or write delay time (same bank). (This field is valid only for
 * LPDDR2 memories)
 *
...
#define BP_MMDC1_MDCFG3LP_TRCD_LP      8
#define BM_MMDC1_MDCFG3LP_TRCD_LP      0x00000f00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG3LP_TRCD_LP(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MDCFG3LP_TRCD_LP)
#else
#define BF_MMDC1_MDCFG3LP_TRCD_LP(v)   (((v) << 8) & BM_MMDC1_MDCFG3LP_TRCD_LP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRCD_LP field to a new value.
#define BW_MMDC1_MDCFG3LP_TRCD_LP(v)   BF_CS1(MMDC1_MDCFG3LP, TRCD_LP, v)
#endif


/* --- Register HW_MMDC1_MDCFG3LP, field RC_LP (RW)
 *
...
#define BP_MMDC1_MDCFG3LP_RC_LP      16
#define BM_MMDC1_MDCFG3LP_RC_LP      0x003f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDCFG3LP_RC_LP(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MDCFG3LP_RC_LP)
#else
#define BF_MMDC1_MDCFG3LP_RC_LP(v)   (((v) << 16) & BM_MMDC1_MDCFG3LP_RC_LP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RC_LP field to a new value.
#define BW_MMDC1_MDCFG3LP_RC_LP(v)   BF_CS1(MMDC1_MDCFG3LP, RC_LP, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDMR4 - MMDC Core MR4 Derating Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDMR4 register
 */
#define HW_MMDC1_MDMR4_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x3c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDMR4(x)           (*(volatile hw_mmdc1_mdmr4_t *) HW_MMDC1_MDMR4_ADDR(x))
#define HW_MMDC1_MDMR4_RD(x)        (HW_MMDC1_MDMR4(x).U)
#define HW_MMDC1_MDMR4_WR(x, v)     (HW_MMDC1_MDMR4(x).U = (v))
#define HW_MMDC1_MDMR4_SET(x, v)    (HW_MMDC1_MDMR4_WR(x, HW_MMDC1_MDMR4_RD(x) |  (v)))
#define HW_MMDC1_MDMR4_CLR(x, v)    (HW_MMDC1_MDMR4_WR(x, HW_MMDC1_MDMR4_RD(x) & ~(v)))
#define HW_MMDC1_MDMR4_TOG(x, v)    (HW_MMDC1_MDMR4_WR(x, HW_MMDC1_MDMR4_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDMR4 bitfields
 */

/* --- Register HW_MMDC1_MDMR4, field UPDATE_DE_REQ (RW)
 *
...
#define BP_MMDC1_MDMR4_UPDATE_DE_REQ      0
#define BM_MMDC1_MDMR4_UPDATE_DE_REQ      0x00000001

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMR4_UPDATE_DE_REQ(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDMR4_UPDATE_DE_REQ)
#else
#define BF_MMDC1_MDMR4_UPDATE_DE_REQ(v)   (((v) << 0) & BM_MMDC1_MDMR4_UPDATE_DE_REQ)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the UPDATE_DE_REQ field to a new value.
#define BW_MMDC1_MDMR4_UPDATE_DE_REQ(v)   BF_CS1(MMDC1_MDMR4, UPDATE_DE_REQ, v)
#endif


/* --- Register HW_MMDC1_MDMR4, field UPDATE_DE_ACK (RO)
 *
...
#define BP_MMDC1_MDMR4_UPDATE_DE_ACK      1
#define BM_MMDC1_MDMR4_UPDATE_DE_ACK      0x00000002

/* --- Register HW_MMDC1_MDMR4, field TRCD_DE (RW)
 *
 * tRCD derating value.
 *
 * Values:
...
#define BP_MMDC1_MDMR4_TRCD_DE      4
#define BM_MMDC1_MDMR4_TRCD_DE      0x00000010

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMR4_TRCD_DE(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MDMR4_TRCD_DE)
#else
#define BF_MMDC1_MDMR4_TRCD_DE(v)   (((v) << 4) & BM_MMDC1_MDMR4_TRCD_DE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRCD_DE field to a new value.
#define BW_MMDC1_MDMR4_TRCD_DE(v)   BF_CS1(MMDC1_MDMR4, TRCD_DE, v)
#endif


/* --- Register HW_MMDC1_MDMR4, field TRC_DE (RW)
 *
 * tRC derating value.
 *
 * Values:
...
#define BP_MMDC1_MDMR4_TRC_DE      5
#define BM_MMDC1_MDMR4_TRC_DE      0x00000020

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMR4_TRC_DE(v)   ((((reg32_t) v) << 5) & BM_MMDC1_MDMR4_TRC_DE)
#else
#define BF_MMDC1_MDMR4_TRC_DE(v)   (((v) << 5) & BM_MMDC1_MDMR4_TRC_DE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRC_DE field to a new value.
#define BW_MMDC1_MDMR4_TRC_DE(v)   BF_CS1(MMDC1_MDMR4, TRC_DE, v)
#endif


/* --- Register HW_MMDC1_MDMR4, field TRAS_DE (RW)
 *
 * tRAS derating value.
 *
 * Values:
...
#define BP_MMDC1_MDMR4_TRAS_DE      6
#define BM_MMDC1_MDMR4_TRAS_DE      0x00000040

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMR4_TRAS_DE(v)   ((((reg32_t) v) << 6) & BM_MMDC1_MDMR4_TRAS_DE)
#else
#define BF_MMDC1_MDMR4_TRAS_DE(v)   (((v) << 6) & BM_MMDC1_MDMR4_TRAS_DE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRAS_DE field to a new value.
#define BW_MMDC1_MDMR4_TRAS_DE(v)   BF_CS1(MMDC1_MDMR4, TRAS_DE, v)
#endif


/* --- Register HW_MMDC1_MDMR4, field TRP_DE (RW)
 *
 * tRP derating value.
 *
 * Values:
...
#define BP_MMDC1_MDMR4_TRP_DE      7
#define BM_MMDC1_MDMR4_TRP_DE      0x00000080

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMR4_TRP_DE(v)   ((((reg32_t) v) << 7) & BM_MMDC1_MDMR4_TRP_DE)
#else
#define BF_MMDC1_MDMR4_TRP_DE(v)   (((v) << 7) & BM_MMDC1_MDMR4_TRP_DE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRP_DE field to a new value.
#define BW_MMDC1_MDMR4_TRP_DE(v)   BF_CS1(MMDC1_MDMR4, TRP_DE, v)
#endif


/* --- Register HW_MMDC1_MDMR4, field TRRD_DE (RW)
 *
 * tRRD derating value.
 *
 * Values:
...
#define BP_MMDC1_MDMR4_TRRD_DE      8
#define BM_MMDC1_MDMR4_TRRD_DE      0x00000100

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDMR4_TRRD_DE(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MDMR4_TRRD_DE)
#else
#define BF_MMDC1_MDMR4_TRRD_DE(v)   (((v) << 8) & BM_MMDC1_MDMR4_TRRD_DE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TRRD_DE field to a new value.
#define BW_MMDC1_MDMR4_TRRD_DE(v)   BF_CS1(MMDC1_MDMR4, TRRD_DE, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MDASP - MMDC Core Address Space Partition Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MDASP register
 */
#define HW_MMDC1_MDASP_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x40)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MDASP(x)           (*(volatile hw_mmdc1_mdasp_t *) HW_MMDC1_MDASP_ADDR(x))
#define HW_MMDC1_MDASP_RD(x)        (HW_MMDC1_MDASP(x).U)
#define HW_MMDC1_MDASP_WR(x, v)     (HW_MMDC1_MDASP(x).U = (v))
#define HW_MMDC1_MDASP_SET(x, v)    (HW_MMDC1_MDASP_WR(x, HW_MMDC1_MDASP_RD(x) |  (v)))
#define HW_MMDC1_MDASP_CLR(x, v)    (HW_MMDC1_MDASP_WR(x, HW_MMDC1_MDASP_RD(x) & ~(v)))
#define HW_MMDC1_MDASP_TOG(x, v)    (HW_MMDC1_MDASP_WR(x, HW_MMDC1_MDASP_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MDASP bitfields
 */

/* --- Register HW_MMDC1_MDASP, field CS0_END (RW)
 *
...
#define BP_MMDC1_MDASP_CS0_END      0
#define BM_MMDC1_MDASP_CS0_END      0x0000007f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MDASP_CS0_END(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MDASP_CS0_END)
#else
#define BF_MMDC1_MDASP_CS0_END(v)   (((v) << 0) & BM_MMDC1_MDASP_CS0_END)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the CS0_END field to a new value.
#define BW_MMDC1_MDASP_CS0_END(v)   BF_CS1(MMDC1_MDASP, CS0_END, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MAARCR - MMDC Core AXI Reordering Control Regsiter (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MAARCR register
 */
#define HW_MMDC1_MAARCR_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x400)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MAARCR(x)           (*(volatile hw_mmdc1_maarcr_t *) HW_MMDC1_MAARCR_ADDR(x))
#define HW_MMDC1_MAARCR_RD(x)        (HW_MMDC1_MAARCR(x).U)
#define HW_MMDC1_MAARCR_WR(x, v)     (HW_MMDC1_MAARCR(x).U = (v))
#define HW_MMDC1_MAARCR_SET(x, v)    (HW_MMDC1_MAARCR_WR(x, HW_MMDC1_MAARCR_RD(x) |  (v)))
#define HW_MMDC1_MAARCR_CLR(x, v)    (HW_MMDC1_MAARCR_WR(x, HW_MMDC1_MAARCR_RD(x) & ~(v)))
#define HW_MMDC1_MAARCR_TOG(x, v)    (HW_MMDC1_MAARCR_WR(x, HW_MMDC1_MAARCR_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MAARCR bitfields
 */

/* --- Register HW_MMDC1_MAARCR, field ARCR_GUARD (RW)
 *
...
#define BP_MMDC1_MAARCR_ARCR_GUARD      0
#define BM_MMDC1_MAARCR_ARCR_GUARD      0x0000000f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAARCR_ARCR_GUARD(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MAARCR_ARCR_GUARD)
#else
#define BF_MMDC1_MAARCR_ARCR_GUARD(v)   (((v) << 0) & BM_MMDC1_MAARCR_ARCR_GUARD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ARCR_GUARD field to a new value.
#define BW_MMDC1_MAARCR_ARCR_GUARD(v)   BF_CS1(MMDC1_MAARCR, ARCR_GUARD, v)
#endif


/* --- Register HW_MMDC1_MAARCR, field ARCR_DYN_MAX (RW)
 *
...
#define BP_MMDC1_MAARCR_ARCR_DYN_MAX      4
#define BM_MMDC1_MAARCR_ARCR_DYN_MAX      0x000000f0

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAARCR_ARCR_DYN_MAX(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MAARCR_ARCR_DYN_MAX)
#else
#define BF_MMDC1_MAARCR_ARCR_DYN_MAX(v)   (((v) << 4) & BM_MMDC1_MAARCR_ARCR_DYN_MAX)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ARCR_DYN_MAX field to a new value.
#define BW_MMDC1_MAARCR_ARCR_DYN_MAX(v)   BF_CS1(MMDC1_MAARCR, ARCR_DYN_MAX, v)
#endif


/* --- Register HW_MMDC1_MAARCR, field ARCR_DYN_JMP (RW)
 *
...
#define BP_MMDC1_MAARCR_ARCR_DYN_JMP      8
#define BM_MMDC1_MAARCR_ARCR_DYN_JMP      0x00000f00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAARCR_ARCR_DYN_JMP(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MAARCR_ARCR_DYN_JMP)
#else
#define BF_MMDC1_MAARCR_ARCR_DYN_JMP(v)   (((v) << 8) & BM_MMDC1_MAARCR_ARCR_DYN_JMP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ARCR_DYN_JMP field to a new value.
#define BW_MMDC1_MAARCR_ARCR_DYN_JMP(v)   BF_CS1(MMDC1_MAARCR, ARCR_DYN_JMP, v)
#endif

/* --- Register HW_MMDC1_MAARCR, field ARCR_ACC_HIT (RW)
 *
...
#define BP_MMDC1_MAARCR_ARCR_ACC_HIT      16
#define BM_MMDC1_MAARCR_ARCR_ACC_HIT      0x00070000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAARCR_ARCR_ACC_HIT(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MAARCR_ARCR_ACC_HIT)
#else
#define BF_MMDC1_MAARCR_ARCR_ACC_HIT(v)   (((v) << 16) & BM_MMDC1_MAARCR_ARCR_ACC_HIT)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ARCR_ACC_HIT field to a new value.
#define BW_MMDC1_MAARCR_ARCR_ACC_HIT(v)   BF_CS1(MMDC1_MAARCR, ARCR_ACC_HIT, v)
#endif

/* --- Register HW_MMDC1_MAARCR, field ARCR_PAG_HIT (RW)
 *
...
#define BP_MMDC1_MAARCR_ARCR_PAG_HIT      20
#define BM_MMDC1_MAARCR_ARCR_PAG_HIT      0x00700000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAARCR_ARCR_PAG_HIT(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MAARCR_ARCR_PAG_HIT)
#else
#define BF_MMDC1_MAARCR_ARCR_PAG_HIT(v)   (((v) << 20) & BM_MMDC1_MAARCR_ARCR_PAG_HIT)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ARCR_PAG_HIT field to a new value.
#define BW_MMDC1_MAARCR_ARCR_PAG_HIT(v)   BF_CS1(MMDC1_MAARCR, ARCR_PAG_HIT, v)
#endif

/* --- Register HW_MMDC1_MAARCR, field ARCR_RCH_EN (RW)
 *
...
#define BP_MMDC1_MAARCR_ARCR_RCH_EN      24
#define BM_MMDC1_MAARCR_ARCR_RCH_EN      0x01000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAARCR_ARCR_RCH_EN(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MAARCR_ARCR_RCH_EN)
#else
#define BF_MMDC1_MAARCR_ARCR_RCH_EN(v)   (((v) << 24) & BM_MMDC1_MAARCR_ARCR_RCH_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ARCR_RCH_EN field to a new value.
#define BW_MMDC1_MAARCR_ARCR_RCH_EN(v)   BF_CS1(MMDC1_MAARCR, ARCR_RCH_EN, v)
#endif


/* --- Register HW_MMDC1_MAARCR, field ARCR_EXC_ERR_EN (RW)
 *
...
#define BP_MMDC1_MAARCR_ARCR_EXC_ERR_EN      28
#define BM_MMDC1_MAARCR_ARCR_EXC_ERR_EN      0x10000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAARCR_ARCR_EXC_ERR_EN(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MAARCR_ARCR_EXC_ERR_EN)
#else
#define BF_MMDC1_MAARCR_ARCR_EXC_ERR_EN(v)   (((v) << 28) & BM_MMDC1_MAARCR_ARCR_EXC_ERR_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ARCR_EXC_ERR_EN field to a new value.
#define BW_MMDC1_MAARCR_ARCR_EXC_ERR_EN(v)   BF_CS1(MMDC1_MAARCR, ARCR_EXC_ERR_EN, v)
#endif


/* --- Register HW_MMDC1_MAARCR, field ARCR_SEC_ERR_EN (RW)
 *
...
#define BP_MMDC1_MAARCR_ARCR_SEC_ERR_EN      30
#define BM_MMDC1_MAARCR_ARCR_SEC_ERR_EN      0x40000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAARCR_ARCR_SEC_ERR_EN(v)   ((((reg32_t) v) << 30) & BM_MMDC1_MAARCR_ARCR_SEC_ERR_EN)
#else
#define BF_MMDC1_MAARCR_ARCR_SEC_ERR_EN(v)   (((v) << 30) & BM_MMDC1_MAARCR_ARCR_SEC_ERR_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ARCR_SEC_ERR_EN field to a new value.
#define BW_MMDC1_MAARCR_ARCR_SEC_ERR_EN(v)   BF_CS1(MMDC1_MAARCR, ARCR_SEC_ERR_EN, v)
#endif


/* --- Register HW_MMDC1_MAARCR, field ARCR_SEC_ERR_LOCK (RW)
 *
...
#define BP_MMDC1_MAARCR_ARCR_SEC_ERR_LOCK      31
#define BM_MMDC1_MAARCR_ARCR_SEC_ERR_LOCK      0x80000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAARCR_ARCR_SEC_ERR_LOCK(v)   ((((reg32_t) v) << 31) & BM_MMDC1_MAARCR_ARCR_SEC_ERR_LOCK)
#else
#define BF_MMDC1_MAARCR_ARCR_SEC_ERR_LOCK(v)   (((v) << 31) & BM_MMDC1_MAARCR_ARCR_SEC_ERR_LOCK)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ARCR_SEC_ERR_LOCK field to a new value.
#define BW_MMDC1_MAARCR_ARCR_SEC_ERR_LOCK(v)   BF_CS1(MMDC1_MAARCR, ARCR_SEC_ERR_LOCK, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MAPSR - MMDC Core Power Saving Control and Status Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MAPSR register
 */
#define HW_MMDC1_MAPSR_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x404)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MAPSR(x)           (*(volatile hw_mmdc1_mapsr_t *) HW_MMDC1_MAPSR_ADDR(x))
#define HW_MMDC1_MAPSR_RD(x)        (HW_MMDC1_MAPSR(x).U)
#define HW_MMDC1_MAPSR_WR(x, v)     (HW_MMDC1_MAPSR(x).U = (v))
#define HW_MMDC1_MAPSR_SET(x, v)    (HW_MMDC1_MAPSR_WR(x, HW_MMDC1_MAPSR_RD(x) |  (v)))
#define HW_MMDC1_MAPSR_CLR(x, v)    (HW_MMDC1_MAPSR_WR(x, HW_MMDC1_MAPSR_RD(x) & ~(v)))
#define HW_MMDC1_MAPSR_TOG(x, v)    (HW_MMDC1_MAPSR_WR(x, HW_MMDC1_MAPSR_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MAPSR bitfields
 */

/* --- Register HW_MMDC1_MAPSR, field PSD (RW)
 *
...
#define BP_MMDC1_MAPSR_PSD      0
#define BM_MMDC1_MAPSR_PSD      0x00000001

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAPSR_PSD(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MAPSR_PSD)
#else
#define BF_MMDC1_MAPSR_PSD(v)   (((v) << 0) & BM_MMDC1_MAPSR_PSD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PSD field to a new value.
#define BW_MMDC1_MAPSR_PSD(v)   BF_CS1(MMDC1_MAPSR, PSD, v)
#endif


/* --- Register HW_MMDC1_MAPSR, field PSS (RO)
 *
...
#define BP_MMDC1_MAPSR_PSS      4
#define BM_MMDC1_MAPSR_PSS      0x00000010


/* --- Register HW_MMDC1_MAPSR, field RIS (RO)
 *
...
#define BP_MMDC1_MAPSR_RIS      5
#define BM_MMDC1_MAPSR_RIS      0x00000020


/* --- Register HW_MMDC1_MAPSR, field WIS (RO)
 *
...
#define BP_MMDC1_MAPSR_WIS      6
#define BM_MMDC1_MAPSR_WIS      0x00000040


/* --- Register HW_MMDC1_MAPSR, field PST (RW)
 *
...
#define BP_MMDC1_MAPSR_PST      8
#define BM_MMDC1_MAPSR_PST      0x0000ff00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAPSR_PST(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MAPSR_PST)
#else
#define BF_MMDC1_MAPSR_PST(v)   (((v) << 8) & BM_MMDC1_MAPSR_PST)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PST field to a new value.
#define BW_MMDC1_MAPSR_PST(v)   BF_CS1(MMDC1_MAPSR, PST, v)
#endif


/* --- Register HW_MMDC1_MAPSR, field LPMD (RW)
 *
...
#define BP_MMDC1_MAPSR_LPMD      20
#define BM_MMDC1_MAPSR_LPMD      0x00100000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAPSR_LPMD(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MAPSR_LPMD)
#else
#define BF_MMDC1_MAPSR_LPMD(v)   (((v) << 20) & BM_MMDC1_MAPSR_LPMD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the LPMD field to a new value.
#define BW_MMDC1_MAPSR_LPMD(v)   BF_CS1(MMDC1_MAPSR, LPMD, v)
#endif


/* --- Register HW_MMDC1_MAPSR, field DVFS (RW)
 *
...
#define BP_MMDC1_MAPSR_DVFS      21
#define BM_MMDC1_MAPSR_DVFS      0x00200000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAPSR_DVFS(v)   ((((reg32_t) v) << 21) & BM_MMDC1_MAPSR_DVFS)
#else
#define BF_MMDC1_MAPSR_DVFS(v)   (((v) << 21) & BM_MMDC1_MAPSR_DVFS)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DVFS field to a new value.
#define BW_MMDC1_MAPSR_DVFS(v)   BF_CS1(MMDC1_MAPSR, DVFS, v)
#endif


/* --- Register HW_MMDC1_MAPSR, field LPACK (RO)
 *
...
#define BP_MMDC1_MAPSR_LPACK      24
#define BM_MMDC1_MAPSR_LPACK      0x01000000

/* --- Register HW_MMDC1_MAPSR, field DVACK (RO)
 *
...
#define BP_MMDC1_MAPSR_DVACK      25
#define BM_MMDC1_MAPSR_DVACK      0x02000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MAEXIDR0 - MMDC Core Exclusive ID Monitor Register0 (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MAEXIDR0 register
 */
#define HW_MMDC1_MAEXIDR0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x408)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MAEXIDR0(x)           (*(volatile hw_mmdc1_maexidr0_t *) HW_MMDC1_MAEXIDR0_ADDR(x))
#define HW_MMDC1_MAEXIDR0_RD(x)        (HW_MMDC1_MAEXIDR0(x).U)
#define HW_MMDC1_MAEXIDR0_WR(x, v)     (HW_MMDC1_MAEXIDR0(x).U = (v))
#define HW_MMDC1_MAEXIDR0_SET(x, v)    (HW_MMDC1_MAEXIDR0_WR(x, HW_MMDC1_MAEXIDR0_RD(x) |  (v)))
#define HW_MMDC1_MAEXIDR0_CLR(x, v)    (HW_MMDC1_MAEXIDR0_WR(x, HW_MMDC1_MAEXIDR0_RD(x) & ~(v)))
#define HW_MMDC1_MAEXIDR0_TOG(x, v)    (HW_MMDC1_MAEXIDR0_WR(x, HW_MMDC1_MAEXIDR0_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MAEXIDR0 bitfields
 */

/* --- Register HW_MMDC1_MAEXIDR0, field EXC_ID_MONITOR0 (RW)
 *
 * This feild defines ID for Exclusive monitor#0. Default value is 0x0000
 */

#define BP_MMDC1_MAEXIDR0_EXC_ID_MONITOR0      0
#define BM_MMDC1_MAEXIDR0_EXC_ID_MONITOR0      0x0000ffff

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAEXIDR0_EXC_ID_MONITOR0(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MAEXIDR0_EXC_ID_MONITOR0)
#else
#define BF_MMDC1_MAEXIDR0_EXC_ID_MONITOR0(v)   (((v) << 0) & BM_MMDC1_MAEXIDR0_EXC_ID_MONITOR0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the EXC_ID_MONITOR0 field to a new value.
#define BW_MMDC1_MAEXIDR0_EXC_ID_MONITOR0(v)   BF_CS1(MMDC1_MAEXIDR0, EXC_ID_MONITOR0, v)
#endif

/* --- Register HW_MMDC1_MAEXIDR0, field EXC_ID_MONITOR1 (RW)
 *
 * This feild defines ID for Exclusive monitor#1. Default value is 0x0020
 */

#define BP_MMDC1_MAEXIDR0_EXC_ID_MONITOR1      16
#define BM_MMDC1_MAEXIDR0_EXC_ID_MONITOR1      0xffff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAEXIDR0_EXC_ID_MONITOR1(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MAEXIDR0_EXC_ID_MONITOR1)
#else
#define BF_MMDC1_MAEXIDR0_EXC_ID_MONITOR1(v)   (((v) << 16) & BM_MMDC1_MAEXIDR0_EXC_ID_MONITOR1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the EXC_ID_MONITOR1 field to a new value.
#define BW_MMDC1_MAEXIDR0_EXC_ID_MONITOR1(v)   BF_CS1(MMDC1_MAEXIDR0, EXC_ID_MONITOR1, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MAEXIDR1 - MMDC Core Exclusive ID Monitor Register1 (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MAEXIDR1 register
 */
#define HW_MMDC1_MAEXIDR1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x40c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MAEXIDR1(x)           (*(volatile hw_mmdc1_maexidr1_t *) HW_MMDC1_MAEXIDR1_ADDR(x))
#define HW_MMDC1_MAEXIDR1_RD(x)        (HW_MMDC1_MAEXIDR1(x).U)
#define HW_MMDC1_MAEXIDR1_WR(x, v)     (HW_MMDC1_MAEXIDR1(x).U = (v))
#define HW_MMDC1_MAEXIDR1_SET(x, v)    (HW_MMDC1_MAEXIDR1_WR(x, HW_MMDC1_MAEXIDR1_RD(x) |  (v)))
#define HW_MMDC1_MAEXIDR1_CLR(x, v)    (HW_MMDC1_MAEXIDR1_WR(x, HW_MMDC1_MAEXIDR1_RD(x) & ~(v)))
#define HW_MMDC1_MAEXIDR1_TOG(x, v)    (HW_MMDC1_MAEXIDR1_WR(x, HW_MMDC1_MAEXIDR1_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MAEXIDR1 bitfields
 */

/* --- Register HW_MMDC1_MAEXIDR1, field EXC_ID_MONITOR2 (RW)
 *
 * This feild defines ID for Exclusive monitor#2. Default value is 0x0040
 */

#define BP_MMDC1_MAEXIDR1_EXC_ID_MONITOR2      0
#define BM_MMDC1_MAEXIDR1_EXC_ID_MONITOR2      0x0000ffff

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAEXIDR1_EXC_ID_MONITOR2(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MAEXIDR1_EXC_ID_MONITOR2)
#else
#define BF_MMDC1_MAEXIDR1_EXC_ID_MONITOR2(v)   (((v) << 0) & BM_MMDC1_MAEXIDR1_EXC_ID_MONITOR2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the EXC_ID_MONITOR2 field to a new value.
#define BW_MMDC1_MAEXIDR1_EXC_ID_MONITOR2(v)   BF_CS1(MMDC1_MAEXIDR1, EXC_ID_MONITOR2, v)
#endif

/* --- Register HW_MMDC1_MAEXIDR1, field EXC_ID_MONITOR3 (RW)
 *
 * This feild defines ID for Exclusive monitor#3. Default value is 0x0060
 */

#define BP_MMDC1_MAEXIDR1_EXC_ID_MONITOR3      16
#define BM_MMDC1_MAEXIDR1_EXC_ID_MONITOR3      0xffff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MAEXIDR1_EXC_ID_MONITOR3(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MAEXIDR1_EXC_ID_MONITOR3)
#else
#define BF_MMDC1_MAEXIDR1_EXC_ID_MONITOR3(v)   (((v) << 16) & BM_MMDC1_MAEXIDR1_EXC_ID_MONITOR3)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the EXC_ID_MONITOR3 field to a new value.
#define BW_MMDC1_MAEXIDR1_EXC_ID_MONITOR3(v)   BF_CS1(MMDC1_MAEXIDR1, EXC_ID_MONITOR3, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MADPCR0 - MMDC Core Debug and Profiling Control Register 0 (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MADPCR0 register
 */
#define HW_MMDC1_MADPCR0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x410)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MADPCR0(x)           (*(volatile hw_mmdc1_madpcr0_t *) HW_MMDC1_MADPCR0_ADDR(x))
#define HW_MMDC1_MADPCR0_RD(x)        (HW_MMDC1_MADPCR0(x).U)
#define HW_MMDC1_MADPCR0_WR(x, v)     (HW_MMDC1_MADPCR0(x).U = (v))
#define HW_MMDC1_MADPCR0_SET(x, v)    (HW_MMDC1_MADPCR0_WR(x, HW_MMDC1_MADPCR0_RD(x) |  (v)))
#define HW_MMDC1_MADPCR0_CLR(x, v)    (HW_MMDC1_MADPCR0_WR(x, HW_MMDC1_MADPCR0_RD(x) & ~(v)))
#define HW_MMDC1_MADPCR0_TOG(x, v)    (HW_MMDC1_MADPCR0_WR(x, HW_MMDC1_MADPCR0_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MADPCR0 bitfields
 */

/* --- Register HW_MMDC1_MADPCR0, field DBG_EN (RW)
 *
...
#define BP_MMDC1_MADPCR0_DBG_EN      0
#define BM_MMDC1_MADPCR0_DBG_EN      0x00000001

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MADPCR0_DBG_EN(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MADPCR0_DBG_EN)
#else
#define BF_MMDC1_MADPCR0_DBG_EN(v)   (((v) << 0) & BM_MMDC1_MADPCR0_DBG_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DBG_EN field to a new value.
#define BW_MMDC1_MADPCR0_DBG_EN(v)   BF_CS1(MMDC1_MADPCR0, DBG_EN, v)
#endif


/* --- Register HW_MMDC1_MADPCR0, field DBG_RST (RW)
 *
...
#define BP_MMDC1_MADPCR0_DBG_RST      1
#define BM_MMDC1_MADPCR0_DBG_RST      0x00000002

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MADPCR0_DBG_RST(v)   ((((reg32_t) v) << 1) & BM_MMDC1_MADPCR0_DBG_RST)
#else
#define BF_MMDC1_MADPCR0_DBG_RST(v)   (((v) << 1) & BM_MMDC1_MADPCR0_DBG_RST)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DBG_RST field to a new value.
#define BW_MMDC1_MADPCR0_DBG_RST(v)   BF_CS1(MMDC1_MADPCR0, DBG_RST, v)
#endif


/* --- Register HW_MMDC1_MADPCR0, field PRF_FRZ (RW)
 *
...
#define BP_MMDC1_MADPCR0_PRF_FRZ      2
#define BM_MMDC1_MADPCR0_PRF_FRZ      0x00000004

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MADPCR0_PRF_FRZ(v)   ((((reg32_t) v) << 2) & BM_MMDC1_MADPCR0_PRF_FRZ)
#else
#define BF_MMDC1_MADPCR0_PRF_FRZ(v)   (((v) << 2) & BM_MMDC1_MADPCR0_PRF_FRZ)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PRF_FRZ field to a new value.
#define BW_MMDC1_MADPCR0_PRF_FRZ(v)   BF_CS1(MMDC1_MADPCR0, PRF_FRZ, v)
#endif


/* --- Register HW_MMDC1_MADPCR0, field CYC_OVF (W1C)
 *
...
#define BP_MMDC1_MADPCR0_SBS_EN      8
#define BM_MMDC1_MADPCR0_SBS_EN      0x00000100

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MADPCR0_SBS_EN(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MADPCR0_SBS_EN)
#else
#define BF_MMDC1_MADPCR0_SBS_EN(v)   (((v) << 8) & BM_MMDC1_MADPCR0_SBS_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SBS_EN field to a new value.
#define BW_MMDC1_MADPCR0_SBS_EN(v)   BF_CS1(MMDC1_MADPCR0, SBS_EN, v)
#endif


/* --- Register HW_MMDC1_MADPCR0, field SBS (RW)
 *
...
#define BP_MMDC1_MADPCR0_SBS      9
#define BM_MMDC1_MADPCR0_SBS      0x00000200

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MADPCR0_SBS(v)   ((((reg32_t) v) << 9) & BM_MMDC1_MADPCR0_SBS)
#else
#define BF_MMDC1_MADPCR0_SBS(v)   (((v) << 9) & BM_MMDC1_MADPCR0_SBS)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SBS field to a new value.
#define BW_MMDC1_MADPCR0_SBS(v)   BF_CS1(MMDC1_MADPCR0, SBS, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MADPCR1 - MMDC Core Debug and Profiling Control Register 1 (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MADPCR1 register
 */
#define HW_MMDC1_MADPCR1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x414)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MADPCR1(x)           (*(volatile hw_mmdc1_madpcr1_t *) HW_MMDC1_MADPCR1_ADDR(x))
#define HW_MMDC1_MADPCR1_RD(x)        (HW_MMDC1_MADPCR1(x).U)
#define HW_MMDC1_MADPCR1_WR(x, v)     (HW_MMDC1_MADPCR1(x).U = (v))
#define HW_MMDC1_MADPCR1_SET(x, v)    (HW_MMDC1_MADPCR1_WR(x, HW_MMDC1_MADPCR1_RD(x) |  (v)))
#define HW_MMDC1_MADPCR1_CLR(x, v)    (HW_MMDC1_MADPCR1_WR(x, HW_MMDC1_MADPCR1_RD(x) & ~(v)))
#define HW_MMDC1_MADPCR1_TOG(x, v)    (HW_MMDC1_MADPCR1_WR(x, HW_MMDC1_MADPCR1_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MADPCR1 bitfields
 */

/* --- Register HW_MMDC1_MADPCR1, field PRF_AXI_ID (RW)
 *
...
#define BP_MMDC1_MADPCR1_PRF_AXI_ID      0
#define BM_MMDC1_MADPCR1_PRF_AXI_ID      0x0000ffff

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MADPCR1_PRF_AXI_ID(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MADPCR1_PRF_AXI_ID)
#else
#define BF_MMDC1_MADPCR1_PRF_AXI_ID(v)   (((v) << 0) & BM_MMDC1_MADPCR1_PRF_AXI_ID)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PRF_AXI_ID field to a new value.
#define BW_MMDC1_MADPCR1_PRF_AXI_ID(v)   BF_CS1(MMDC1_MADPCR1, PRF_AXI_ID, v)
#endif

/* --- Register HW_MMDC1_MADPCR1, field PRF_AXI_ID_MASK (RW)
 *
...
#define BP_MMDC1_MADPCR1_PRF_AXI_ID_MASK      16
#define BM_MMDC1_MADPCR1_PRF_AXI_ID_MASK      0xffff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MADPCR1_PRF_AXI_ID_MASK(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MADPCR1_PRF_AXI_ID_MASK)
#else
#define BF_MMDC1_MADPCR1_PRF_AXI_ID_MASK(v)   (((v) << 16) & BM_MMDC1_MADPCR1_PRF_AXI_ID_MASK)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PRF_AXI_ID_MASK field to a new value.
#define BW_MMDC1_MADPCR1_PRF_AXI_ID_MASK(v)   BF_CS1(MMDC1_MADPCR1, PRF_AXI_ID_MASK, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MADPSR0 - MMDC Core Debug and Profiling Status Register 0 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MADPSR0 register
 */
#define HW_MMDC1_MADPSR0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x418)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MADPSR0(x)           (*(volatile hw_mmdc1_madpsr0_t *) HW_MMDC1_MADPSR0_ADDR(x))
#define HW_MMDC1_MADPSR0_RD(x)        (HW_MMDC1_MADPSR0(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MADPSR0 bitfields
 */

/* --- Register HW_MMDC1_MADPSR0, field CYC_COUNT (RO)
 *
...
#define BP_MMDC1_MADPSR0_CYC_COUNT      0
#define BM_MMDC1_MADPSR0_CYC_COUNT      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MADPSR1 - MMDC Core Debug and Profiling Status Register 1 (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MADPSR1 register
 */
#define HW_MMDC1_MADPSR1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x41c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MADPSR1(x)           (*(volatile hw_mmdc1_madpsr1_t *) HW_MMDC1_MADPSR1_ADDR(x))
#define HW_MMDC1_MADPSR1_RD(x)        (HW_MMDC1_MADPSR1(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MADPSR1 bitfields
 */

/* --- Register HW_MMDC1_MADPSR1, field BUSY_COUNT (RO)
 *
...
#define BP_MMDC1_MADPSR1_BUSY_COUNT      0
#define BM_MMDC1_MADPSR1_BUSY_COUNT      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MADPSR2 - MMDC Core Debug and Profiling Status Register 2 (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MADPSR2 register
 */
#define HW_MMDC1_MADPSR2_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x420)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MADPSR2(x)           (*(volatile hw_mmdc1_madpsr2_t *) HW_MMDC1_MADPSR2_ADDR(x))
#define HW_MMDC1_MADPSR2_RD(x)        (HW_MMDC1_MADPSR2(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MADPSR2 bitfields
 */

/* --- Register HW_MMDC1_MADPSR2, field RD_ACC_COUNT (RO)
 *
 * Profiling Read Access Count. This register reflects the total number of read accesses (per AXI
 * ID) toward MMDC.
 */

#define BP_MMDC1_MADPSR2_RD_ACC_COUNT      0
#define BM_MMDC1_MADPSR2_RD_ACC_COUNT      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MADPSR3 - MMDC Core Debug and Profiling Status Register 3 (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MADPSR3 register
 */
#define HW_MMDC1_MADPSR3_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x424)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MADPSR3(x)           (*(volatile hw_mmdc1_madpsr3_t *) HW_MMDC1_MADPSR3_ADDR(x))
#define HW_MMDC1_MADPSR3_RD(x)        (HW_MMDC1_MADPSR3(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MADPSR3 bitfields
 */

/* --- Register HW_MMDC1_MADPSR3, field WR_ACC_COUNT (RO)
 *
 * Profiling Write Access Count. This register reflects the total number of write accesses (per AXI
 * ID) toward MMDC.
 */

#define BP_MMDC1_MADPSR3_WR_ACC_COUNT      0
#define BM_MMDC1_MADPSR3_WR_ACC_COUNT      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MADPSR4 - MMDC Core Debug and Profiling Status Register 4 (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MADPSR4 register
 */
#define HW_MMDC1_MADPSR4_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x428)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MADPSR4(x)           (*(volatile hw_mmdc1_madpsr4_t *) HW_MMDC1_MADPSR4_ADDR(x))
#define HW_MMDC1_MADPSR4_RD(x)        (HW_MMDC1_MADPSR4(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MADPSR4 bitfields
 */

/* --- Register HW_MMDC1_MADPSR4, field RD_BYTES_COUNT (RO)
 *
...
#define BP_MMDC1_MADPSR4_RD_BYTES_COUNT      0
#define BM_MMDC1_MADPSR4_RD_BYTES_COUNT      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MADPSR5 - MMDC Core Debug and Profiling Status Register 5 (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MADPSR5 register
 */
#define HW_MMDC1_MADPSR5_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x42c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MADPSR5(x)           (*(volatile hw_mmdc1_madpsr5_t *) HW_MMDC1_MADPSR5_ADDR(x))
#define HW_MMDC1_MADPSR5_RD(x)        (HW_MMDC1_MADPSR5(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MADPSR5 bitfields
 */

/* --- Register HW_MMDC1_MADPSR5, field WR_BYTES_COUNT (RO)
 *
...
#define BP_MMDC1_MADPSR5_WR_BYTES_COUNT      0
#define BM_MMDC1_MADPSR5_WR_BYTES_COUNT      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MASBS0 - MMDC Core Step By Step Address Register (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MASBS0 register
 */
#define HW_MMDC1_MASBS0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x430)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MASBS0(x)           (*(volatile hw_mmdc1_masbs0_t *) HW_MMDC1_MASBS0_ADDR(x))
#define HW_MMDC1_MASBS0_RD(x)        (HW_MMDC1_MASBS0(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MASBS0 bitfields
 */

/* --- Register HW_MMDC1_MASBS0, field SBS_ADDR (RO)
 *
 * Step By Step Address. These bits reflect the address of the pending request in case of step by
 * step mode.
 */

#define BP_MMDC1_MASBS0_SBS_ADDR      0
#define BM_MMDC1_MASBS0_SBS_ADDR      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MASBS1 - MMDC Core Step By Step Address Attributes Register (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MASBS1 register
 */
#define HW_MMDC1_MASBS1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x434)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MASBS1(x)           (*(volatile hw_mmdc1_masbs1_t *) HW_MMDC1_MASBS1_ADDR(x))
#define HW_MMDC1_MASBS1_RD(x)        (HW_MMDC1_MASBS1(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MASBS1 bitfields
 */

/* --- Register HW_MMDC1_MASBS1, field SBS_VLD (RO)
 *
...
#define BP_MMDC1_MASBS1_SBS_VLD      0
#define BM_MMDC1_MASBS1_SBS_VLD      0x00000001


/* --- Register HW_MMDC1_MASBS1, field SBS_TYPE (RO)
 *
...
#define BP_MMDC1_MASBS1_SBS_TYPE      1
#define BM_MMDC1_MASBS1_SBS_TYPE      0x00000002


/* --- Register HW_MMDC1_MASBS1, field SBS_LOCK (RO)
 *
 * Step By Step Lock. These bits reflect the AXI LOCK of the pending request in case of step by step
 * mode.
 */

#define BP_MMDC1_MASBS1_SBS_LOCK      2
#define BM_MMDC1_MASBS1_SBS_LOCK      0x0000000c

/* --- Register HW_MMDC1_MASBS1, field SBS_PROT (RO)
 *
 * Step By Step Protection. These bits reflect the AXI PROT of the pending request in case of step
 * by step mode.
 */

#define BP_MMDC1_MASBS1_SBS_PROT      4
#define BM_MMDC1_MASBS1_SBS_PROT      0x00000070

/* --- Register HW_MMDC1_MASBS1, field SBS_BURST (RO)
 *
...
#define BP_MMDC1_MASBS1_SBS_BURST      7
#define BM_MMDC1_MASBS1_SBS_BURST      0x00000180


/* --- Register HW_MMDC1_MASBS1, field SBS_SIZE (RO)
 *
...
#define BP_MMDC1_MASBS1_SBS_SIZE      9
#define BM_MMDC1_MASBS1_SBS_SIZE      0x00000e00


/* --- Register HW_MMDC1_MASBS1, field SBS_BUFF (RO)
 *
...
#define BP_MMDC1_MASBS1_SBS_BUFF      12
#define BM_MMDC1_MASBS1_SBS_BUFF      0x00001000

/* --- Register HW_MMDC1_MASBS1, field SBS_LEN (RO)
 *
...
#define BP_MMDC1_MASBS1_SBS_LEN      13
#define BM_MMDC1_MASBS1_SBS_LEN      0x0000e000


/* --- Register HW_MMDC1_MASBS1, field SBS_AXI_ID (RO)
 *
 * Step By Step AXI ID. These bits reflect the AXI ID of the pending request in case of step by step
 * mode.
 */

#define BP_MMDC1_MASBS1_SBS_AXI_ID      16
#define BM_MMDC1_MASBS1_SBS_AXI_ID      0xffff0000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MAGENP - MMDC Core General Purpose Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MAGENP register
 */
#define HW_MMDC1_MAGENP_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x440)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MAGENP(x)           (*(volatile hw_mmdc1_magenp_t *) HW_MMDC1_MAGENP_ADDR(x))
#define HW_MMDC1_MAGENP_RD(x)        (HW_MMDC1_MAGENP(x).U)
#define HW_MMDC1_MAGENP_WR(x, v)     (HW_MMDC1_MAGENP(x).U = (v))
#define HW_MMDC1_MAGENP_SET(x, v)    (HW_MMDC1_MAGENP_WR(x, HW_MMDC1_MAGENP_RD(x) |  (v)))
#define HW_MMDC1_MAGENP_CLR(x, v)    (HW_MMDC1_MAGENP_WR(x, HW_MMDC1_MAGENP_RD(x) & ~(v)))
#define HW_MMDC1_MAGENP_TOG(x, v)    (HW_MMDC1_MAGENP_WR(x, HW_MMDC1_MAGENP_RD(x) ^  (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPZQHWCTRL - MMDC PHY ZQ HW control register (RW)
 *
...
} hw_mmdc1_mpzqhwctrl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPZQHWCTRL register
 */
#define HW_MMDC1_MPZQHWCTRL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x800)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPZQHWCTRL(x)           (*(volatile hw_mmdc1_mpzqhwctrl_t *) HW_MMDC1_MPZQHWCTRL_ADDR(x))
#define HW_MMDC1_MPZQHWCTRL_RD(x)        (HW_MMDC1_MPZQHWCTRL(x).U)
#define HW_MMDC1_MPZQHWCTRL_WR(x, v)     (HW_MMDC1_MPZQHWCTRL(x).U = (v))
#define HW_MMDC1_MPZQHWCTRL_SET(x, v)    (HW_MMDC1_MPZQHWCTRL_WR(x, HW_MMDC1_MPZQHWCTRL_RD(x) |  (v)))
#define HW_MMDC1_MPZQHWCTRL_CLR(x, v)    (HW_MMDC1_MPZQHWCTRL_WR(x, HW_MMDC1_MPZQHWCTRL_RD(x) & ~(v)))
#define HW_MMDC1_MPZQHWCTRL_TOG(x, v)    (HW_MMDC1_MPZQHWCTRL_WR(x, HW_MMDC1_MPZQHWCTRL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPZQHWCTRL bitfields
 */

/* --- Register HW_MMDC1_MPZQHWCTRL, field ZQ_MODE (RW)
 *
 * ZQ calibration mode:
 *
 * Values:
...
#define BP_MMDC1_MPZQHWCTRL_ZQ_MODE      0
#define BM_MMDC1_MPZQHWCTRL_ZQ_MODE      0x00000003

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQHWCTRL_ZQ_MODE(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPZQHWCTRL_ZQ_MODE)
#else
#define BF_MMDC1_MPZQHWCTRL_ZQ_MODE(v)   (((v) << 0) & BM_MMDC1_MPZQHWCTRL_ZQ_MODE)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_MODE field to a new value.
#define BW_MMDC1_MPZQHWCTRL_ZQ_MODE(v)   BF_CS1(MMDC1_MPZQHWCTRL, ZQ_MODE, v)
#endif


/* --- Register HW_MMDC1_MPZQHWCTRL, field ZQ_HW_PER (RW)
 *
...
#define BP_MMDC1_MPZQHWCTRL_ZQ_HW_PER      2
#define BM_MMDC1_MPZQHWCTRL_ZQ_HW_PER      0x0000003c

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQHWCTRL_ZQ_HW_PER(v)   ((((reg32_t) v) << 2) & BM_MMDC1_MPZQHWCTRL_ZQ_HW_PER)
#else
#define BF_MMDC1_MPZQHWCTRL_ZQ_HW_PER(v)   (((v) << 2) & BM_MMDC1_MPZQHWCTRL_ZQ_HW_PER)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_HW_PER field to a new value.
#define BW_MMDC1_MPZQHWCTRL_ZQ_HW_PER(v)   BF_CS1(MMDC1_MPZQHWCTRL, ZQ_HW_PER, v)
#endif


/* --- Register HW_MMDC1_MPZQHWCTRL, field ZQ_HW_PU_RES (RO)
 *
...
#define BP_MMDC1_MPZQHWCTRL_ZQ_HW_PU_RES      6
#define BM_MMDC1_MPZQHWCTRL_ZQ_HW_PU_RES      0x000007c0


/* --- Register HW_MMDC1_MPZQHWCTRL, field ZQ_HW_PD_RES (RO)
 *
...
#define BP_MMDC1_MPZQHWCTRL_ZQ_HW_PD_RES      11
#define BM_MMDC1_MPZQHWCTRL_ZQ_HW_PD_RES      0x0000f800


/* --- Register HW_MMDC1_MPZQHWCTRL, field ZQ_HW_FOR (RW)
 *
...
#define BP_MMDC1_MPZQHWCTRL_ZQ_HW_FOR      16
#define BM_MMDC1_MPZQHWCTRL_ZQ_HW_FOR      0x00010000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQHWCTRL_ZQ_HW_FOR(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPZQHWCTRL_ZQ_HW_FOR)
#else
#define BF_MMDC1_MPZQHWCTRL_ZQ_HW_FOR(v)   (((v) << 16) & BM_MMDC1_MPZQHWCTRL_ZQ_HW_FOR)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_HW_FOR field to a new value.
#define BW_MMDC1_MPZQHWCTRL_ZQ_HW_FOR(v)   BF_CS1(MMDC1_MPZQHWCTRL, ZQ_HW_FOR, v)
#endif

/* --- Register HW_MMDC1_MPZQHWCTRL, field TZQ_INIT (RW)
 *
...
#define BP_MMDC1_MPZQHWCTRL_TZQ_INIT      17
#define BM_MMDC1_MPZQHWCTRL_TZQ_INIT      0x000e0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQHWCTRL_TZQ_INIT(v)   ((((reg32_t) v) << 17) & BM_MMDC1_MPZQHWCTRL_TZQ_INIT)
#else
#define BF_MMDC1_MPZQHWCTRL_TZQ_INIT(v)   (((v) << 17) & BM_MMDC1_MPZQHWCTRL_TZQ_INIT)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TZQ_INIT field to a new value.
#define BW_MMDC1_MPZQHWCTRL_TZQ_INIT(v)   BF_CS1(MMDC1_MPZQHWCTRL, TZQ_INIT, v)
#endif


/* --- Register HW_MMDC1_MPZQHWCTRL, field TZQ_OPER (RW)
 *
...
#define BP_MMDC1_MPZQHWCTRL_TZQ_OPER      20
#define BM_MMDC1_MPZQHWCTRL_TZQ_OPER      0x00700000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQHWCTRL_TZQ_OPER(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MPZQHWCTRL_TZQ_OPER)
#else
#define BF_MMDC1_MPZQHWCTRL_TZQ_OPER(v)   (((v) << 20) & BM_MMDC1_MPZQHWCTRL_TZQ_OPER)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TZQ_OPER field to a new value.
#define BW_MMDC1_MPZQHWCTRL_TZQ_OPER(v)   BF_CS1(MMDC1_MPZQHWCTRL, TZQ_OPER, v)
#endif


/* --- Register HW_MMDC1_MPZQHWCTRL, field TZQ_CS (RW)
 *
...
#define BP_MMDC1_MPZQHWCTRL_TZQ_CS      23
#define BM_MMDC1_MPZQHWCTRL_TZQ_CS      0x03800000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQHWCTRL_TZQ_CS(v)   ((((reg32_t) v) << 23) & BM_MMDC1_MPZQHWCTRL_TZQ_CS)
#else
#define BF_MMDC1_MPZQHWCTRL_TZQ_CS(v)   (((v) << 23) & BM_MMDC1_MPZQHWCTRL_TZQ_CS)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the TZQ_CS field to a new value.
#define BW_MMDC1_MPZQHWCTRL_TZQ_CS(v)   BF_CS1(MMDC1_MPZQHWCTRL, TZQ_CS, v)
#endif


/* --- Register HW_MMDC1_MPZQHWCTRL, field ZQ_EARLY_COMPARATOR_EN_TIMER (RW)
 *
...
#define BP_MMDC1_MPZQHWCTRL_ZQ_EARLY_COMPARATOR_EN_TIMER      27
#define BM_MMDC1_MPZQHWCTRL_ZQ_EARLY_COMPARATOR_EN_TIMER      0xf8000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQHWCTRL_ZQ_EARLY_COMPARATOR_EN_TIMER(v)   ((((reg32_t) v) << 27) & BM_MMDC1_MPZQHWCTRL_ZQ_EARLY_COMPARATOR_EN_TIMER)
#else
#define BF_MMDC1_MPZQHWCTRL_ZQ_EARLY_COMPARATOR_EN_TIMER(v)   (((v) << 27) & BM_MMDC1_MPZQHWCTRL_ZQ_EARLY_COMPARATOR_EN_TIMER)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_EARLY_COMPARATOR_EN_TIMER field to a new value.
#define BW_MMDC1_MPZQHWCTRL_ZQ_EARLY_COMPARATOR_EN_TIMER(v)   BF_CS1(MMDC1_MPZQHWCTRL, ZQ_EARLY_COMPARATOR_EN_TIMER, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPZQSWCTRL - MMDC PHY ZQ SW control register (RW)
 *
...
} hw_mmdc1_mpzqswctrl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPZQSWCTRL register
 */
#define HW_MMDC1_MPZQSWCTRL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x804)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPZQSWCTRL(x)           (*(volatile hw_mmdc1_mpzqswctrl_t *) HW_MMDC1_MPZQSWCTRL_ADDR(x))
#define HW_MMDC1_MPZQSWCTRL_RD(x)        (HW_MMDC1_MPZQSWCTRL(x).U)
#define HW_MMDC1_MPZQSWCTRL_WR(x, v)     (HW_MMDC1_MPZQSWCTRL(x).U = (v))
#define HW_MMDC1_MPZQSWCTRL_SET(x, v)    (HW_MMDC1_MPZQSWCTRL_WR(x, HW_MMDC1_MPZQSWCTRL_RD(x) |  (v)))
#define HW_MMDC1_MPZQSWCTRL_CLR(x, v)    (HW_MMDC1_MPZQSWCTRL_WR(x, HW_MMDC1_MPZQSWCTRL_RD(x) & ~(v)))
#define HW_MMDC1_MPZQSWCTRL_TOG(x, v)    (HW_MMDC1_MPZQSWCTRL_WR(x, HW_MMDC1_MPZQSWCTRL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPZQSWCTRL bitfields
 */

/* --- Register HW_MMDC1_MPZQSWCTRL, field ZQ_SW_FOR (RW)
 *
...
#define BP_MMDC1_MPZQSWCTRL_ZQ_SW_FOR      0
#define BM_MMDC1_MPZQSWCTRL_ZQ_SW_FOR      0x00000001

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQSWCTRL_ZQ_SW_FOR(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPZQSWCTRL_ZQ_SW_FOR)
#else
#define BF_MMDC1_MPZQSWCTRL_ZQ_SW_FOR(v)   (((v) << 0) & BM_MMDC1_MPZQSWCTRL_ZQ_SW_FOR)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_SW_FOR field to a new value.
#define BW_MMDC1_MPZQSWCTRL_ZQ_SW_FOR(v)   BF_CS1(MMDC1_MPZQSWCTRL, ZQ_SW_FOR, v)
#endif

/* --- Register HW_MMDC1_MPZQSWCTRL, field ZQ_SW_RES (RO)
 *
...
#define BP_MMDC1_MPZQSWCTRL_ZQ_SW_RES      1
#define BM_MMDC1_MPZQSWCTRL_ZQ_SW_RES      0x00000002


/* --- Register HW_MMDC1_MPZQSWCTRL, field ZQ_SW_PU_VAL (RW)
 *
...
#define BP_MMDC1_MPZQSWCTRL_ZQ_SW_PU_VAL      2
#define BM_MMDC1_MPZQSWCTRL_ZQ_SW_PU_VAL      0x0000007c

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQSWCTRL_ZQ_SW_PU_VAL(v)   ((((reg32_t) v) << 2) & BM_MMDC1_MPZQSWCTRL_ZQ_SW_PU_VAL)
#else
#define BF_MMDC1_MPZQSWCTRL_ZQ_SW_PU_VAL(v)   (((v) << 2) & BM_MMDC1_MPZQSWCTRL_ZQ_SW_PU_VAL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_SW_PU_VAL field to a new value.
#define BW_MMDC1_MPZQSWCTRL_ZQ_SW_PU_VAL(v)   BF_CS1(MMDC1_MPZQSWCTRL, ZQ_SW_PU_VAL, v)
#endif


/* --- Register HW_MMDC1_MPZQSWCTRL, field ZQ_SW_PD_VAL (RW)
 *
...
#define BP_MMDC1_MPZQSWCTRL_ZQ_SW_PD_VAL      7
#define BM_MMDC1_MPZQSWCTRL_ZQ_SW_PD_VAL      0x00000f80

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQSWCTRL_ZQ_SW_PD_VAL(v)   ((((reg32_t) v) << 7) & BM_MMDC1_MPZQSWCTRL_ZQ_SW_PD_VAL)
#else
#define BF_MMDC1_MPZQSWCTRL_ZQ_SW_PD_VAL(v)   (((v) << 7) & BM_MMDC1_MPZQSWCTRL_ZQ_SW_PD_VAL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_SW_PD_VAL field to a new value.
#define BW_MMDC1_MPZQSWCTRL_ZQ_SW_PD_VAL(v)   BF_CS1(MMDC1_MPZQSWCTRL, ZQ_SW_PD_VAL, v)
#endif


/* --- Register HW_MMDC1_MPZQSWCTRL, field ZQ_SW_PD (RW)
 *
...
#define BP_MMDC1_MPZQSWCTRL_ZQ_SW_PD      12
#define BM_MMDC1_MPZQSWCTRL_ZQ_SW_PD      0x00001000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQSWCTRL_ZQ_SW_PD(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPZQSWCTRL_ZQ_SW_PD)
#else
#define BF_MMDC1_MPZQSWCTRL_ZQ_SW_PD(v)   (((v) << 12) & BM_MMDC1_MPZQSWCTRL_ZQ_SW_PD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_SW_PD field to a new value.
#define BW_MMDC1_MPZQSWCTRL_ZQ_SW_PD(v)   BF_CS1(MMDC1_MPZQSWCTRL, ZQ_SW_PD, v)
#endif


/* --- Register HW_MMDC1_MPZQSWCTRL, field USE_ZQ_SW_VAL (RW)
 *
...
#define BP_MMDC1_MPZQSWCTRL_USE_ZQ_SW_VAL      13
#define BM_MMDC1_MPZQSWCTRL_USE_ZQ_SW_VAL      0x00002000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQSWCTRL_USE_ZQ_SW_VAL(v)   ((((reg32_t) v) << 13) & BM_MMDC1_MPZQSWCTRL_USE_ZQ_SW_VAL)
#else
#define BF_MMDC1_MPZQSWCTRL_USE_ZQ_SW_VAL(v)   (((v) << 13) & BM_MMDC1_MPZQSWCTRL_USE_ZQ_SW_VAL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the USE_ZQ_SW_VAL field to a new value.
#define BW_MMDC1_MPZQSWCTRL_USE_ZQ_SW_VAL(v)   BF_CS1(MMDC1_MPZQSWCTRL, USE_ZQ_SW_VAL, v)
#endif


/* --- Register HW_MMDC1_MPZQSWCTRL, field ZQ_CMP_OUT_SMP (RW)
 *
...
#define BP_MMDC1_MPZQSWCTRL_ZQ_CMP_OUT_SMP      16
#define BM_MMDC1_MPZQSWCTRL_ZQ_CMP_OUT_SMP      0x00030000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQSWCTRL_ZQ_CMP_OUT_SMP(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPZQSWCTRL_ZQ_CMP_OUT_SMP)
#else
#define BF_MMDC1_MPZQSWCTRL_ZQ_CMP_OUT_SMP(v)   (((v) << 16) & BM_MMDC1_MPZQSWCTRL_ZQ_CMP_OUT_SMP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_CMP_OUT_SMP field to a new value.
#define BW_MMDC1_MPZQSWCTRL_ZQ_CMP_OUT_SMP(v)   BF_CS1(MMDC1_MPZQSWCTRL, ZQ_CMP_OUT_SMP, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWLGCR - MMDC PHY Write Leveling Configuration and Error Status Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MPWLGCR register
 */
#define HW_MMDC1_MPWLGCR_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x808)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWLGCR(x)           (*(volatile hw_mmdc1_mpwlgcr_t *) HW_MMDC1_MPWLGCR_ADDR(x))
#define HW_MMDC1_MPWLGCR_RD(x)        (HW_MMDC1_MPWLGCR(x).U)
#define HW_MMDC1_MPWLGCR_WR(x, v)     (HW_MMDC1_MPWLGCR(x).U = (v))
#define HW_MMDC1_MPWLGCR_SET(x, v)    (HW_MMDC1_MPWLGCR_WR(x, HW_MMDC1_MPWLGCR_RD(x) |  (v)))
#define HW_MMDC1_MPWLGCR_CLR(x, v)    (HW_MMDC1_MPWLGCR_WR(x, HW_MMDC1_MPWLGCR_RD(x) & ~(v)))
#define HW_MMDC1_MPWLGCR_TOG(x, v)    (HW_MMDC1_MPWLGCR_WR(x, HW_MMDC1_MPWLGCR_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWLGCR bitfields
 */

/* --- Register HW_MMDC1_MPWLGCR, field HW_WL_EN (RW)
 *
...
#define BP_MMDC1_MPWLGCR_HW_WL_EN      0
#define BM_MMDC1_MPWLGCR_HW_WL_EN      0x00000001

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLGCR_HW_WL_EN(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPWLGCR_HW_WL_EN)
#else
#define BF_MMDC1_MPWLGCR_HW_WL_EN(v)   (((v) << 0) & BM_MMDC1_MPWLGCR_HW_WL_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the HW_WL_EN field to a new value.
#define BW_MMDC1_MPWLGCR_HW_WL_EN(v)   BF_CS1(MMDC1_MPWLGCR, HW_WL_EN, v)
#endif

/* --- Register HW_MMDC1_MPWLGCR, field SW_WL_EN (RW)
 *
...
#define BP_MMDC1_MPWLGCR_SW_WL_EN      1
#define BM_MMDC1_MPWLGCR_SW_WL_EN      0x00000002

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLGCR_SW_WL_EN(v)   ((((reg32_t) v) << 1) & BM_MMDC1_MPWLGCR_SW_WL_EN)
#else
#define BF_MMDC1_MPWLGCR_SW_WL_EN(v)   (((v) << 1) & BM_MMDC1_MPWLGCR_SW_WL_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SW_WL_EN field to a new value.
#define BW_MMDC1_MPWLGCR_SW_WL_EN(v)   BF_CS1(MMDC1_MPWLGCR, SW_WL_EN, v)
#endif

/* --- Register HW_MMDC1_MPWLGCR, field SW_WL_CNT_EN (RW)
 *
...
#define BP_MMDC1_MPWLGCR_SW_WL_CNT_EN      2
#define BM_MMDC1_MPWLGCR_SW_WL_CNT_EN      0x00000004

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLGCR_SW_WL_CNT_EN(v)   ((((reg32_t) v) << 2) & BM_MMDC1_MPWLGCR_SW_WL_CNT_EN)
#else
#define BF_MMDC1_MPWLGCR_SW_WL_CNT_EN(v)   (((v) << 2) & BM_MMDC1_MPWLGCR_SW_WL_CNT_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SW_WL_CNT_EN field to a new value.
#define BW_MMDC1_MPWLGCR_SW_WL_CNT_EN(v)   BF_CS1(MMDC1_MPWLGCR, SW_WL_CNT_EN, v)
#endif


/* --- Register HW_MMDC1_MPWLGCR, field WL_SW_RES0 (RO)
 *
...
#define BP_MMDC1_MPWLGCR_WL_SW_RES0      4
#define BM_MMDC1_MPWLGCR_WL_SW_RES0      0x00000010


/* --- Register HW_MMDC1_MPWLGCR, field WL_SW_RES1 (RO)
 *
...
#define BP_MMDC1_MPWLGCR_WL_SW_RES1      5
#define BM_MMDC1_MPWLGCR_WL_SW_RES1      0x00000020


/* --- Register HW_MMDC1_MPWLGCR, field WL_SW_RES2 (RO)
 *
...
#define BP_MMDC1_MPWLGCR_WL_SW_RES2      6
#define BM_MMDC1_MPWLGCR_WL_SW_RES2      0x00000040


/* --- Register HW_MMDC1_MPWLGCR, field WL_SW_RES3 (RO)
 *
...
#define BP_MMDC1_MPWLGCR_WL_SW_RES3      7
#define BM_MMDC1_MPWLGCR_WL_SW_RES3      0x00000080


/* --- Register HW_MMDC1_MPWLGCR, field WL_HW_ERR0 (RO)
 *
...
#define BP_MMDC1_MPWLGCR_WL_HW_ERR0      8
#define BM_MMDC1_MPWLGCR_WL_HW_ERR0      0x00000100


/* --- Register HW_MMDC1_MPWLGCR, field WL_HW_ERR1 (RO)
 *
...
#define BP_MMDC1_MPWLGCR_WL_HW_ERR1      9
#define BM_MMDC1_MPWLGCR_WL_HW_ERR1      0x00000200


/* --- Register HW_MMDC1_MPWLGCR, field WL_HW_ERR2 (RO)
 *
...
#define BP_MMDC1_MPWLGCR_WL_HW_ERR2      10
#define BM_MMDC1_MPWLGCR_WL_HW_ERR2      0x00000400


/* --- Register HW_MMDC1_MPWLGCR, field WL_HW_ERR3 (RO)
 *
...
#define BP_MMDC1_MPWLGCR_WL_HW_ERR3      11
#define BM_MMDC1_MPWLGCR_WL_HW_ERR3      0x00000800


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWLDECTRL0 - MMDC PHY Write Leveling Delay Control Register 0 (RW)
 *
 * Supported Mode OF Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpwldectrl0_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWLDECTRL0 register
 */
#define HW_MMDC1_MPWLDECTRL0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x80c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWLDECTRL0(x)           (*(volatile hw_mmdc1_mpwldectrl0_t *) HW_MMDC1_MPWLDECTRL0_ADDR(x))
#define HW_MMDC1_MPWLDECTRL0_RD(x)        (HW_MMDC1_MPWLDECTRL0(x).U)
#define HW_MMDC1_MPWLDECTRL0_WR(x, v)     (HW_MMDC1_MPWLDECTRL0(x).U = (v))
#define HW_MMDC1_MPWLDECTRL0_SET(x, v)    (HW_MMDC1_MPWLDECTRL0_WR(x, HW_MMDC1_MPWLDECTRL0_RD(x) |  (v)))
#define HW_MMDC1_MPWLDECTRL0_CLR(x, v)    (HW_MMDC1_MPWLDECTRL0_WR(x, HW_MMDC1_MPWLDECTRL0_RD(x) & ~(v)))
#define HW_MMDC1_MPWLDECTRL0_TOG(x, v)    (HW_MMDC1_MPWLDECTRL0_WR(x, HW_MMDC1_MPWLDECTRL0_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWLDECTRL0 bitfields
 */

/* --- Register HW_MMDC1_MPWLDECTRL0, field WL_DL_ABS_OFFSET0 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET0      0
#define BM_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET0      0x0000007f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET0(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET0)
#else
#define BF_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET0(v)   (((v) << 0) & BM_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_DL_ABS_OFFSET0 field to a new value.
#define BW_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET0(v)   BF_CS1(MMDC1_MPWLDECTRL0, WL_DL_ABS_OFFSET0, v)
#endif

/* --- Register HW_MMDC1_MPWLDECTRL0, field WL_HC_DEL0 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL0_WL_HC_DEL0      8
#define BM_MMDC1_MPWLDECTRL0_WL_HC_DEL0      0x00000100

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL0_WL_HC_DEL0(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPWLDECTRL0_WL_HC_DEL0)
#else
#define BF_MMDC1_MPWLDECTRL0_WL_HC_DEL0(v)   (((v) << 8) & BM_MMDC1_MPWLDECTRL0_WL_HC_DEL0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_HC_DEL0 field to a new value.
#define BW_MMDC1_MPWLDECTRL0_WL_HC_DEL0(v)   BF_CS1(MMDC1_MPWLDECTRL0, WL_HC_DEL0, v)
#endif


/* --- Register HW_MMDC1_MPWLDECTRL0, field WL_CYC_DEL0 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL0_WL_CYC_DEL0      9
#define BM_MMDC1_MPWLDECTRL0_WL_CYC_DEL0      0x00000600

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL0_WL_CYC_DEL0(v)   ((((reg32_t) v) << 9) & BM_MMDC1_MPWLDECTRL0_WL_CYC_DEL0)
#else
#define BF_MMDC1_MPWLDECTRL0_WL_CYC_DEL0(v)   (((v) << 9) & BM_MMDC1_MPWLDECTRL0_WL_CYC_DEL0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_CYC_DEL0 field to a new value.
#define BW_MMDC1_MPWLDECTRL0_WL_CYC_DEL0(v)   BF_CS1(MMDC1_MPWLDECTRL0, WL_CYC_DEL0, v)
#endif


/* --- Register HW_MMDC1_MPWLDECTRL0, field WL_DL_ABS_OFFSET1 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET1      16
#define BM_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET1      0x007f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET1(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET1)
#else
#define BF_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET1(v)   (((v) << 16) & BM_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_DL_ABS_OFFSET1 field to a new value.
#define BW_MMDC1_MPWLDECTRL0_WL_DL_ABS_OFFSET1(v)   BF_CS1(MMDC1_MPWLDECTRL0, WL_DL_ABS_OFFSET1, v)
#endif

/* --- Register HW_MMDC1_MPWLDECTRL0, field WL_HC_DEL1 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL0_WL_HC_DEL1      24
#define BM_MMDC1_MPWLDECTRL0_WL_HC_DEL1      0x01000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL0_WL_HC_DEL1(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPWLDECTRL0_WL_HC_DEL1)
#else
#define BF_MMDC1_MPWLDECTRL0_WL_HC_DEL1(v)   (((v) << 24) & BM_MMDC1_MPWLDECTRL0_WL_HC_DEL1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_HC_DEL1 field to a new value.
#define BW_MMDC1_MPWLDECTRL0_WL_HC_DEL1(v)   BF_CS1(MMDC1_MPWLDECTRL0, WL_HC_DEL1, v)
#endif


/* --- Register HW_MMDC1_MPWLDECTRL0, field WL_CYC_DEL1 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL0_WL_CYC_DEL1      25
#define BM_MMDC1_MPWLDECTRL0_WL_CYC_DEL1      0x06000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL0_WL_CYC_DEL1(v)   ((((reg32_t) v) << 25) & BM_MMDC1_MPWLDECTRL0_WL_CYC_DEL1)
#else
#define BF_MMDC1_MPWLDECTRL0_WL_CYC_DEL1(v)   (((v) << 25) & BM_MMDC1_MPWLDECTRL0_WL_CYC_DEL1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_CYC_DEL1 field to a new value.
#define BW_MMDC1_MPWLDECTRL0_WL_CYC_DEL1(v)   BF_CS1(MMDC1_MPWLDECTRL0, WL_CYC_DEL1, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWLDECTRL1 - MMDC PHY Write Leveling Delay Control Register 1 (RW)
 *
...
} hw_mmdc1_mpwldectrl1_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWLDECTRL1 register
 */
#define HW_MMDC1_MPWLDECTRL1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x810)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWLDECTRL1(x)           (*(volatile hw_mmdc1_mpwldectrl1_t *) HW_MMDC1_MPWLDECTRL1_ADDR(x))
#define HW_MMDC1_MPWLDECTRL1_RD(x)        (HW_MMDC1_MPWLDECTRL1(x).U)
#define HW_MMDC1_MPWLDECTRL1_WR(x, v)     (HW_MMDC1_MPWLDECTRL1(x).U = (v))
#define HW_MMDC1_MPWLDECTRL1_SET(x, v)    (HW_MMDC1_MPWLDECTRL1_WR(x, HW_MMDC1_MPWLDECTRL1_RD(x) |  (v)))
#define HW_MMDC1_MPWLDECTRL1_CLR(x, v)    (HW_MMDC1_MPWLDECTRL1_WR(x, HW_MMDC1_MPWLDECTRL1_RD(x) & ~(v)))
#define HW_MMDC1_MPWLDECTRL1_TOG(x, v)    (HW_MMDC1_MPWLDECTRL1_WR(x, HW_MMDC1_MPWLDECTRL1_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWLDECTRL1 bitfields
 */

/* --- Register HW_MMDC1_MPWLDECTRL1, field WL_DL_ABS_OFFSET2 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET2      0
#define BM_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET2      0x0000007f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET2(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET2)
#else
#define BF_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET2(v)   (((v) << 0) & BM_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_DL_ABS_OFFSET2 field to a new value.
#define BW_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET2(v)   BF_CS1(MMDC1_MPWLDECTRL1, WL_DL_ABS_OFFSET2, v)
#endif

/* --- Register HW_MMDC1_MPWLDECTRL1, field WL_HC_DEL2 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL1_WL_HC_DEL2      8
#define BM_MMDC1_MPWLDECTRL1_WL_HC_DEL2      0x00000100

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL1_WL_HC_DEL2(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPWLDECTRL1_WL_HC_DEL2)
#else
#define BF_MMDC1_MPWLDECTRL1_WL_HC_DEL2(v)   (((v) << 8) & BM_MMDC1_MPWLDECTRL1_WL_HC_DEL2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_HC_DEL2 field to a new value.
#define BW_MMDC1_MPWLDECTRL1_WL_HC_DEL2(v)   BF_CS1(MMDC1_MPWLDECTRL1, WL_HC_DEL2, v)
#endif


/* --- Register HW_MMDC1_MPWLDECTRL1, field WL_CYC_DEL2 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL1_WL_CYC_DEL2      9
#define BM_MMDC1_MPWLDECTRL1_WL_CYC_DEL2      0x00000600

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL1_WL_CYC_DEL2(v)   ((((reg32_t) v) << 9) & BM_MMDC1_MPWLDECTRL1_WL_CYC_DEL2)
#else
#define BF_MMDC1_MPWLDECTRL1_WL_CYC_DEL2(v)   (((v) << 9) & BM_MMDC1_MPWLDECTRL1_WL_CYC_DEL2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_CYC_DEL2 field to a new value.
#define BW_MMDC1_MPWLDECTRL1_WL_CYC_DEL2(v)   BF_CS1(MMDC1_MPWLDECTRL1, WL_CYC_DEL2, v)
#endif


/* --- Register HW_MMDC1_MPWLDECTRL1, field WL_DL_ABS_OFFSET3 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET3      16
#define BM_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET3      0x007f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET3(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET3)
#else
#define BF_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET3(v)   (((v) << 16) & BM_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET3)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_DL_ABS_OFFSET3 field to a new value.
#define BW_MMDC1_MPWLDECTRL1_WL_DL_ABS_OFFSET3(v)   BF_CS1(MMDC1_MPWLDECTRL1, WL_DL_ABS_OFFSET3, v)
#endif

/* --- Register HW_MMDC1_MPWLDECTRL1, field WL_HC_DEL3 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL1_WL_HC_DEL3      24
#define BM_MMDC1_MPWLDECTRL1_WL_HC_DEL3      0x01000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL1_WL_HC_DEL3(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPWLDECTRL1_WL_HC_DEL3)
#else
#define BF_MMDC1_MPWLDECTRL1_WL_HC_DEL3(v)   (((v) << 24) & BM_MMDC1_MPWLDECTRL1_WL_HC_DEL3)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_HC_DEL3 field to a new value.
#define BW_MMDC1_MPWLDECTRL1_WL_HC_DEL3(v)   BF_CS1(MMDC1_MPWLDECTRL1, WL_HC_DEL3, v)
#endif


/* --- Register HW_MMDC1_MPWLDECTRL1, field WL_CYC_DEL3 (RW)
 *
...
#define BP_MMDC1_MPWLDECTRL1_WL_CYC_DEL3      25
#define BM_MMDC1_MPWLDECTRL1_WL_CYC_DEL3      0x06000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWLDECTRL1_WL_CYC_DEL3(v)   ((((reg32_t) v) << 25) & BM_MMDC1_MPWLDECTRL1_WL_CYC_DEL3)
#else
#define BF_MMDC1_MPWLDECTRL1_WL_CYC_DEL3(v)   (((v) << 25) & BM_MMDC1_MPWLDECTRL1_WL_CYC_DEL3)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WL_CYC_DEL3 field to a new value.
#define BW_MMDC1_MPWLDECTRL1_WL_CYC_DEL3(v)   BF_CS1(MMDC1_MPWLDECTRL1, WL_CYC_DEL3, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWLDLST - MMDC PHY Write Leveling delay-line Status Register (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MPWLDLST register
 */
#define HW_MMDC1_MPWLDLST_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x814)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWLDLST(x)           (*(volatile hw_mmdc1_mpwldlst_t *) HW_MMDC1_MPWLDLST_ADDR(x))
#define HW_MMDC1_MPWLDLST_RD(x)        (HW_MMDC1_MPWLDLST(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPWLDLST bitfields
 */

/* --- Register HW_MMDC1_MPWLDLST, field WL_DL_UNIT_NUM0 (RO)
 *
 * This field reflects the number of delay units that are actually used by write leveling delay-line
 * 0.
 */

#define BP_MMDC1_MPWLDLST_WL_DL_UNIT_NUM0      0
#define BM_MMDC1_MPWLDLST_WL_DL_UNIT_NUM0      0x0000007f

/* --- Register HW_MMDC1_MPWLDLST, field WL_DL_UNIT_NUM1 (RO)
 *
 * This field reflects the number of delay units that are actually used by write leveling delay-line
 * 1.
 */

#define BP_MMDC1_MPWLDLST_WL_DL_UNIT_NUM1      8
#define BM_MMDC1_MPWLDLST_WL_DL_UNIT_NUM1      0x00007f00

/* --- Register HW_MMDC1_MPWLDLST, field WL_DL_UNIT_NUM2 (RO)
 *
 * This field reflects the number of delay units that are actually used by write leveling delay-line
 * 2.
 */

#define BP_MMDC1_MPWLDLST_WL_DL_UNIT_NUM2      16
#define BM_MMDC1_MPWLDLST_WL_DL_UNIT_NUM2      0x007f0000

/* --- Register HW_MMDC1_MPWLDLST, field WL_DL_UNIT_NUM3 (RO)
 *
 * This field reflects the number of delay units that are actually used by write leveling delay-line
 * 3.
 */

#define BP_MMDC1_MPWLDLST_WL_DL_UNIT_NUM3      24
#define BM_MMDC1_MPWLDLST_WL_DL_UNIT_NUM3      0x7f000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPODTCTRL - MMDC PHY ODT control register (RW)
 *
...
} hw_mmdc1_mpodtctrl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPODTCTRL register
 */
#define HW_MMDC1_MPODTCTRL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x818)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPODTCTRL(x)           (*(volatile hw_mmdc1_mpodtctrl_t *) HW_MMDC1_MPODTCTRL_ADDR(x))
#define HW_MMDC1_MPODTCTRL_RD(x)        (HW_MMDC1_MPODTCTRL(x).U)
#define HW_MMDC1_MPODTCTRL_WR(x, v)     (HW_MMDC1_MPODTCTRL(x).U = (v))
#define HW_MMDC1_MPODTCTRL_SET(x, v)    (HW_MMDC1_MPODTCTRL_WR(x, HW_MMDC1_MPODTCTRL_RD(x) |  (v)))
#define HW_MMDC1_MPODTCTRL_CLR(x, v)    (HW_MMDC1_MPODTCTRL_WR(x, HW_MMDC1_MPODTCTRL_RD(x) & ~(v)))
#define HW_MMDC1_MPODTCTRL_TOG(x, v)    (HW_MMDC1_MPODTCTRL_WR(x, HW_MMDC1_MPODTCTRL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPODTCTRL bitfields
 */

/* --- Register HW_MMDC1_MPODTCTRL, field ODT_WR_PAS_EN (RW)
 *
...
#define BP_MMDC1_MPODTCTRL_ODT_WR_PAS_EN      0
#define BM_MMDC1_MPODTCTRL_ODT_WR_PAS_EN      0x00000001

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPODTCTRL_ODT_WR_PAS_EN(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPODTCTRL_ODT_WR_PAS_EN)
#else
#define BF_MMDC1_MPODTCTRL_ODT_WR_PAS_EN(v)   (((v) << 0) & BM_MMDC1_MPODTCTRL_ODT_WR_PAS_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ODT_WR_PAS_EN field to a new value.
#define BW_MMDC1_MPODTCTRL_ODT_WR_PAS_EN(v)   BF_CS1(MMDC1_MPODTCTRL, ODT_WR_PAS_EN, v)
#endif


/* --- Register HW_MMDC1_MPODTCTRL, field ODT_WR_ACT_EN (RW)
 *
...
#define BP_MMDC1_MPODTCTRL_ODT_WR_ACT_EN      1
#define BM_MMDC1_MPODTCTRL_ODT_WR_ACT_EN      0x00000002

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPODTCTRL_ODT_WR_ACT_EN(v)   ((((reg32_t) v) << 1) & BM_MMDC1_MPODTCTRL_ODT_WR_ACT_EN)
#else
#define BF_MMDC1_MPODTCTRL_ODT_WR_ACT_EN(v)   (((v) << 1) & BM_MMDC1_MPODTCTRL_ODT_WR_ACT_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ODT_WR_ACT_EN field to a new value.
#define BW_MMDC1_MPODTCTRL_ODT_WR_ACT_EN(v)   BF_CS1(MMDC1_MPODTCTRL, ODT_WR_ACT_EN, v)
#endif


/* --- Register HW_MMDC1_MPODTCTRL, field ODT_RD_PAS_EN (RW)
 *
...
#define BP_MMDC1_MPODTCTRL_ODT_RD_PAS_EN      2
#define BM_MMDC1_MPODTCTRL_ODT_RD_PAS_EN      0x00000004

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPODTCTRL_ODT_RD_PAS_EN(v)   ((((reg32_t) v) << 2) & BM_MMDC1_MPODTCTRL_ODT_RD_PAS_EN)
#else
#define BF_MMDC1_MPODTCTRL_ODT_RD_PAS_EN(v)   (((v) << 2) & BM_MMDC1_MPODTCTRL_ODT_RD_PAS_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ODT_RD_PAS_EN field to a new value.
#define BW_MMDC1_MPODTCTRL_ODT_RD_PAS_EN(v)   BF_CS1(MMDC1_MPODTCTRL, ODT_RD_PAS_EN, v)
#endif


/* --- Register HW_MMDC1_MPODTCTRL, field ODT_RD_ACT_EN (RW)
 *
...
#define BP_MMDC1_MPODTCTRL_ODT_RD_ACT_EN      3
#define BM_MMDC1_MPODTCTRL_ODT_RD_ACT_EN      0x00000008

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPODTCTRL_ODT_RD_ACT_EN(v)   ((((reg32_t) v) << 3) & BM_MMDC1_MPODTCTRL_ODT_RD_ACT_EN)
#else
#define BF_MMDC1_MPODTCTRL_ODT_RD_ACT_EN(v)   (((v) << 3) & BM_MMDC1_MPODTCTRL_ODT_RD_ACT_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ODT_RD_ACT_EN field to a new value.
#define BW_MMDC1_MPODTCTRL_ODT_RD_ACT_EN(v)   BF_CS1(MMDC1_MPODTCTRL, ODT_RD_ACT_EN, v)
#endif


/* --- Register HW_MMDC1_MPODTCTRL, field ODT0_INT_RES (RW)
 *
...
#define BP_MMDC1_MPODTCTRL_ODT0_INT_RES      4
#define BM_MMDC1_MPODTCTRL_ODT0_INT_RES      0x00000070

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPODTCTRL_ODT0_INT_RES(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPODTCTRL_ODT0_INT_RES)
#else
#define BF_MMDC1_MPODTCTRL_ODT0_INT_RES(v)   (((v) << 4) & BM_MMDC1_MPODTCTRL_ODT0_INT_RES)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ODT0_INT_RES field to a new value.
#define BW_MMDC1_MPODTCTRL_ODT0_INT_RES(v)   BF_CS1(MMDC1_MPODTCTRL, ODT0_INT_RES, v)
#endif


/* --- Register HW_MMDC1_MPODTCTRL, field ODT1_INT_RES (RW)
 *
...
#define BP_MMDC1_MPODTCTRL_ODT1_INT_RES      8
#define BM_MMDC1_MPODTCTRL_ODT1_INT_RES      0x00000700

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPODTCTRL_ODT1_INT_RES(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPODTCTRL_ODT1_INT_RES)
#else
#define BF_MMDC1_MPODTCTRL_ODT1_INT_RES(v)   (((v) << 8) & BM_MMDC1_MPODTCTRL_ODT1_INT_RES)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ODT1_INT_RES field to a new value.
#define BW_MMDC1_MPODTCTRL_ODT1_INT_RES(v)   BF_CS1(MMDC1_MPODTCTRL, ODT1_INT_RES, v)
#endif


/* --- Register HW_MMDC1_MPODTCTRL, field ODT2_INT_RES (RW)
 *
...
#define BP_MMDC1_MPODTCTRL_ODT2_INT_RES      12
#define BM_MMDC1_MPODTCTRL_ODT2_INT_RES      0x00007000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPODTCTRL_ODT2_INT_RES(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPODTCTRL_ODT2_INT_RES)
#else
#define BF_MMDC1_MPODTCTRL_ODT2_INT_RES(v)   (((v) << 12) & BM_MMDC1_MPODTCTRL_ODT2_INT_RES)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ODT2_INT_RES field to a new value.
#define BW_MMDC1_MPODTCTRL_ODT2_INT_RES(v)   BF_CS1(MMDC1_MPODTCTRL, ODT2_INT_RES, v)
#endif


/* --- Register HW_MMDC1_MPODTCTRL, field ODT3_INT_RES (RW)
 *
...
#define BP_MMDC1_MPODTCTRL_ODT3_INT_RES      16
#define BM_MMDC1_MPODTCTRL_ODT3_INT_RES      0x00070000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPODTCTRL_ODT3_INT_RES(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPODTCTRL_ODT3_INT_RES)
#else
#define BF_MMDC1_MPODTCTRL_ODT3_INT_RES(v)   (((v) << 16) & BM_MMDC1_MPODTCTRL_ODT3_INT_RES)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ODT3_INT_RES field to a new value.
#define BW_MMDC1_MPODTCTRL_ODT3_INT_RES(v)   BF_CS1(MMDC1_MPODTCTRL, ODT3_INT_RES, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPRDDQBY0DL - MMDC PHY Read DQ Byte0 Delay Register (RW)
 *
...
} hw_mmdc1_mprddqby0dl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPRDDQBY0DL register
 */
#define HW_MMDC1_MPRDDQBY0DL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x81c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPRDDQBY0DL(x)           (*(volatile hw_mmdc1_mprddqby0dl_t *) HW_MMDC1_MPRDDQBY0DL_ADDR(x))
#define HW_MMDC1_MPRDDQBY0DL_RD(x)        (HW_MMDC1_MPRDDQBY0DL(x).U)
#define HW_MMDC1_MPRDDQBY0DL_WR(x, v)     (HW_MMDC1_MPRDDQBY0DL(x).U = (v))
#define HW_MMDC1_MPRDDQBY0DL_SET(x, v)    (HW_MMDC1_MPRDDQBY0DL_WR(x, HW_MMDC1_MPRDDQBY0DL_RD(x) |  (v)))
#define HW_MMDC1_MPRDDQBY0DL_CLR(x, v)    (HW_MMDC1_MPRDDQBY0DL_WR(x, HW_MMDC1_MPRDDQBY0DL_RD(x) & ~(v)))
#define HW_MMDC1_MPRDDQBY0DL_TOG(x, v)    (HW_MMDC1_MPRDDQBY0DL_WR(x, HW_MMDC1_MPRDDQBY0DL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPRDDQBY0DL bitfields
 */

/* --- Register HW_MMDC1_MPRDDQBY0DL, field RD_DQ0_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY0DL_RD_DQ0_DEL      0
#define BM_MMDC1_MPRDDQBY0DL_RD_DQ0_DEL      0x00000007

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ0_DEL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPRDDQBY0DL_RD_DQ0_DEL)
#else
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ0_DEL(v)   (((v) << 0) & BM_MMDC1_MPRDDQBY0DL_RD_DQ0_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ0_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY0DL_RD_DQ0_DEL(v)   BF_CS1(MMDC1_MPRDDQBY0DL, RD_DQ0_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY0DL, field RD_DQ1_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY0DL_RD_DQ1_DEL      4
#define BM_MMDC1_MPRDDQBY0DL_RD_DQ1_DEL      0x00000070

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ1_DEL(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPRDDQBY0DL_RD_DQ1_DEL)
#else
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ1_DEL(v)   (((v) << 4) & BM_MMDC1_MPRDDQBY0DL_RD_DQ1_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ1_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY0DL_RD_DQ1_DEL(v)   BF_CS1(MMDC1_MPRDDQBY0DL, RD_DQ1_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY0DL, field RD_DQ2_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY0DL_RD_DQ2_DEL      8
#define BM_MMDC1_MPRDDQBY0DL_RD_DQ2_DEL      0x00000700

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ2_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPRDDQBY0DL_RD_DQ2_DEL)
#else
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ2_DEL(v)   (((v) << 8) & BM_MMDC1_MPRDDQBY0DL_RD_DQ2_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ2_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY0DL_RD_DQ2_DEL(v)   BF_CS1(MMDC1_MPRDDQBY0DL, RD_DQ2_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY0DL, field RD_DQ3_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY0DL_RD_DQ3_DEL      12
#define BM_MMDC1_MPRDDQBY0DL_RD_DQ3_DEL      0x00007000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ3_DEL(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPRDDQBY0DL_RD_DQ3_DEL)
#else
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ3_DEL(v)   (((v) << 12) & BM_MMDC1_MPRDDQBY0DL_RD_DQ3_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ3_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY0DL_RD_DQ3_DEL(v)   BF_CS1(MMDC1_MPRDDQBY0DL, RD_DQ3_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY0DL, field RD_DQ4_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY0DL_RD_DQ4_DEL      16
#define BM_MMDC1_MPRDDQBY0DL_RD_DQ4_DEL      0x00070000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ4_DEL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPRDDQBY0DL_RD_DQ4_DEL)
#else
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ4_DEL(v)   (((v) << 16) & BM_MMDC1_MPRDDQBY0DL_RD_DQ4_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ4_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY0DL_RD_DQ4_DEL(v)   BF_CS1(MMDC1_MPRDDQBY0DL, RD_DQ4_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY0DL, field RD_DQ5_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY0DL_RD_DQ5_DEL      20
#define BM_MMDC1_MPRDDQBY0DL_RD_DQ5_DEL      0x00700000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ5_DEL(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MPRDDQBY0DL_RD_DQ5_DEL)
#else
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ5_DEL(v)   (((v) << 20) & BM_MMDC1_MPRDDQBY0DL_RD_DQ5_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ5_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY0DL_RD_DQ5_DEL(v)   BF_CS1(MMDC1_MPRDDQBY0DL, RD_DQ5_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY0DL, field RD_DQ6_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY0DL_RD_DQ6_DEL      24
#define BM_MMDC1_MPRDDQBY0DL_RD_DQ6_DEL      0x07000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ6_DEL(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPRDDQBY0DL_RD_DQ6_DEL)
#else
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ6_DEL(v)   (((v) << 24) & BM_MMDC1_MPRDDQBY0DL_RD_DQ6_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ6_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY0DL_RD_DQ6_DEL(v)   BF_CS1(MMDC1_MPRDDQBY0DL, RD_DQ6_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY0DL, field RD_DQ7_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY0DL_RD_DQ7_DEL      28
#define BM_MMDC1_MPRDDQBY0DL_RD_DQ7_DEL      0x70000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ7_DEL(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MPRDDQBY0DL_RD_DQ7_DEL)
#else
#define BF_MMDC1_MPRDDQBY0DL_RD_DQ7_DEL(v)   (((v) << 28) & BM_MMDC1_MPRDDQBY0DL_RD_DQ7_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ7_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY0DL_RD_DQ7_DEL(v)   BF_CS1(MMDC1_MPRDDQBY0DL, RD_DQ7_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPRDDQBY1DL - MMDC PHY Read DQ Byte1 Delay Register (RW)
 *
...
} hw_mmdc1_mprddqby1dl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPRDDQBY1DL register
 */
#define HW_MMDC1_MPRDDQBY1DL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x820)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPRDDQBY1DL(x)           (*(volatile hw_mmdc1_mprddqby1dl_t *) HW_MMDC1_MPRDDQBY1DL_ADDR(x))
#define HW_MMDC1_MPRDDQBY1DL_RD(x)        (HW_MMDC1_MPRDDQBY1DL(x).U)
#define HW_MMDC1_MPRDDQBY1DL_WR(x, v)     (HW_MMDC1_MPRDDQBY1DL(x).U = (v))
#define HW_MMDC1_MPRDDQBY1DL_SET(x, v)    (HW_MMDC1_MPRDDQBY1DL_WR(x, HW_MMDC1_MPRDDQBY1DL_RD(x) |  (v)))
#define HW_MMDC1_MPRDDQBY1DL_CLR(x, v)    (HW_MMDC1_MPRDDQBY1DL_WR(x, HW_MMDC1_MPRDDQBY1DL_RD(x) & ~(v)))
#define HW_MMDC1_MPRDDQBY1DL_TOG(x, v)    (HW_MMDC1_MPRDDQBY1DL_WR(x, HW_MMDC1_MPRDDQBY1DL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPRDDQBY1DL bitfields
 */

/* --- Register HW_MMDC1_MPRDDQBY1DL, field RD_DQ8_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY1DL_RD_DQ8_DEL      0
#define BM_MMDC1_MPRDDQBY1DL_RD_DQ8_DEL      0x00000007

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ8_DEL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPRDDQBY1DL_RD_DQ8_DEL)
#else
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ8_DEL(v)   (((v) << 0) & BM_MMDC1_MPRDDQBY1DL_RD_DQ8_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ8_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY1DL_RD_DQ8_DEL(v)   BF_CS1(MMDC1_MPRDDQBY1DL, RD_DQ8_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY1DL, field RD_DQ9_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY1DL_RD_DQ9_DEL      4
#define BM_MMDC1_MPRDDQBY1DL_RD_DQ9_DEL      0x00000070

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ9_DEL(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPRDDQBY1DL_RD_DQ9_DEL)
#else
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ9_DEL(v)   (((v) << 4) & BM_MMDC1_MPRDDQBY1DL_RD_DQ9_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ9_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY1DL_RD_DQ9_DEL(v)   BF_CS1(MMDC1_MPRDDQBY1DL, RD_DQ9_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY1DL, field RD_DQ10_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY1DL_RD_DQ10_DEL      8
#define BM_MMDC1_MPRDDQBY1DL_RD_DQ10_DEL      0x00000700

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ10_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPRDDQBY1DL_RD_DQ10_DEL)
#else
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ10_DEL(v)   (((v) << 8) & BM_MMDC1_MPRDDQBY1DL_RD_DQ10_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ10_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY1DL_RD_DQ10_DEL(v)   BF_CS1(MMDC1_MPRDDQBY1DL, RD_DQ10_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY1DL, field RD_DQ11_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY1DL_RD_DQ11_DEL      12
#define BM_MMDC1_MPRDDQBY1DL_RD_DQ11_DEL      0x00007000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ11_DEL(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPRDDQBY1DL_RD_DQ11_DEL)
#else
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ11_DEL(v)   (((v) << 12) & BM_MMDC1_MPRDDQBY1DL_RD_DQ11_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ11_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY1DL_RD_DQ11_DEL(v)   BF_CS1(MMDC1_MPRDDQBY1DL, RD_DQ11_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY1DL, field RD_DQ12_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY1DL_RD_DQ12_DEL      16
#define BM_MMDC1_MPRDDQBY1DL_RD_DQ12_DEL      0x00070000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ12_DEL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPRDDQBY1DL_RD_DQ12_DEL)
#else
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ12_DEL(v)   (((v) << 16) & BM_MMDC1_MPRDDQBY1DL_RD_DQ12_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ12_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY1DL_RD_DQ12_DEL(v)   BF_CS1(MMDC1_MPRDDQBY1DL, RD_DQ12_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY1DL, field RD_DQ13_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY1DL_RD_DQ13_DEL      20
#define BM_MMDC1_MPRDDQBY1DL_RD_DQ13_DEL      0x00700000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ13_DEL(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MPRDDQBY1DL_RD_DQ13_DEL)
#else
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ13_DEL(v)   (((v) << 20) & BM_MMDC1_MPRDDQBY1DL_RD_DQ13_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ13_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY1DL_RD_DQ13_DEL(v)   BF_CS1(MMDC1_MPRDDQBY1DL, RD_DQ13_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY1DL, field RD_DQ14_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY1DL_RD_DQ14_DEL      24
#define BM_MMDC1_MPRDDQBY1DL_RD_DQ14_DEL      0x07000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ14_DEL(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPRDDQBY1DL_RD_DQ14_DEL)
#else
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ14_DEL(v)   (((v) << 24) & BM_MMDC1_MPRDDQBY1DL_RD_DQ14_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ14_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY1DL_RD_DQ14_DEL(v)   BF_CS1(MMDC1_MPRDDQBY1DL, RD_DQ14_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY1DL, field RD_DQ15_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY1DL_RD_DQ15_DEL      28
#define BM_MMDC1_MPRDDQBY1DL_RD_DQ15_DEL      0x70000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ15_DEL(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MPRDDQBY1DL_RD_DQ15_DEL)
#else
#define BF_MMDC1_MPRDDQBY1DL_RD_DQ15_DEL(v)   (((v) << 28) & BM_MMDC1_MPRDDQBY1DL_RD_DQ15_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ15_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY1DL_RD_DQ15_DEL(v)   BF_CS1(MMDC1_MPRDDQBY1DL, RD_DQ15_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPRDDQBY2DL - MMDC PHY Read DQ Byte2 Delay Register (RW)
 *
...
} hw_mmdc1_mprddqby2dl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPRDDQBY2DL register
 */
#define HW_MMDC1_MPRDDQBY2DL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x824)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPRDDQBY2DL(x)           (*(volatile hw_mmdc1_mprddqby2dl_t *) HW_MMDC1_MPRDDQBY2DL_ADDR(x))
#define HW_MMDC1_MPRDDQBY2DL_RD(x)        (HW_MMDC1_MPRDDQBY2DL(x).U)
#define HW_MMDC1_MPRDDQBY2DL_WR(x, v)     (HW_MMDC1_MPRDDQBY2DL(x).U = (v))
#define HW_MMDC1_MPRDDQBY2DL_SET(x, v)    (HW_MMDC1_MPRDDQBY2DL_WR(x, HW_MMDC1_MPRDDQBY2DL_RD(x) |  (v)))
#define HW_MMDC1_MPRDDQBY2DL_CLR(x, v)    (HW_MMDC1_MPRDDQBY2DL_WR(x, HW_MMDC1_MPRDDQBY2DL_RD(x) & ~(v)))
#define HW_MMDC1_MPRDDQBY2DL_TOG(x, v)    (HW_MMDC1_MPRDDQBY2DL_WR(x, HW_MMDC1_MPRDDQBY2DL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPRDDQBY2DL bitfields
 */

/* --- Register HW_MMDC1_MPRDDQBY2DL, field RD_DQ16_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY2DL_RD_DQ16_DEL      0
#define BM_MMDC1_MPRDDQBY2DL_RD_DQ16_DEL      0x00000007

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ16_DEL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPRDDQBY2DL_RD_DQ16_DEL)
#else
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ16_DEL(v)   (((v) << 0) & BM_MMDC1_MPRDDQBY2DL_RD_DQ16_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ16_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY2DL_RD_DQ16_DEL(v)   BF_CS1(MMDC1_MPRDDQBY2DL, RD_DQ16_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY2DL, field RD_DQ17_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY2DL_RD_DQ17_DEL      4
#define BM_MMDC1_MPRDDQBY2DL_RD_DQ17_DEL      0x00000070

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ17_DEL(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPRDDQBY2DL_RD_DQ17_DEL)
#else
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ17_DEL(v)   (((v) << 4) & BM_MMDC1_MPRDDQBY2DL_RD_DQ17_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ17_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY2DL_RD_DQ17_DEL(v)   BF_CS1(MMDC1_MPRDDQBY2DL, RD_DQ17_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY2DL, field RD_DQ18_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY2DL_RD_DQ18_DEL      8
#define BM_MMDC1_MPRDDQBY2DL_RD_DQ18_DEL      0x00000700

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ18_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPRDDQBY2DL_RD_DQ18_DEL)
#else
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ18_DEL(v)   (((v) << 8) & BM_MMDC1_MPRDDQBY2DL_RD_DQ18_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ18_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY2DL_RD_DQ18_DEL(v)   BF_CS1(MMDC1_MPRDDQBY2DL, RD_DQ18_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY2DL, field RD_DQ19_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY2DL_RD_DQ19_DEL      12
#define BM_MMDC1_MPRDDQBY2DL_RD_DQ19_DEL      0x00007000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ19_DEL(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPRDDQBY2DL_RD_DQ19_DEL)
#else
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ19_DEL(v)   (((v) << 12) & BM_MMDC1_MPRDDQBY2DL_RD_DQ19_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ19_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY2DL_RD_DQ19_DEL(v)   BF_CS1(MMDC1_MPRDDQBY2DL, RD_DQ19_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY2DL, field RD_DQ20_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY2DL_RD_DQ20_DEL      16
#define BM_MMDC1_MPRDDQBY2DL_RD_DQ20_DEL      0x00070000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ20_DEL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPRDDQBY2DL_RD_DQ20_DEL)
#else
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ20_DEL(v)   (((v) << 16) & BM_MMDC1_MPRDDQBY2DL_RD_DQ20_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ20_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY2DL_RD_DQ20_DEL(v)   BF_CS1(MMDC1_MPRDDQBY2DL, RD_DQ20_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY2DL, field RD_DQ21_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY2DL_RD_DQ21_DEL      20
#define BM_MMDC1_MPRDDQBY2DL_RD_DQ21_DEL      0x00700000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ21_DEL(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MPRDDQBY2DL_RD_DQ21_DEL)
#else
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ21_DEL(v)   (((v) << 20) & BM_MMDC1_MPRDDQBY2DL_RD_DQ21_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ21_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY2DL_RD_DQ21_DEL(v)   BF_CS1(MMDC1_MPRDDQBY2DL, RD_DQ21_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY2DL, field RD_DQ22_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY2DL_RD_DQ22_DEL      24
#define BM_MMDC1_MPRDDQBY2DL_RD_DQ22_DEL      0x07000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ22_DEL(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPRDDQBY2DL_RD_DQ22_DEL)
#else
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ22_DEL(v)   (((v) << 24) & BM_MMDC1_MPRDDQBY2DL_RD_DQ22_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ22_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY2DL_RD_DQ22_DEL(v)   BF_CS1(MMDC1_MPRDDQBY2DL, RD_DQ22_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY2DL, field RD_DQ23_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY2DL_RD_DQ23_DEL      28
#define BM_MMDC1_MPRDDQBY2DL_RD_DQ23_DEL      0x70000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ23_DEL(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MPRDDQBY2DL_RD_DQ23_DEL)
#else
#define BF_MMDC1_MPRDDQBY2DL_RD_DQ23_DEL(v)   (((v) << 28) & BM_MMDC1_MPRDDQBY2DL_RD_DQ23_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ23_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY2DL_RD_DQ23_DEL(v)   BF_CS1(MMDC1_MPRDDQBY2DL, RD_DQ23_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPRDDQBY3DL - MMDC PHY Read DQ Byte3 Delay Register (RW)
 *
...
} hw_mmdc1_mprddqby3dl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPRDDQBY3DL register
 */
#define HW_MMDC1_MPRDDQBY3DL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x828)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPRDDQBY3DL(x)           (*(volatile hw_mmdc1_mprddqby3dl_t *) HW_MMDC1_MPRDDQBY3DL_ADDR(x))
#define HW_MMDC1_MPRDDQBY3DL_RD(x)        (HW_MMDC1_MPRDDQBY3DL(x).U)
#define HW_MMDC1_MPRDDQBY3DL_WR(x, v)     (HW_MMDC1_MPRDDQBY3DL(x).U = (v))
#define HW_MMDC1_MPRDDQBY3DL_SET(x, v)    (HW_MMDC1_MPRDDQBY3DL_WR(x, HW_MMDC1_MPRDDQBY3DL_RD(x) |  (v)))
#define HW_MMDC1_MPRDDQBY3DL_CLR(x, v)    (HW_MMDC1_MPRDDQBY3DL_WR(x, HW_MMDC1_MPRDDQBY3DL_RD(x) & ~(v)))
#define HW_MMDC1_MPRDDQBY3DL_TOG(x, v)    (HW_MMDC1_MPRDDQBY3DL_WR(x, HW_MMDC1_MPRDDQBY3DL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPRDDQBY3DL bitfields
 */

/* --- Register HW_MMDC1_MPRDDQBY3DL, field RD_DQ24_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY3DL_RD_DQ24_DEL      0
#define BM_MMDC1_MPRDDQBY3DL_RD_DQ24_DEL      0x00000007

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ24_DEL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPRDDQBY3DL_RD_DQ24_DEL)
#else
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ24_DEL(v)   (((v) << 0) & BM_MMDC1_MPRDDQBY3DL_RD_DQ24_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ24_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY3DL_RD_DQ24_DEL(v)   BF_CS1(MMDC1_MPRDDQBY3DL, RD_DQ24_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY3DL, field RD_DQ25_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY3DL_RD_DQ25_DEL      4
#define BM_MMDC1_MPRDDQBY3DL_RD_DQ25_DEL      0x00000070

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ25_DEL(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPRDDQBY3DL_RD_DQ25_DEL)
#else
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ25_DEL(v)   (((v) << 4) & BM_MMDC1_MPRDDQBY3DL_RD_DQ25_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ25_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY3DL_RD_DQ25_DEL(v)   BF_CS1(MMDC1_MPRDDQBY3DL, RD_DQ25_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY3DL, field RD_DQ26_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY3DL_RD_DQ26_DEL      8
#define BM_MMDC1_MPRDDQBY3DL_RD_DQ26_DEL      0x00000700

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ26_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPRDDQBY3DL_RD_DQ26_DEL)
#else
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ26_DEL(v)   (((v) << 8) & BM_MMDC1_MPRDDQBY3DL_RD_DQ26_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ26_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY3DL_RD_DQ26_DEL(v)   BF_CS1(MMDC1_MPRDDQBY3DL, RD_DQ26_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY3DL, field RD_DQ27_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY3DL_RD_DQ27_DEL      12
#define BM_MMDC1_MPRDDQBY3DL_RD_DQ27_DEL      0x00007000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ27_DEL(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPRDDQBY3DL_RD_DQ27_DEL)
#else
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ27_DEL(v)   (((v) << 12) & BM_MMDC1_MPRDDQBY3DL_RD_DQ27_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ27_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY3DL_RD_DQ27_DEL(v)   BF_CS1(MMDC1_MPRDDQBY3DL, RD_DQ27_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY3DL, field RD_DQ28_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY3DL_RD_DQ28_DEL      16
#define BM_MMDC1_MPRDDQBY3DL_RD_DQ28_DEL      0x00070000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ28_DEL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPRDDQBY3DL_RD_DQ28_DEL)
#else
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ28_DEL(v)   (((v) << 16) & BM_MMDC1_MPRDDQBY3DL_RD_DQ28_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ28_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY3DL_RD_DQ28_DEL(v)   BF_CS1(MMDC1_MPRDDQBY3DL, RD_DQ28_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY3DL, field RD_DQ29_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY3DL_RD_DQ29_DEL      20
#define BM_MMDC1_MPRDDQBY3DL_RD_DQ29_DEL      0x00700000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ29_DEL(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MPRDDQBY3DL_RD_DQ29_DEL)
#else
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ29_DEL(v)   (((v) << 20) & BM_MMDC1_MPRDDQBY3DL_RD_DQ29_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ29_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY3DL_RD_DQ29_DEL(v)   BF_CS1(MMDC1_MPRDDQBY3DL, RD_DQ29_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY3DL, field RD_DQ30_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY3DL_RD_DQ30_DEL      24
#define BM_MMDC1_MPRDDQBY3DL_RD_DQ30_DEL      0x07000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ30_DEL(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPRDDQBY3DL_RD_DQ30_DEL)
#else
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ30_DEL(v)   (((v) << 24) & BM_MMDC1_MPRDDQBY3DL_RD_DQ30_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ30_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY3DL_RD_DQ30_DEL(v)   BF_CS1(MMDC1_MPRDDQBY3DL, RD_DQ30_DEL, v)
#endif


/* --- Register HW_MMDC1_MPRDDQBY3DL, field RD_DQ31_DEL (RW)
 *
...
#define BP_MMDC1_MPRDDQBY3DL_RD_DQ31_DEL      28
#define BM_MMDC1_MPRDDQBY3DL_RD_DQ31_DEL      0x70000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ31_DEL(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MPRDDQBY3DL_RD_DQ31_DEL)
#else
#define BF_MMDC1_MPRDDQBY3DL_RD_DQ31_DEL(v)   (((v) << 28) & BM_MMDC1_MPRDDQBY3DL_RD_DQ31_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DQ31_DEL field to a new value.
#define BW_MMDC1_MPRDDQBY3DL_RD_DQ31_DEL(v)   BF_CS1(MMDC1_MPRDDQBY3DL, RD_DQ31_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRDQBY0DL - MMDC PHY Write DQ Byte0 Delay Register (RW)
 *
...
} hw_mmdc1_mpwrdqby0dl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWRDQBY0DL register
 */
#define HW_MMDC1_MPWRDQBY0DL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x82c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRDQBY0DL(x)           (*(volatile hw_mmdc1_mpwrdqby0dl_t *) HW_MMDC1_MPWRDQBY0DL_ADDR(x))
#define HW_MMDC1_MPWRDQBY0DL_RD(x)        (HW_MMDC1_MPWRDQBY0DL(x).U)
#define HW_MMDC1_MPWRDQBY0DL_WR(x, v)     (HW_MMDC1_MPWRDQBY0DL(x).U = (v))
#define HW_MMDC1_MPWRDQBY0DL_SET(x, v)    (HW_MMDC1_MPWRDQBY0DL_WR(x, HW_MMDC1_MPWRDQBY0DL_RD(x) |  (v)))
#define HW_MMDC1_MPWRDQBY0DL_CLR(x, v)    (HW_MMDC1_MPWRDQBY0DL_WR(x, HW_MMDC1_MPWRDQBY0DL_RD(x) & ~(v)))
#define HW_MMDC1_MPWRDQBY0DL_TOG(x, v)    (HW_MMDC1_MPWRDQBY0DL_WR(x, HW_MMDC1_MPWRDQBY0DL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWRDQBY0DL bitfields
 */

/* --- Register HW_MMDC1_MPWRDQBY0DL, field WR_DQ0_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY0DL_WR_DQ0_DEL      0
#define BM_MMDC1_MPWRDQBY0DL_WR_DQ0_DEL      0x00000003

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ0_DEL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPWRDQBY0DL_WR_DQ0_DEL)
#else
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ0_DEL(v)   (((v) << 0) & BM_MMDC1_MPWRDQBY0DL_WR_DQ0_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ0_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY0DL_WR_DQ0_DEL(v)   BF_CS1(MMDC1_MPWRDQBY0DL, WR_DQ0_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY0DL, field WR_DQ1_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY0DL_WR_DQ1_DEL      4
#define BM_MMDC1_MPWRDQBY0DL_WR_DQ1_DEL      0x00000030

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ1_DEL(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPWRDQBY0DL_WR_DQ1_DEL)
#else
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ1_DEL(v)   (((v) << 4) & BM_MMDC1_MPWRDQBY0DL_WR_DQ1_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ1_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY0DL_WR_DQ1_DEL(v)   BF_CS1(MMDC1_MPWRDQBY0DL, WR_DQ1_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY0DL, field WR_DQ2_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY0DL_WR_DQ2_DEL      8
#define BM_MMDC1_MPWRDQBY0DL_WR_DQ2_DEL      0x00000300

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ2_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPWRDQBY0DL_WR_DQ2_DEL)
#else
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ2_DEL(v)   (((v) << 8) & BM_MMDC1_MPWRDQBY0DL_WR_DQ2_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ2_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY0DL_WR_DQ2_DEL(v)   BF_CS1(MMDC1_MPWRDQBY0DL, WR_DQ2_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY0DL, field WR_DQ3_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY0DL_WR_DQ3_DEL      12
#define BM_MMDC1_MPWRDQBY0DL_WR_DQ3_DEL      0x00003000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ3_DEL(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPWRDQBY0DL_WR_DQ3_DEL)
#else
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ3_DEL(v)   (((v) << 12) & BM_MMDC1_MPWRDQBY0DL_WR_DQ3_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ3_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY0DL_WR_DQ3_DEL(v)   BF_CS1(MMDC1_MPWRDQBY0DL, WR_DQ3_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY0DL, field WR_DQ4_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY0DL_WR_DQ4_DEL      16
#define BM_MMDC1_MPWRDQBY0DL_WR_DQ4_DEL      0x00030000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ4_DEL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPWRDQBY0DL_WR_DQ4_DEL)
#else
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ4_DEL(v)   (((v) << 16) & BM_MMDC1_MPWRDQBY0DL_WR_DQ4_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ4_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY0DL_WR_DQ4_DEL(v)   BF_CS1(MMDC1_MPWRDQBY0DL, WR_DQ4_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY0DL, field WR_DQ5_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY0DL_WR_DQ5_DEL      20
#define BM_MMDC1_MPWRDQBY0DL_WR_DQ5_DEL      0x00300000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ5_DEL(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MPWRDQBY0DL_WR_DQ5_DEL)
#else
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ5_DEL(v)   (((v) << 20) & BM_MMDC1_MPWRDQBY0DL_WR_DQ5_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ5_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY0DL_WR_DQ5_DEL(v)   BF_CS1(MMDC1_MPWRDQBY0DL, WR_DQ5_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY0DL, field WR_DQ6_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY0DL_WR_DQ6_DEL      24
#define BM_MMDC1_MPWRDQBY0DL_WR_DQ6_DEL      0x03000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ6_DEL(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPWRDQBY0DL_WR_DQ6_DEL)
#else
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ6_DEL(v)   (((v) << 24) & BM_MMDC1_MPWRDQBY0DL_WR_DQ6_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ6_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY0DL_WR_DQ6_DEL(v)   BF_CS1(MMDC1_MPWRDQBY0DL, WR_DQ6_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY0DL, field WR_DQ7_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY0DL_WR_DQ7_DEL      28
#define BM_MMDC1_MPWRDQBY0DL_WR_DQ7_DEL      0x30000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ7_DEL(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MPWRDQBY0DL_WR_DQ7_DEL)
#else
#define BF_MMDC1_MPWRDQBY0DL_WR_DQ7_DEL(v)   (((v) << 28) & BM_MMDC1_MPWRDQBY0DL_WR_DQ7_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ7_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY0DL_WR_DQ7_DEL(v)   BF_CS1(MMDC1_MPWRDQBY0DL, WR_DQ7_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY0DL, field WR_DM0_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY0DL_WR_DM0_DEL      30
#define BM_MMDC1_MPWRDQBY0DL_WR_DM0_DEL      0xc0000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY0DL_WR_DM0_DEL(v)   ((((reg32_t) v) << 30) & BM_MMDC1_MPWRDQBY0DL_WR_DM0_DEL)
#else
#define BF_MMDC1_MPWRDQBY0DL_WR_DM0_DEL(v)   (((v) << 30) & BM_MMDC1_MPWRDQBY0DL_WR_DM0_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DM0_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY0DL_WR_DM0_DEL(v)   BF_CS1(MMDC1_MPWRDQBY0DL, WR_DM0_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRDQBY1DL - MMDC PHY Write DQ Byte1 Delay Register (RW)
 *
...
} hw_mmdc1_mpwrdqby1dl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWRDQBY1DL register
 */
#define HW_MMDC1_MPWRDQBY1DL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x830)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRDQBY1DL(x)           (*(volatile hw_mmdc1_mpwrdqby1dl_t *) HW_MMDC1_MPWRDQBY1DL_ADDR(x))
#define HW_MMDC1_MPWRDQBY1DL_RD(x)        (HW_MMDC1_MPWRDQBY1DL(x).U)
#define HW_MMDC1_MPWRDQBY1DL_WR(x, v)     (HW_MMDC1_MPWRDQBY1DL(x).U = (v))
#define HW_MMDC1_MPWRDQBY1DL_SET(x, v)    (HW_MMDC1_MPWRDQBY1DL_WR(x, HW_MMDC1_MPWRDQBY1DL_RD(x) |  (v)))
#define HW_MMDC1_MPWRDQBY1DL_CLR(x, v)    (HW_MMDC1_MPWRDQBY1DL_WR(x, HW_MMDC1_MPWRDQBY1DL_RD(x) & ~(v)))
#define HW_MMDC1_MPWRDQBY1DL_TOG(x, v)    (HW_MMDC1_MPWRDQBY1DL_WR(x, HW_MMDC1_MPWRDQBY1DL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWRDQBY1DL bitfields
 */

/* --- Register HW_MMDC1_MPWRDQBY1DL, field WR_DQ8_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY1DL_WR_DQ8_DEL      0
#define BM_MMDC1_MPWRDQBY1DL_WR_DQ8_DEL      0x00000003

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ8_DEL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPWRDQBY1DL_WR_DQ8_DEL)
#else
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ8_DEL(v)   (((v) << 0) & BM_MMDC1_MPWRDQBY1DL_WR_DQ8_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ8_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY1DL_WR_DQ8_DEL(v)   BF_CS1(MMDC1_MPWRDQBY1DL, WR_DQ8_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY1DL, field WR_DQ9_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY1DL_WR_DQ9_DEL      4
#define BM_MMDC1_MPWRDQBY1DL_WR_DQ9_DEL      0x00000030

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ9_DEL(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPWRDQBY1DL_WR_DQ9_DEL)
#else
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ9_DEL(v)   (((v) << 4) & BM_MMDC1_MPWRDQBY1DL_WR_DQ9_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ9_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY1DL_WR_DQ9_DEL(v)   BF_CS1(MMDC1_MPWRDQBY1DL, WR_DQ9_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY1DL, field WR_DQ10_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY1DL_WR_DQ10_DEL      8
#define BM_MMDC1_MPWRDQBY1DL_WR_DQ10_DEL      0x00000300

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ10_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPWRDQBY1DL_WR_DQ10_DEL)
#else
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ10_DEL(v)   (((v) << 8) & BM_MMDC1_MPWRDQBY1DL_WR_DQ10_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ10_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY1DL_WR_DQ10_DEL(v)   BF_CS1(MMDC1_MPWRDQBY1DL, WR_DQ10_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY1DL, field WR_DQ11_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY1DL_WR_DQ11_DEL      12
#define BM_MMDC1_MPWRDQBY1DL_WR_DQ11_DEL      0x00003000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ11_DEL(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPWRDQBY1DL_WR_DQ11_DEL)
#else
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ11_DEL(v)   (((v) << 12) & BM_MMDC1_MPWRDQBY1DL_WR_DQ11_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ11_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY1DL_WR_DQ11_DEL(v)   BF_CS1(MMDC1_MPWRDQBY1DL, WR_DQ11_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY1DL, field WR_DQ12_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY1DL_WR_DQ12_DEL      16
#define BM_MMDC1_MPWRDQBY1DL_WR_DQ12_DEL      0x00030000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ12_DEL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPWRDQBY1DL_WR_DQ12_DEL)
#else
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ12_DEL(v)   (((v) << 16) & BM_MMDC1_MPWRDQBY1DL_WR_DQ12_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ12_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY1DL_WR_DQ12_DEL(v)   BF_CS1(MMDC1_MPWRDQBY1DL, WR_DQ12_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY1DL, field WR_DQ13_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY1DL_WR_DQ13_DEL      20
#define BM_MMDC1_MPWRDQBY1DL_WR_DQ13_DEL      0x00300000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ13_DEL(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MPWRDQBY1DL_WR_DQ13_DEL)
#else
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ13_DEL(v)   (((v) << 20) & BM_MMDC1_MPWRDQBY1DL_WR_DQ13_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ13_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY1DL_WR_DQ13_DEL(v)   BF_CS1(MMDC1_MPWRDQBY1DL, WR_DQ13_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY1DL, field WR_DQ14_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY1DL_WR_DQ14_DEL      24
#define BM_MMDC1_MPWRDQBY1DL_WR_DQ14_DEL      0x03000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ14_DEL(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPWRDQBY1DL_WR_DQ14_DEL)
#else
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ14_DEL(v)   (((v) << 24) & BM_MMDC1_MPWRDQBY1DL_WR_DQ14_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ14_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY1DL_WR_DQ14_DEL(v)   BF_CS1(MMDC1_MPWRDQBY1DL, WR_DQ14_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY1DL, field WR_DQ15_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY1DL_WR_DQ15_DEL      28
#define BM_MMDC1_MPWRDQBY1DL_WR_DQ15_DEL      0x30000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ15_DEL(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MPWRDQBY1DL_WR_DQ15_DEL)
#else
#define BF_MMDC1_MPWRDQBY1DL_WR_DQ15_DEL(v)   (((v) << 28) & BM_MMDC1_MPWRDQBY1DL_WR_DQ15_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ15_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY1DL_WR_DQ15_DEL(v)   BF_CS1(MMDC1_MPWRDQBY1DL, WR_DQ15_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY1DL, field WR_DM1_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY1DL_WR_DM1_DEL      30
#define BM_MMDC1_MPWRDQBY1DL_WR_DM1_DEL      0xc0000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY1DL_WR_DM1_DEL(v)   ((((reg32_t) v) << 30) & BM_MMDC1_MPWRDQBY1DL_WR_DM1_DEL)
#else
#define BF_MMDC1_MPWRDQBY1DL_WR_DM1_DEL(v)   (((v) << 30) & BM_MMDC1_MPWRDQBY1DL_WR_DM1_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DM1_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY1DL_WR_DM1_DEL(v)   BF_CS1(MMDC1_MPWRDQBY1DL, WR_DM1_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRDQBY2DL - MMDC PHY Write DQ Byte2 Delay Register (RW)
 *
...
} hw_mmdc1_mpwrdqby2dl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWRDQBY2DL register
 */
#define HW_MMDC1_MPWRDQBY2DL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x834)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRDQBY2DL(x)           (*(volatile hw_mmdc1_mpwrdqby2dl_t *) HW_MMDC1_MPWRDQBY2DL_ADDR(x))
#define HW_MMDC1_MPWRDQBY2DL_RD(x)        (HW_MMDC1_MPWRDQBY2DL(x).U)
#define HW_MMDC1_MPWRDQBY2DL_WR(x, v)     (HW_MMDC1_MPWRDQBY2DL(x).U = (v))
#define HW_MMDC1_MPWRDQBY2DL_SET(x, v)    (HW_MMDC1_MPWRDQBY2DL_WR(x, HW_MMDC1_MPWRDQBY2DL_RD(x) |  (v)))
#define HW_MMDC1_MPWRDQBY2DL_CLR(x, v)    (HW_MMDC1_MPWRDQBY2DL_WR(x, HW_MMDC1_MPWRDQBY2DL_RD(x) & ~(v)))
#define HW_MMDC1_MPWRDQBY2DL_TOG(x, v)    (HW_MMDC1_MPWRDQBY2DL_WR(x, HW_MMDC1_MPWRDQBY2DL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWRDQBY2DL bitfields
 */

/* --- Register HW_MMDC1_MPWRDQBY2DL, field WR_DQ16_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY2DL_WR_DQ16_DEL      0
#define BM_MMDC1_MPWRDQBY2DL_WR_DQ16_DEL      0x00000003

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ16_DEL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPWRDQBY2DL_WR_DQ16_DEL)
#else
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ16_DEL(v)   (((v) << 0) & BM_MMDC1_MPWRDQBY2DL_WR_DQ16_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ16_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY2DL_WR_DQ16_DEL(v)   BF_CS1(MMDC1_MPWRDQBY2DL, WR_DQ16_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY2DL, field WR_DQ17_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY2DL_WR_DQ17_DEL      4
#define BM_MMDC1_MPWRDQBY2DL_WR_DQ17_DEL      0x00000030

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ17_DEL(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPWRDQBY2DL_WR_DQ17_DEL)
#else
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ17_DEL(v)   (((v) << 4) & BM_MMDC1_MPWRDQBY2DL_WR_DQ17_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ17_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY2DL_WR_DQ17_DEL(v)   BF_CS1(MMDC1_MPWRDQBY2DL, WR_DQ17_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY2DL, field WR_DQ18_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY2DL_WR_DQ18_DEL      8
#define BM_MMDC1_MPWRDQBY2DL_WR_DQ18_DEL      0x00000300

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ18_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPWRDQBY2DL_WR_DQ18_DEL)
#else
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ18_DEL(v)   (((v) << 8) & BM_MMDC1_MPWRDQBY2DL_WR_DQ18_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ18_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY2DL_WR_DQ18_DEL(v)   BF_CS1(MMDC1_MPWRDQBY2DL, WR_DQ18_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY2DL, field WR_DQ19_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY2DL_WR_DQ19_DEL      12
#define BM_MMDC1_MPWRDQBY2DL_WR_DQ19_DEL      0x00003000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ19_DEL(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPWRDQBY2DL_WR_DQ19_DEL)
#else
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ19_DEL(v)   (((v) << 12) & BM_MMDC1_MPWRDQBY2DL_WR_DQ19_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ19_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY2DL_WR_DQ19_DEL(v)   BF_CS1(MMDC1_MPWRDQBY2DL, WR_DQ19_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY2DL, field WR_DQ20_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY2DL_WR_DQ20_DEL      16
#define BM_MMDC1_MPWRDQBY2DL_WR_DQ20_DEL      0x00030000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ20_DEL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPWRDQBY2DL_WR_DQ20_DEL)
#else
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ20_DEL(v)   (((v) << 16) & BM_MMDC1_MPWRDQBY2DL_WR_DQ20_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ20_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY2DL_WR_DQ20_DEL(v)   BF_CS1(MMDC1_MPWRDQBY2DL, WR_DQ20_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY2DL, field WR_DQ21_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY2DL_WR_DQ21_DEL      20
#define BM_MMDC1_MPWRDQBY2DL_WR_DQ21_DEL      0x00300000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ21_DEL(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MPWRDQBY2DL_WR_DQ21_DEL)
#else
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ21_DEL(v)   (((v) << 20) & BM_MMDC1_MPWRDQBY2DL_WR_DQ21_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ21_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY2DL_WR_DQ21_DEL(v)   BF_CS1(MMDC1_MPWRDQBY2DL, WR_DQ21_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY2DL, field WR_DQ22_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY2DL_WR_DQ22_DEL      24
#define BM_MMDC1_MPWRDQBY2DL_WR_DQ22_DEL      0x03000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ22_DEL(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPWRDQBY2DL_WR_DQ22_DEL)
#else
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ22_DEL(v)   (((v) << 24) & BM_MMDC1_MPWRDQBY2DL_WR_DQ22_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ22_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY2DL_WR_DQ22_DEL(v)   BF_CS1(MMDC1_MPWRDQBY2DL, WR_DQ22_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY2DL, field WR_DQ23_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY2DL_WR_DQ23_DEL      28
#define BM_MMDC1_MPWRDQBY2DL_WR_DQ23_DEL      0x30000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ23_DEL(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MPWRDQBY2DL_WR_DQ23_DEL)
#else
#define BF_MMDC1_MPWRDQBY2DL_WR_DQ23_DEL(v)   (((v) << 28) & BM_MMDC1_MPWRDQBY2DL_WR_DQ23_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ23_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY2DL_WR_DQ23_DEL(v)   BF_CS1(MMDC1_MPWRDQBY2DL, WR_DQ23_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY2DL, field WR_DM2_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY2DL_WR_DM2_DEL      30
#define BM_MMDC1_MPWRDQBY2DL_WR_DM2_DEL      0xc0000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY2DL_WR_DM2_DEL(v)   ((((reg32_t) v) << 30) & BM_MMDC1_MPWRDQBY2DL_WR_DM2_DEL)
#else
#define BF_MMDC1_MPWRDQBY2DL_WR_DM2_DEL(v)   (((v) << 30) & BM_MMDC1_MPWRDQBY2DL_WR_DM2_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DM2_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY2DL_WR_DM2_DEL(v)   BF_CS1(MMDC1_MPWRDQBY2DL, WR_DM2_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRDQBY3DL - MMDC PHY Write DQ Byte3 Delay Register (RW)
 *
...
} hw_mmdc1_mpwrdqby3dl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWRDQBY3DL register
 */
#define HW_MMDC1_MPWRDQBY3DL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x838)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRDQBY3DL(x)           (*(volatile hw_mmdc1_mpwrdqby3dl_t *) HW_MMDC1_MPWRDQBY3DL_ADDR(x))
#define HW_MMDC1_MPWRDQBY3DL_RD(x)        (HW_MMDC1_MPWRDQBY3DL(x).U)
#define HW_MMDC1_MPWRDQBY3DL_WR(x, v)     (HW_MMDC1_MPWRDQBY3DL(x).U = (v))
#define HW_MMDC1_MPWRDQBY3DL_SET(x, v)    (HW_MMDC1_MPWRDQBY3DL_WR(x, HW_MMDC1_MPWRDQBY3DL_RD(x) |  (v)))
#define HW_MMDC1_MPWRDQBY3DL_CLR(x, v)    (HW_MMDC1_MPWRDQBY3DL_WR(x, HW_MMDC1_MPWRDQBY3DL_RD(x) & ~(v)))
#define HW_MMDC1_MPWRDQBY3DL_TOG(x, v)    (HW_MMDC1_MPWRDQBY3DL_WR(x, HW_MMDC1_MPWRDQBY3DL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWRDQBY3DL bitfields
 */

/* --- Register HW_MMDC1_MPWRDQBY3DL, field WR_DQ24_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY3DL_WR_DQ24_DEL      0
#define BM_MMDC1_MPWRDQBY3DL_WR_DQ24_DEL      0x00000003

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ24_DEL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPWRDQBY3DL_WR_DQ24_DEL)
#else
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ24_DEL(v)   (((v) << 0) & BM_MMDC1_MPWRDQBY3DL_WR_DQ24_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ24_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY3DL_WR_DQ24_DEL(v)   BF_CS1(MMDC1_MPWRDQBY3DL, WR_DQ24_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY3DL, field WR_DQ25_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY3DL_WR_DQ25_DEL      4
#define BM_MMDC1_MPWRDQBY3DL_WR_DQ25_DEL      0x00000030

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ25_DEL(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPWRDQBY3DL_WR_DQ25_DEL)
#else
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ25_DEL(v)   (((v) << 4) & BM_MMDC1_MPWRDQBY3DL_WR_DQ25_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ25_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY3DL_WR_DQ25_DEL(v)   BF_CS1(MMDC1_MPWRDQBY3DL, WR_DQ25_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY3DL, field WR_DQ26_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY3DL_WR_DQ26_DEL      8
#define BM_MMDC1_MPWRDQBY3DL_WR_DQ26_DEL      0x00000300

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ26_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPWRDQBY3DL_WR_DQ26_DEL)
#else
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ26_DEL(v)   (((v) << 8) & BM_MMDC1_MPWRDQBY3DL_WR_DQ26_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ26_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY3DL_WR_DQ26_DEL(v)   BF_CS1(MMDC1_MPWRDQBY3DL, WR_DQ26_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY3DL, field WR_DQ27_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY3DL_WR_DQ27_DEL      12
#define BM_MMDC1_MPWRDQBY3DL_WR_DQ27_DEL      0x00003000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ27_DEL(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPWRDQBY3DL_WR_DQ27_DEL)
#else
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ27_DEL(v)   (((v) << 12) & BM_MMDC1_MPWRDQBY3DL_WR_DQ27_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ27_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY3DL_WR_DQ27_DEL(v)   BF_CS1(MMDC1_MPWRDQBY3DL, WR_DQ27_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY3DL, field WR_DQ28_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY3DL_WR_DQ28_DEL      16
#define BM_MMDC1_MPWRDQBY3DL_WR_DQ28_DEL      0x00030000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ28_DEL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPWRDQBY3DL_WR_DQ28_DEL)
#else
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ28_DEL(v)   (((v) << 16) & BM_MMDC1_MPWRDQBY3DL_WR_DQ28_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ28_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY3DL_WR_DQ28_DEL(v)   BF_CS1(MMDC1_MPWRDQBY3DL, WR_DQ28_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY3DL, field WR_DQ29_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY3DL_WR_DQ29_DEL      20
#define BM_MMDC1_MPWRDQBY3DL_WR_DQ29_DEL      0x00300000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ29_DEL(v)   ((((reg32_t) v) << 20) & BM_MMDC1_MPWRDQBY3DL_WR_DQ29_DEL)
#else
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ29_DEL(v)   (((v) << 20) & BM_MMDC1_MPWRDQBY3DL_WR_DQ29_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ29_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY3DL_WR_DQ29_DEL(v)   BF_CS1(MMDC1_MPWRDQBY3DL, WR_DQ29_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY3DL, field WR_DQ30_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY3DL_WR_DQ30_DEL      24
#define BM_MMDC1_MPWRDQBY3DL_WR_DQ30_DEL      0x03000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ30_DEL(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPWRDQBY3DL_WR_DQ30_DEL)
#else
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ30_DEL(v)   (((v) << 24) & BM_MMDC1_MPWRDQBY3DL_WR_DQ30_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ30_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY3DL_WR_DQ30_DEL(v)   BF_CS1(MMDC1_MPWRDQBY3DL, WR_DQ30_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY3DL, field WR_DQ31_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY3DL_WR_DQ31_DEL      28
#define BM_MMDC1_MPWRDQBY3DL_WR_DQ31_DEL      0x30000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ31_DEL(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MPWRDQBY3DL_WR_DQ31_DEL)
#else
#define BF_MMDC1_MPWRDQBY3DL_WR_DQ31_DEL(v)   (((v) << 28) & BM_MMDC1_MPWRDQBY3DL_WR_DQ31_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DQ31_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY3DL_WR_DQ31_DEL(v)   BF_CS1(MMDC1_MPWRDQBY3DL, WR_DQ31_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRDQBY3DL, field WR_DM3_DEL (RW)
 *
...
#define BP_MMDC1_MPWRDQBY3DL_WR_DM3_DEL      30
#define BM_MMDC1_MPWRDQBY3DL_WR_DM3_DEL      0xc0000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDQBY3DL_WR_DM3_DEL(v)   ((((reg32_t) v) << 30) & BM_MMDC1_MPWRDQBY3DL_WR_DM3_DEL)
#else
#define BF_MMDC1_MPWRDQBY3DL_WR_DM3_DEL(v)   (((v) << 30) & BM_MMDC1_MPWRDQBY3DL_WR_DM3_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DM3_DEL field to a new value.
#define BW_MMDC1_MPWRDQBY3DL_WR_DM3_DEL(v)   BF_CS1(MMDC1_MPWRDQBY3DL, WR_DM3_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPDGCTRL0 - MMDC PHY Read DQS Gating Control Register 0 (RW)
 *
...
} hw_mmdc1_mpdgctrl0_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPDGCTRL0 register
 */
#define HW_MMDC1_MPDGCTRL0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x83c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPDGCTRL0(x)           (*(volatile hw_mmdc1_mpdgctrl0_t *) HW_MMDC1_MPDGCTRL0_ADDR(x))
#define HW_MMDC1_MPDGCTRL0_RD(x)        (HW_MMDC1_MPDGCTRL0(x).U)
#define HW_MMDC1_MPDGCTRL0_WR(x, v)     (HW_MMDC1_MPDGCTRL0(x).U = (v))
#define HW_MMDC1_MPDGCTRL0_SET(x, v)    (HW_MMDC1_MPDGCTRL0_WR(x, HW_MMDC1_MPDGCTRL0_RD(x) |  (v)))
#define HW_MMDC1_MPDGCTRL0_CLR(x, v)    (HW_MMDC1_MPDGCTRL0_WR(x, HW_MMDC1_MPDGCTRL0_RD(x) & ~(v)))
#define HW_MMDC1_MPDGCTRL0_TOG(x, v)    (HW_MMDC1_MPDGCTRL0_WR(x, HW_MMDC1_MPDGCTRL0_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPDGCTRL0 bitfields
 */

/* --- Register HW_MMDC1_MPDGCTRL0, field DG_DL_ABS_OFFSET0 (RW)
 *
...
#define BP_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET0      0
#define BM_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET0      0x0000007f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET0(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET0)
#else
#define BF_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET0(v)   (((v) << 0) & BM_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DG_DL_ABS_OFFSET0 field to a new value.
#define BW_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET0(v)   BF_CS1(MMDC1_MPDGCTRL0, DG_DL_ABS_OFFSET0, v)
#endif

/* --- Register HW_MMDC1_MPDGCTRL0, field DG_HC_DEL0 (RW)
 *
...
#define BP_MMDC1_MPDGCTRL0_DG_HC_DEL0      8
#define BM_MMDC1_MPDGCTRL0_DG_HC_DEL0      0x00000f00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL0_DG_HC_DEL0(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPDGCTRL0_DG_HC_DEL0)
#else
#define BF_MMDC1_MPDGCTRL0_DG_HC_DEL0(v)   (((v) << 8) & BM_MMDC1_MPDGCTRL0_DG_HC_DEL0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DG_HC_DEL0 field to a new value.
#define BW_MMDC1_MPDGCTRL0_DG_HC_DEL0(v)   BF_CS1(MMDC1_MPDGCTRL0, DG_HC_DEL0, v)
#endif


/* --- Register HW_MMDC1_MPDGCTRL0, field HW_DG_ERR (RO)
 *
...
#define BP_MMDC1_MPDGCTRL0_HW_DG_ERR      12
#define BM_MMDC1_MPDGCTRL0_HW_DG_ERR      0x00001000


/* --- Register HW_MMDC1_MPDGCTRL0, field DG_DL_ABS_OFFSET1 (RW)
 *
...
#define BP_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET1      16
#define BM_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET1      0x007f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET1(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET1)
#else
#define BF_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET1(v)   (((v) << 16) & BM_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DG_DL_ABS_OFFSET1 field to a new value.
#define BW_MMDC1_MPDGCTRL0_DG_DL_ABS_OFFSET1(v)   BF_CS1(MMDC1_MPDGCTRL0, DG_DL_ABS_OFFSET1, v)
#endif

/* --- Register HW_MMDC1_MPDGCTRL0, field DG_EXT_UP (RW)
 *
...
#define BP_MMDC1_MPDGCTRL0_DG_EXT_UP      23
#define BM_MMDC1_MPDGCTRL0_DG_EXT_UP      0x00800000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL0_DG_EXT_UP(v)   ((((reg32_t) v) << 23) & BM_MMDC1_MPDGCTRL0_DG_EXT_UP)
#else
#define BF_MMDC1_MPDGCTRL0_DG_EXT_UP(v)   (((v) << 23) & BM_MMDC1_MPDGCTRL0_DG_EXT_UP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DG_EXT_UP field to a new value.
#define BW_MMDC1_MPDGCTRL0_DG_EXT_UP(v)   BF_CS1(MMDC1_MPDGCTRL0, DG_EXT_UP, v)
#endif

/* --- Register HW_MMDC1_MPDGCTRL0, field DG_HC_DEL1 (RW)
 *
...
#define BP_MMDC1_MPDGCTRL0_DG_HC_DEL1      24
#define BM_MMDC1_MPDGCTRL0_DG_HC_DEL1      0x0f000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL0_DG_HC_DEL1(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPDGCTRL0_DG_HC_DEL1)
#else
#define BF_MMDC1_MPDGCTRL0_DG_HC_DEL1(v)   (((v) << 24) & BM_MMDC1_MPDGCTRL0_DG_HC_DEL1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DG_HC_DEL1 field to a new value.
#define BW_MMDC1_MPDGCTRL0_DG_HC_DEL1(v)   BF_CS1(MMDC1_MPDGCTRL0, DG_HC_DEL1, v)
#endif


/* --- Register HW_MMDC1_MPDGCTRL0, field HW_DG_EN (RW)
 *
...
#define BP_MMDC1_MPDGCTRL0_HW_DG_EN      28
#define BM_MMDC1_MPDGCTRL0_HW_DG_EN      0x10000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL0_HW_DG_EN(v)   ((((reg32_t) v) << 28) & BM_MMDC1_MPDGCTRL0_HW_DG_EN)
#else
#define BF_MMDC1_MPDGCTRL0_HW_DG_EN(v)   (((v) << 28) & BM_MMDC1_MPDGCTRL0_HW_DG_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the HW_DG_EN field to a new value.
#define BW_MMDC1_MPDGCTRL0_HW_DG_EN(v)   BF_CS1(MMDC1_MPDGCTRL0, HW_DG_EN, v)
#endif


/* --- Register HW_MMDC1_MPDGCTRL0, field DG_DIS (RO)
 *
...
#define BP_MMDC1_MPDGCTRL0_DG_DIS      29
#define BM_MMDC1_MPDGCTRL0_DG_DIS      0x20000000


/* --- Register HW_MMDC1_MPDGCTRL0, field DG_CMP_CYC (RO)
 *
...
#define BP_MMDC1_MPDGCTRL0_DG_CMP_CYC      30
#define BM_MMDC1_MPDGCTRL0_DG_CMP_CYC      0x40000000


/* --- Register HW_MMDC1_MPDGCTRL0, field RST_RD_FIFO (RW)
 *
...
#define BP_MMDC1_MPDGCTRL0_RST_RD_FIFO      31
#define BM_MMDC1_MPDGCTRL0_RST_RD_FIFO      0x80000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL0_RST_RD_FIFO(v)   ((((reg32_t) v) << 31) & BM_MMDC1_MPDGCTRL0_RST_RD_FIFO)
#else
#define BF_MMDC1_MPDGCTRL0_RST_RD_FIFO(v)   (((v) << 31) & BM_MMDC1_MPDGCTRL0_RST_RD_FIFO)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RST_RD_FIFO field to a new value.
#define BW_MMDC1_MPDGCTRL0_RST_RD_FIFO(v)   BF_CS1(MMDC1_MPDGCTRL0, RST_RD_FIFO, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPDGCTRL1 - MMDC PHY Read DQS Gating Control Register 1 (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: DDR3_x16, DDR3_x32, DDR3_x64  For Channel 1:
 * DDR3_x64
 */
...
} hw_mmdc1_mpdgctrl1_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPDGCTRL1 register
 */
#define HW_MMDC1_MPDGCTRL1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x840)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPDGCTRL1(x)           (*(volatile hw_mmdc1_mpdgctrl1_t *) HW_MMDC1_MPDGCTRL1_ADDR(x))
#define HW_MMDC1_MPDGCTRL1_RD(x)        (HW_MMDC1_MPDGCTRL1(x).U)
#define HW_MMDC1_MPDGCTRL1_WR(x, v)     (HW_MMDC1_MPDGCTRL1(x).U = (v))
#define HW_MMDC1_MPDGCTRL1_SET(x, v)    (HW_MMDC1_MPDGCTRL1_WR(x, HW_MMDC1_MPDGCTRL1_RD(x) |  (v)))
#define HW_MMDC1_MPDGCTRL1_CLR(x, v)    (HW_MMDC1_MPDGCTRL1_WR(x, HW_MMDC1_MPDGCTRL1_RD(x) & ~(v)))
#define HW_MMDC1_MPDGCTRL1_TOG(x, v)    (HW_MMDC1_MPDGCTRL1_WR(x, HW_MMDC1_MPDGCTRL1_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPDGCTRL1 bitfields
 */

/* --- Register HW_MMDC1_MPDGCTRL1, field DG_DL_ABS_OFFSET2 (RW)
 *
...
#define BP_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET2      0
#define BM_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET2      0x0000007f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET2(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET2)
#else
#define BF_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET2(v)   (((v) << 0) & BM_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DG_DL_ABS_OFFSET2 field to a new value.
#define BW_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET2(v)   BF_CS1(MMDC1_MPDGCTRL1, DG_DL_ABS_OFFSET2, v)
#endif

/* --- Register HW_MMDC1_MPDGCTRL1, field DG_HC_DEL2 (RW)
 *
...
#define BP_MMDC1_MPDGCTRL1_DG_HC_DEL2      8
#define BM_MMDC1_MPDGCTRL1_DG_HC_DEL2      0x00000f00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL1_DG_HC_DEL2(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPDGCTRL1_DG_HC_DEL2)
#else
#define BF_MMDC1_MPDGCTRL1_DG_HC_DEL2(v)   (((v) << 8) & BM_MMDC1_MPDGCTRL1_DG_HC_DEL2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DG_HC_DEL2 field to a new value.
#define BW_MMDC1_MPDGCTRL1_DG_HC_DEL2(v)   BF_CS1(MMDC1_MPDGCTRL1, DG_HC_DEL2, v)
#endif


/* --- Register HW_MMDC1_MPDGCTRL1, field DG_DL_ABS_OFFSET3 (RW)
 *
...
#define BP_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET3      16
#define BM_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET3      0x007f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET3(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET3)
#else
#define BF_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET3(v)   (((v) << 16) & BM_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET3)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DG_DL_ABS_OFFSET3 field to a new value.
#define BW_MMDC1_MPDGCTRL1_DG_DL_ABS_OFFSET3(v)   BF_CS1(MMDC1_MPDGCTRL1, DG_DL_ABS_OFFSET3, v)
#endif

/* --- Register HW_MMDC1_MPDGCTRL1, field DG_HC_DEL3 (RW)
 *
...
#define BP_MMDC1_MPDGCTRL1_DG_HC_DEL3      24
#define BM_MMDC1_MPDGCTRL1_DG_HC_DEL3      0x0f000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPDGCTRL1_DG_HC_DEL3(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPDGCTRL1_DG_HC_DEL3)
#else
#define BF_MMDC1_MPDGCTRL1_DG_HC_DEL3(v)   (((v) << 24) & BM_MMDC1_MPDGCTRL1_DG_HC_DEL3)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the DG_HC_DEL3 field to a new value.
#define BW_MMDC1_MPDGCTRL1_DG_HC_DEL3(v)   BF_CS1(MMDC1_MPDGCTRL1, DG_HC_DEL3, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPDGDLST0 - MMDC PHY Read DQS Gating delay-line Status Register (RO)
 *
...
} hw_mmdc1_mpdgdlst0_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPDGDLST0 register
 */
#define HW_MMDC1_MPDGDLST0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x844)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPDGDLST0(x)           (*(volatile hw_mmdc1_mpdgdlst0_t *) HW_MMDC1_MPDGDLST0_ADDR(x))
#define HW_MMDC1_MPDGDLST0_RD(x)        (HW_MMDC1_MPDGDLST0(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPDGDLST0 bitfields
 */

/* --- Register HW_MMDC1_MPDGDLST0, field DG_DL_UNIT_NUM0 (RO)
 *
 * This field reflects the number of delay units that are actually used by read DQS gating delay-
 * line 0.
 */

#define BP_MMDC1_MPDGDLST0_DG_DL_UNIT_NUM0      0
#define BM_MMDC1_MPDGDLST0_DG_DL_UNIT_NUM0      0x0000007f

/* --- Register HW_MMDC1_MPDGDLST0, field DG_DL_UNIT_NUM1 (RO)
 *
 * This field reflects the number of delay units that are actually used by read DQS gating delay-
 * line 1.
 */

#define BP_MMDC1_MPDGDLST0_DG_DL_UNIT_NUM1      8
#define BM_MMDC1_MPDGDLST0_DG_DL_UNIT_NUM1      0x00007f00

/* --- Register HW_MMDC1_MPDGDLST0, field DG_DL_UNIT_NUM2 (RO)
 *
 * This field reflects the number of delay units that are actually used by read DQS gating delay-
 * line 2.
 */

#define BP_MMDC1_MPDGDLST0_DG_DL_UNIT_NUM2      16
#define BM_MMDC1_MPDGDLST0_DG_DL_UNIT_NUM2      0x007f0000

/* --- Register HW_MMDC1_MPDGDLST0, field DG_DL_UNIT_NUM3 (RO)
 *
 * This field reflects the number of delay units that are actually used by read DQS gating delay-
 * line 3.
 */

#define BP_MMDC1_MPDGDLST0_DG_DL_UNIT_NUM3      24
#define BM_MMDC1_MPDGDLST0_DG_DL_UNIT_NUM3      0x7f000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPRDDLCTL - MMDC PHY Read delay-lines Configuration Register (RW)
 *
...
} hw_mmdc1_mprddlctl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPRDDLCTL register
 */
#define HW_MMDC1_MPRDDLCTL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x848)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPRDDLCTL(x)           (*(volatile hw_mmdc1_mprddlctl_t *) HW_MMDC1_MPRDDLCTL_ADDR(x))
#define HW_MMDC1_MPRDDLCTL_RD(x)        (HW_MMDC1_MPRDDLCTL(x).U)
#define HW_MMDC1_MPRDDLCTL_WR(x, v)     (HW_MMDC1_MPRDDLCTL(x).U = (v))
#define HW_MMDC1_MPRDDLCTL_SET(x, v)    (HW_MMDC1_MPRDDLCTL_WR(x, HW_MMDC1_MPRDDLCTL_RD(x) |  (v)))
#define HW_MMDC1_MPRDDLCTL_CLR(x, v)    (HW_MMDC1_MPRDDLCTL_WR(x, HW_MMDC1_MPRDDLCTL_RD(x) & ~(v)))
#define HW_MMDC1_MPRDDLCTL_TOG(x, v)    (HW_MMDC1_MPRDDLCTL_WR(x, HW_MMDC1_MPRDDLCTL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPRDDLCTL bitfields
 */

/* --- Register HW_MMDC1_MPRDDLCTL, field RD_DL_ABS_OFFSET0 (RW)
 *
...
#define BP_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET0      0
#define BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET0      0x0000007f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET0(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET0)
#else
#define BF_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET0(v)   (((v) << 0) & BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DL_ABS_OFFSET0 field to a new value.
#define BW_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET0(v)   BF_CS1(MMDC1_MPRDDLCTL, RD_DL_ABS_OFFSET0, v)
#endif

/* --- Register HW_MMDC1_MPRDDLCTL, field RD_DL_ABS_OFFSET1 (RW)
 *
...
#define BP_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET1      8
#define BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET1      0x00007f00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET1(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET1)
#else
#define BF_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET1(v)   (((v) << 8) & BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DL_ABS_OFFSET1 field to a new value.
#define BW_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET1(v)   BF_CS1(MMDC1_MPRDDLCTL, RD_DL_ABS_OFFSET1, v)
#endif

/* --- Register HW_MMDC1_MPRDDLCTL, field RD_DL_ABS_OFFSET2 (RW)
 *
...
#define BP_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET2      16
#define BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET2      0x007f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET2(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET2)
#else
#define BF_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET2(v)   (((v) << 16) & BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DL_ABS_OFFSET2 field to a new value.
#define BW_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET2(v)   BF_CS1(MMDC1_MPRDDLCTL, RD_DL_ABS_OFFSET2, v)
#endif

/* --- Register HW_MMDC1_MPRDDLCTL, field RD_DL_ABS_OFFSET3 (RW)
 *
...
#define BP_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET3      24
#define BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET3      0x7f000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET3(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET3)
#else
#define BF_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET3(v)   (((v) << 24) & BM_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET3)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the RD_DL_ABS_OFFSET3 field to a new value.
#define BW_MMDC1_MPRDDLCTL_RD_DL_ABS_OFFSET3(v)   BF_CS1(MMDC1_MPRDDLCTL, RD_DL_ABS_OFFSET3, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPRDDLST - MMDC PHY Read delay-lines Status Register (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MPRDDLST register
 */
#define HW_MMDC1_MPRDDLST_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x84c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPRDDLST(x)           (*(volatile hw_mmdc1_mprddlst_t *) HW_MMDC1_MPRDDLST_ADDR(x))
#define HW_MMDC1_MPRDDLST_RD(x)        (HW_MMDC1_MPRDDLST(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPRDDLST bitfields
 */

/* --- Register HW_MMDC1_MPRDDLST, field RD_DL_UNIT_NUM0 (RO)
 *
 * This field reflects the number of delay units that are actually used by read delay-line 0.
 */

#define BP_MMDC1_MPRDDLST_RD_DL_UNIT_NUM0      0
#define BM_MMDC1_MPRDDLST_RD_DL_UNIT_NUM0      0x0000007f

/* --- Register HW_MMDC1_MPRDDLST, field RD_DL_UNIT_NUM1 (RO)
 *
 * This field reflects the number of delay units that are actually used by read delay-line 1.
 */

#define BP_MMDC1_MPRDDLST_RD_DL_UNIT_NUM1      8
#define BM_MMDC1_MPRDDLST_RD_DL_UNIT_NUM1      0x00007f00

/* --- Register HW_MMDC1_MPRDDLST, field RD_DL_UNIT_NUM2 (RO)
 *
 * This field reflects the number of delay units that are actually used by read delay-line 2.
 */

#define BP_MMDC1_MPRDDLST_RD_DL_UNIT_NUM2      16
#define BM_MMDC1_MPRDDLST_RD_DL_UNIT_NUM2      0x007f0000

/* --- Register HW_MMDC1_MPRDDLST, field RD_DL_UNIT_NUM3 (RO)
 *
 * This field reflects the number of delay units that are actually used by read delay-line 3.
 */

#define BP_MMDC1_MPRDDLST_RD_DL_UNIT_NUM3      24
#define BM_MMDC1_MPRDDLST_RD_DL_UNIT_NUM3      0x7f000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRDLCTL - MMDC PHY Write delay-lines Configuration Register (RW)
 *
...
} hw_mmdc1_mpwrdlctl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWRDLCTL register
 */
#define HW_MMDC1_MPWRDLCTL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x850)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRDLCTL(x)           (*(volatile hw_mmdc1_mpwrdlctl_t *) HW_MMDC1_MPWRDLCTL_ADDR(x))
#define HW_MMDC1_MPWRDLCTL_RD(x)        (HW_MMDC1_MPWRDLCTL(x).U)
#define HW_MMDC1_MPWRDLCTL_WR(x, v)     (HW_MMDC1_MPWRDLCTL(x).U = (v))
#define HW_MMDC1_MPWRDLCTL_SET(x, v)    (HW_MMDC1_MPWRDLCTL_WR(x, HW_MMDC1_MPWRDLCTL_RD(x) |  (v)))
#define HW_MMDC1_MPWRDLCTL_CLR(x, v)    (HW_MMDC1_MPWRDLCTL_WR(x, HW_MMDC1_MPWRDLCTL_RD(x) & ~(v)))
#define HW_MMDC1_MPWRDLCTL_TOG(x, v)    (HW_MMDC1_MPWRDLCTL_WR(x, HW_MMDC1_MPWRDLCTL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWRDLCTL bitfields
 */

/* --- Register HW_MMDC1_MPWRDLCTL, field WR_DL_ABS_OFFSET0 (RW)
 *
...
#define BP_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET0      0
#define BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET0      0x0000007f

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET0(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET0)
#else
#define BF_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET0(v)   (((v) << 0) & BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET0)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DL_ABS_OFFSET0 field to a new value.
#define BW_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET0(v)   BF_CS1(MMDC1_MPWRDLCTL, WR_DL_ABS_OFFSET0, v)
#endif

/* --- Register HW_MMDC1_MPWRDLCTL, field WR_DL_ABS_OFFSET1 (RW)
 *
...
#define BP_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET1      8
#define BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET1      0x00007f00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET1(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET1)
#else
#define BF_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET1(v)   (((v) << 8) & BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DL_ABS_OFFSET1 field to a new value.
#define BW_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET1(v)   BF_CS1(MMDC1_MPWRDLCTL, WR_DL_ABS_OFFSET1, v)
#endif

/* --- Register HW_MMDC1_MPWRDLCTL, field WR_DL_ABS_OFFSET2 (RW)
 *
...
#define BP_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET2      16
#define BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET2      0x007f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET2(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET2)
#else
#define BF_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET2(v)   (((v) << 16) & BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DL_ABS_OFFSET2 field to a new value.
#define BW_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET2(v)   BF_CS1(MMDC1_MPWRDLCTL, WR_DL_ABS_OFFSET2, v)
#endif

/* --- Register HW_MMDC1_MPWRDLCTL, field WR_DL_ABS_OFFSET3 (RW)
 *
...
#define BP_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET3      24
#define BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET3      0x7f000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET3(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET3)
#else
#define BF_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET3(v)   (((v) << 24) & BM_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET3)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_DL_ABS_OFFSET3 field to a new value.
#define BW_MMDC1_MPWRDLCTL_WR_DL_ABS_OFFSET3(v)   BF_CS1(MMDC1_MPWRDLCTL, WR_DL_ABS_OFFSET3, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRDLST - MMDC PHY Write delay-lines Status Register (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MPWRDLST register
 */
#define HW_MMDC1_MPWRDLST_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x854)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRDLST(x)           (*(volatile hw_mmdc1_mpwrdlst_t *) HW_MMDC1_MPWRDLST_ADDR(x))
#define HW_MMDC1_MPWRDLST_RD(x)        (HW_MMDC1_MPWRDLST(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPWRDLST bitfields
 */

/* --- Register HW_MMDC1_MPWRDLST, field WR_DL_UNIT_NUM0 (RO)
 *
 * This field reflects the number of delay units that are actually used by write delay-line 0.
 */

#define BP_MMDC1_MPWRDLST_WR_DL_UNIT_NUM0      0
#define BM_MMDC1_MPWRDLST_WR_DL_UNIT_NUM0      0x0000007f

/* --- Register HW_MMDC1_MPWRDLST, field WR_DL_UNIT_NUM1 (RO)
 *
 * This field reflects the number of delay units that are actually used by write delay-line 1.
 */

#define BP_MMDC1_MPWRDLST_WR_DL_UNIT_NUM1      8
#define BM_MMDC1_MPWRDLST_WR_DL_UNIT_NUM1      0x00007f00

/* --- Register HW_MMDC1_MPWRDLST, field WR_DL_UNIT_NUM2 (RO)
 *
 * This field reflects the number of delay units that are actually used by write delay-line 2.
 */

#define BP_MMDC1_MPWRDLST_WR_DL_UNIT_NUM2      16
#define BM_MMDC1_MPWRDLST_WR_DL_UNIT_NUM2      0x007f0000

/* --- Register HW_MMDC1_MPWRDLST, field WR_DL_UNIT_NUM3 (RO)
 *
 * This field reflects the number of delay units that are actually used by write delay-line 3.
 */

#define BP_MMDC1_MPWRDLST_WR_DL_UNIT_NUM3      24
#define BM_MMDC1_MPWRDLST_WR_DL_UNIT_NUM3      0x7f000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSDCTRL - MMDC PHY CK Control Register (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MPSDCTRL register
 */
#define HW_MMDC1_MPSDCTRL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x858)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSDCTRL(x)           (*(volatile hw_mmdc1_mpsdctrl_t *) HW_MMDC1_MPSDCTRL_ADDR(x))
#define HW_MMDC1_MPSDCTRL_RD(x)        (HW_MMDC1_MPSDCTRL(x).U)
#define HW_MMDC1_MPSDCTRL_WR(x, v)     (HW_MMDC1_MPSDCTRL(x).U = (v))
#define HW_MMDC1_MPSDCTRL_SET(x, v)    (HW_MMDC1_MPSDCTRL_WR(x, HW_MMDC1_MPSDCTRL_RD(x) |  (v)))
#define HW_MMDC1_MPSDCTRL_CLR(x, v)    (HW_MMDC1_MPSDCTRL_WR(x, HW_MMDC1_MPSDCTRL_RD(x) & ~(v)))
#define HW_MMDC1_MPSDCTRL_TOG(x, v)    (HW_MMDC1_MPSDCTRL_WR(x, HW_MMDC1_MPSDCTRL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPSDCTRL bitfields
 */

/* --- Register HW_MMDC1_MPSDCTRL, field SDCLK0_DEL (RW)
 *
...
#define BP_MMDC1_MPSDCTRL_SDCLK0_DEL      8
#define BM_MMDC1_MPSDCTRL_SDCLK0_DEL      0x00000300

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPSDCTRL_SDCLK0_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPSDCTRL_SDCLK0_DEL)
#else
#define BF_MMDC1_MPSDCTRL_SDCLK0_DEL(v)   (((v) << 8) & BM_MMDC1_MPSDCTRL_SDCLK0_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SDCLK0_DEL field to a new value.
#define BW_MMDC1_MPSDCTRL_SDCLK0_DEL(v)   BF_CS1(MMDC1_MPSDCTRL, SDCLK0_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPZQLP2CTL - MMDC ZQ LPDDR2 HW Control Register (RW)
 *
...
} hw_mmdc1_mpzqlp2ctl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPZQLP2CTL register
 */
#define HW_MMDC1_MPZQLP2CTL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x85c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPZQLP2CTL(x)           (*(volatile hw_mmdc1_mpzqlp2ctl_t *) HW_MMDC1_MPZQLP2CTL_ADDR(x))
#define HW_MMDC1_MPZQLP2CTL_RD(x)        (HW_MMDC1_MPZQLP2CTL(x).U)
#define HW_MMDC1_MPZQLP2CTL_WR(x, v)     (HW_MMDC1_MPZQLP2CTL(x).U = (v))
#define HW_MMDC1_MPZQLP2CTL_SET(x, v)    (HW_MMDC1_MPZQLP2CTL_WR(x, HW_MMDC1_MPZQLP2CTL_RD(x) |  (v)))
#define HW_MMDC1_MPZQLP2CTL_CLR(x, v)    (HW_MMDC1_MPZQLP2CTL_WR(x, HW_MMDC1_MPZQLP2CTL_RD(x) & ~(v)))
#define HW_MMDC1_MPZQLP2CTL_TOG(x, v)    (HW_MMDC1_MPZQLP2CTL_WR(x, HW_MMDC1_MPZQLP2CTL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPZQLP2CTL bitfields
 */

/* --- Register HW_MMDC1_MPZQLP2CTL, field ZQ_LP2_HW_ZQINIT (RW)
 *
...
#define BP_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQINIT      0
#define BM_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQINIT      0x000001ff

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQINIT(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQINIT)
#else
#define BF_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQINIT(v)   (((v) << 0) & BM_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQINIT)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_LP2_HW_ZQINIT field to a new value.
#define BW_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQINIT(v)   BF_CS1(MMDC1_MPZQLP2CTL, ZQ_LP2_HW_ZQINIT, v)
#endif


/* --- Register HW_MMDC1_MPZQLP2CTL, field ZQ_LP2_HW_ZQCL (RW)
 *
...
#define BP_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCL      16
#define BM_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCL      0x00ff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCL)
#else
#define BF_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCL(v)   (((v) << 16) & BM_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_LP2_HW_ZQCL field to a new value.
#define BW_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCL(v)   BF_CS1(MMDC1_MPZQLP2CTL, ZQ_LP2_HW_ZQCL, v)
#endif


/* --- Register HW_MMDC1_MPZQLP2CTL, field ZQ_LP2_HW_ZQCS (RW)
 *
...
#define BP_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCS      24
#define BM_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCS      0x7f000000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCS(v)   ((((reg32_t) v) << 24) & BM_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCS)
#else
#define BF_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCS(v)   (((v) << 24) & BM_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCS)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the ZQ_LP2_HW_ZQCS field to a new value.
#define BW_MMDC1_MPZQLP2CTL_ZQ_LP2_HW_ZQCS(v)   BF_CS1(MMDC1_MPZQLP2CTL, ZQ_LP2_HW_ZQCS, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPRDDLHWCTL - MMDC PHY Read Delay HW Calibration Control Register (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mprddlhwctl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPRDDLHWCTL register
 */
#define HW_MMDC1_MPRDDLHWCTL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x860)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPRDDLHWCTL(x)           (*(volatile hw_mmdc1_mprddlhwctl_t *) HW_MMDC1_MPRDDLHWCTL_ADDR(x))
#define HW_MMDC1_MPRDDLHWCTL_RD(x)        (HW_MMDC1_MPRDDLHWCTL(x).U)
#define HW_MMDC1_MPRDDLHWCTL_WR(x, v)     (HW_MMDC1_MPRDDLHWCTL(x).U = (v))
#define HW_MMDC1_MPRDDLHWCTL_SET(x, v)    (HW_MMDC1_MPRDDLHWCTL_WR(x, HW_MMDC1_MPRDDLHWCTL_RD(x) |  (v)))
#define HW_MMDC1_MPRDDLHWCTL_CLR(x, v)    (HW_MMDC1_MPRDDLHWCTL_WR(x, HW_MMDC1_MPRDDLHWCTL_RD(x) & ~(v)))
#define HW_MMDC1_MPRDDLHWCTL_TOG(x, v)    (HW_MMDC1_MPRDDLHWCTL_WR(x, HW_MMDC1_MPRDDLHWCTL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPRDDLHWCTL bitfields
 */

/* --- Register HW_MMDC1_MPRDDLHWCTL, field HW_RD_DL_ERR0 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWCTL_HW_RD_DL_ERR0      0
#define BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_ERR0      0x00000001


/* --- Register HW_MMDC1_MPRDDLHWCTL, field HW_RD_DL_ERR1 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWCTL_HW_RD_DL_ERR1      1
#define BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_ERR1      0x00000002


/* --- Register HW_MMDC1_MPRDDLHWCTL, field HW_RD_DL_ERR2 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWCTL_HW_RD_DL_ERR2      2
#define BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_ERR2      0x00000004


/* --- Register HW_MMDC1_MPRDDLHWCTL, field HW_RD_DL_ERR3 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWCTL_HW_RD_DL_ERR3      3
#define BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_ERR3      0x00000008


/* --- Register HW_MMDC1_MPRDDLHWCTL, field HW_RD_DL_EN (RW)
 *
...
#define BP_MMDC1_MPRDDLHWCTL_HW_RD_DL_EN      4
#define BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_EN      0x00000010

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDLHWCTL_HW_RD_DL_EN(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_EN)
#else
#define BF_MMDC1_MPRDDLHWCTL_HW_RD_DL_EN(v)   (((v) << 4) & BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the HW_RD_DL_EN field to a new value.
#define BW_MMDC1_MPRDDLHWCTL_HW_RD_DL_EN(v)   BF_CS1(MMDC1_MPRDDLHWCTL, HW_RD_DL_EN, v)
#endif

/* --- Register HW_MMDC1_MPRDDLHWCTL, field HW_RD_DL_CMP_CYC (RW)
 *
...
#define BP_MMDC1_MPRDDLHWCTL_HW_RD_DL_CMP_CYC      5
#define BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_CMP_CYC      0x00000020

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPRDDLHWCTL_HW_RD_DL_CMP_CYC(v)   ((((reg32_t) v) << 5) & BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_CMP_CYC)
#else
#define BF_MMDC1_MPRDDLHWCTL_HW_RD_DL_CMP_CYC(v)   (((v) << 5) & BM_MMDC1_MPRDDLHWCTL_HW_RD_DL_CMP_CYC)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the HW_RD_DL_CMP_CYC field to a new value.
#define BW_MMDC1_MPRDDLHWCTL_HW_RD_DL_CMP_CYC(v)   BF_CS1(MMDC1_MPRDDLHWCTL, HW_RD_DL_CMP_CYC, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRDLHWCTL - MMDC PHY Write Delay HW Calibration Control Register (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpwrdlhwctl_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWRDLHWCTL register
 */
#define HW_MMDC1_MPWRDLHWCTL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x864)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRDLHWCTL(x)           (*(volatile hw_mmdc1_mpwrdlhwctl_t *) HW_MMDC1_MPWRDLHWCTL_ADDR(x))
#define HW_MMDC1_MPWRDLHWCTL_RD(x)        (HW_MMDC1_MPWRDLHWCTL(x).U)
#define HW_MMDC1_MPWRDLHWCTL_WR(x, v)     (HW_MMDC1_MPWRDLHWCTL(x).U = (v))
#define HW_MMDC1_MPWRDLHWCTL_SET(x, v)    (HW_MMDC1_MPWRDLHWCTL_WR(x, HW_MMDC1_MPWRDLHWCTL_RD(x) |  (v)))
#define HW_MMDC1_MPWRDLHWCTL_CLR(x, v)    (HW_MMDC1_MPWRDLHWCTL_WR(x, HW_MMDC1_MPWRDLHWCTL_RD(x) & ~(v)))
#define HW_MMDC1_MPWRDLHWCTL_TOG(x, v)    (HW_MMDC1_MPWRDLHWCTL_WR(x, HW_MMDC1_MPWRDLHWCTL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWRDLHWCTL bitfields
 */

/* --- Register HW_MMDC1_MPWRDLHWCTL, field HW_WR_DL_ERR0 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWCTL_HW_WR_DL_ERR0      0
#define BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_ERR0      0x00000001


/* --- Register HW_MMDC1_MPWRDLHWCTL, field HW_WR_DL_ERR1 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWCTL_HW_WR_DL_ERR1      1
#define BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_ERR1      0x00000002


/* --- Register HW_MMDC1_MPWRDLHWCTL, field HW_WR_DL_ERR2 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWCTL_HW_WR_DL_ERR2      2
#define BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_ERR2      0x00000004


/* --- Register HW_MMDC1_MPWRDLHWCTL, field HW_WR_DL_ERR3 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWCTL_HW_WR_DL_ERR3      3
#define BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_ERR3      0x00000008


/* --- Register HW_MMDC1_MPWRDLHWCTL, field HW_WR_DL_EN (RW)
 *
...
#define BP_MMDC1_MPWRDLHWCTL_HW_WR_DL_EN      4
#define BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_EN      0x00000010

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDLHWCTL_HW_WR_DL_EN(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_EN)
#else
#define BF_MMDC1_MPWRDLHWCTL_HW_WR_DL_EN(v)   (((v) << 4) & BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the HW_WR_DL_EN field to a new value.
#define BW_MMDC1_MPWRDLHWCTL_HW_WR_DL_EN(v)   BF_CS1(MMDC1_MPWRDLHWCTL, HW_WR_DL_EN, v)
#endif

/* --- Register HW_MMDC1_MPWRDLHWCTL, field HW_WR_DL_CMP_CYC (RW)
 *
...
#define BP_MMDC1_MPWRDLHWCTL_HW_WR_DL_CMP_CYC      5
#define BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_CMP_CYC      0x00000020

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRDLHWCTL_HW_WR_DL_CMP_CYC(v)   ((((reg32_t) v) << 5) & BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_CMP_CYC)
#else
#define BF_MMDC1_MPWRDLHWCTL_HW_WR_DL_CMP_CYC(v)   (((v) << 5) & BM_MMDC1_MPWRDLHWCTL_HW_WR_DL_CMP_CYC)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the HW_WR_DL_CMP_CYC field to a new value.
#define BW_MMDC1_MPWRDLHWCTL_HW_WR_DL_CMP_CYC(v)   BF_CS1(MMDC1_MPWRDLHWCTL, HW_WR_DL_CMP_CYC, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPRDDLHWST0 - MMDC PHY Read Delay HW Calibration Status Register 0 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mprddlhwst0_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPRDDLHWST0 register
 */
#define HW_MMDC1_MPRDDLHWST0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x868)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPRDDLHWST0(x)           (*(volatile hw_mmdc1_mprddlhwst0_t *) HW_MMDC1_MPRDDLHWST0_ADDR(x))
#define HW_MMDC1_MPRDDLHWST0_RD(x)        (HW_MMDC1_MPRDDLHWST0(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPRDDLHWST0 bitfields
 */

/* --- Register HW_MMDC1_MPRDDLHWST0, field HW_RD_DL_LOW0 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWST0_HW_RD_DL_LOW0      0
#define BM_MMDC1_MPRDDLHWST0_HW_RD_DL_LOW0      0x0000007f

/* --- Register HW_MMDC1_MPRDDLHWST0, field HW_RD_DL_UP0 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWST0_HW_RD_DL_UP0      8
#define BM_MMDC1_MPRDDLHWST0_HW_RD_DL_UP0      0x00007f00

/* --- Register HW_MMDC1_MPRDDLHWST0, field HW_RD_DL_LOW1 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWST0_HW_RD_DL_LOW1      16
#define BM_MMDC1_MPRDDLHWST0_HW_RD_DL_LOW1      0x007f0000

/* --- Register HW_MMDC1_MPRDDLHWST0, field HW_RD_DL_UP1 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWST0_HW_RD_DL_UP1      24
#define BM_MMDC1_MPRDDLHWST0_HW_RD_DL_UP1      0x7f000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPRDDLHWST1 - MMDC PHY Read Delay HW Calibration Status Register 1 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mprddlhwst1_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPRDDLHWST1 register
 */
#define HW_MMDC1_MPRDDLHWST1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x86c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPRDDLHWST1(x)           (*(volatile hw_mmdc1_mprddlhwst1_t *) HW_MMDC1_MPRDDLHWST1_ADDR(x))
#define HW_MMDC1_MPRDDLHWST1_RD(x)        (HW_MMDC1_MPRDDLHWST1(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPRDDLHWST1 bitfields
 */

/* --- Register HW_MMDC1_MPRDDLHWST1, field HW_RD_DL_LOW2 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWST1_HW_RD_DL_LOW2      0
#define BM_MMDC1_MPRDDLHWST1_HW_RD_DL_LOW2      0x0000007f

/* --- Register HW_MMDC1_MPRDDLHWST1, field HW_RD_DL_UP2 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWST1_HW_RD_DL_UP2      8
#define BM_MMDC1_MPRDDLHWST1_HW_RD_DL_UP2      0x00007f00

/* --- Register HW_MMDC1_MPRDDLHWST1, field HW_RD_DL_LOW3 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWST1_HW_RD_DL_LOW3      16
#define BM_MMDC1_MPRDDLHWST1_HW_RD_DL_LOW3      0x007f0000

/* --- Register HW_MMDC1_MPRDDLHWST1, field HW_RD_DL_UP3 (RO)
 *
...
#define BP_MMDC1_MPRDDLHWST1_HW_RD_DL_UP3      24
#define BM_MMDC1_MPRDDLHWST1_HW_RD_DL_UP3      0x7f000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRDLHWST0 - MMDC PHY Write Delay HW Calibration Status Register 0 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpwrdlhwst0_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWRDLHWST0 register
 */
#define HW_MMDC1_MPWRDLHWST0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x870)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRDLHWST0(x)           (*(volatile hw_mmdc1_mpwrdlhwst0_t *) HW_MMDC1_MPWRDLHWST0_ADDR(x))
#define HW_MMDC1_MPWRDLHWST0_RD(x)        (HW_MMDC1_MPWRDLHWST0(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPWRDLHWST0 bitfields
 */

/* --- Register HW_MMDC1_MPWRDLHWST0, field HW_WR_DL_LOW0 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWST0_HW_WR_DL_LOW0      0
#define BM_MMDC1_MPWRDLHWST0_HW_WR_DL_LOW0      0x0000007f

/* --- Register HW_MMDC1_MPWRDLHWST0, field HW_WR_DL_UP0 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWST0_HW_WR_DL_UP0      8
#define BM_MMDC1_MPWRDLHWST0_HW_WR_DL_UP0      0x00007f00

/* --- Register HW_MMDC1_MPWRDLHWST0, field HW_WR_DL_LOW1 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWST0_HW_WR_DL_LOW1      16
#define BM_MMDC1_MPWRDLHWST0_HW_WR_DL_LOW1      0x007f0000

/* --- Register HW_MMDC1_MPWRDLHWST0, field HW_WR_DL_UP1 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWST0_HW_WR_DL_UP1      24
#define BM_MMDC1_MPWRDLHWST0_HW_WR_DL_UP1      0x7f000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRDLHWST1 - MMDC PHY Write Delay HW Calibration Status Register 1 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x32
 */
typedef union
...
} hw_mmdc1_mpwrdlhwst1_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWRDLHWST1 register
 */
#define HW_MMDC1_MPWRDLHWST1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x874)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRDLHWST1(x)           (*(volatile hw_mmdc1_mpwrdlhwst1_t *) HW_MMDC1_MPWRDLHWST1_ADDR(x))
#define HW_MMDC1_MPWRDLHWST1_RD(x)        (HW_MMDC1_MPWRDLHWST1(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPWRDLHWST1 bitfields
 */

/* --- Register HW_MMDC1_MPWRDLHWST1, field HW_WR_DL_LOW2 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWST1_HW_WR_DL_LOW2      0
#define BM_MMDC1_MPWRDLHWST1_HW_WR_DL_LOW2      0x0000007f

/* --- Register HW_MMDC1_MPWRDLHWST1, field HW_WR_DL_UP2 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWST1_HW_WR_DL_UP2      8
#define BM_MMDC1_MPWRDLHWST1_HW_WR_DL_UP2      0x00007f00

/* --- Register HW_MMDC1_MPWRDLHWST1, field HW_WR_DL_LOW3 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWST1_HW_WR_DL_LOW3      16
#define BM_MMDC1_MPWRDLHWST1_HW_WR_DL_LOW3      0x007f0000

/* --- Register HW_MMDC1_MPWRDLHWST1, field HW_WR_DL_UP3 (RO)
 *
...
#define BP_MMDC1_MPWRDLHWST1_HW_WR_DL_UP3      24
#define BM_MMDC1_MPWRDLHWST1_HW_WR_DL_UP3      0x7f000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWLHWERR - MMDC PHY Write Leveling HW Error Register (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpwlhwerr_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPWLHWERR register
 */
#define HW_MMDC1_MPWLHWERR_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x878)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWLHWERR(x)           (*(volatile hw_mmdc1_mpwlhwerr_t *) HW_MMDC1_MPWLHWERR_ADDR(x))
#define HW_MMDC1_MPWLHWERR_RD(x)        (HW_MMDC1_MPWLHWERR(x).U)
#define HW_MMDC1_MPWLHWERR_WR(x, v)     (HW_MMDC1_MPWLHWERR(x).U = (v))
#define HW_MMDC1_MPWLHWERR_SET(x, v)    (HW_MMDC1_MPWLHWERR_WR(x, HW_MMDC1_MPWLHWERR_RD(x) |  (v)))
#define HW_MMDC1_MPWLHWERR_CLR(x, v)    (HW_MMDC1_MPWLHWERR_WR(x, HW_MMDC1_MPWLHWERR_RD(x) & ~(v)))
#define HW_MMDC1_MPWLHWERR_TOG(x, v)    (HW_MMDC1_MPWLHWERR_WR(x, HW_MMDC1_MPWLHWERR_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWLHWERR bitfields
 */

/* --- Register HW_MMDC1_MPWLHWERR, field HW_WL0_DQ (RO)
 *
...
#define BP_MMDC1_MPWLHWERR_HW_WL0_DQ      0
#define BM_MMDC1_MPWLHWERR_HW_WL0_DQ      0x000000ff

/* --- Register HW_MMDC1_MPWLHWERR, field HW_WL1_DQ (RO)
 *
...
#define BP_MMDC1_MPWLHWERR_HW_WL1_DQ      8
#define BM_MMDC1_MPWLHWERR_HW_WL1_DQ      0x0000ff00

/* --- Register HW_MMDC1_MPWLHWERR, field HW_WL2_DQ (RO)
 *
...
#define BP_MMDC1_MPWLHWERR_HW_WL2_DQ      16
#define BM_MMDC1_MPWLHWERR_HW_WL2_DQ      0x00ff0000

/* --- Register HW_MMDC1_MPWLHWERR, field HW_WL3_DQ (RO)
 *
...
#define BP_MMDC1_MPWLHWERR_HW_WL3_DQ      24
#define BM_MMDC1_MPWLHWERR_HW_WL3_DQ      0xff000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPDGHWST0 - MMDC PHY Read DQS Gating HW Status Register 0 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: DDR3_x16, DDR3_x32, DDR3_x64  For Channel 1:
 * DDR3_x64
 */
...
} hw_mmdc1_mpdghwst0_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPDGHWST0 register
 */
#define HW_MMDC1_MPDGHWST0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x87c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPDGHWST0(x)           (*(volatile hw_mmdc1_mpdghwst0_t *) HW_MMDC1_MPDGHWST0_ADDR(x))
#define HW_MMDC1_MPDGHWST0_RD(x)        (HW_MMDC1_MPDGHWST0(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPDGHWST0 bitfields
 */

/* --- Register HW_MMDC1_MPDGHWST0, field HW_DG_LOW0 (RO)
 *
...
#define BP_MMDC1_MPDGHWST0_HW_DG_LOW0      0
#define BM_MMDC1_MPDGHWST0_HW_DG_LOW0      0x000007ff

/* --- Register HW_MMDC1_MPDGHWST0, field HW_DG_UP0 (RO)
 *
...
#define BP_MMDC1_MPDGHWST0_HW_DG_UP0      16
#define BM_MMDC1_MPDGHWST0_HW_DG_UP0      0x07ff0000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPDGHWST1 - MMDC PHY Read DQS Gating HW Status Register 1 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: DDR3_x16, DDR3_x32, DDR3_x64  For Channel 1:
 * DDR3_x64
 */
...
} hw_mmdc1_mpdghwst1_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPDGHWST1 register
 */
#define HW_MMDC1_MPDGHWST1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x880)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPDGHWST1(x)           (*(volatile hw_mmdc1_mpdghwst1_t *) HW_MMDC1_MPDGHWST1_ADDR(x))
#define HW_MMDC1_MPDGHWST1_RD(x)        (HW_MMDC1_MPDGHWST1(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPDGHWST1 bitfields
 */

/* --- Register HW_MMDC1_MPDGHWST1, field HW_DG_LOW1 (RO)
 *
...
#define BP_MMDC1_MPDGHWST1_HW_DG_LOW1      0
#define BM_MMDC1_MPDGHWST1_HW_DG_LOW1      0x000007ff

/* --- Register HW_MMDC1_MPDGHWST1, field HW_DG_UP1 (RO)
 *
...
#define BP_MMDC1_MPDGHWST1_HW_DG_UP1      16
#define BM_MMDC1_MPDGHWST1_HW_DG_UP1      0x07ff0000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPDGHWST2 - MMDC PHY Read DQS Gating HW Status Register 2 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: DDR3_x16, DDR3_x32, DDR3_x64  For Channel 1:
 * DDR3_x64
 */
...
} hw_mmdc1_mpdghwst2_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPDGHWST2 register
 */
#define HW_MMDC1_MPDGHWST2_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x884)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPDGHWST2(x)           (*(volatile hw_mmdc1_mpdghwst2_t *) HW_MMDC1_MPDGHWST2_ADDR(x))
#define HW_MMDC1_MPDGHWST2_RD(x)        (HW_MMDC1_MPDGHWST2(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPDGHWST2 bitfields
 */

/* --- Register HW_MMDC1_MPDGHWST2, field HW_DG_LOW2 (RO)
 *
...
#define BP_MMDC1_MPDGHWST2_HW_DG_LOW2      0
#define BM_MMDC1_MPDGHWST2_HW_DG_LOW2      0x000007ff

/* --- Register HW_MMDC1_MPDGHWST2, field HW_DG_UP2 (RO)
 *
...
#define BP_MMDC1_MPDGHWST2_HW_DG_UP2      16
#define BM_MMDC1_MPDGHWST2_HW_DG_UP2      0x07ff0000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPDGHWST3 - MMDC PHY Read DQS Gating HW Status Register 3 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: DDR3_x16, DDR3_x32, DDR3_x64  For Channel 1:
 * DDR3_x64
 */
...
} hw_mmdc1_mpdghwst3_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPDGHWST3 register
 */
#define HW_MMDC1_MPDGHWST3_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x888)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPDGHWST3(x)           (*(volatile hw_mmdc1_mpdghwst3_t *) HW_MMDC1_MPDGHWST3_ADDR(x))
#define HW_MMDC1_MPDGHWST3_RD(x)        (HW_MMDC1_MPDGHWST3(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPDGHWST3 bitfields
 */

/* --- Register HW_MMDC1_MPDGHWST3, field HW_DG_LOW3 (RO)
 *
...
#define BP_MMDC1_MPDGHWST3_HW_DG_LOW3      0
#define BM_MMDC1_MPDGHWST3_HW_DG_LOW3      0x000007ff

/* --- Register HW_MMDC1_MPDGHWST3, field HW_DG_UP3 (RO)
 *
...
#define BP_MMDC1_MPDGHWST3_HW_DG_UP3      16
#define BM_MMDC1_MPDGHWST3_HW_DG_UP3      0x07ff0000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPPDCMPR1 - MMDC PHY Pre-defined Compare Register 1 (RW)
 *
...
} hw_mmdc1_mppdcmpr1_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPPDCMPR1 register
 */
#define HW_MMDC1_MPPDCMPR1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x88c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPPDCMPR1(x)           (*(volatile hw_mmdc1_mppdcmpr1_t *) HW_MMDC1_MPPDCMPR1_ADDR(x))
#define HW_MMDC1_MPPDCMPR1_RD(x)        (HW_MMDC1_MPPDCMPR1(x).U)
#define HW_MMDC1_MPPDCMPR1_WR(x, v)     (HW_MMDC1_MPPDCMPR1(x).U = (v))
#define HW_MMDC1_MPPDCMPR1_SET(x, v)    (HW_MMDC1_MPPDCMPR1_WR(x, HW_MMDC1_MPPDCMPR1_RD(x) |  (v)))
#define HW_MMDC1_MPPDCMPR1_CLR(x, v)    (HW_MMDC1_MPPDCMPR1_WR(x, HW_MMDC1_MPPDCMPR1_RD(x) & ~(v)))
#define HW_MMDC1_MPPDCMPR1_TOG(x, v)    (HW_MMDC1_MPPDCMPR1_WR(x, HW_MMDC1_MPPDCMPR1_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPPDCMPR1 bitfields
 */

/* --- Register HW_MMDC1_MPPDCMPR1, field PDV1 (RW)
 *
...
#define BP_MMDC1_MPPDCMPR1_PDV1      0
#define BM_MMDC1_MPPDCMPR1_PDV1      0x0000ffff

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPPDCMPR1_PDV1(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPPDCMPR1_PDV1)
#else
#define BF_MMDC1_MPPDCMPR1_PDV1(v)   (((v) << 0) & BM_MMDC1_MPPDCMPR1_PDV1)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PDV1 field to a new value.
#define BW_MMDC1_MPPDCMPR1_PDV1(v)   BF_CS1(MMDC1_MPPDCMPR1, PDV1, v)
#endif

/* --- Register HW_MMDC1_MPPDCMPR1, field PDV2 (RW)
 *
...
#define BP_MMDC1_MPPDCMPR1_PDV2      16
#define BM_MMDC1_MPPDCMPR1_PDV2      0xffff0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPPDCMPR1_PDV2(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPPDCMPR1_PDV2)
#else
#define BF_MMDC1_MPPDCMPR1_PDV2(v)   (((v) << 16) & BM_MMDC1_MPPDCMPR1_PDV2)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PDV2 field to a new value.
#define BW_MMDC1_MPPDCMPR1_PDV2(v)   BF_CS1(MMDC1_MPPDCMPR1, PDV2, v)
#endif

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPPDCMPR2 - MMDC PHY Pre-defined Compare and CA delay-line Configuration Register (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
} hw_mmdc1_mppdcmpr2_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPPDCMPR2 register
 */
#define HW_MMDC1_MPPDCMPR2_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x890)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPPDCMPR2(x)           (*(volatile hw_mmdc1_mppdcmpr2_t *) HW_MMDC1_MPPDCMPR2_ADDR(x))
#define HW_MMDC1_MPPDCMPR2_RD(x)        (HW_MMDC1_MPPDCMPR2(x).U)
#define HW_MMDC1_MPPDCMPR2_WR(x, v)     (HW_MMDC1_MPPDCMPR2(x).U = (v))
#define HW_MMDC1_MPPDCMPR2_SET(x, v)    (HW_MMDC1_MPPDCMPR2_WR(x, HW_MMDC1_MPPDCMPR2_RD(x) |  (v)))
#define HW_MMDC1_MPPDCMPR2_CLR(x, v)    (HW_MMDC1_MPPDCMPR2_WR(x, HW_MMDC1_MPPDCMPR2_RD(x) & ~(v)))
#define HW_MMDC1_MPPDCMPR2_TOG(x, v)    (HW_MMDC1_MPPDCMPR2_WR(x, HW_MMDC1_MPPDCMPR2_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPPDCMPR2 bitfields
 */

/* --- Register HW_MMDC1_MPPDCMPR2, field MPR_CMP (RW)
 *
...
#define BP_MMDC1_MPPDCMPR2_MPR_CMP      0
#define BM_MMDC1_MPPDCMPR2_MPR_CMP      0x00000001

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPPDCMPR2_MPR_CMP(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPPDCMPR2_MPR_CMP)
#else
#define BF_MMDC1_MPPDCMPR2_MPR_CMP(v)   (((v) << 0) & BM_MMDC1_MPPDCMPR2_MPR_CMP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the MPR_CMP field to a new value.
#define BW_MMDC1_MPPDCMPR2_MPR_CMP(v)   BF_CS1(MMDC1_MPPDCMPR2, MPR_CMP, v)
#endif

/* --- Register HW_MMDC1_MPPDCMPR2, field MPR_FULL_CMP (RW)
 *
...
#define BP_MMDC1_MPPDCMPR2_MPR_FULL_CMP      1
#define BM_MMDC1_MPPDCMPR2_MPR_FULL_CMP      0x00000002

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPPDCMPR2_MPR_FULL_CMP(v)   ((((reg32_t) v) << 1) & BM_MMDC1_MPPDCMPR2_MPR_FULL_CMP)
#else
#define BF_MMDC1_MPPDCMPR2_MPR_FULL_CMP(v)   (((v) << 1) & BM_MMDC1_MPPDCMPR2_MPR_FULL_CMP)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the MPR_FULL_CMP field to a new value.
#define BW_MMDC1_MPPDCMPR2_MPR_FULL_CMP(v)   BF_CS1(MMDC1_MPPDCMPR2, MPR_FULL_CMP, v)
#endif

/* --- Register HW_MMDC1_MPPDCMPR2, field READ_LEVEL_PATTERN (RW)
 *
...
#define BP_MMDC1_MPPDCMPR2_READ_LEVEL_PATTERN      2
#define BM_MMDC1_MPPDCMPR2_READ_LEVEL_PATTERN      0x00000004

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPPDCMPR2_READ_LEVEL_PATTERN(v)   ((((reg32_t) v) << 2) & BM_MMDC1_MPPDCMPR2_READ_LEVEL_PATTERN)
#else
#define BF_MMDC1_MPPDCMPR2_READ_LEVEL_PATTERN(v)   (((v) << 2) & BM_MMDC1_MPPDCMPR2_READ_LEVEL_PATTERN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the READ_LEVEL_PATTERN field to a new value.
#define BW_MMDC1_MPPDCMPR2_READ_LEVEL_PATTERN(v)   BF_CS1(MMDC1_MPPDCMPR2, READ_LEVEL_PATTERN, v)
#endif


/* --- Register HW_MMDC1_MPPDCMPR2, field CA_DL_ABS_OFFSET (RW)
 *
...
#define BP_MMDC1_MPPDCMPR2_CA_DL_ABS_OFFSET      16
#define BM_MMDC1_MPPDCMPR2_CA_DL_ABS_OFFSET      0x007f0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPPDCMPR2_CA_DL_ABS_OFFSET(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPPDCMPR2_CA_DL_ABS_OFFSET)
#else
#define BF_MMDC1_MPPDCMPR2_CA_DL_ABS_OFFSET(v)   (((v) << 16) & BM_MMDC1_MPPDCMPR2_CA_DL_ABS_OFFSET)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the CA_DL_ABS_OFFSET field to a new value.
#define BW_MMDC1_MPPDCMPR2_CA_DL_ABS_OFFSET(v)   BF_CS1(MMDC1_MPPDCMPR2, CA_DL_ABS_OFFSET, v)
#endif

/* --- Register HW_MMDC1_MPPDCMPR2, field PHY_CA_DL_UNIT (RO)
 *
 * This field reflects the number of delay units that are actually used by CA (Command/Address of
 * LPDDR2) delay-line
 */

#define BP_MMDC1_MPPDCMPR2_PHY_CA_DL_UNIT      24
#define BM_MMDC1_MPPDCMPR2_PHY_CA_DL_UNIT      0x7f000000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSWDAR0 - MMDC PHY SW Dummy Access Register (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
/*
 * constants & macros for entire multi-block MMDC1_MPSWDAR0 register
 */
#define HW_MMDC1_MPSWDAR0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x894)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSWDAR0(x)           (*(volatile hw_mmdc1_mpswdar0_t *) HW_MMDC1_MPSWDAR0_ADDR(x))
#define HW_MMDC1_MPSWDAR0_RD(x)        (HW_MMDC1_MPSWDAR0(x).U)
#define HW_MMDC1_MPSWDAR0_WR(x, v)     (HW_MMDC1_MPSWDAR0(x).U = (v))
#define HW_MMDC1_MPSWDAR0_SET(x, v)    (HW_MMDC1_MPSWDAR0_WR(x, HW_MMDC1_MPSWDAR0_RD(x) |  (v)))
#define HW_MMDC1_MPSWDAR0_CLR(x, v)    (HW_MMDC1_MPSWDAR0_WR(x, HW_MMDC1_MPSWDAR0_RD(x) & ~(v)))
#define HW_MMDC1_MPSWDAR0_TOG(x, v)    (HW_MMDC1_MPSWDAR0_WR(x, HW_MMDC1_MPSWDAR0_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPSWDAR0 bitfields
 */

/* --- Register HW_MMDC1_MPSWDAR0, field SW_DUMMY_WR (RW)
 *
...
#define BP_MMDC1_MPSWDAR0_SW_DUMMY_WR      0
#define BM_MMDC1_MPSWDAR0_SW_DUMMY_WR      0x00000001

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPSWDAR0_SW_DUMMY_WR(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPSWDAR0_SW_DUMMY_WR)
#else
#define BF_MMDC1_MPSWDAR0_SW_DUMMY_WR(v)   (((v) << 0) & BM_MMDC1_MPSWDAR0_SW_DUMMY_WR)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SW_DUMMY_WR field to a new value.
#define BW_MMDC1_MPSWDAR0_SW_DUMMY_WR(v)   BF_CS1(MMDC1_MPSWDAR0, SW_DUMMY_WR, v)
#endif

/* --- Register HW_MMDC1_MPSWDAR0, field SW_DUMMY_RD (RW)
 *
...
#define BP_MMDC1_MPSWDAR0_SW_DUMMY_RD      1
#define BM_MMDC1_MPSWDAR0_SW_DUMMY_RD      0x00000002

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPSWDAR0_SW_DUMMY_RD(v)   ((((reg32_t) v) << 1) & BM_MMDC1_MPSWDAR0_SW_DUMMY_RD)
#else
#define BF_MMDC1_MPSWDAR0_SW_DUMMY_RD(v)   (((v) << 1) & BM_MMDC1_MPSWDAR0_SW_DUMMY_RD)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the SW_DUMMY_RD field to a new value.
#define BW_MMDC1_MPSWDAR0_SW_DUMMY_RD(v)   BF_CS1(MMDC1_MPSWDAR0, SW_DUMMY_RD, v)
#endif

/* --- Register HW_MMDC1_MPSWDAR0, field SW_DUM_CMP0 (RO)
 *
...
#define BP_MMDC1_MPSWDAR0_SW_DUM_CMP0      2
#define BM_MMDC1_MPSWDAR0_SW_DUM_CMP0      0x00000004


/* --- Register HW_MMDC1_MPSWDAR0, field SW_DUM_CMP1 (RO)
 *
...
#define BP_MMDC1_MPSWDAR0_SW_DUM_CMP1      3
#define BM_MMDC1_MPSWDAR0_SW_DUM_CMP1      0x00000008


/* --- Register HW_MMDC1_MPSWDAR0, field SW_DUM_CMP2 (RO)
 *
...
#define BP_MMDC1_MPSWDAR0_SW_DUM_CMP2      4
#define BM_MMDC1_MPSWDAR0_SW_DUM_CMP2      0x00000010


/* --- Register HW_MMDC1_MPSWDAR0, field SW_DUM_CMP3 (RO)
 *
...
#define BP_MMDC1_MPSWDAR0_SW_DUM_CMP3      5
#define BM_MMDC1_MPSWDAR0_SW_DUM_CMP3      0x00000020


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSWDRDR0 - MMDC PHY SW Dummy Read Data Register 0 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpswdrdr0_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPSWDRDR0 register
 */
#define HW_MMDC1_MPSWDRDR0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x898)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSWDRDR0(x)           (*(volatile hw_mmdc1_mpswdrdr0_t *) HW_MMDC1_MPSWDRDR0_ADDR(x))
#define HW_MMDC1_MPSWDRDR0_RD(x)        (HW_MMDC1_MPSWDRDR0(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPSWDRDR0 bitfields
 */

/* --- Register HW_MMDC1_MPSWDRDR0, field DUM_RD0 (RO)
 *
...
#define BP_MMDC1_MPSWDRDR0_DUM_RD0      0
#define BM_MMDC1_MPSWDRDR0_DUM_RD0      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSWDRDR1 - MMDC PHY SW Dummy Read Data Register 1 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpswdrdr1_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPSWDRDR1 register
 */
#define HW_MMDC1_MPSWDRDR1_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x89c)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSWDRDR1(x)           (*(volatile hw_mmdc1_mpswdrdr1_t *) HW_MMDC1_MPSWDRDR1_ADDR(x))
#define HW_MMDC1_MPSWDRDR1_RD(x)        (HW_MMDC1_MPSWDRDR1(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPSWDRDR1 bitfields
 */

/* --- Register HW_MMDC1_MPSWDRDR1, field DUM_RD1 (RO)
 *
 * Dummy read data1. This field holds the second data that is read from the DDR during SW dummy read
 * access (i.e when SW_DUMMY_RD = 1). This field is valid only when SW_DUMMY_RD is de-assrted
 */

#define BP_MMDC1_MPSWDRDR1_DUM_RD1      0
#define BM_MMDC1_MPSWDRDR1_DUM_RD1      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSWDRDR2 - MMDC PHY SW Dummy Read Data Register 2 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpswdrdr2_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPSWDRDR2 register
 */
#define HW_MMDC1_MPSWDRDR2_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8a0)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSWDRDR2(x)           (*(volatile hw_mmdc1_mpswdrdr2_t *) HW_MMDC1_MPSWDRDR2_ADDR(x))
#define HW_MMDC1_MPSWDRDR2_RD(x)        (HW_MMDC1_MPSWDRDR2(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPSWDRDR2 bitfields
 */

/* --- Register HW_MMDC1_MPSWDRDR2, field DUM_RD2 (RO)
 *
 * Dummy read data2. This field holds the third data that is read from the DDR during SW dummy read
 * access (i.e when SW_DUMMY_RD = 1). This field is valid only when SW_DUMMY_RD is de-assrted.
 */

#define BP_MMDC1_MPSWDRDR2_DUM_RD2      0
#define BM_MMDC1_MPSWDRDR2_DUM_RD2      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSWDRDR3 - MMDC PHY SW Dummy Read Data Register 3 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpswdrdr3_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPSWDRDR3 register
 */
#define HW_MMDC1_MPSWDRDR3_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8a4)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSWDRDR3(x)           (*(volatile hw_mmdc1_mpswdrdr3_t *) HW_MMDC1_MPSWDRDR3_ADDR(x))
#define HW_MMDC1_MPSWDRDR3_RD(x)        (HW_MMDC1_MPSWDRDR3(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPSWDRDR3 bitfields
 */

/* --- Register HW_MMDC1_MPSWDRDR3, field DUM_RD3 (RO)
 *
 * Dummy read data3. This field holds the forth data that is read from the DDR during SW dummy read
 * access (i.e when SW_DUMMY_RD = 1). This field is valid only when SW_DUMMY_RD is de-assrted.
 */

#define BP_MMDC1_MPSWDRDR3_DUM_RD3      0
#define BM_MMDC1_MPSWDRDR3_DUM_RD3      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSWDRDR4 - MMDC PHY SW Dummy Read Data Register 4 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpswdrdr4_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPSWDRDR4 register
 */
#define HW_MMDC1_MPSWDRDR4_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8a8)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSWDRDR4(x)           (*(volatile hw_mmdc1_mpswdrdr4_t *) HW_MMDC1_MPSWDRDR4_ADDR(x))
#define HW_MMDC1_MPSWDRDR4_RD(x)        (HW_MMDC1_MPSWDRDR4(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPSWDRDR4 bitfields
 */

/* --- Register HW_MMDC1_MPSWDRDR4, field DUM_RD4 (RO)
 *
...
#define BP_MMDC1_MPSWDRDR4_DUM_RD4      0
#define BM_MMDC1_MPSWDRDR4_DUM_RD4      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSWDRDR5 - MMDC PHY SW Dummy Read Data Register 5 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpswdrdr5_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPSWDRDR5 register
 */
#define HW_MMDC1_MPSWDRDR5_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8ac)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSWDRDR5(x)           (*(volatile hw_mmdc1_mpswdrdr5_t *) HW_MMDC1_MPSWDRDR5_ADDR(x))
#define HW_MMDC1_MPSWDRDR5_RD(x)        (HW_MMDC1_MPSWDRDR5(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPSWDRDR5 bitfields
 */

/* --- Register HW_MMDC1_MPSWDRDR5, field DUM_RD5 (RO)
 *
...
#define BP_MMDC1_MPSWDRDR5_DUM_RD5      0
#define BM_MMDC1_MPSWDRDR5_DUM_RD5      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSWDRDR6 - MMDC PHY SW Dummy Read Data Register 6 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpswdrdr6_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPSWDRDR6 register
 */
#define HW_MMDC1_MPSWDRDR6_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8b0)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSWDRDR6(x)           (*(volatile hw_mmdc1_mpswdrdr6_t *) HW_MMDC1_MPSWDRDR6_ADDR(x))
#define HW_MMDC1_MPSWDRDR6_RD(x)        (HW_MMDC1_MPSWDRDR6(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPSWDRDR6 bitfields
 */

/* --- Register HW_MMDC1_MPSWDRDR6, field DUM_RD6 (RO)
 *
...
#define BP_MMDC1_MPSWDRDR6_DUM_RD6      0
#define BM_MMDC1_MPSWDRDR6_DUM_RD6      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPSWDRDR7 - MMDC PHY SW Dummy Read Data Register 7 (RO)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: DDR3_x64, LP2_2ch_x16,
 * LP2_2ch_x32
 */
...
} hw_mmdc1_mpswdrdr7_t;
#endif

/*
 * constants & macros for entire multi-block MMDC1_MPSWDRDR7 register
 */
#define HW_MMDC1_MPSWDRDR7_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8b4)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPSWDRDR7(x)           (*(volatile hw_mmdc1_mpswdrdr7_t *) HW_MMDC1_MPSWDRDR7_ADDR(x))
#define HW_MMDC1_MPSWDRDR7_RD(x)        (HW_MMDC1_MPSWDRDR7(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPSWDRDR7 bitfields
 */

/* --- Register HW_MMDC1_MPSWDRDR7, field DUM_RD7 (RO)
 *
...
#define BP_MMDC1_MPSWDRDR7_DUM_RD7      0
#define BM_MMDC1_MPSWDRDR7_DUM_RD7      0xffffffff

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPMUR0 - MMDC PHY Measure Unit Register (RW)
 *
 * Supported Mode Of Operations:  For Channel 0: All  For Channel 1: LP2_2ch_x16, LP2_2ch_x32
 */
typedef union
...
/*
 * constants & macros for entire multi-block MMDC1_MPMUR0 register
 */
#define HW_MMDC1_MPMUR0_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8b8)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPMUR0(x)           (*(volatile hw_mmdc1_mpmur0_t *) HW_MMDC1_MPMUR0_ADDR(x))
#define HW_MMDC1_MPMUR0_RD(x)        (HW_MMDC1_MPMUR0(x).U)
#define HW_MMDC1_MPMUR0_WR(x, v)     (HW_MMDC1_MPMUR0(x).U = (v))
#define HW_MMDC1_MPMUR0_SET(x, v)    (HW_MMDC1_MPMUR0_WR(x, HW_MMDC1_MPMUR0_RD(x) |  (v)))
#define HW_MMDC1_MPMUR0_CLR(x, v)    (HW_MMDC1_MPMUR0_WR(x, HW_MMDC1_MPMUR0_RD(x) & ~(v)))
#define HW_MMDC1_MPMUR0_TOG(x, v)    (HW_MMDC1_MPMUR0_WR(x, HW_MMDC1_MPMUR0_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPMUR0 bitfields
 */

/* --- Register HW_MMDC1_MPMUR0, field MU_BYP_VAL (RW)
 *
...
#define BP_MMDC1_MPMUR0_MU_BYP_VAL      0
#define BM_MMDC1_MPMUR0_MU_BYP_VAL      0x000003ff

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPMUR0_MU_BYP_VAL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPMUR0_MU_BYP_VAL)
#else
#define BF_MMDC1_MPMUR0_MU_BYP_VAL(v)   (((v) << 0) & BM_MMDC1_MPMUR0_MU_BYP_VAL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the MU_BYP_VAL field to a new value.
#define BW_MMDC1_MPMUR0_MU_BYP_VAL(v)   BF_CS1(MMDC1_MPMUR0, MU_BYP_VAL, v)
#endif

/* --- Register HW_MMDC1_MPMUR0, field MU_BYP_EN (RW)
 *
...
#define BP_MMDC1_MPMUR0_MU_BYP_EN      10
#define BM_MMDC1_MPMUR0_MU_BYP_EN      0x00000400

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPMUR0_MU_BYP_EN(v)   ((((reg32_t) v) << 10) & BM_MMDC1_MPMUR0_MU_BYP_EN)
#else
#define BF_MMDC1_MPMUR0_MU_BYP_EN(v)   (((v) << 10) & BM_MMDC1_MPMUR0_MU_BYP_EN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the MU_BYP_EN field to a new value.
#define BW_MMDC1_MPMUR0_MU_BYP_EN(v)   BF_CS1(MMDC1_MPMUR0, MU_BYP_EN, v)
#endif


/* --- Register HW_MMDC1_MPMUR0, field FRC_MSR (RW)
 *
...
#define BP_MMDC1_MPMUR0_FRC_MSR      11
#define BM_MMDC1_MPMUR0_FRC_MSR      0x00000800

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPMUR0_FRC_MSR(v)   ((((reg32_t) v) << 11) & BM_MMDC1_MPMUR0_FRC_MSR)
#else
#define BF_MMDC1_MPMUR0_FRC_MSR(v)   (((v) << 11) & BM_MMDC1_MPMUR0_FRC_MSR)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the FRC_MSR field to a new value.
#define BW_MMDC1_MPMUR0_FRC_MSR(v)   BF_CS1(MMDC1_MPMUR0, FRC_MSR, v)
#endif


/* --- Register HW_MMDC1_MPMUR0, field MU_UNIT_DEL_NUM (RO)
 *
...
#define BP_MMDC1_MPMUR0_MU_UNIT_DEL_NUM      16
#define BM_MMDC1_MPMUR0_MU_UNIT_DEL_NUM      0x03ff0000

#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPWRCADL - MMDC Write CA delay-line controller (RW)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MPWRCADL register
 */
#define HW_MMDC1_MPWRCADL_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8bc)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPWRCADL(x)           (*(volatile hw_mmdc1_mpwrcadl_t *) HW_MMDC1_MPWRCADL_ADDR(x))
#define HW_MMDC1_MPWRCADL_RD(x)        (HW_MMDC1_MPWRCADL(x).U)
#define HW_MMDC1_MPWRCADL_WR(x, v)     (HW_MMDC1_MPWRCADL(x).U = (v))
#define HW_MMDC1_MPWRCADL_SET(x, v)    (HW_MMDC1_MPWRCADL_WR(x, HW_MMDC1_MPWRCADL_RD(x) |  (v)))
#define HW_MMDC1_MPWRCADL_CLR(x, v)    (HW_MMDC1_MPWRCADL_WR(x, HW_MMDC1_MPWRCADL_RD(x) & ~(v)))
#define HW_MMDC1_MPWRCADL_TOG(x, v)    (HW_MMDC1_MPWRCADL_WR(x, HW_MMDC1_MPWRCADL_RD(x) ^  (v)))
#endif

/*
 * constants & macros for individual MMDC1_MPWRCADL bitfields
 */

/* --- Register HW_MMDC1_MPWRCADL, field WR_CA0_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA0_DEL      0
#define BM_MMDC1_MPWRCADL_WR_CA0_DEL      0x00000003

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA0_DEL(v)   ((((reg32_t) v) << 0) & BM_MMDC1_MPWRCADL_WR_CA0_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA0_DEL(v)   (((v) << 0) & BM_MMDC1_MPWRCADL_WR_CA0_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA0_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA0_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA0_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRCADL, field WR_CA1_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA1_DEL      2
#define BM_MMDC1_MPWRCADL_WR_CA1_DEL      0x0000000c

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA1_DEL(v)   ((((reg32_t) v) << 2) & BM_MMDC1_MPWRCADL_WR_CA1_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA1_DEL(v)   (((v) << 2) & BM_MMDC1_MPWRCADL_WR_CA1_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA1_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA1_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA1_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRCADL, field WR_CA2_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA2_DEL      4
#define BM_MMDC1_MPWRCADL_WR_CA2_DEL      0x00000030

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA2_DEL(v)   ((((reg32_t) v) << 4) & BM_MMDC1_MPWRCADL_WR_CA2_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA2_DEL(v)   (((v) << 4) & BM_MMDC1_MPWRCADL_WR_CA2_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA2_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA2_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA2_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRCADL, field WR_CA3_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA3_DEL      6
#define BM_MMDC1_MPWRCADL_WR_CA3_DEL      0x000000c0

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA3_DEL(v)   ((((reg32_t) v) << 6) & BM_MMDC1_MPWRCADL_WR_CA3_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA3_DEL(v)   (((v) << 6) & BM_MMDC1_MPWRCADL_WR_CA3_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA3_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA3_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA3_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRCADL, field WR_CA4_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA4_DEL      8
#define BM_MMDC1_MPWRCADL_WR_CA4_DEL      0x00000300

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA4_DEL(v)   ((((reg32_t) v) << 8) & BM_MMDC1_MPWRCADL_WR_CA4_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA4_DEL(v)   (((v) << 8) & BM_MMDC1_MPWRCADL_WR_CA4_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA4_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA4_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA4_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRCADL, field WR_CA5_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA5_DEL      10
#define BM_MMDC1_MPWRCADL_WR_CA5_DEL      0x00000c00

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA5_DEL(v)   ((((reg32_t) v) << 10) & BM_MMDC1_MPWRCADL_WR_CA5_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA5_DEL(v)   (((v) << 10) & BM_MMDC1_MPWRCADL_WR_CA5_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA5_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA5_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA5_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRCADL, field WR_CA6_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA6_DEL      12
#define BM_MMDC1_MPWRCADL_WR_CA6_DEL      0x00003000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA6_DEL(v)   ((((reg32_t) v) << 12) & BM_MMDC1_MPWRCADL_WR_CA6_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA6_DEL(v)   (((v) << 12) & BM_MMDC1_MPWRCADL_WR_CA6_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA6_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA6_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA6_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRCADL, field WR_CA7_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA7_DEL      14
#define BM_MMDC1_MPWRCADL_WR_CA7_DEL      0x0000c000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA7_DEL(v)   ((((reg32_t) v) << 14) & BM_MMDC1_MPWRCADL_WR_CA7_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA7_DEL(v)   (((v) << 14) & BM_MMDC1_MPWRCADL_WR_CA7_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA7_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA7_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA7_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRCADL, field WR_CA8_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA8_DEL      16
#define BM_MMDC1_MPWRCADL_WR_CA8_DEL      0x00030000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA8_DEL(v)   ((((reg32_t) v) << 16) & BM_MMDC1_MPWRCADL_WR_CA8_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA8_DEL(v)   (((v) << 16) & BM_MMDC1_MPWRCADL_WR_CA8_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA8_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA8_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA8_DEL, v)
#endif


/* --- Register HW_MMDC1_MPWRCADL, field WR_CA9_DEL (RW)
 *
...
#define BP_MMDC1_MPWRCADL_WR_CA9_DEL      18
#define BM_MMDC1_MPWRCADL_WR_CA9_DEL      0x000c0000

#ifndef __LANGUAGE_ASM__
#define BF_MMDC1_MPWRCADL_WR_CA9_DEL(v)   ((((reg32_t) v) << 18) & BM_MMDC1_MPWRCADL_WR_CA9_DEL)
#else
#define BF_MMDC1_MPWRCADL_WR_CA9_DEL(v)   (((v) << 18) & BM_MMDC1_MPWRCADL_WR_CA9_DEL)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the WR_CA9_DEL field to a new value.
#define BW_MMDC1_MPWRCADL_WR_CA9_DEL(v)   BF_CS1(MMDC1_MPWRCADL, WR_CA9_DEL, v)
#endif


#ifndef __LANGUAGE_ASM__
/*!
 * @brief HW_MMDC1_MPDCCR - MMDC Duty Cycle Control Register (RO)
 *
...
/*
 * constants & macros for entire multi-block MMDC1_MPDCCR register
 */
#define HW_MMDC1_MPDCCR_ADDR(x)      (REGS_MMDC1_BASE(x) + 0x8c0)

#ifndef __LANGUAGE_ASM__
#define HW_MMDC1_MPDCCR(x)           (*(volatile hw_mmdc1_mpdccr_t *) HW_MMDC1_MPDCCR_ADDR(x))
#define HW_MMDC1_MPDCCR_RD(x)        (HW_MMDC1_MPDCCR(x).U)
#endif

/*
 * constants & macros for individual MMDC1_MPDCCR bitfields
 */

/* --- Register HW_MMDC1_MPDCCR, field WR_DQS0_FT_DCC (RO)
 *
...
#define BP_MMDC1_MPDCCR_WR_DQS0_FT_DCC      0
#define BM_MMDC1_MPDCCR_WR_DQS0_FT_DCC      0x00000007


/* --- Register HW_MMDC1_MPDCCR, field WR_DQS1_FT_DCC (RO)
 *
...
#define BP_MMDC1_MPDCCR_WR_DQS1_FT_DCC      3
#define BM_MMDC1_MPDCCR_WR_DQS1_FT_DCC      0x00000038


/* --- Register HW_MMDC1_MPDCCR, field WR_DQS2_FT_DCC (RO)
 *
 * Write DQS duty cycle fine tuning control of Byte1. This field controls the duty cycle of write
 * DQS of Byte1 Note all the other options are not allowed
 *
...
#define BP_MMDC1_MPDCCR_WR_DQS2_FT_DCC      6
#define BM_MMDC1_MPDCCR_WR_DQS2_FT_DCC      0x000001c0


/* --- Register HW_MMDC1_MPDCCR, field WR_DQS3_FT_DCC (RO)
 *
 * Write DQS duty cycle fine tuning control of Byte0. This field controls the duty cycle of write
 * DQS of Byte0 Note all the other options are not allowed
 *
...
#define BP_MMDC1_MPDCCR_WR_DQS3_FT_DCC      9
#define BM_MMDC1_MPDCCR_WR_DQS3_FT_DCC      0x00000e00


/* --- Register HW_MMDC1_MPDCCR, field CK_FT0_DCC (RO)
 *
...
#define BP_MMDC1_MPDCCR_CK_FT0_DCC      12
#define BM_MMDC1_MPDCCR_CK_FT0_DCC      0x00007000


/* --- Register HW_MMDC1_MPDCCR, field CK_FT1_DCC (RO)
 *
...
#define BP_MMDC1_MPDCCR_CK_FT1_DCC      16
#define BM_MMDC1_MPDCCR_CK_FT1_DCC      0x00070000


/* --- Register HW_MMDC1_MPDCCR, field RD_DQS0_FT_DCC (RO)
 *
...
#define BP_MMDC1_MPDCCR_RD_DQS0_FT_DCC      19
#define BM_MMDC1_MPDCCR_RD_DQS0_FT_DCC      0x00380000


/* --- Register HW_MMDC1_MPDCCR, field RD_DQS1_FT_DCC (RO)
 *
...
#define BP_MMDC1_MPDCCR_RD_DQS1_FT_DCC      22
#define BM_MMDC1_MPDCCR_RD_DQS1_FT_DCC      0x01c00000


/* --- Register HW_MMDC1_MPDCCR, field RD_DQS2_FT_DCC (RO)
 *
...
#define BP_MMDC1_MPDCCR_RD_DQS2_FT_DCC      25
#define BM_MMDC1_MPDCCR_RD_DQS2_FT_DCC      0x0e000000


/* --- Register HW_MMDC1_MPDCCR, field RD_DQS3_FT_DCC (RO)
 *
...
#define BP_MMDC1_MPDCCR_RD_DQS3_FT_DCC      28
#define BM_MMDC1_MPDCCR_RD_DQS3_FT_DCC      0x70000000



/*!
 * @brief All MMDC1 module registers.
 */
#ifndef __LANGUAGE_ASM__
typedef struct
{
    volatile hw_mmdc1_mdctl_t MDCTL; //!< MMDC Core Control Register
    volatile hw_mmdc1_mdpdc_t MDPDC; //!< MMDC Core Power Down Control Register
    volatile hw_mmdc1_mdotc_t MDOTC; //!< MMDC Core ODT Timing Control Register
    volatile hw_mmdc1_mdcfg0_t MDCFG0; //!< MMDC Core Timing Configuration Register 0
    volatile hw_mmdc1_mdcfg1_t MDCFG1; //!< MMDC Core Timing Configuration Register 1
    volatile hw_mmdc1_mdcfg2_t MDCFG2; //!< MMDC Core Timing Configuration Register 2
    volatile hw_mmdc1_mdmisc_t MDMISC; //!< MMDC Core Miscellaneous Register
    volatile hw_mmdc1_mdscr_t MDSCR; //!< MMDC Core Special Command Register
    volatile hw_mmdc1_mdref_t MDREF; //!< MMDC Core Refresh Control Register
    reg32_t _reserved0[2];
    volatile hw_mmdc1_mdrwd_t MDRWD; //!< MMDC Core Read/Write Command Delay Register
    volatile hw_mmdc1_mdor_t MDOR; //!< MMDC Core Out of Reset Delays Register
    volatile hw_mmdc1_mdmrr_t MDMRR; //!< MMDC Core MRR Data Register
    volatile hw_mmdc1_mdcfg3lp_t MDCFG3LP; //!< MMDC Core Timing Configuration Register 3
    volatile hw_mmdc1_mdmr4_t MDMR4; //!< MMDC Core MR4 Derating Register
    volatile hw_mmdc1_mdasp_t MDASP; //!< MMDC Core Address Space Partition Register
    reg32_t _reserved1[239];
    volatile hw_mmdc1_maarcr_t MAARCR; //!< MMDC Core AXI Reordering Control Regsiter
    volatile hw_mmdc1_mapsr_t MAPSR; //!< MMDC Core Power Saving Control and Status Register
    volatile hw_mmdc1_maexidr0_t MAEXIDR0; //!< MMDC Core Exclusive ID Monitor Register0
    volatile hw_mmdc1_maexidr1_t MAEXIDR1; //!< MMDC Core Exclusive ID Monitor Register1
    volatile hw_mmdc1_madpcr0_t MADPCR0; //!< MMDC Core Debug and Profiling Control Register 0
    volatile hw_mmdc1_madpcr1_t MADPCR1; //!< MMDC Core Debug and Profiling Control Register 1
    volatile hw_mmdc1_madpsr0_t MADPSR0; //!< MMDC Core Debug and Profiling Status Register 0
    volatile hw_mmdc1_madpsr1_t MADPSR1; //!< MMDC Core Debug and Profiling Status Register 1
    volatile hw_mmdc1_madpsr2_t MADPSR2; //!< MMDC Core Debug and Profiling Status Register 2
    volatile hw_mmdc1_madpsr3_t MADPSR3; //!< MMDC Core Debug and Profiling Status Register 3
    volatile hw_mmdc1_madpsr4_t MADPSR4; //!< MMDC Core Debug and Profiling Status Register 4
    volatile hw_mmdc1_madpsr5_t MADPSR5; //!< MMDC Core Debug and Profiling Status Register 5
    volatile hw_mmdc1_masbs0_t MASBS0; //!< MMDC Core Step By Step Address Register
    volatile hw_mmdc1_masbs1_t MASBS1; //!< MMDC Core Step By Step Address Attributes Register
    reg32_t _reserved2[2];
    volatile hw_mmdc1_magenp_t MAGENP; //!< MMDC Core General Purpose Register
    reg32_t _reserved3[239];
    volatile hw_mmdc1_mpzqhwctrl_t MPZQHWCTRL; //!< MMDC PHY ZQ HW control register
    volatile hw_mmdc1_mpzqswctrl_t MPZQSWCTRL; //!< MMDC PHY ZQ SW control register
    volatile hw_mmdc1_mpwlgcr_t MPWLGCR; //!< MMDC PHY Write Leveling Configuration and Error Status Register
    volatile hw_mmdc1_mpwldectrl0_t MPWLDECTRL0; //!< MMDC PHY Write Leveling Delay Control Register 0
    volatile hw_mmdc1_mpwldectrl1_t MPWLDECTRL1; //!< MMDC PHY Write Leveling Delay Control Register 1
    volatile hw_mmdc1_mpwldlst_t MPWLDLST; //!< MMDC PHY Write Leveling delay-line Status Register
    volatile hw_mmdc1_mpodtctrl_t MPODTCTRL; //!< MMDC PHY ODT control register
    volatile hw_mmdc1_mprddqby0dl_t MPRDDQBY0DL; //!< MMDC PHY Read DQ Byte0 Delay Register
    volatile hw_mmdc1_mprddqby1dl_t MPRDDQBY1DL; //!< MMDC PHY Read DQ Byte1 Delay Register
    volatile hw_mmdc1_mprddqby2dl_t MPRDDQBY2DL; //!< MMDC PHY Read DQ Byte2 Delay Register
    volatile hw_mmdc1_mprddqby3dl_t MPRDDQBY3DL; //!< MMDC PHY Read DQ Byte3 Delay Register
    volatile hw_mmdc1_mpwrdqby0dl_t MPWRDQBY0DL; //!< MMDC PHY Write DQ Byte0 Delay Register
    volatile hw_mmdc1_mpwrdqby1dl_t MPWRDQBY1DL; //!< MMDC PHY Write DQ Byte1 Delay Register
    volatile hw_mmdc1_mpwrdqby2dl_t MPWRDQBY2DL; //!< MMDC PHY Write DQ Byte2 Delay Register
    volatile hw_mmdc1_mpwrdqby3dl_t MPWRDQBY3DL; //!< MMDC PHY Write DQ Byte3 Delay Register
    volatile hw_mmdc1_mpdgctrl0_t MPDGCTRL0; //!< MMDC PHY Read DQS Gating Control Register 0
    volatile hw_mmdc1_mpdgctrl1_t MPDGCTRL1; //!< MMDC PHY Read DQS Gating Control Register 1
    volatile hw_mmdc1_mpdgdlst0_t MPDGDLST0; //!< MMDC PHY Read DQS Gating delay-line Status Register
    volatile hw_mmdc1_mprddlctl_t MPRDDLCTL; //!< MMDC PHY Read delay-lines Configuration Register
    volatile hw_mmdc1_mprddlst_t MPRDDLST; //!< MMDC PHY Read delay-lines Status Register
    volatile hw_mmdc1_mpwrdlctl_t MPWRDLCTL; //!< MMDC PHY Write delay-lines Configuration Register
    volatile hw_mmdc1_mpwrdlst_t MPWRDLST; //!< MMDC PHY Write delay-lines Status Register
    volatile hw_mmdc1_mpsdctrl_t MPSDCTRL; //!< MMDC PHY CK Control Register
    volatile hw_mmdc1_mpzqlp2ctl_t MPZQLP2CTL; //!< MMDC ZQ LPDDR2 HW Control Register
    volatile hw_mmdc1_mprddlhwctl_t MPRDDLHWCTL; //!< MMDC PHY Read Delay HW Calibration Control Register
    volatile hw_mmdc1_mpwrdlhwctl_t MPWRDLHWCTL; //!< MMDC PHY Write Delay HW Calibration Control Register
    volatile hw_mmdc1_mprddlhwst0_t MPRDDLHWST0; //!< MMDC PHY Read Delay HW Calibration Status Register 0
    volatile hw_mmdc1_mprddlhwst1_t MPRDDLHWST1; //!< MMDC PHY Read Delay HW Calibration Status Register 1
    volatile hw_mmdc1_mpwrdlhwst0_t MPWRDLHWST0; //!< MMDC PHY Write Delay HW Calibration Status Register 0
    volatile hw_mmdc1_mpwrdlhwst1_t MPWRDLHWST1; //!< MMDC PHY Write Delay HW Calibration Status Register 1
    volatile hw_mmdc1_mpwlhwerr_t MPWLHWERR; //!< MMDC PHY Write Leveling HW Error Register
    volatile hw_mmdc1_mpdghwst0_t MPDGHWST0; //!< MMDC PHY Read DQS Gating HW Status Register 0
    volatile hw_mmdc1_mpdghwst1_t MPDGHWST1; //!< MMDC PHY Read DQS Gating HW Status Register 1
    volatile hw_mmdc1_mpdghwst2_t MPDGHWST2; //!< MMDC PHY Read DQS Gating HW Status Register 2
    volatile hw_mmdc1_mpdghwst3_t MPDGHWST3; //!< MMDC PHY Read DQS Gating HW Status Register 3
    volatile hw_mmdc1_mppdcmpr1_t MPPDCMPR1; //!< MMDC PHY Pre-defined Compare Register 1
    volatile hw_mmdc1_mppdcmpr2_t MPPDCMPR2; //!< MMDC PHY Pre-defined Compare and CA delay-line Configuration Register
    volatile hw_mmdc1_mpswdar0_t MPSWDAR0; //!< MMDC PHY SW Dummy Access Register
    volatile hw_mmdc1_mpswdrdr0_t MPSWDRDR0; //!< MMDC PHY SW Dummy Read Data Register 0
    volatile hw_mmdc1_mpswdrdr1_t MPSWDRDR1; //!< MMDC PHY SW Dummy Read Data Register 1
    volatile hw_mmdc1_mpswdrdr2_t MPSWDRDR2; //!< MMDC PHY SW Dummy Read Data Register 2
    volatile hw_mmdc1_mpswdrdr3_t MPSWDRDR3; //!< MMDC PHY SW Dummy Read Data Register 3
    volatile hw_mmdc1_mpswdrdr4_t MPSWDRDR4; //!< MMDC PHY SW Dummy Read Data Register 4
    volatile hw_mmdc1_mpswdrdr5_t MPSWDRDR5; //!< MMDC PHY SW Dummy Read Data Register 5
    volatile hw_mmdc1_mpswdrdr6_t MPSWDRDR6; //!< MMDC PHY SW Dummy Read Data Register 6
    volatile hw_mmdc1_mpswdrdr7_t MPSWDRDR7; //!< MMDC PHY SW Dummy Read Data Register 7
...
//! @param x MMDC1 instance number.
//! @return Reference (not a pointer) to the registers struct. To get a pointer to the struct,
//!     use the '&' operator, like <code>&HW_MMDC1(0)</code>.
#define HW_MMDC1(x)     (*(volatile hw_mmdc1_t *) REGS_MMDC1_BASE(x))
