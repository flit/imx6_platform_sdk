...
#define HW_OCOTP_CTRL_SET(v)    (HW_OCOTP_CTRL_WR(HW_OCOTP_CTRL_RD() |  (v)))
#define HW_OCOTP_CTRL_CLR(v)    (HW_OCOTP_CTRL_WR(HW_OCOTP_CTRL_RD() & ~(v)))
...
#define HW_OCOTP_SCS_SET(v)    (HW_OCOTP_SCS_WR(HW_OCOTP_SCS_RD() |  (v)))
#define HW_OCOTP_SCS_CLR(v)    (HW_OCOTP_SCS_WR(HW_OCOTP_SCS_RD() & ~(v)))
