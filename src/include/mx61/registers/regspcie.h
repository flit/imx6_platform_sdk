...
/* --- Register HW_PCIE_COMMAND, field I_O_SPACE_ENABLE (RW)
 *
 * I/O Space Enable
 */
...
/* --- Register HW_PCIE_COMMAND, field MEMORY_SPACE_ENABLE (RW)
 *
 * Memory Space Enable
 */
...
/* --- Register HW_PCIE_COMMAND, field BUS_MASTER_ENABLE (RW)
 *
 * Bus Master Enable
 */
...
/* --- Register HW_PCIE_COMMAND, field SPECIAL_CYCLE_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field MEMORY_WRITE_AND_INVALIDATE (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field VGA_PALETTE_SNOOP (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field PARITY_ERROR_RESPONSE (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field IDSEL_STEPPING (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field SERR_ENABLE (RW)
 *
 * SERR# Enable
 */
...
/* --- Register HW_PCIE_COMMAND, field FAST_BACK_TO_BACK_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field INTX_ASSERTION_DISABLE (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field INTX_STATUS (RW)
 *
 * INTx Status
 */
...
/* --- Register HW_PCIE_COMMAND, field CAPABILITIES_LIST (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field SIXTYSIX_MHZ_CAPABLE (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field FAST_BACK_TO_BACK_CAPABLE (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field MASTER_DATA_PARITY_ERROR (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field DEVSEL_TIMING (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field SIGNALED_TARGET_ABORT (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field RECEIVED_TARGET_ABORT (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field RECEIVED_MASTER_ABORT (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field DETECTED_PARITY_ERROR (RW)
 *
...
/* --- Register HW_PCIE_COMMAND, field SIGNALED_SYSTEM_ERROR (RW)
 *
...
/* --- Register HW_PCIE_REVID, field CX_REVISION_ID_N (RO)
 *
...
/* --- Register HW_PCIE_REVID, field IF_CODE_N (RO)
 *
...
/* --- Register HW_PCIE_REVID, field SUB_CLASS_CODE_N (RO)
 *
...
/* --- Register HW_PCIE_REVID, field BASE_CLASS_CODE_N (RO)
 *
...
/* --- Register HW_PCIE_BIST, field CACHE_LINE_SIZE (RW)
 *
...
/* --- Register HW_PCIE_BIST, field MASTER_LATENCY_TIMER (RW)
 *
...
/* --- Register HW_PCIE_BIST, field CONFIGURATION_HEADER_FORMAT (RW)
 *
...
/* --- Register HW_PCIE_BIST, field MULTI_FUNCTION_DEVICE (RW)
 *
...
/* --- Register HW_PCIE_BIST, field NOT_SUPPORTED_BY__CORE (RW)
 *
...
/* --- Register HW_PCIE_BAR0, field MEM_I_O (RO)
 *
...
/* --- Register HW_PCIE_BAR0, field TYPE (RO)
 *
...
/* --- Register HW_PCIE_BAR0, field PREF (RO)
 *
...
/* --- Register HW_PCIE_BAR0, field ADDRESS (RO)
 *
...
/* --- Register HW_PCIE_BAR1, field ADDRESS (RO)
 *
...
/* --- Register HW_PCIE_BAR2, field MEM_I_O (RO)
 *
...
/* --- Register HW_PCIE_BAR2, field TYPE (RO)
 *
...
/* --- Register HW_PCIE_BAR2, field PREF (RO)
 *
...
/* --- Register HW_PCIE_BAR2, field ADDRESS (RO)
 *
...
/* --- Register HW_PCIE_BAR3, field ADDRESS (RO)
 *
...
/* --- Register HW_PCIE_BAR4, field MEM_I_O (RO)
 *
...
/* --- Register HW_PCIE_BAR4, field TYPE (RO)
 *
...
/* --- Register HW_PCIE_BAR4, field PREF (RO)
 *
...
/* --- Register HW_PCIE_BAR4, field ADDRESS (RO)
 *
...
/* --- Register HW_PCIE_BAR5, field ADDRESS (RO)
 *
...
/* --- Register HW_PCIE_EROMBAR, field ENABLE (RW)
 *
...
/* --- Register HW_PCIE_EROMBAR, field ADDRESS (RW)
 *
...
/* --- Register HW_PCIE_CAPPR, field CFG_NEXT_PTR (RO)
 *
...
/* --- Register HW_PCIE_ILR, field INTERRUPT_LINE (RW)
 *
...
/* --- Register HW_PCIE_ILR, field INT_PIN_MAPPING_N (RW)
 *
...
/* --- Register HW_PCIE_PMCR, field POWER_MANAGEMENT_CAPABILITY_ID (RO)
 *
...
/* --- Register HW_PCIE_PMCR, field NEXT_CAPABILITY_POINTER (RO)
 *
...
/* --- Register HW_PCIE_PMCR, field POWER_MANAGEMENT_SPECIFICATION_VERSION (RO)
 *
...
/* --- Register HW_PCIE_PMCR, field PME_CLOCK (RO)
 *
...
/* --- Register HW_PCIE_PMCR, field DSI (RO)
 *
...
/* --- Register HW_PCIE_PMCR, field AUX_CURRENT (RO)
 *
...
/* --- Register HW_PCIE_PMCR, field D1_SUPPORT (RO)
 *
...
/* --- Register HW_PCIE_PMCR, field D2_SUPPORT (RO)
 *
...
/* --- Register HW_PCIE_PMCR, field PME_SUPPORT (RO)
 *
...
/* --- Register HW_PCIE_PMCSR, field POWER_STATE (RW)
 *
...
/* --- Register HW_PCIE_PMCSR, field NO_SOFT_RESET (RW)
 *
...
/* --- Register HW_PCIE_PMCSR, field PME_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_PMCSR, field DATA_SELECT (RW)
 *
...
/* --- Register HW_PCIE_PMCSR, field DATA_SCALE (RW)
 *
...
/* --- Register HW_PCIE_PMCSR, field PME_STATUS (RW)
 *
...
/* --- Register HW_PCIE_PMCSR, field B2_B3_SUPPORT (RW)
 *
...
/* --- Register HW_PCIE_PMCSR, field BUS_POWER_CLOCK_CONTROL_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_PMCSR, field DATA_REGISTER_FOR_ADDITIONAL_INFORMATION (RW)
 *
...
/* --- Register HW_PCIE_CIDR, field PCI_EXPRESS_CAPABILITY_ID (RO)
 *
...
/* --- Register HW_PCIE_CIDR, field NEXT_CAPABILITY_POINTER (RO)
 *
...
/* --- Register HW_PCIE_CIDR, field PCI_EXPRESS_CAPABILITY_VERSION (RO)
 *
...
/* --- Register HW_PCIE_CIDR, field DEVICE_PORT_TYPE (RO)
 *
...
/* --- Register HW_PCIE_CIDR, field SLOT_IMPLEMENTED (RO)
 *
...
/* --- Register HW_PCIE_CIDR, field INTERRUPT_MESSAGE_NUMBER (RO)
 *
...
/* --- Register HW_PCIE_DCR, field MAX_PAYLOAD_SIZE_SUPPORTED (RW)
 *
...
/* --- Register HW_PCIE_DCR, field PHANTOM_FUNCTION_SUPPORTED (RW)
 *
...
/* --- Register HW_PCIE_DCR, field EXTENDED_TAG_FIELD_SUPPORTED (RW)
 *
...
/* --- Register HW_PCIE_DCR, field ENDPOINT_L0S_ACCEPTABLE_LATENCY (RW)
 *
...
/* --- Register HW_PCIE_DCR, field ENDPOINT_L1_ACCEPTABLE_LATENCY (RW)
 *
...
/* --- Register HW_PCIE_DCR, field CAPTURED_SLOT_POWER_LIMIT_SCALE (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field CORRECTABLE_ERROR_REPORTING_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field NON_FATAL_ERROR_REPORTING_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field FATAL_ERROR_REPORTING_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field UNSUPPORTED_REQUEST_REPORTING_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field ENABLE_RELAXED_ORDERING (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field MAX_PAYLOAD_SIZE (RW)
 *
 * Max_Payload_Size
 */
...
/* --- Register HW_PCIE_DCONR, field EXTENDED_TAG_FIELD_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field PHANTOM_FUNCTION_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field AUX_POWER_PM_ENABLE (RW)
 *
 * AUX Power PM Enable
 */
...
/* --- Register HW_PCIE_DCONR, field ENABLE_NO_SNOOP (RW)
 *
 * Enable No Snoop
 */
...
/* --- Register HW_PCIE_DCONR, field MAX_READ_REQUEST_SIZE (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field CORRECTABLE_ERROR_DETECTED (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field NON_FATAL_ERROR_DETECTED (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field FATAL_ERROR_DETECTED (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field UNSUPPORTED_REQUEST_DETECTED (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field AUX_POWER_DETECTED (RW)
 *
...
/* --- Register HW_PCIE_DCONR, field TRANSACTION_PENDING (RW)
 *
...
/* --- Register HW_PCIE_LCR, field MAX_LINK_SPEEDS (RO)
 *
...
/* --- Register HW_PCIE_LCR, field MAXIMUM_LINK_WIDTH (RO)
 *
...
/* --- Register HW_PCIE_LCR, field ACTIVE_STATE_LINK_PM_SUPPORT (RO)
 *
...
/* --- Register HW_PCIE_LCR, field L0S_EXIT_LATENCY (RO)
 *
...
/* --- Register HW_PCIE_LCR, field L1_EXIT_LATENCY (RO)
 *
...
/* --- Register HW_PCIE_LCR, field CLOCK_POWER_MANAGEMENT (RO)
 *
...
/* --- Register HW_PCIE_LCR, field SURPRISE_DOWN_ERROR_REPORTING_CAPABLE (RO)
 *
...
/* --- Register HW_PCIE_LCR, field DATA_LINK_LAYER_ACTIVE_REPORTING_CAPABLE (RO)
 *
...
/* --- Register HW_PCIE_LCR, field LINK_BANDWIDTH_NOTIFICATION_CAPABILITY (RO)
 *
...
/* --- Register HW_PCIE_LCR, field PORT_NUMBER (RO)
 *
 * Port Number
 */
...
/* --- Register HW_PCIE_LCSR, field ACTIVE_STATE_LINK_PM_CONTROL (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field RCB (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field LINK_DISABLE (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field RETRAIN_LINK (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field COMMON_CLOCK_CONFIGURATION (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field EXTENDED_SYNCH (RW)
 *
 * Extended Synch
 */
...
/* --- Register HW_PCIE_LCSR, field ENABLE_CLOCK_POWER_MANAGEMENT (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field HARDWARE_AUTONOMOUS_WIDTH_DISABLE (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field LINK_SPEED (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field NEGOTIATED_LINK_WIDTH (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field LINK_TRAINING (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field SLOT_CLOCK_CONFIGURATION (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field DATA_LINK_LAYER_ACTIVE (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field LINK_BANDWIDTH_MANAGEMENT_STATUS (RW)
 *
...
/* --- Register HW_PCIE_LCSR, field LINK_AUTONOMOUS_BANDWIDTH_STATUS (RW)
 *
...
/* --- Register HW_PCIE_SCR, field POWER_CONTROLLER_PRESENT (RO)
 *
...
/* --- Register HW_PCIE_SCR, field MRL_SENSOR_PRESENT (RO)
 *
...
/* --- Register HW_PCIE_SCR, field HOT_PLUG_SURPRISE (RO)
 *
...
/* --- Register HW_PCIE_SCR, field HOT_PLUG_CAPABLE (RO)
 *
...
/* --- Register HW_PCIE_SCR, field SLOT_POWER_LIMIT_VALUE (RO)
 *
...
/* --- Register HW_PCIE_SCR, field SLOT_POWER_LIMIT_SCALE (RO)
 *
...
/* --- Register HW_PCIE_SCR, field ELECTROMECHANICAL_INTERLOCK_PRESENT (RO)
 *
...
/* --- Register HW_PCIE_SCR, field NO_COMMAND_COMPLETE_SUPPORT (RO)
 *
...
/* --- Register HW_PCIE_SCR, field PHYSICAL_SLOT_NUMBER (RO)
 *
...
/* --- Register HW_PCIE_SCSR, field ATTENTION_BUTTON_PRESSED_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field POWER_FAULT_DETECTED_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field MRL_SENSOR_CHANGED_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field PRESENCE_DETECT_CHANGED_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field COMMAND_COMPLETED_INTERRUPT_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field HOT_PLUG_INTERRUPT_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field ATTENTION_INDICATOR_CONTROL (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field POWER_INDICATOR_CONTROL (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field POWER_CONTROLLER_CONTROL (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field ELECTROMECHANICAL_INTERLOCK_CONTROL (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field DATA_LINK_LAYER_STATE_CHANGED_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field ATTENTION_BUTTON_PRESSED (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field POWER_FAULT_DETECTED (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field MRL_SENSOR_CHANGED (RW)
 *
 * MRL Sensor Changed
 */
...
/* --- Register HW_PCIE_SCSR, field PRESENCE_DETECT_CHANGED (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field COMMAND_COMPLETED (RW)
 *
 * Command Completed
 */
...
/* --- Register HW_PCIE_SCSR, field MRL_SENSOR_STATE (RW)
 *
 * MRL Sensor State
 */
...
/* --- Register HW_PCIE_SCSR, field PRESENCE_DETECT_STATE (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field ELECTROMECHANICAL_INTERLOCK_STATUS (RW)
 *
...
/* --- Register HW_PCIE_SCSR, field DATA_LINK_LAYER_STATE_CHANGED (RW)
 *
...
/* --- Register HW_PCIE_RCCR, field SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_RCCR, field SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_RCCR, field SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_RCCR, field PME_INTERRUPT_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_RCCR, field CRS_SOFTWARE_VISIBILITY_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_RCCR, field CRS_SOFTWARE_VISIBILITY (RW)
 *
...
/* --- Register HW_PCIE_RSR, field PME_REQUESTER_ID (W1C)
 *
 * PME Requester ID
 */
...
/* --- Register HW_PCIE_DCR2, field COMPLETION_TIMEOUT_RANGES_SUPPORTED (RO)
 *
...
/* --- Register HW_PCIE_DCR2, field COMPLETION_TIMEOUT_DISABLE_SUPPORTED (RO)
 *
...
/* --- Register HW_PCIE_DCSR2, field COMPLETION_TIMEOUT_VALUE (RW)
 *
...
/* --- Register HW_PCIE_DCSR2, field COMPLETION_TIMEOUT_DISABLE (RW)
 *
...
/* --- Register HW_PCIE_LCR2, field SUPPORTED_LINK_SPEEDS_VECTOR (RO)
 *
...
/* --- Register HW_PCIE_LCR2, field CROSSLINK_SUPPORTED (RO)
 *
 * Crosslink Supported
 */
...
/* --- Register HW_PCIE_LCSR2, field TARGET_LINK_SPEED (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field ENTER_COMPLIANCE (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field HARDWARE_AUTONOMOUS_SPEED_DISABLE (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field SELECTABLE_DEEMPHASIS (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field TRANSMIT_MARGIN (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field ENTER_MODIFIED_COMPLIANCE (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field COMPLIANCE_SOS (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field COMPLIANCE_PRE_SET_DEEMPHASIS (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field CURRENT_DEEMPHASIS_LEVEL (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field EQUALIZATION_COMPLETE (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field EQUALIZATION_PHASE_1_SUCCESSFUL (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field EQUALIZATION_PHASE_2_SUCCESSFUL (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field EQUALIZATION_PHASE_3_SUCCESSFUL (RW)
 *
...
/* --- Register HW_PCIE_LCSR2, field LINK_EQUALIZATION_REQUEST (RW)
 *
...
/* --- Register HW_PCIE_AER, field PCI_EXPRESS_EXTENDED_CAPABILITY_ID (RW)
 *
...
/* --- Register HW_PCIE_AER, field CAPABILITY_VERSION (RW)
 *
 * Capability Version
 */
...
/* --- Register HW_PCIE_AER, field NEXT_CAPABILITY_OFFSET (RW)
 *
...
/* --- Register HW_PCIE_UESR, field FLOW_CONTROL_PROTOCOL_ERROR_STATUS (RW)
 *
...
/* --- Register HW_PCIE_UESR, field COMPLETION_TIMEOUT_STATUS (RW)
 *
...
/* --- Register HW_PCIE_UESR, field COMPLETER_ABORT_STATUS (RW)
 *
...
/* --- Register HW_PCIE_UESR, field UNEXPECTED_COMPLETION_STATUS (RW)
 *
...
/* --- Register HW_PCIE_UESR, field RECEIVER_OVERFLOW_STATUS (RW)
 *
...
/* --- Register HW_PCIE_UESR, field MALFORMED_TLP_STATUS (RW)
 *
...
/* --- Register HW_PCIE_UESR, field ECRC_ERROR_STATUS (RW)
 *
 * ECRC Error Status
 */
...
/* --- Register HW_PCIE_UESR, field UNSUPPORTED_REQUEST_ERROR_STATUS (RW)
 *
...
/* --- Register HW_PCIE_UEMR, field SURPRISE_DOWN_ERROR_MASK (RW)
 *
...
/* --- Register HW_PCIE_UEMR, field POISONED_TLP_MASK (RW)
 *
 * Poisoned TLP Mask
 */
...
/* --- Register HW_PCIE_UEMR, field FLOW_CONTROL_PROTOCOL_ERROR_MASK (RW)
 *
...
/* --- Register HW_PCIE_UEMR, field COMPLETION_TIMEOUT_MASK (RW)
 *
...
/* --- Register HW_PCIE_UEMR, field COMPLETER_ABORT_MASK (RW)
 *
...
/* --- Register HW_PCIE_UEMR, field UNEXPECTED_COMPLETION_MASK (RW)
 *
...
/* --- Register HW_PCIE_UEMR, field RECEIVER_OVERFLOW_MASK (RW)
 *
...
/* --- Register HW_PCIE_UEMR, field MALFORMED_TLP_MASK (RW)
 *
 * Malformed TLP Mask
 */
...
/* --- Register HW_PCIE_UEMR, field ECRC_ERROR_MASK (RW)
 *
 * ECRC Error Mask
 */
...
/* --- Register HW_PCIE_UEMR, field UNSUPPORTED_REQUEST_ERROR_MASK (RW)
 *
...
/* --- Register HW_PCIE_UESEVR, field SURPRISE_DOWN_ERROR_SEVERITY (RW)
 *
...
/* --- Register HW_PCIE_UESEVR, field POISONED_TLP_SEVERITY (RW)
 *
...
/* --- Register HW_PCIE_UESEVR, field FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY (RW)
 *
...
/* --- Register HW_PCIE_UESEVR, field COMPLETION_TIMEOUT_SEVERITY (RW)
 *
...
/* --- Register HW_PCIE_UESEVR, field COMPLETER_ABORT_SEVERITY (RW)
 *
...
/* --- Register HW_PCIE_UESEVR, field UNEXPECTED_COMPLETION_SEVERITY (RW)
 *
...
/* --- Register HW_PCIE_UESEVR, field RECEIVER_OVERFLOW_SEVERITY (RW)
 *
...
/* --- Register HW_PCIE_UESEVR, field MALFORMED_TLP_SEVERITY (RW)
 *
...
/* --- Register HW_PCIE_UESEVR, field ECRC_ERROR_SEVERITY (RW)
 *
 * ECRC Error Severity
 */
...
/* --- Register HW_PCIE_UESEVR, field UNSUPPORTED_REQUEST_ERROR_SEVERITY (RW)
 *
...
/* --- Register HW_PCIE_CESR, field RECEIVER_ERROR_STATUS (RW)
 *
...
/* --- Register HW_PCIE_CESR, field BAD_TLP_STATUS (RW)
 *
 * Bad TLP Status
 */
...
/* --- Register HW_PCIE_CESR, field BAD_DLLP_STATUS (RW)
 *
 * Bad DLLP Status
 */
...
/* --- Register HW_PCIE_CESR, field REPLAY_NUM_ROLLOVER_STATUS (RW)
 *
...
/* --- Register HW_PCIE_CESR, field REPLY_TIMER_TIMEOUT_STATUS (RW)
 *
...
/* --- Register HW_PCIE_CESR, field ADVISORY_NON_FATAL_ERROR_STATUS (RW)
 *
...
/* --- Register HW_PCIE_CEMR, field RECEIVER_ERROR_MASK (RW)
 *
 * Receiver Error Mask
 */
...
/* --- Register HW_PCIE_CEMR, field BAD_TLP_MASK (RW)
 *
 * Bad TLP Mask
 */
...
/* --- Register HW_PCIE_CEMR, field BAD_DLLP_MASK (RW)
 *
 * Bad DLLP Mask
 */
...
/* --- Register HW_PCIE_CEMR, field REPLAY_NUM_ROLLOVER_MASK (RW)
 *
...
/* --- Register HW_PCIE_CEMR, field REPLY_TIMER_TIMEOUT_MASK (RW)
 *
...
/* --- Register HW_PCIE_CEMR, field ADVISORY_NON_FATAL_ERROR_MASK (RW)
 *
...
/* --- Register HW_PCIE_ACCR, field FIRST_ERROR_POINTER (RW)
 *
 * First Error Pointer
 */
...
/* --- Register HW_PCIE_ACCR, field ECRC_GENERATION_CAPABILITY (RW)
 *
...
/* --- Register HW_PCIE_ACCR, field ECRC_GENERATION_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_ACCR, field ECRC_CHECK_CAPABLE (RW)
 *
 * ECRC Check Capable
 */
...
/* --- Register HW_PCIE_ACCR, field ECRC_CHECK_ENABLE (RW)
 *
 * ECRC Check Enable
 */
...
/* --- Register HW_PCIE_RECR, field CORRECTABLE_ERROR_REPORTING_ENABLE (RW)
 *
 * Correctable Error Reporting Enable
 */
...
/* --- Register HW_PCIE_RECR, field NON_FATAL_ERROR_REPORTING_ENABLE (RW)
 *
 * Non-Fatal Error Reporting Enable
 */
...
/* --- Register HW_PCIE_RECR, field FATAL_ERROR_REPORTING_ENABLE (RW)
 *
 * Fatal Error Reporting Enable
 */
...
/* --- Register HW_PCIE_RESR, field ERR_COR_RECEIVED (RW)
 *
 * ERR_COR Received
 */
...
/* --- Register HW_PCIE_RESR, field MULTIPLE_ERR_COR_RECEIVED (RW)
 *
...
/* --- Register HW_PCIE_RESR, field ERR_FATAL_NONFATAL_RECEIVED (RW)
 *
...
/* --- Register HW_PCIE_RESR, field MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED (RW)
 *
...
/* --- Register HW_PCIE_RESR, field FIRST_UNCORRECTABLE_FATAL (RW)
 *
...
/* --- Register HW_PCIE_RESR, field NON_FATAL_ERROR_MESSAGES_RECEIVED (RW)
 *
...
/* --- Register HW_PCIE_RESR, field FATAL_ERROR_MESSAGES_RECEIVED (RW)
 *
...
/* --- Register HW_PCIE_RESR, field ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER (RW)
 *
...
/* --- Register HW_PCIE_ESIR, field ERR_COR_SID (RO)
 *
...
/* --- Register HW_PCIE_ESIR, field ERR_FATAL_NONFATAL_SID (RO)
 *
...
/* --- Register HW_PCIE_VCECHR, field EXTENDED_CAPABILITY (RO)
 *
...
/* --- Register HW_PCIE_VCECHR, field CAPABILITY_VERSION (RO)
 *
 * Capability Version
 */
...
/* --- Register HW_PCIE_VCECHR, field NEXT_CAPABILITY_OFFSET (RO)
 *
 * Next Capability Offset See Table 5-222 on page 641.
 */
...
/* --- Register HW_PCIE_PVCCR1, field EXTENDED_VC_COUNT (RO)
 *
...
/* --- Register HW_PCIE_PVCCR1, field LOW_PRIORITY_EXTENDED_VC_COUNT (RO)
 *
...
/* --- Register HW_PCIE_PVCCR1, field REFERENCE_CLOCK (RO)
 *
 * Reference Clock
 */
...
/* --- Register HW_PCIE_PVCCR1, field PORT_ARBITRATION_TABLE_ENTRY_SIZE (RO)
 *
...
/* --- Register HW_PCIE_PVCCR2, field VC_ARBITRATION_CAPABILITY (RO)
 *
...
/* --- Register HW_PCIE_PVCCR2, field VC_ARBITRATION_TABLE_OFFSET (RO)
 *
...
/* --- Register HW_PCIE_PVCCSR, field LOAD_VC_ARBITRATION_TABLE (RW)
 *
...
/* --- Register HW_PCIE_PVCCSR, field VC_ARBITRATION_SELECT (RW)
 *
...
/* --- Register HW_PCIE_PVCCSR, field ARBITRATION_TABLE_STATUS (RW)
 *
...
/* --- Register HW_PCIE_VCRCR, field PORT_ARBITRATION_CAPABILITY (RO)
 *
...
/* --- Register HW_PCIE_VCRCR, field MAXIMUM_TIME_SLOTS (RO)
 *
 * Maximum Time Slots
 */
...
/* --- Register HW_PCIE_VCRCR, field PORT_ARBITRATION_TABLE_OFFSET (RO)
 *
...
/* --- Register HW_PCIE_VCRCONR, field TC_VC_MAP (RW)
 *
...
/* --- Register HW_PCIE_VCRCONR, field LOAD_PORT_ARBITRATION_TABLE (RW)
 *
...
/* --- Register HW_PCIE_VCRCONR, field PORT_ARBITRATION_SELECT (RW)
 *
...
/* --- Register HW_PCIE_VCRCONR, field VC_ID (RW)
 *
...
/* --- Register HW_PCIE_VCRCONR, field VC_ENABLE (RW)
 *
...
/* --- Register HW_PCIE_VCRSR, field PORT_ARBITRATION_TABLE_STATUS (RO)
 *
...
/* --- Register HW_PCIE_VCRSR, field VC_NEGOTIATION_PENDING (RO)
 *
