...
/*!
 * @brief HW_PMU_REG_1P1 - Regulator 1P1 Register
 *
...
/*!
 * @brief HW_PMU_REG_3P0 - Regulator 3P0 Register
 *
...
/*!
 * @brief HW_PMU_REG_2P5 - Regulator 2P5 Register
 *
 ...
 *
 * Enables the weak 2p5 regulator.   This regulator is used when the main 2p5 regulator is disabled
 * to keep the 2.5V output roughly at 2.5V.  Depends directly on the value of VDDIO.
 */
...
/*!
 * @brief HW_PMU_REG_CORE - Digital Regulator Core Register
 *
 ...
 * reflect                                 25mV core voltage steps. Not all steps will make sense to
 * use either because of input supply                                  limitations or load
 * operation.
 */
 ...
 * adjustment is applied on top                              of any adjustment applied to the global
 * reference in the MISC0 Register.
 */
 ...
 * must be taken to only apply this bit                              when the input supply voltage
 * to the power fet is less than 1.1V. This bit should only be used in low power modes where
 * the external input supply voltage is nominally 0.9V.
 */
...
/*!
 * @brief HW_PMU_MISC0 - Miscellaneous Register 0
 *
 ...
 *
 * Control bit to disable the self-bias circuit in the analog bandgap.  The self-bias circuit is
 * used by the bandgap during startup.   This bit should be set after the bandgap has stabilized and
 * is necessary for best noise performance of analog blocks using the outputs of the bandgap. Value
...
/*!
 * @brief HW_PMU_REG_MISC1 - Miscellaneous Register 1
 *
 * This register defines the control and status bits for miscellaneous analog blocks.   The lvds1
 * and lvds2 controls below control the behavior of the anaclk1/1b and anaclk2/2b lvds IO's.
 */
#ifndef __LANGUAGE_ASM__
typedef union
{
...
/*!
 * @brief HW_PMU_REG_MISC2 - Miscellaneous Register 2
 *
