...
#define REGS_USDHC0_BASE (0x02190000) //!< Base address for USDHC instance number 0.
#define REGS_USDHC1_BASE (0x02194000) //!< Base address for USDHC instance number 1.
#define REGS_USDHC2_BASE (0x02198000) //!< Base address for USDHC instance number 2.
#define REGS_USDHC3_BASE (0x0219c000) //!< Base address for USDHC instance number 3.
...
/* --- Register HW_USDHC_DS_ADDR, field DS_ADDR (RW)
 *
...
/* --- Register HW_USDHC_BLK_ATT, field BLKSIZE (RW)
 *
...
/* --- Register HW_USDHC_BLK_ATT, field BLKCNT (RW)
 *
...
/* --- Register HW_USDHC_CMD_ARG, field CMDARG (RW)
 *
...
/* --- Register HW_USDHC_CMD_XFR_TYP, field RSPTYP (RW)
 *
...
/* --- Register HW_USDHC_CMD_XFR_TYP, field CCCEN (RW)
 *
...
/* --- Register HW_USDHC_CMD_XFR_TYP, field CICEN (RW)
 *
...
/* --- Register HW_USDHC_CMD_XFR_TYP, field DPSEL (RW)
 *
...
/* --- Register HW_USDHC_CMD_XFR_TYP, field CMDTYP (RW)
 *
...
/* --- Register HW_USDHC_CMD_XFR_TYP, field CMDINX (RW)
 *
...
/* --- Register HW_USDHC_CMD_RSP0, field CMDRSP0 (RO)
 *
...
/* --- Register HW_USDHC_CMD_RSP1, field CMDRSP1 (RO)
 *
...
/* --- Register HW_USDHC_CMD_RSP2, field CMDRSP2 (RO)
 *
...
/* --- Register HW_USDHC_CMD_RSP3, field CMDRSP3 (RO)
 *
...
/* --- Register HW_USDHC_DATA_BUFF_ACC_PORT, field DATCONT (RW)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field CIHB (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field CDIHB (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field DLA (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field SDSTB (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field IPGOFF (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field HCKOFF (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field PEROFF (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field SDOFF (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field WTA (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field RTA (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field BWEN (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field BREN (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field RTR (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field CINST (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field CDPL (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field WPSPL (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field CLSL (RO)
 *
...
/* --- Register HW_USDHC_PRES_STATE, field DLSL (RO)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field LCTL (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field DTW (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field D3CD (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field EMODE (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field CDTL (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field CDSS (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field DMASEL (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field SABGREQ (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field CREQ (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field RWCTL (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field IABG (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field RD_DONE_NO_8CLK (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field RD_WAIT_POINT (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field WECINT (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field WECINS (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field WECRM (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field BURST_LEN_EN (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field NON_EXACT_BLK_RD (RW)
 *
...
/* --- Register HW_USDHC_PROT_CTRL, field RD_NO8CLK_EN (RW)
 *
...
/* --- Register HW_USDHC_SYS_CTRL, field IPGEN (RW)
 *
...
/* --- Register HW_USDHC_SYS_CTRL, field HCKEN (RW)
 *
...
/* --- Register HW_USDHC_SYS_CTRL, field PEREN (RW)
 *
...
/* --- Register HW_USDHC_SYS_CTRL, field SDCLKEN (RW)
 *
...
/* --- Register HW_USDHC_SYS_CTRL, field DVS (RW)
 *
...
/* --- Register HW_USDHC_SYS_CTRL, field SDCLKFS (RW)
 *
...
/* --- Register HW_USDHC_SYS_CTRL, field DTOCV (RW)
 *
...
/* --- Register HW_USDHC_SYS_CTRL, field RST_FIFO (WORZ)
 *
...
/* --- Register HW_USDHC_SYS_CTRL, field RSTA (WORZ)
 *
...
/* --- Register HW_USDHC_INT_STATUS, field CC (W1C)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field CCSEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field TCSEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field BGESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field DINTSEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field BWRSEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field BRRSEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field CINSSEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field CRMSEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field CINTSEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field RTESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field TPSEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field CTOESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field CCESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field CEBESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field CIESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field DTOESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field DCESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field DEBESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field AC12ESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field TNESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_STATUS_EN, field DMAESEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field CCIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field TCIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field BGEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field DINTIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field BWRIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field BRRIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field CINSIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field CRMIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field CINTIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field RTEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field TPIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field CTOEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field CCEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field CEBEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field CIEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field DTOEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field DCEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field DEBEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field AC12EIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field TNEIEN (RW)
 *
...
/* --- Register HW_USDHC_INT_SIGNAL_EN, field DMAEIEN (RW)
 *
...
/* --- Register HW_USDHC_AUTOCMD12_ERR_STATUS, field AC12NE (RO)
 *
...
/* --- Register HW_USDHC_AUTOCMD12_ERR_STATUS, field AC12TOE (RO)
 *
...
/* --- Register HW_USDHC_AUTOCMD12_ERR_STATUS, field AC12EBE (RO)
 *
...
/* --- Register HW_USDHC_AUTOCMD12_ERR_STATUS, field AC12CE (RO)
 *
...
/* --- Register HW_USDHC_AUTOCMD12_ERR_STATUS, field AC12IE (RO)
 *
...
/* --- Register HW_USDHC_AUTOCMD12_ERR_STATUS, field CNIBAC12E (RO)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_CAP, field MBL (RO)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_CAP, field ADMAS (RO)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_CAP, field HSS (RO)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_CAP, field DMAS (RO)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_CAP, field SRS (RO)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_CAP, field VS33 (RO)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_CAP, field VS30 (RO)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_CAP, field VS18 (RO)
 *
...
/* --- Register HW_USDHC_WTMK_LVL, field RD_WML (RW)
 *
...
/* --- Register HW_USDHC_WTMK_LVL, field RD_BRST_LEN (RW)
 *
...
/* --- Register HW_USDHC_WTMK_LVL, field WR_WML (RW)
 *
...
/* --- Register HW_USDHC_WTMK_LVL, field WR_BRST_LEN (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field DMAEN (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field BCEN (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field AC12EN (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field DDR_EN (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field DTDSEL (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field MSBSEL (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field NIBBLE_POS (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field AC23EN (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field EXE_TUNE (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field SMP_CLK_SEL (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field AUTO_TUNE_EN (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field FBCLK_SEL (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field AC12_RD_POINT (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field CMD_DMY_WAIT_CFG (RW)
 *
...
/* --- Register HW_USDHC_MIX_CTRL, field CMD_DMY_EN (RW)
 *
...
/* --- Register HW_USDHC_FORCE_EVENT, field FEVTAC12NE (WORZ)
 *
...
/* --- Register HW_USDHC_ADMA_ERR_STATUS, field ADMAES (RO)
 *
...
/* --- Register HW_USDHC_ADMA_ERR_STATUS, field ADMALME (RO)
 *
...
/* --- Register HW_USDHC_ADMA_ERR_STATUS, field ADMADCE (RO)
 *
...
/* --- Register HW_USDHC_ADMA_SYS_ADDR, field ADS_ADDR (RW)
 *
...
/* --- Register HW_USDHC_DLL_CTRL, field DLL_CTRL_ENABLE (RW)
 *
...
/* --- Register HW_USDHC_DLL_CTRL, field DLL_CTRL_RESET (RW)
 *
...
/* --- Register HW_USDHC_DLL_CTRL, field DLL_CTRL_SLV_FORCE_UPD (RW)
 *
...
/* --- Register HW_USDHC_DLL_CTRL, field DLL_CTRL_GATE_UPDATE (RW)
 *
...
/* --- Register HW_USDHC_DLL_CTRL, field DLL_CTRL_SLV_OVERRIDE (RW)
 *
...
/* --- Register HW_USDHC_DLL_CTRL, field DLL_CTRL_SLV_OVERRIDE_VAL (RW)
 *
...
/* --- Register HW_USDHC_DLL_CTRL, field DLL_CTRL_REF_UPDATE_INT (RW)
 *
...
/* --- Register HW_USDHC_DLL_STATUS, field DLL_STS_SLV_LOCK (RO)
 *
...
/* --- Register HW_USDHC_DLL_STATUS, field DLL_STS_REF_LOCK (RO)
 *
...
/* --- Register HW_USDHC_DLL_STATUS, field DLL_STS_SLV_SEL (RO)
 *
...
/* --- Register HW_USDHC_DLL_STATUS, field DLL_STS_REF_SEL (RO)
 *
...
/* --- Register HW_USDHC_CLK_TUNE_CTRL_STATUS, field DLY_CELL_SET_POST (RW)
 *
...
/* --- Register HW_USDHC_CLK_TUNE_CTRL_STATUS, field DLY_CELL_SET_OUT (RW)
 *
...
/* --- Register HW_USDHC_CLK_TUNE_CTRL_STATUS, field DLY_CELL_SET_PRE (RW)
 *
...
/* --- Register HW_USDHC_CLK_TUNE_CTRL_STATUS, field NXT_ERR (RO)
 *
...
/* --- Register HW_USDHC_CLK_TUNE_CTRL_STATUS, field TAP_SEL_POST (RO)
 *
...
/* --- Register HW_USDHC_CLK_TUNE_CTRL_STATUS, field TAP_SEL_OUT (RO)
 *
...
/* --- Register HW_USDHC_CLK_TUNE_CTRL_STATUS, field TAP_SEL_PRE (RO)
 *
...
/* --- Register HW_USDHC_CLK_TUNE_CTRL_STATUS, field PRE_ERR (RO)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field EXT_DMA_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field VSELECT (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field CONFLICT_CHK_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field AC12_WR_CHKBUSY_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field DAT3_CD_POL (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field CD_POL (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field WP_POL (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field CLKONJ_IN_ABORT (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field FRC_SDCLK_ON (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field AC12_ISNOT_ABORT (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field DDREN_ACT_ATONCE (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field IPG_CLK_SOFT_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field HCLK_SOFT_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field IPG_PERCLK_SOFT_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field CRC_CHK_DIS (RW)
 *
 * CRC check disable
 *
 * Values:
...
/* --- Register HW_USDHC_VEND_SPEC, field INT_ST_VAL (RO)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field DBG_SEL (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field CMD_OE_PRE_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field AC12_RD_CHKBUSY_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC, field CARD_DET_IN_IDLE_ENJ (RW)
 *
...
/* --- Register HW_USDHC_MMC_BOOT, field DTOCV_ACK (RW)
 *
...
/* --- Register HW_USDHC_MMC_BOOT, field BOOT_ACK (RW)
 *
...
/* --- Register HW_USDHC_MMC_BOOT, field BOOT_MODE (RW)
 *
...
/* --- Register HW_USDHC_MMC_BOOT, field BOOT_EN (RW)
 *
...
/* --- Register HW_USDHC_MMC_BOOT, field AUTO_SABG_EN (RW)
 *
...
/* --- Register HW_USDHC_MMC_BOOT, field DISABLE_TIME_OUT (RW)
 *
...
/* --- Register HW_USDHC_MMC_BOOT, field BOOT_BLK_CNT (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC2, field SDR104_TIMING_DIS (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC2, field SDR104_OE_DIS (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC2, field SDR104_NSD_DIS (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC2, field CARD_INT_D3_TEST (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC2, field TUNING_8BIT_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC2, field TUNING_1BIT_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC2, field TUNING_CMD_EN (RW)
 *
...
/* --- Register HW_USDHC_VEND_SPEC2, field CARD_INT_AUTO_CLR_DIS (RW)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_VER, field SVN (RO)
 *
...
/* --- Register HW_USDHC_HOST_CTRL_VER, field VVN (RO)
 *
