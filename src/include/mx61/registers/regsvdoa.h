...
/* --- Register HW_VDOA_VDOAC, field BNDM (RW)
 *
 * BNDM Band Size
 *
 * Values:
 * 00 - Band height = 8 lines.- Supported only for interlaced scan (SO=1)
 * 01 - Band height = 16 lines.
 * 10 - Band height = 32 lines.
 * 11 - reserved
 */
...
/* --- Register HW_VDOA_VDOAC, field NF (RW)
 *
...
/* --- Register HW_VDOA_VDOAC, field SYNC (RW)
 *
...
/* --- Register HW_VDOA_VDOAC, field SO (RW)
 *
 * Scan Order
 *
 * Values:
 * 0 - Scan order is progressive
 * 1 - Scan order is interlaced
 */
...
/* --- Register HW_VDOA_VDOAC, field PFS (RW)
 *
 ...
 *
 * Values:
 * 0 - partialy interleaved 4:2:0
 * 1 - interleaved 4:2:2 Y1U1Y2V1
 */
...
/* --- Register HW_VDOA_VDOAC, field ISEL (RW)
 *
...
/* --- Register HW_VDOA_VDOASRR, field SWRST (RW)
 *
...
/* --- Register HW_VDOA_VDOASRR, field START (RW)
 *
 ...
 * Values:
 * 0 - Ignored
 * 1 - Start a new transfer All registers we copied internally so any write to them will take place only in
...
/* --- Register HW_VDOA_VDOAIE, field EIEOT (RW)
 *
...
/* --- Register HW_VDOA_VDOAIE, field EITERR (RW)
 *
...
/* --- Register HW_VDOA_VDOAIST, field EOT (W1C)
 *
...
/* --- Register HW_VDOA_VDOAFP, field FW (RW)
 *
...
/* --- Register HW_VDOA_VDOAFP, field FH (RW)
 *
...
/* --- Register HW_VDOA_VDOAIEBA00, field IEBA00 (RW)
 *
...
/* --- Register HW_VDOA_VDOAIEBA01, field IEBA01 (RW)
 *
...
/* --- Register HW_VDOA_VDOAIEBA02, field IEBA02 (RW)
 *
...
/* --- Register HW_VDOA_VDOAIEBA10, field IEBA10 (RW)
 *
...
/* --- Register HW_VDOA_VDOAIEBA11, field IEBA11 (RW)
 *
...
/* --- Register HW_VDOA_VDOAIEBA12, field IEBA12 (RW)
 *
...
/* --- Register HW_VDOA_VDOASL, field ISLY (RW)
 *
...
/* --- Register HW_VDOA_VDOASL, field VSLY (RW)
 *
...
/* --- Register HW_VDOA_VDOAIUBO, field IUBO (RW)
 *
...
/* --- Register HW_VDOA_VDOAVEBA0, field VEBA0 (RW)
 *
...
/* --- Register HW_VDOA_VDOAVEBA1, field VEBA1 (RW)
 *
...
/* --- Register HW_VDOA_VDOAVEBA2, field VEBA2 (RW)
 *
...
/* --- Register HW_VDOA_VDOAVUBO, field VUBO (RW)
 *
...
/* --- Register HW_VDOA_VDOASR, field CURRENT_BUFFER (RO)
 *
...
/* --- Register HW_VDOA_VDOASR, field CURRENT_FRAME (RO)
 *
...
/* --- Register HW_VDOA_VDOASR, field EOB (RO)
 *
...
/* --- Register HW_VDOA_VDOASR, field ERRW (RO)
 *
