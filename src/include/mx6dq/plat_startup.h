...
dcd_write_data_cmd: .long 0x04D402CC /* Tag=0xCC, Len=4 + 8*90, Param=0x04 */
    ...
    /*
     * Below is a list of 90 elements (DCD_DATA), if this number is modified,
     * the size must be re-calculated like shown above.
     */
...
/* 
 * The following seems also functional for the EVB.
 * Have to unify this later if possible !
 */
#if defined(MX6DQ_SMART_DEVICE)
dcd_header:         .long 0x40C002D2 /* Tag=0xD2, Len=4 + 4 + 8*87, Ver=0x40 */
dcd_write_data_cmd: .long 0x04BC02CC /* Tag=0xCC, Len=4 + 8*87, Param=0x04 */

    /*
     * Below is a list of 87 elements (DCD_DATA), if this number is modified,
     * the size must be re-calculated like shown above.
     */
    /*Use default DDR frequency: 528MHz*/
    DCD_DATA(0x020e05a8, 0x00000028)
    DCD_DATA(0x020e05b0, 0x00000028)
    DCD_DATA(0x020e0524, 0x00000028)
    DCD_DATA(0x020e051c, 0x00000028)
    DCD_DATA(0x020e0518, 0x00000028)
    DCD_DATA(0x020e050c, 0x00000028)
    DCD_DATA(0x020e05b8, 0x00000028)
    DCD_DATA(0x020e05c0, 0x00000028)
    DCD_DATA(0x020e05ac, 0x00000028)
    DCD_DATA(0x020e05b4, 0x00000028)
    DCD_DATA(0x020e0528, 0x00000028)
    DCD_DATA(0x020e0520, 0x00000028)
    DCD_DATA(0x020e0514, 0x00000028)
    DCD_DATA(0x020e0510, 0x00000028)
    DCD_DATA(0x020e05bc, 0x00000028)
    DCD_DATA(0x020e05c4, 0x00000028)
    DCD_DATA(0x020e0784, 0x00000028)
    DCD_DATA(0x020e0788, 0x00000028)
    DCD_DATA(0x020e0794, 0x00000028)
    DCD_DATA(0x020e079c, 0x00000028)
    DCD_DATA(0x020e07a0, 0x00000028)
    DCD_DATA(0x020e07a4, 0x00000028)
    DCD_DATA(0x020e07a8, 0x00000028)
    DCD_DATA(0x020e0748, 0x00000028)
    DCD_DATA(0x020e0588, 0x00000030)
    DCD_DATA(0x020e0594, 0x00000030)
    DCD_DATA(0x020e056c, 0x00000030)
    DCD_DATA(0x020e0578, 0x00000030)
    DCD_DATA(0x020e074c, 0x00000030)
    DCD_DATA(0x020e078c, 0x00000030)
    DCD_DATA(0x020e057c, 0x00020030)
    DCD_DATA(0x020e059c, 0x00003030)
    DCD_DATA(0x020e05a0, 0x00003030)
    DCD_DATA(0x020e0590, 0x00003000)
    DCD_DATA(0x020e0598, 0x00003000)
    ...
    DCD_DATA(0x021b4824, 0x33333333)
    DCD_DATA(0x021b4828, 0x33333333)
    DCD_DATA(0x021b0018, 0x00001740)
    DCD_DATA(0x021b001c, 0x00008000)
    DCD_DATA(0x021b000c, 0x555A7975)
    DCD_DATA(0x021b0010, 0xFF538F64)
    DCD_DATA(0x021b0014, 0x01ff00db)
    DCD_DATA(0x021b002c, 0x000076d2)
    DCD_DATA(0x021b0030, 0x005b0e21)
    DCD_DATA(0x021b0008, 0x09444040)
    DCD_DATA(0x021b0004, 0x00025576)
    DCD_DATA(0x021b0040, 0x00000027)
    DCD_DATA(0x021b0000, 0x831a0000)
    DCD_DATA(0x021b0800, 0xa1380003)
    DCD_DATA(0x021b083c, 0x43220322)
    DCD_DATA(0x021b0840, 0x03020302)
    DCD_DATA(0x021b483c, 0x430E030E)
    DCD_DATA(0x021b4840, 0x02540254)
    DCD_DATA(0x021b0848, 0x493C3B3E)
    DCD_DATA(0x021b4848, 0x41413645)
    DCD_DATA(0x021b0850, 0x37464944)
    DCD_DATA(0x021b4850, 0x4A2B4C39)
    DCD_DATA(0x021b080c, 0x001F001F)
    DCD_DATA(0x021b0810, 0x001F001F)
    DCD_DATA(0x021b480c, 0x001F001F)
    DCD_DATA(0x021b4810, 0x001F001F)
    DCD_DATA(0x021b08b8, 0x00000800)
    DCD_DATA(0x021b48b8, 0x00000800)
    DCD_DATA(0x021b001c, 0x04088032)
    DCD_DATA(0x021b001c, 0x00008033)
    ...
    DCD_DATA(0x021b4818, 0x00022227)
    DCD_DATA(0x021b001c, 0x00000000)
    DCD_DATA(0x020E0010, 0xF00000FF)
    DCD_DATA(0x020E0018, 0x00070007)
    DCD_DATA(0x020E001C, 0x00070007)
    DCD_DATA(0x021b0404, 0x00011006)
#endif /* (defined MX6DQ_SMART_DEVICE) */

#if defined(MX6DQ_SABRE_LITE)
dcd_header:         .long 0x40F002D2 /* Tag=0xD2, Len=4 + 4 + 8*93, Ver=0x40 */
dcd_write_data_cmd: .long 0x04EC02CC /* Tag=0xCC, Len=4 + 8*93, Param=0x04 */
