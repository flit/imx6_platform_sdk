...
/*
 * i.MX6DQ SATA_PHY_CLOCK registers defined in this header file.
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CRCMP_LT_LIMIT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_LT_LIMIT, field CRCMP_LT_LIMIT[15:0] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CRCMP_GT_LIMIT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_GT_LIMIT, field CRCMP_GT_LIMIT[15:0] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CRCMP_MASK register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_MASK, field CRCMP_MASK[15:0] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CRCMP_CTL register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_CTL, field HOLD_SCRATCH0[0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_CTL, field HOLD_SCRATCH1[1] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CRCMP_STAT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_STAT, field S0_LOW[0] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_STAT, field S0_HIGH[1] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_STAT, field S1_S0_LOW[2] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_STAT, field S1_S0_HIGH[3] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_STAT, field S0_OUTSIDE[4] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CRCMP_STAT, field S1_S0_OUTSIDE[5] (RO)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_SCOPE_SAMPLES register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_SCOPE_SAMPLES, field SCOPE_SAMPLES[15:0] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_SCOPE_COUNT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_SCOPE_COUNT, field SCOPE_COUNT[15:0] (RO)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_DAC_CTL register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_DAC_CTL, field DAC_VAL[9:0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_DAC_CTL, field OVRD_RTUNE_TX[10] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_DAC_CTL, field OVRD_RTUNE_RX[11] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_DAC_CTL, field DAC_MODE[14:12] (RW)
 *
 * DAC output mode:
 *
 * Values:
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_RTUNE_CTL register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field MODE[1:0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field FRC_PWRON[2] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field PWRON_LCL[3] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field SEL_ATBP[4] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field RSC_X4[5] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field DAC_CHOP[6] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field CMP_INVERT[7] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field RTUNE_DIS[8] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field RTUNE_TRIG[9] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_RTUNE_CTL, field ADC_TRIG[10] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_ADC_OUT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_ADC_OUT, field VALUE[9:0] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_ADC_OUT, field FRESH[10] (RO)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_SS_PHASE register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_SS_PHASE, field DTHR[1:0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_SS_PHASE, field VAL[11:2] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_SS_PHASE, field ZERO_FREQ[12] (RW)
 *
 ...
 *
 * Address: 0x000C  This register contains the internal chip ID (high 16 bits) of the JTAG
 * interface.
 */
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CHIP_ID_HI register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CHIP_ID_HI, field CHIP_ID_HI[15:0] (RO)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CHIP_ID_LOW register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CHIP_ID_LOW, field CHIP_ID_LO[15:0] (RO)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_FREQ_STAT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_FREQ_STAT, field PROP_CTL[2:0] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_FREQ_STAT, field INT_CTL[5:3] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_FREQ_STAT, field NCY5[7:6] (RO)
 *
 * Divide-by-5 control
 */
...
/* --- Register HW_SATA_PHY_CLOCK_FREQ_STAT, field NCY[12:8] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_FREQ_STAT, field PRESCALE[14:13] (RO)
 *
 * Prescaler control
 */
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CTL_STAT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field USE_REFCLK_ALT[0] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field MPLL_CLK_OFF[1] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field MPLL_PWRON[2] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field MPLL_SS_EN[3] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field CKO_ALIVE_CON[5:4] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field CKO_WORD_CON[8:6] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field RTUNE_DO_TUNE[10] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field WIDE_XFACE[11] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field VPH_IS_3P3[12] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field VP_IS_1P2[13] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_STAT, field FAST_TECH[14] (RO)
 *
 * Technology is fast
 */
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_LVL_STAT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_LVL_STAT, field ACJT_LVL[4:0] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_LVL_STAT, field LOS_LVL[9:5] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_LVL_STAT, field TX_LVL[14:10] (RO)
 *
 * Transmit level
 */
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CREG_STAT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_STAT, field CR_READ[0] (RO)
 *
 * Read request
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_STAT, field CR_WRITE[1] (RO)
 *
 * Write request
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_STAT, field CR_CAP_DATA[2] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_STAT, field CR_CAP_ADDR[3] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_STAT, field CR_ACK[5] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_STAT, field POWER_GOOD[6] (RO)
 *
 * Power good output
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_STAT, field OP_DONE[7] (RO)
 *
...
typedef union _hw_sata_phy_clock_frew_ovrd
{
    ...
    struct _hw_sata_phy_clock_frew_ovrd_bitfields
    {
        ...
        unsigned short NCY5 : 2; //!< [7:6] Divide-by-5 control MPLL Divider period = 4 x (NCY + 1) + NCY5.
        unsigned short NCY : 5; //!< [12:8] Divide-by-4 cycle control MPLL Divider period = 4 x (NCY + 1) + NCY5.
        unsigned short PRESCALE : 2; //!< [14:13] Prescaler control:
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_FREW_OVRD register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_FREW_OVRD, field PROP_CTL[2:0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_FREW_OVRD, field INT_CTL[5:3] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_FREW_OVRD, field NCY5[7:6] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_FREW_OVRD, field NCY[12:8] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_FREW_OVRD, field PRESCALE[14:13] (RW)
 *
 * Prescaler control:
 *
 * Values:
...
/* --- Register HW_SATA_PHY_CLOCK_FREW_OVRD, field OVRD[15] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CTL_OVRD register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field USE_REFCLK_ALT[0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field MPLL_CLK_OFF[1] (RW)
 *
 * Reference clock is off
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field MPLL_PWRON[2] (RW)
 *
 * MPLL power-on control
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field MPLL_SS_EN[3] (RW)
 *
 * Spread spectrum enable
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field CKO_ALIVE_CON[5:4] (RW)
 *
 * cko_alive mux control
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field CKO_WORD_CON[8:6] (RW)
 *
 * cko_word mux control
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field OVRD_CLK[9] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field RTUNE_DO_TUNE[10] (RW)
 *
 * Manual resistor tune control
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field WIDE_XFACE[11] (RW)
 *
 * Wide interface control
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field VPH_IS_3P3[12] (RW)
 *
 * High-voltage supply is 3.3 V
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field VP_IS_1P2[13] (RW)
 *
 * Low-voltage supply is 1.2 V
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field FAST_TECH[14] (RW)
 *
 * Technology is fast
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CTL_OVRD, field OVRD_STATIC[15] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_LVL_OVRD register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_LVL_OVRD, field ACJT_LVL[4:0] (RW)
 *
 * ACJTAG comparator level
 */
...
/* --- Register HW_SATA_PHY_CLOCK_LVL_OVRD, field LOS_LVL[9:5] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_LVL_OVRD, field LEVEL_TX_LVL[14:10] (RW)
 *
 * Transmit level
 */
...
/* --- Register HW_SATA_PHY_CLOCK_LVL_OVRD, field OVRD[15] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_CREG_OVRD register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_OVRD, field CR_READ[0] (RW)
 *
 * Reads request
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_OVRD, field CR_WRITE[1] (RW)
 *
 * Writes request
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_OVRD, field CR_CAP_DATA[2] (RW)
 *
 * Captures data request
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_OVRD, field CR_CAP_ADDR[3] (RW)
 *
 * Captures address request
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_OVRD, field OVRD_IN[4] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_OVRD, field CR_ACK[5] (RW)
 *
 * Creg request acknowledgement
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_OVRD, field POWER_GOOD[6] (RW)
 *
 * Power good output
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_OVRD, field OP_DONE[7] (RW)
 *
 * Operation is complete output
 */
...
/* --- Register HW_SATA_PHY_CLOCK_CREG_OVRD, field OVRD_OUT[8] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_MPLL_CTL register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_CTL, field CLKDRV_ANA[0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_CTL, field CLKDRV_DIG[1] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_CTL, field OVRD_CLKDRV[2] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_CTL, field DIS_PARA_CREG[3] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_CTL, field REFCLK_DELAY[4] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_CTL, field DTB_SEL0[9:5] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_CTL, field DTB_SEL1[14:10] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_MPLL_TEST register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_TEST, field ATB_SENSE[0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_TEST, field MEAS_GD[1] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_TEST, field MEAS_IV[12:2] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_TEST, field RESET_VAL[13] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_TEST, field GEARSHIFT_VAL[14] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_MPLL_TEST, field OVRD_CTL[15] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_SS_FREQ register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_SS_FREQ, field FREQ_CNT_INIT[6:0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_SS_FREQ, field FREQ_PK[13:7] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_SS_FREQ, field FREQ_REG_OVRD[14] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_SEL_STAT register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_SEL_STAT, field MPLL_SS_SEL[1:0] (RO)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_SEL_STAT, field REF_CLK_SEL[9:2] (RO)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_SEL_OVRD register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_SEL_OVRD, field MPLL_SS_SEL[1:0] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_SEL_OVRD, field REF_CLK_SEL[9:2] (RW)
 *
...
/* --- Register HW_SATA_PHY_CLOCK_SEL_OVRD, field CLK_SEL_OVRD[10] (RW)
 *
...
/*
 * constants & macros for entire SATA_PHY_CLOCK_RESET register
 */
...
/* --- Register HW_SATA_PHY_CLOCK_RESET, field RESET[0] (WO)
 *
