...
#if defined(MX6SDL_EVB) || defined(MX6SDL_SMART_DEVICE) || defined(MX6SDL_SABRE_LITE)
...
/* 
 * MX6SDL_SMART_DEVICE/MX6SDL_SABRE_LITE for compile error
 */
#if defined(MX6SDL_SMART_DEVICE) || defined(MX6SDL_SABRE_LITE)
...
#elif defined(MX6SDL_EVB)
#define BOARD_TYPE_ID           BOARD_ID_MX6SDL_EVB
#elif defined(MX6SDL_SABRE_LITE)
