...
/*
 * i.MX6SDL GPT registers defined in this header file.
 *
...
/* --- Register HW_GPT_CR, field _24MEN[10] (RW)
 *
...
#define BG_GPT_CR__24MEN(r)   (((r) & BM_GPT_CR__24MEN) >> BP_GPT_CR__24MEN)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield GPT_CR__24MEN.
#define BF_GPT_CR__24MEN(v)   ((((reg32_t) v) << BP_GPT_CR__24MEN) & BM_GPT_CR__24MEN)
#else
//! @brief Format value for bitfield GPT_CR__24MEN.
#define BF_GPT_CR__24MEN(v)   (((v) << BP_GPT_CR__24MEN) & BM_GPT_CR__24MEN)
#endif
...
#define BG_GPT_PR_PRESCALER24M(r)   (((r) & BM_GPT_PR_PRESCALER24M) >> BP_GPT_PR_PRESCALER24M)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield GPT_PR_PRESCALER24M.
#define BF_GPT_PR_PRESCALER24M(v)   ((((reg32_t) v) << BP_GPT_PR_PRESCALER24M) & BM_GPT_PR_PRESCALER24M)
#else
//! @brief Format value for bitfield GPT_PR_PRESCALER24M.
#define BF_GPT_PR_PRESCALER24M(v)   (((v) << BP_GPT_PR_PRESCALER24M) & BM_GPT_PR_PRESCALER24M)
#endif
