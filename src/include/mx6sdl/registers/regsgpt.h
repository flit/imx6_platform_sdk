...
typedef union
{
    ...
    struct
    {
        ...
        unsigned _24MEN : 1; //!< Enable 24MHz clock input from crystal. A hardware reset resets the 24MEN bit. A software reset does not affect the 24MEN bit.
        unsigned RESERVED0 : 4; //!< Reserved bits. Writing a value to these reserved bits will not affect GPT operations. These reserved bits are always read as zero. It is recommended that all writes to these reserved bits be 0 (for forward compatibility).
...
/* --- Register HW_GPT_CR, field _24MEN[10:10] (RW)
 *
...
#define BP_GPT_CR__24MEN      (10)
#define BM_GPT_CR__24MEN      (0x00000400)

#ifndef __LANGUAGE_ASM__
#define BF_GPT_CR__24MEN(v)   ((((reg32_t) v) << 10) & BM_GPT_CR__24MEN)
#else
#define BF_GPT_CR__24MEN(v)   (((v) << 10) & BM_GPT_CR__24MEN)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the _24MEN field to a new value.
#define BW_GPT_CR__24MEN(v)   BF_CS1(GPT_CR, _24MEN, v)
#endif
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned PRESCALER24M : 4; //!< Prescaler bits. 24M crystal clock is divided by [PRESCALER24M + 1] before selected by the CLKSRC field. If 24M crystal clock is not selected, this feild takes no effect.
        unsigned RESERVED0 : 16; //!< Reserved bits. Writing a value to these reserved bits will not affect GPT operations. These reserved bits are always read as zero.
    } B;
} hw_gpt_pr_t;
#endif
...
/* --- Register HW_GPT_PR, field PRESCALER24M[15:12] (RW)
 *
...
#define BP_GPT_PR_PRESCALER24M      (12)
#define BM_GPT_PR_PRESCALER24M      (0x0000f000)

#ifndef __LANGUAGE_ASM__
#define BF_GPT_PR_PRESCALER24M(v)   ((((reg32_t) v) << 12) & BM_GPT_PR_PRESCALER24M)
#else
#define BF_GPT_PR_PRESCALER24M(v)   (((v) << 12) & BM_GPT_PR_PRESCALER24M)
#endif
#ifndef __LANGUAGE_ASM__
//! @brief Set the PRESCALER24M field to a new value.
#define BW_GPT_PR_PRESCALER24M(v)   BF_CS1(GPT_PR, PRESCALER24M, v)
#endif
