...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field CLK3D_DIS[0:0] (RW)
 *
 * Disable 3D clock.
 */
...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field CLK2D_DIS[1:1] (RW)
 *
 * Disable 2D clock.
 */
...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field FSCALE_CMD_LOAD[9:9] (RW)
 *
...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field DISABLE_RAM_CLOCK_GATING[10:10] (RW)
 *
...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field DISABLE_DEBUG_REGISTERS[11:11] (RW)
 *
...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field SOFT_RESET[12:12] (RW)
 *
 * Soft resets the IP.
 */
...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field IDLE3_D[16:16] (RW)
 *
 * 3D pipe is idle.
 */
...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field IDLE2_D[17:17] (RW)
 *
 * 2D pipe is idle.
 */
...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field IDLE_VG[18:18] (RW)
 *
 * VG is idle.
 */
...
/* --- Register HW_GPU3D_AQH_CLK_CTRL, field ISOLATE_GPU[19:19] (RW)
 *
 * Isolate GPU bit
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_FE[0:0] (RO)
 *
 * FE is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_DE[1:1] (RO)
 *
 * DE is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_PE[2:2] (RO)
 *
 * PE is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_SH[3:3] (RO)
 *
 * SH is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_PA[4:4] (RO)
 *
 * PA is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_SE[5:5] (RO)
 *
 * SE is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_RA[6:6] (RO)
 *
 * RA is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_TX[7:7] (RO)
 *
 * TX is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_VG[8:8] (RO)
 *
 * VG is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_IM[9:9] (RO)
 *
 * IM is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_FP[10:10] (RO)
 *
 * FP is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field IDLE_TS[11:11] (RO)
 *
 * TS is idle.
 */
...
/* --- Register HW_GPU3D_AQH_IDLE, field AXI_LP[31:31] (RO)
 *
...
/* --- Register HW_GPU3D_AQA_STATUS, field DET_WR_ERR[8:8] (RO)
 *
...
/* --- Register HW_GPU3D_AQA_STATUS, field DET_RD_ERR[9:9] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field FAST_CLEAR[0:0] (RO)
 *
 * Fast clear.
 *
 * Values:
...
/* --- Register HW_GPU3D_GC_FEAT, field SPECIAL_ANTI_ALIASING[1:1] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field PIPE_3D[2:2] (RO)
 *
 * 3D pipe.
 *
 * Values:
...
/* --- Register HW_GPU3D_GC_FEAT, field DXT_TEXTURE_COMPRESSION[3:3] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field DEBUG_MODE[4:4] (RO)
 *
 * Debug registers.
 *
 * Values:
...
/* --- Register HW_GPU3D_GC_FEAT, field ZCOMPRESSION[5:5] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field YUV420_FILTER[6:6] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field MSAA[7:7] (RO)
 *
 * MSAA support.
 *
 * Values:
...
/* --- Register HW_GPU3D_GC_FEAT, field DC[8:8] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field PIPE_2D[9:9] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field ETC1_TEXTURE_COMPRESSION[10:10] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field FAST_SCALER[11:11] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field HIGH_DYNAMIC_RANGE[12:12] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field YUV420_TILER[13:13] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field MODULE_CG[14:14] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field MIN_AREA[15:15] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field NO_EZ[16:16] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field NO422_TEXTURE[17:17] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field BUFFER_INTERLEAVING[18:18] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field BYTE_WRITE_2D[19:19] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field NO_SCALER[20:20] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field YUY2_AVERAGING[21:21] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field HALF_PE_CACHE[22:22] (RO)
 *
 * PE cache is half.
 *
 * Values:
...
/* --- Register HW_GPU3D_GC_FEAT, field HALF_TX_CACHE[23:23] (RO)
 *
 * TX cache is half.
 *
 * Values:
...
/* --- Register HW_GPU3D_GC_FEAT, field YUY2_RENDER_TARGET[24:24] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field MEM32_BIT_SUPPORT[25:25] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field PIPE_VG[26:26] (RO)
 *
 * VCG pipe is present.
 *
 * Values:
...
/* --- Register HW_GPU3D_GC_FEAT, field VGTS[27:27] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field FE20[28:28] (RO)
 *
 * FE 2.0 is present.
 *
 * Values:
...
/* --- Register HW_GPU3D_GC_FEAT, field BYTE_WRITE_3D[29:29] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field RS_YUV_TARGET[30:30] (RO)
 *
...
/* --- Register HW_GPU3D_GC_FEAT, field FE20_BIT_INDEX[31:31] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field FLIP_Y[0:0] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field DUAL_RETURN_BUS[1:1] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field ENDIANNESS_CONFIG[2:2] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field TESTURE8_K[3:3] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field CORRECT_TEXTURE_CONVERTER[4:4] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field SPECIAL_MSAA_LOD[5:5] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field FAST_CLEAR_FLUSH[6:6] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field _2DPE20[7:7] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field CORRECT_AUTO_DISABLE[8:8] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field RENDER_8K[9:9] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field TILE_STATUS_2BITS[10:10] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field SEPARATE_TILE_STATUS_WHEN_INTERLEAVED[11:11] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field SUPER_TILED_32X32[12:12] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field VG_20[13:13] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field TS_EXTENDED_COMMANDS[14:14] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field COMPRESSION_FIFO_FIXED[15:15] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field EXTRA_SHADER_INSTRUCTIONS0[16:16] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field VG_FILTER[17:17] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field VG_21[18:18] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field SHADER_GETS_W[19:19] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field EXTRA_SHADER_INSTRUCTIONS1[20:20] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field DEFAULT_REG0[21:21] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field MC_20[22:22] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field SHADER_MSAA_SIDEBAND[23:23] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field BUG_FIXES0[24:24] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field VAA[25:25] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field BYPASS_IN_MSAA[26:26] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field HIERARCHICAL_Z[27:27] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field NEW_TEXTURE[28:28] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field A8_TARGET_SUPPORT[29:29] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field CORRECT_STENCIL[30:30] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_0, field ENHANCE_VR[31:31] (RO)
 *
...
/* --- Register HW_GPU3D_GCA_CRTL, field WR_FULL_BURST_MODE[0:0] (RW)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_1, field RSUV_SWIZZLE[0:0] (RO)
 *
 * Resolve UV swizzle.
 *
 * Values:
...
/* --- Register HW_GPU3D_GCM_FEAT_1, field V2_COMPRESSION[1:1] (RO)
 *
 * V2 compression.
 *
 * Values:
...
/* --- Register HW_GPU3D_GCM_FEAT_1, field VG_DOUBLE_BUFFER[2:2] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_1, field BUG_FIXES1[3:3] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_1, field BUG_FIXES2[4:4] (RO)
 *
...
/* --- Register HW_GPU3D_GCM_FEAT_1, field TEXTURE_STRIDE[5:5] (RO)
 *
