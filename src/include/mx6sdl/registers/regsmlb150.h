...
/*
 * i.MX6SDL MLB150 registers defined in this header file.
 *
...
/*
 * constants & macros for entire MLB150_MLBC0 register
 */
...
/* --- Register HW_MLB150_MLBC0, field MLBEN[0] (RW)
 *
...
/* --- Register HW_MLB150_MLBC0, field MLBCLK[4:2] (RW)
 *
...
/* --- Register HW_MLB150_MLBC0, field MLBPEN[5] (RW)
 *
...
/* --- Register HW_MLB150_MLBC0, field MLBLK[7] (RO)
 *
...
/* --- Register HW_MLB150_MLBC0, field ASYRETRY[12] (RW)
 *
...
/* --- Register HW_MLB150_MLBC0, field CTLRETRY[14] (RW)
 *
...
/* --- Register HW_MLB150_MLBC0, field FCNT[17:15] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MLBPC0 register
 */
...
/* --- Register HW_MLB150_MLBPC0, field MCLKHYS[11] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MS0 register
 */
...
/* --- Register HW_MLB150_MS0, field MCS[31:0] (RO)
 *
...
/*
 * constants & macros for entire MLB150_MLBPC2 register
 */
...
/* --- Register HW_MLB150_MLBPC2, field SDOPC[0] (RW)
 *
...
/* --- Register HW_MLB150_MLBPC2, field SDRTO[2:1] (RW)
 *
...
/* --- Register HW_MLB150_MLBPC2, field MORCD[14:8] (RW)
 *
...
/* --- Register HW_MLB150_MLBPC2, field MORCE[15] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MS1 register
 */
...
/* --- Register HW_MLB150_MS1, field MCS[31:0] (RO)
 *
...
/*
 * constants & macros for entire MLB150_MSS register
 */
...
/* --- Register HW_MLB150_MSS, field RSTSYSCMD[0] (RO)
 *
...
/* --- Register HW_MLB150_MSS, field LKSYSCMD[1] (RO)
 *
...
/* --- Register HW_MLB150_MSS, field ULKSYSCMD[2] (RO)
 *
...
/* --- Register HW_MLB150_MSS, field CSSYSCMD[3] (RO)
 *
...
/* --- Register HW_MLB150_MSS, field SWSYSCMD[4] (RO)
 *
...
/* --- Register HW_MLB150_MSS, field SERVREQ[5] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MSD register
 */
...
/* --- Register HW_MLB150_MSD, field SD0[7:0] (RO)
 *
...
/* --- Register HW_MLB150_MSD, field SD1[15:8] (RO)
 *
...
/* --- Register HW_MLB150_MSD, field SD2[23:16] (RO)
 *
...
/* --- Register HW_MLB150_MSD, field SD3[31:24] (RO)
 *
...
/*
 * constants & macros for entire MLB150_MIEN register
 */
...
/* --- Register HW_MLB150_MIEN, field ISOC_PE[0] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field ISOC_BUFO[1] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field SYNC_PE[16] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field ARX_DONE[17] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field ARX_PE[18] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field ARX_BREAK[19] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field ATX_DONE[20] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field ATX_PE[21] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field ATX_BREAK[22] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field CRX_DONE[24] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field CRX_PE[25] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field CRX_BREAK[26] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field CTX_DONE[27] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field CTX_PE[28] (RW)
 *
...
/* --- Register HW_MLB150_MIEN, field CTX_BREAK[29] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MLBPC1 register
 */
...
/* --- Register HW_MLB150_MLBPC1, field SDRCVBIAS[3:0] (RW)
 *
...
/* --- Register HW_MLB150_MLBPC1, field SDXMTBIAS[7:4] (RW)
 *
...
/* --- Register HW_MLB150_MLBPC1, field CKRCVBIAS[11:8] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MLBC1 register
 */
...
/* --- Register HW_MLB150_MLBC1, field LOCK[6] (RO)
 *
...
/* --- Register HW_MLB150_MLBC1, field CLKM[7] (RO)
 *
...
/* --- Register HW_MLB150_MLBC1, field NDA[15:8] (RW)
 *
...
/*
 * constants & macros for entire MLB150_HCTL register
 */
...
/* --- Register HW_MLB150_HCTL, field RST0[0] (RW)
 *
 * AGU0 software reset
 *
 * Values:
...
/* --- Register HW_MLB150_HCTL, field RST1[1] (RW)
 *
 * AGU1 software reset
 *
 * Values:
...
/* --- Register HW_MLB150_HCTL, field EN[15] (RW)
 *
 * HBI enable
 *
 * Values:
...
/*
 * constants & macros for entire MLB150_HCMR0 register
 */
...
/* --- Register HW_MLB150_HCMR0, field CHM[31:0] (RW)
 *
...
/*
 * constants & macros for entire MLB150_HCMR1 register
 */
...
/* --- Register HW_MLB150_HCMR1, field CHM[31:0] (RW)
 *
 * Bitwise channel mask bit
 *
 * Values:
...
/*
 * constants & macros for entire MLB150_HCER0 register
 */
...
/* --- Register HW_MLB150_HCER0, field CERR[31:0] (RO)
 *
...
/*
 * constants & macros for entire MLB150_HCER1 register
 */
...
/* --- Register HW_MLB150_HCER1, field CERR[31:0] (RO)
 *
 * Bitwise channel error bit
 */
...
/*
 * constants & macros for entire MLB150_HCBR0 register
 */
...
/* --- Register HW_MLB150_HCBR0, field CHB[31:0] (RO)
 *
...
/*
 * constants & macros for entire MLB150_HCBR1 register
 */
...
/* --- Register HW_MLB150_HCBR1, field CHB[31:0] (RO)
 *
 * Bitwise channel busy bit
 *
 * Values:
...
/*
 * constants & macros for entire MLB150_MDAT0 register
 */
...
/* --- Register HW_MLB150_MDAT0, field DATA[31:0] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MDAT1 register
 */
...
/* --- Register HW_MLB150_MDAT1, field DATA[31:0] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MDAT2 register
 */
...
/* --- Register HW_MLB150_MDAT2, field DATA[31:0] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MDAT3 register
 */
...
/* --- Register HW_MLB150_MDAT3, field DATA[31:0] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MDWE0 register
 */
...
/* --- Register HW_MLB150_MDWE0, field MASK[31:0] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MDWE1 register
 */
...
/* --- Register HW_MLB150_MDWE1, field MASK[31:0] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MDWE2 register
 */
...
/* --- Register HW_MLB150_MDWE2, field MASK[31:0] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MDWE3 register
 */
...
/* --- Register HW_MLB150_MDWE3, field MASK[31:0] (RW)
 *
...
/*
 * constants & macros for entire MLB150_MCTL register
 */
...
/* --- Register HW_MLB150_MCTL, field XCMP[0] (RO)
 *
...
/*
 * constants & macros for entire MLB150_MADR register
 */
...
/* --- Register HW_MLB150_MADR, field ADDR[7:0] (RW)
 *
 * CTR address of 128-bit entry or DBR address of 8-bit entry - bits[7:0]
 */

#define BP_MLB150_MADR_ADDR      (0)      //!< Bit position for MLB150_MADR_ADDR.
#define BM_MLB150_MADR_ADDR      (0x000000ff)  //!< Bit mask for MLB150_MADR_ADDR.
...
/* --- Register HW_MLB150_MADR, field ADDR1[13:8] (RW)
 *
 * DBR address of 8-bit entry - bits[13:8]
 */

#define BP_MLB150_MADR_ADDR1      (8)      //!< Bit position for MLB150_MADR_ADDR1.
#define BM_MLB150_MADR_ADDR1      (0x00003f00)  //!< Bit mask for MLB150_MADR_ADDR1.
...
/* --- Register HW_MLB150_MADR, field TB[30] (RW)
 *
 * Target location bit
 *
 * Values:
...
/* --- Register HW_MLB150_MADR, field WNR[31] (RW)
 *
...
/*
 * constants & macros for entire MLB150_ACTL register
 */
...
/* --- Register HW_MLB150_ACTL, field SCE[0] (RW)
 *
...
/* --- Register HW_MLB150_ACTL, field SMX[1] (RW)
 *
...
/* --- Register HW_MLB150_ACTL, field DMA_MODE[2] (RW)
 *
 * DMA Mode:
 *
 * Values:
...
/* --- Register HW_MLB150_ACTL, field MPB[4] (RW)
 *
...
/*
 * constants & macros for entire MLB150_ACSR0 register
 */
...
/* --- Register HW_MLB150_ACSR0, field V[31:0] (RO)
 *
...
#define BP_MLB150_ACSR0_V      (0)      //!< Bit position for MLB150_ACSR0_V.
#define BM_MLB150_ACSR0_V      (0xffffffff)  //!< Bit mask for MLB150_ACSR0_V.

//! @brief Get value of MLB150_ACSR0_V from a register value.
#define BG_MLB150_ACSR0_V(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_MLB150_ACSR0_V) >> BP_MLB150_ACSR0_V)
...
/*
 * constants & macros for entire MLB150_ACSR1 register
 */
...
/* --- Register HW_MLB150_ACSR1, field CHS[31:0] (RO)
 *
...
/*
 * constants & macros for entire MLB150_ACMR0 register
 */
...
/* --- Register HW_MLB150_ACMR0, field CHM[31:0] (RW)
 *
 * Bitwise channel mask bit:
 *
 * Values:
...
/*
 * constants & macros for entire MLB150_ACMR1 register
 */
...
/* --- Register HW_MLB150_ACMR1, field CHM[31:0] (RW)
 *
 * Bitwise channel mask bit:
 *
 * Values:
...
//!     use the '&' operator, like <code>&HW_MLB150(0)</code>.
#define HW_MLB150     (*(volatile hw_mlb150_t *) REGS_MLB150_BASE)
