...
/*
 * i.MX6SDL PCIE registers defined in this header file.
 *
...
#define BG_PCIE_COMMAND_I_O_SPACE_ENABLE(r)   (((r) & BM_PCIE_COMMAND_I_O_SPACE_ENABLE) >> BP_PCIE_COMMAND_I_O_SPACE_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_I_O_SPACE_ENABLE.
#define BF_PCIE_COMMAND_I_O_SPACE_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_I_O_SPACE_ENABLE) & BM_PCIE_COMMAND_I_O_SPACE_ENABLE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_I_O_SPACE_ENABLE.
#define BF_PCIE_COMMAND_I_O_SPACE_ENABLE(v)   (((v) << BP_PCIE_COMMAND_I_O_SPACE_ENABLE) & BM_PCIE_COMMAND_I_O_SPACE_ENABLE)
#endif
...
#define BG_PCIE_COMMAND_MEMORY_SPACE_ENABLE(r)   (((r) & BM_PCIE_COMMAND_MEMORY_SPACE_ENABLE) >> BP_PCIE_COMMAND_MEMORY_SPACE_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_MEMORY_SPACE_ENABLE.
#define BF_PCIE_COMMAND_MEMORY_SPACE_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_MEMORY_SPACE_ENABLE) & BM_PCIE_COMMAND_MEMORY_SPACE_ENABLE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_MEMORY_SPACE_ENABLE.
#define BF_PCIE_COMMAND_MEMORY_SPACE_ENABLE(v)   (((v) << BP_PCIE_COMMAND_MEMORY_SPACE_ENABLE) & BM_PCIE_COMMAND_MEMORY_SPACE_ENABLE)
#endif
...
#define BG_PCIE_COMMAND_BUS_MASTER_ENABLE(r)   (((r) & BM_PCIE_COMMAND_BUS_MASTER_ENABLE) >> BP_PCIE_COMMAND_BUS_MASTER_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_BUS_MASTER_ENABLE.
#define BF_PCIE_COMMAND_BUS_MASTER_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_BUS_MASTER_ENABLE) & BM_PCIE_COMMAND_BUS_MASTER_ENABLE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_BUS_MASTER_ENABLE.
#define BF_PCIE_COMMAND_BUS_MASTER_ENABLE(v)   (((v) << BP_PCIE_COMMAND_BUS_MASTER_ENABLE) & BM_PCIE_COMMAND_BUS_MASTER_ENABLE)
#endif
...
#define BG_PCIE_COMMAND_SPECIAL_CYCLE_ENABLE(r)   (((r) & BM_PCIE_COMMAND_SPECIAL_CYCLE_ENABLE) >> BP_PCIE_COMMAND_SPECIAL_CYCLE_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_SPECIAL_CYCLE_ENABLE.
#define BF_PCIE_COMMAND_SPECIAL_CYCLE_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_SPECIAL_CYCLE_ENABLE) & BM_PCIE_COMMAND_SPECIAL_CYCLE_ENABLE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_SPECIAL_CYCLE_ENABLE.
#define BF_PCIE_COMMAND_SPECIAL_CYCLE_ENABLE(v)   (((v) << BP_PCIE_COMMAND_SPECIAL_CYCLE_ENABLE) & BM_PCIE_COMMAND_SPECIAL_CYCLE_ENABLE)
#endif
...
#define BG_PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE(r)   (((r) & BM_PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE) >> BP_PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE.
#define BF_PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE) & BM_PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE.
#define BF_PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE(v)   (((v) << BP_PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE) & BM_PCIE_COMMAND_MEMORY_WRITE_AND_INVALIDATE)
#endif
...
#define BG_PCIE_COMMAND_VGA_PALETTE_SNOOP(r)   (((r) & BM_PCIE_COMMAND_VGA_PALETTE_SNOOP) >> BP_PCIE_COMMAND_VGA_PALETTE_SNOOP)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_VGA_PALETTE_SNOOP.
#define BF_PCIE_COMMAND_VGA_PALETTE_SNOOP(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_VGA_PALETTE_SNOOP) & BM_PCIE_COMMAND_VGA_PALETTE_SNOOP)
#else
//! @brief Format value for bitfield PCIE_COMMAND_VGA_PALETTE_SNOOP.
#define BF_PCIE_COMMAND_VGA_PALETTE_SNOOP(v)   (((v) << BP_PCIE_COMMAND_VGA_PALETTE_SNOOP) & BM_PCIE_COMMAND_VGA_PALETTE_SNOOP)
#endif
...
#define BG_PCIE_COMMAND_PARITY_ERROR_RESPONSE(r)   (((r) & BM_PCIE_COMMAND_PARITY_ERROR_RESPONSE) >> BP_PCIE_COMMAND_PARITY_ERROR_RESPONSE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_PARITY_ERROR_RESPONSE.
#define BF_PCIE_COMMAND_PARITY_ERROR_RESPONSE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_PARITY_ERROR_RESPONSE) & BM_PCIE_COMMAND_PARITY_ERROR_RESPONSE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_PARITY_ERROR_RESPONSE.
#define BF_PCIE_COMMAND_PARITY_ERROR_RESPONSE(v)   (((v) << BP_PCIE_COMMAND_PARITY_ERROR_RESPONSE) & BM_PCIE_COMMAND_PARITY_ERROR_RESPONSE)
#endif
...
#define BG_PCIE_COMMAND_IDSEL_STEPPING(r)   (((r) & BM_PCIE_COMMAND_IDSEL_STEPPING) >> BP_PCIE_COMMAND_IDSEL_STEPPING)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_IDSEL_STEPPING.
#define BF_PCIE_COMMAND_IDSEL_STEPPING(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_IDSEL_STEPPING) & BM_PCIE_COMMAND_IDSEL_STEPPING)
#else
//! @brief Format value for bitfield PCIE_COMMAND_IDSEL_STEPPING.
#define BF_PCIE_COMMAND_IDSEL_STEPPING(v)   (((v) << BP_PCIE_COMMAND_IDSEL_STEPPING) & BM_PCIE_COMMAND_IDSEL_STEPPING)
#endif
...
#define BG_PCIE_COMMAND_SERR_ENABLE(r)   (((r) & BM_PCIE_COMMAND_SERR_ENABLE) >> BP_PCIE_COMMAND_SERR_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_SERR_ENABLE.
#define BF_PCIE_COMMAND_SERR_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_SERR_ENABLE) & BM_PCIE_COMMAND_SERR_ENABLE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_SERR_ENABLE.
#define BF_PCIE_COMMAND_SERR_ENABLE(v)   (((v) << BP_PCIE_COMMAND_SERR_ENABLE) & BM_PCIE_COMMAND_SERR_ENABLE)
#endif
...
#define BG_PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE(r)   (((r) & BM_PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE) >> BP_PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE.
#define BF_PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE) & BM_PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE.
#define BF_PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE(v)   (((v) << BP_PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE) & BM_PCIE_COMMAND_FAST_BACK_TO_BACK_ENABLE)
#endif
...
#define BG_PCIE_COMMAND_INTX_ASSERTION_DISABLE(r)   (((r) & BM_PCIE_COMMAND_INTX_ASSERTION_DISABLE) >> BP_PCIE_COMMAND_INTX_ASSERTION_DISABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_INTX_ASSERTION_DISABLE.
#define BF_PCIE_COMMAND_INTX_ASSERTION_DISABLE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_INTX_ASSERTION_DISABLE) & BM_PCIE_COMMAND_INTX_ASSERTION_DISABLE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_INTX_ASSERTION_DISABLE.
#define BF_PCIE_COMMAND_INTX_ASSERTION_DISABLE(v)   (((v) << BP_PCIE_COMMAND_INTX_ASSERTION_DISABLE) & BM_PCIE_COMMAND_INTX_ASSERTION_DISABLE)
#endif
...
#define BG_PCIE_COMMAND_INTX_STATUS(r)   (((r) & BM_PCIE_COMMAND_INTX_STATUS) >> BP_PCIE_COMMAND_INTX_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_INTX_STATUS.
#define BF_PCIE_COMMAND_INTX_STATUS(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_INTX_STATUS) & BM_PCIE_COMMAND_INTX_STATUS)
#else
//! @brief Format value for bitfield PCIE_COMMAND_INTX_STATUS.
#define BF_PCIE_COMMAND_INTX_STATUS(v)   (((v) << BP_PCIE_COMMAND_INTX_STATUS) & BM_PCIE_COMMAND_INTX_STATUS)
#endif
...
#define BG_PCIE_COMMAND_CAPABILITIES_LIST(r)   (((r) & BM_PCIE_COMMAND_CAPABILITIES_LIST) >> BP_PCIE_COMMAND_CAPABILITIES_LIST)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_CAPABILITIES_LIST.
#define BF_PCIE_COMMAND_CAPABILITIES_LIST(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_CAPABILITIES_LIST) & BM_PCIE_COMMAND_CAPABILITIES_LIST)
#else
//! @brief Format value for bitfield PCIE_COMMAND_CAPABILITIES_LIST.
#define BF_PCIE_COMMAND_CAPABILITIES_LIST(v)   (((v) << BP_PCIE_COMMAND_CAPABILITIES_LIST) & BM_PCIE_COMMAND_CAPABILITIES_LIST)
#endif
...
#define BG_PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE(r)   (((r) & BM_PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE) >> BP_PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE.
#define BF_PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE) & BM_PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE.
#define BF_PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE(v)   (((v) << BP_PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE) & BM_PCIE_COMMAND_SIXTYSIX_MHZ_CAPABLE)
#endif
...
#define BG_PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE(r)   (((r) & BM_PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE) >> BP_PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE.
#define BF_PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE) & BM_PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE)
#else
//! @brief Format value for bitfield PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE.
#define BF_PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE(v)   (((v) << BP_PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE) & BM_PCIE_COMMAND_FAST_BACK_TO_BACK_CAPABLE)
#endif
...
#define BG_PCIE_COMMAND_MASTER_DATA_PARITY_ERROR(r)   (((r) & BM_PCIE_COMMAND_MASTER_DATA_PARITY_ERROR) >> BP_PCIE_COMMAND_MASTER_DATA_PARITY_ERROR)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_MASTER_DATA_PARITY_ERROR.
#define BF_PCIE_COMMAND_MASTER_DATA_PARITY_ERROR(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_MASTER_DATA_PARITY_ERROR) & BM_PCIE_COMMAND_MASTER_DATA_PARITY_ERROR)
#else
//! @brief Format value for bitfield PCIE_COMMAND_MASTER_DATA_PARITY_ERROR.
#define BF_PCIE_COMMAND_MASTER_DATA_PARITY_ERROR(v)   (((v) << BP_PCIE_COMMAND_MASTER_DATA_PARITY_ERROR) & BM_PCIE_COMMAND_MASTER_DATA_PARITY_ERROR)
#endif
...
#define BG_PCIE_COMMAND_DEVSEL_TIMING(r)   (((r) & BM_PCIE_COMMAND_DEVSEL_TIMING) >> BP_PCIE_COMMAND_DEVSEL_TIMING)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_DEVSEL_TIMING.
#define BF_PCIE_COMMAND_DEVSEL_TIMING(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_DEVSEL_TIMING) & BM_PCIE_COMMAND_DEVSEL_TIMING)
#else
//! @brief Format value for bitfield PCIE_COMMAND_DEVSEL_TIMING.
#define BF_PCIE_COMMAND_DEVSEL_TIMING(v)   (((v) << BP_PCIE_COMMAND_DEVSEL_TIMING) & BM_PCIE_COMMAND_DEVSEL_TIMING)
#endif
...
#define BG_PCIE_COMMAND_SIGNALED_TARGET_ABORT(r)   (((r) & BM_PCIE_COMMAND_SIGNALED_TARGET_ABORT) >> BP_PCIE_COMMAND_SIGNALED_TARGET_ABORT)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_SIGNALED_TARGET_ABORT.
#define BF_PCIE_COMMAND_SIGNALED_TARGET_ABORT(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_SIGNALED_TARGET_ABORT) & BM_PCIE_COMMAND_SIGNALED_TARGET_ABORT)
#else
//! @brief Format value for bitfield PCIE_COMMAND_SIGNALED_TARGET_ABORT.
#define BF_PCIE_COMMAND_SIGNALED_TARGET_ABORT(v)   (((v) << BP_PCIE_COMMAND_SIGNALED_TARGET_ABORT) & BM_PCIE_COMMAND_SIGNALED_TARGET_ABORT)
#endif
...
#define BG_PCIE_COMMAND_RECEIVED_TARGET_ABORT(r)   (((r) & BM_PCIE_COMMAND_RECEIVED_TARGET_ABORT) >> BP_PCIE_COMMAND_RECEIVED_TARGET_ABORT)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_RECEIVED_TARGET_ABORT.
#define BF_PCIE_COMMAND_RECEIVED_TARGET_ABORT(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_RECEIVED_TARGET_ABORT) & BM_PCIE_COMMAND_RECEIVED_TARGET_ABORT)
#else
//! @brief Format value for bitfield PCIE_COMMAND_RECEIVED_TARGET_ABORT.
#define BF_PCIE_COMMAND_RECEIVED_TARGET_ABORT(v)   (((v) << BP_PCIE_COMMAND_RECEIVED_TARGET_ABORT) & BM_PCIE_COMMAND_RECEIVED_TARGET_ABORT)
#endif
...
#define BG_PCIE_COMMAND_RECEIVED_MASTER_ABORT(r)   (((r) & BM_PCIE_COMMAND_RECEIVED_MASTER_ABORT) >> BP_PCIE_COMMAND_RECEIVED_MASTER_ABORT)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_RECEIVED_MASTER_ABORT.
#define BF_PCIE_COMMAND_RECEIVED_MASTER_ABORT(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_RECEIVED_MASTER_ABORT) & BM_PCIE_COMMAND_RECEIVED_MASTER_ABORT)
#else
//! @brief Format value for bitfield PCIE_COMMAND_RECEIVED_MASTER_ABORT.
#define BF_PCIE_COMMAND_RECEIVED_MASTER_ABORT(v)   (((v) << BP_PCIE_COMMAND_RECEIVED_MASTER_ABORT) & BM_PCIE_COMMAND_RECEIVED_MASTER_ABORT)
#endif
...
#define BG_PCIE_COMMAND_DETECTED_PARITY_ERROR(r)   (((r) & BM_PCIE_COMMAND_DETECTED_PARITY_ERROR) >> BP_PCIE_COMMAND_DETECTED_PARITY_ERROR)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_DETECTED_PARITY_ERROR.
#define BF_PCIE_COMMAND_DETECTED_PARITY_ERROR(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_DETECTED_PARITY_ERROR) & BM_PCIE_COMMAND_DETECTED_PARITY_ERROR)
#else
//! @brief Format value for bitfield PCIE_COMMAND_DETECTED_PARITY_ERROR.
#define BF_PCIE_COMMAND_DETECTED_PARITY_ERROR(v)   (((v) << BP_PCIE_COMMAND_DETECTED_PARITY_ERROR) & BM_PCIE_COMMAND_DETECTED_PARITY_ERROR)
#endif
...
#define BG_PCIE_COMMAND_SIGNALED_SYSTEM_ERROR(r)   (((r) & BM_PCIE_COMMAND_SIGNALED_SYSTEM_ERROR) >> BP_PCIE_COMMAND_SIGNALED_SYSTEM_ERROR)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_COMMAND_SIGNALED_SYSTEM_ERROR.
#define BF_PCIE_COMMAND_SIGNALED_SYSTEM_ERROR(v)   ((((reg32_t) v) << BP_PCIE_COMMAND_SIGNALED_SYSTEM_ERROR) & BM_PCIE_COMMAND_SIGNALED_SYSTEM_ERROR)
#else
//! @brief Format value for bitfield PCIE_COMMAND_SIGNALED_SYSTEM_ERROR.
#define BF_PCIE_COMMAND_SIGNALED_SYSTEM_ERROR(v)   (((v) << BP_PCIE_COMMAND_SIGNALED_SYSTEM_ERROR) & BM_PCIE_COMMAND_SIGNALED_SYSTEM_ERROR)
#endif
...
#define BG_PCIE_REVID_CX_REVISION_ID_N(r)   (((r) & BM_PCIE_REVID_CX_REVISION_ID_N) >> BP_PCIE_REVID_CX_REVISION_ID_N)
...
#define BG_PCIE_REVID_IF_CODE_N(r)   (((r) & BM_PCIE_REVID_IF_CODE_N) >> BP_PCIE_REVID_IF_CODE_N)
...
#define BG_PCIE_REVID_SUB_CLASS_CODE_N(r)   (((r) & BM_PCIE_REVID_SUB_CLASS_CODE_N) >> BP_PCIE_REVID_SUB_CLASS_CODE_N)
...
#define BG_PCIE_REVID_BASE_CLASS_CODE_N(r)   (((r) & BM_PCIE_REVID_BASE_CLASS_CODE_N) >> BP_PCIE_REVID_BASE_CLASS_CODE_N)
...
#define BG_PCIE_BIST_CACHE_LINE_SIZE(r)   (((r) & BM_PCIE_BIST_CACHE_LINE_SIZE) >> BP_PCIE_BIST_CACHE_LINE_SIZE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_BIST_CACHE_LINE_SIZE.
#define BF_PCIE_BIST_CACHE_LINE_SIZE(v)   ((((reg32_t) v) << BP_PCIE_BIST_CACHE_LINE_SIZE) & BM_PCIE_BIST_CACHE_LINE_SIZE)
#else
//! @brief Format value for bitfield PCIE_BIST_CACHE_LINE_SIZE.
#define BF_PCIE_BIST_CACHE_LINE_SIZE(v)   (((v) << BP_PCIE_BIST_CACHE_LINE_SIZE) & BM_PCIE_BIST_CACHE_LINE_SIZE)
#endif
...
#define BG_PCIE_BIST_MASTER_LATENCY_TIMER(r)   (((r) & BM_PCIE_BIST_MASTER_LATENCY_TIMER) >> BP_PCIE_BIST_MASTER_LATENCY_TIMER)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_BIST_MASTER_LATENCY_TIMER.
#define BF_PCIE_BIST_MASTER_LATENCY_TIMER(v)   ((((reg32_t) v) << BP_PCIE_BIST_MASTER_LATENCY_TIMER) & BM_PCIE_BIST_MASTER_LATENCY_TIMER)
#else
//! @brief Format value for bitfield PCIE_BIST_MASTER_LATENCY_TIMER.
#define BF_PCIE_BIST_MASTER_LATENCY_TIMER(v)   (((v) << BP_PCIE_BIST_MASTER_LATENCY_TIMER) & BM_PCIE_BIST_MASTER_LATENCY_TIMER)
#endif
...
#define BG_PCIE_BIST_CONFIGURATION_HEADER_FORMAT(r)   (((r) & BM_PCIE_BIST_CONFIGURATION_HEADER_FORMAT) >> BP_PCIE_BIST_CONFIGURATION_HEADER_FORMAT)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_BIST_CONFIGURATION_HEADER_FORMAT.
#define BF_PCIE_BIST_CONFIGURATION_HEADER_FORMAT(v)   ((((reg32_t) v) << BP_PCIE_BIST_CONFIGURATION_HEADER_FORMAT) & BM_PCIE_BIST_CONFIGURATION_HEADER_FORMAT)
#else
//! @brief Format value for bitfield PCIE_BIST_CONFIGURATION_HEADER_FORMAT.
#define BF_PCIE_BIST_CONFIGURATION_HEADER_FORMAT(v)   (((v) << BP_PCIE_BIST_CONFIGURATION_HEADER_FORMAT) & BM_PCIE_BIST_CONFIGURATION_HEADER_FORMAT)
#endif
...
#define BG_PCIE_BIST_MULTI_FUNCTION_DEVICE(r)   (((r) & BM_PCIE_BIST_MULTI_FUNCTION_DEVICE) >> BP_PCIE_BIST_MULTI_FUNCTION_DEVICE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_BIST_MULTI_FUNCTION_DEVICE.
#define BF_PCIE_BIST_MULTI_FUNCTION_DEVICE(v)   ((((reg32_t) v) << BP_PCIE_BIST_MULTI_FUNCTION_DEVICE) & BM_PCIE_BIST_MULTI_FUNCTION_DEVICE)
#else
//! @brief Format value for bitfield PCIE_BIST_MULTI_FUNCTION_DEVICE.
#define BF_PCIE_BIST_MULTI_FUNCTION_DEVICE(v)   (((v) << BP_PCIE_BIST_MULTI_FUNCTION_DEVICE) & BM_PCIE_BIST_MULTI_FUNCTION_DEVICE)
#endif
...
#define BG_PCIE_BIST_NOT_SUPPORTED_BY__CORE(r)   (((r) & BM_PCIE_BIST_NOT_SUPPORTED_BY__CORE) >> BP_PCIE_BIST_NOT_SUPPORTED_BY__CORE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_BIST_NOT_SUPPORTED_BY__CORE.
#define BF_PCIE_BIST_NOT_SUPPORTED_BY__CORE(v)   ((((reg32_t) v) << BP_PCIE_BIST_NOT_SUPPORTED_BY__CORE) & BM_PCIE_BIST_NOT_SUPPORTED_BY__CORE)
#else
//! @brief Format value for bitfield PCIE_BIST_NOT_SUPPORTED_BY__CORE.
#define BF_PCIE_BIST_NOT_SUPPORTED_BY__CORE(v)   (((v) << BP_PCIE_BIST_NOT_SUPPORTED_BY__CORE) & BM_PCIE_BIST_NOT_SUPPORTED_BY__CORE)
#endif
...
#define BG_PCIE_BAR0_MEM_I_O(r)   (((r) & BM_PCIE_BAR0_MEM_I_O) >> BP_PCIE_BAR0_MEM_I_O)
...
#define BG_PCIE_BAR0_TYPE(r)   (((r) & BM_PCIE_BAR0_TYPE) >> BP_PCIE_BAR0_TYPE)
...
#define BG_PCIE_BAR0_PREF(r)   (((r) & BM_PCIE_BAR0_PREF) >> BP_PCIE_BAR0_PREF)
...
#define BG_PCIE_BAR0_ADDRESS(r)   (((r) & BM_PCIE_BAR0_ADDRESS) >> BP_PCIE_BAR0_ADDRESS)
...
#define BG_PCIE_BAR1_ADDRESS(r)   (((r) & BM_PCIE_BAR1_ADDRESS) >> BP_PCIE_BAR1_ADDRESS)
...
#define BG_PCIE_BAR2_MEM_I_O(r)   (((r) & BM_PCIE_BAR2_MEM_I_O) >> BP_PCIE_BAR2_MEM_I_O)
...
#define BG_PCIE_BAR2_TYPE(r)   (((r) & BM_PCIE_BAR2_TYPE) >> BP_PCIE_BAR2_TYPE)
...
#define BG_PCIE_BAR2_PREF(r)   (((r) & BM_PCIE_BAR2_PREF) >> BP_PCIE_BAR2_PREF)
...
#define BG_PCIE_BAR2_ADDRESS(r)   (((r) & BM_PCIE_BAR2_ADDRESS) >> BP_PCIE_BAR2_ADDRESS)
...
#define BG_PCIE_BAR3_ADDRESS(r)   (((r) & BM_PCIE_BAR3_ADDRESS) >> BP_PCIE_BAR3_ADDRESS)
...
#define BG_PCIE_BAR4_MEM_I_O(r)   (((r) & BM_PCIE_BAR4_MEM_I_O) >> BP_PCIE_BAR4_MEM_I_O)
...
#define BG_PCIE_BAR4_TYPE(r)   (((r) & BM_PCIE_BAR4_TYPE) >> BP_PCIE_BAR4_TYPE)
...
#define BG_PCIE_BAR4_PREF(r)   (((r) & BM_PCIE_BAR4_PREF) >> BP_PCIE_BAR4_PREF)
...
#define BG_PCIE_BAR4_ADDRESS(r)   (((r) & BM_PCIE_BAR4_ADDRESS) >> BP_PCIE_BAR4_ADDRESS)
...
#define BG_PCIE_BAR5_ADDRESS(r)   (((r) & BM_PCIE_BAR5_ADDRESS) >> BP_PCIE_BAR5_ADDRESS)
...
#define BG_PCIE_EROMBAR_ENABLE(r)   (((r) & BM_PCIE_EROMBAR_ENABLE) >> BP_PCIE_EROMBAR_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_EROMBAR_ENABLE.
#define BF_PCIE_EROMBAR_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_EROMBAR_ENABLE) & BM_PCIE_EROMBAR_ENABLE)
#else
//! @brief Format value for bitfield PCIE_EROMBAR_ENABLE.
#define BF_PCIE_EROMBAR_ENABLE(v)   (((v) << BP_PCIE_EROMBAR_ENABLE) & BM_PCIE_EROMBAR_ENABLE)
#endif
...
#define BG_PCIE_EROMBAR_ADDRESS(r)   (((r) & BM_PCIE_EROMBAR_ADDRESS) >> BP_PCIE_EROMBAR_ADDRESS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_EROMBAR_ADDRESS.
#define BF_PCIE_EROMBAR_ADDRESS(v)   ((((reg32_t) v) << BP_PCIE_EROMBAR_ADDRESS) & BM_PCIE_EROMBAR_ADDRESS)
#else
//! @brief Format value for bitfield PCIE_EROMBAR_ADDRESS.
#define BF_PCIE_EROMBAR_ADDRESS(v)   (((v) << BP_PCIE_EROMBAR_ADDRESS) & BM_PCIE_EROMBAR_ADDRESS)
#endif
...
#define BG_PCIE_CAPPR_CFG_NEXT_PTR(r)   (((r) & BM_PCIE_CAPPR_CFG_NEXT_PTR) >> BP_PCIE_CAPPR_CFG_NEXT_PTR)
...
#define BG_PCIE_ILR_INTERRUPT_LINE(r)   (((r) & BM_PCIE_ILR_INTERRUPT_LINE) >> BP_PCIE_ILR_INTERRUPT_LINE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_ILR_INTERRUPT_LINE.
#define BF_PCIE_ILR_INTERRUPT_LINE(v)   ((((reg32_t) v) << BP_PCIE_ILR_INTERRUPT_LINE) & BM_PCIE_ILR_INTERRUPT_LINE)
#else
//! @brief Format value for bitfield PCIE_ILR_INTERRUPT_LINE.
#define BF_PCIE_ILR_INTERRUPT_LINE(v)   (((v) << BP_PCIE_ILR_INTERRUPT_LINE) & BM_PCIE_ILR_INTERRUPT_LINE)
#endif
...
#define BG_PCIE_ILR_INT_PIN_MAPPING_N(r)   (((r) & BM_PCIE_ILR_INT_PIN_MAPPING_N) >> BP_PCIE_ILR_INT_PIN_MAPPING_N)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_ILR_INT_PIN_MAPPING_N.
#define BF_PCIE_ILR_INT_PIN_MAPPING_N(v)   ((((reg32_t) v) << BP_PCIE_ILR_INT_PIN_MAPPING_N) & BM_PCIE_ILR_INT_PIN_MAPPING_N)
#else
//! @brief Format value for bitfield PCIE_ILR_INT_PIN_MAPPING_N.
#define BF_PCIE_ILR_INT_PIN_MAPPING_N(v)   (((v) << BP_PCIE_ILR_INT_PIN_MAPPING_N) & BM_PCIE_ILR_INT_PIN_MAPPING_N)
#endif
...
#define BG_PCIE_PMCR_POWER_MANAGEMENT_CAPABILITY_ID(r)   (((r) & BM_PCIE_PMCR_POWER_MANAGEMENT_CAPABILITY_ID) >> BP_PCIE_PMCR_POWER_MANAGEMENT_CAPABILITY_ID)
...
#define BG_PCIE_PMCR_NEXT_CAPABILITY_POINTER(r)   (((r) & BM_PCIE_PMCR_NEXT_CAPABILITY_POINTER) >> BP_PCIE_PMCR_NEXT_CAPABILITY_POINTER)
...
#define BG_PCIE_PMCR_POWER_MANAGEMENT_SPECIFICATION_VERSION(r)   (((r) & BM_PCIE_PMCR_POWER_MANAGEMENT_SPECIFICATION_VERSION) >> BP_PCIE_PMCR_POWER_MANAGEMENT_SPECIFICATION_VERSION)
...
#define BG_PCIE_PMCR_PME_CLOCK(r)   (((r) & BM_PCIE_PMCR_PME_CLOCK) >> BP_PCIE_PMCR_PME_CLOCK)
...
#define BG_PCIE_PMCR_DSI(r)   (((r) & BM_PCIE_PMCR_DSI) >> BP_PCIE_PMCR_DSI)
...
#define BG_PCIE_PMCR_AUX_CURRENT(r)   (((r) & BM_PCIE_PMCR_AUX_CURRENT) >> BP_PCIE_PMCR_AUX_CURRENT)
...
#define BG_PCIE_PMCR_D1_SUPPORT(r)   (((r) & BM_PCIE_PMCR_D1_SUPPORT) >> BP_PCIE_PMCR_D1_SUPPORT)
...
#define BG_PCIE_PMCR_D2_SUPPORT(r)   (((r) & BM_PCIE_PMCR_D2_SUPPORT) >> BP_PCIE_PMCR_D2_SUPPORT)
...
#define BG_PCIE_PMCR_PME_SUPPORT(r)   (((r) & BM_PCIE_PMCR_PME_SUPPORT) >> BP_PCIE_PMCR_PME_SUPPORT)
...
#define BG_PCIE_PMCSR_POWER_STATE(r)   (((r) & BM_PCIE_PMCSR_POWER_STATE) >> BP_PCIE_PMCSR_POWER_STATE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PMCSR_POWER_STATE.
#define BF_PCIE_PMCSR_POWER_STATE(v)   ((((reg32_t) v) << BP_PCIE_PMCSR_POWER_STATE) & BM_PCIE_PMCSR_POWER_STATE)
#else
//! @brief Format value for bitfield PCIE_PMCSR_POWER_STATE.
#define BF_PCIE_PMCSR_POWER_STATE(v)   (((v) << BP_PCIE_PMCSR_POWER_STATE) & BM_PCIE_PMCSR_POWER_STATE)
#endif
...
#define BG_PCIE_PMCSR_NO_SOFT_RESET(r)   (((r) & BM_PCIE_PMCSR_NO_SOFT_RESET) >> BP_PCIE_PMCSR_NO_SOFT_RESET)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PMCSR_NO_SOFT_RESET.
#define BF_PCIE_PMCSR_NO_SOFT_RESET(v)   ((((reg32_t) v) << BP_PCIE_PMCSR_NO_SOFT_RESET) & BM_PCIE_PMCSR_NO_SOFT_RESET)
#else
//! @brief Format value for bitfield PCIE_PMCSR_NO_SOFT_RESET.
#define BF_PCIE_PMCSR_NO_SOFT_RESET(v)   (((v) << BP_PCIE_PMCSR_NO_SOFT_RESET) & BM_PCIE_PMCSR_NO_SOFT_RESET)
#endif
...
#define BG_PCIE_PMCSR_PME_ENABLE(r)   (((r) & BM_PCIE_PMCSR_PME_ENABLE) >> BP_PCIE_PMCSR_PME_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PMCSR_PME_ENABLE.
#define BF_PCIE_PMCSR_PME_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_PMCSR_PME_ENABLE) & BM_PCIE_PMCSR_PME_ENABLE)
#else
//! @brief Format value for bitfield PCIE_PMCSR_PME_ENABLE.
#define BF_PCIE_PMCSR_PME_ENABLE(v)   (((v) << BP_PCIE_PMCSR_PME_ENABLE) & BM_PCIE_PMCSR_PME_ENABLE)
#endif
...
#define BG_PCIE_PMCSR_DATA_SELECT(r)   (((r) & BM_PCIE_PMCSR_DATA_SELECT) >> BP_PCIE_PMCSR_DATA_SELECT)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PMCSR_DATA_SELECT.
#define BF_PCIE_PMCSR_DATA_SELECT(v)   ((((reg32_t) v) << BP_PCIE_PMCSR_DATA_SELECT) & BM_PCIE_PMCSR_DATA_SELECT)
#else
//! @brief Format value for bitfield PCIE_PMCSR_DATA_SELECT.
#define BF_PCIE_PMCSR_DATA_SELECT(v)   (((v) << BP_PCIE_PMCSR_DATA_SELECT) & BM_PCIE_PMCSR_DATA_SELECT)
#endif
...
#define BG_PCIE_PMCSR_DATA_SCALE(r)   (((r) & BM_PCIE_PMCSR_DATA_SCALE) >> BP_PCIE_PMCSR_DATA_SCALE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PMCSR_DATA_SCALE.
#define BF_PCIE_PMCSR_DATA_SCALE(v)   ((((reg32_t) v) << BP_PCIE_PMCSR_DATA_SCALE) & BM_PCIE_PMCSR_DATA_SCALE)
#else
//! @brief Format value for bitfield PCIE_PMCSR_DATA_SCALE.
#define BF_PCIE_PMCSR_DATA_SCALE(v)   (((v) << BP_PCIE_PMCSR_DATA_SCALE) & BM_PCIE_PMCSR_DATA_SCALE)
#endif
...
#define BG_PCIE_PMCSR_PME_STATUS(r)   (((r) & BM_PCIE_PMCSR_PME_STATUS) >> BP_PCIE_PMCSR_PME_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PMCSR_PME_STATUS.
#define BF_PCIE_PMCSR_PME_STATUS(v)   ((((reg32_t) v) << BP_PCIE_PMCSR_PME_STATUS) & BM_PCIE_PMCSR_PME_STATUS)
#else
//! @brief Format value for bitfield PCIE_PMCSR_PME_STATUS.
#define BF_PCIE_PMCSR_PME_STATUS(v)   (((v) << BP_PCIE_PMCSR_PME_STATUS) & BM_PCIE_PMCSR_PME_STATUS)
#endif
...
#define BG_PCIE_PMCSR_B2_B3_SUPPORT(r)   (((r) & BM_PCIE_PMCSR_B2_B3_SUPPORT) >> BP_PCIE_PMCSR_B2_B3_SUPPORT)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PMCSR_B2_B3_SUPPORT.
#define BF_PCIE_PMCSR_B2_B3_SUPPORT(v)   ((((reg32_t) v) << BP_PCIE_PMCSR_B2_B3_SUPPORT) & BM_PCIE_PMCSR_B2_B3_SUPPORT)
#else
//! @brief Format value for bitfield PCIE_PMCSR_B2_B3_SUPPORT.
#define BF_PCIE_PMCSR_B2_B3_SUPPORT(v)   (((v) << BP_PCIE_PMCSR_B2_B3_SUPPORT) & BM_PCIE_PMCSR_B2_B3_SUPPORT)
#endif
...
#define BG_PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE(r)   (((r) & BM_PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE) >> BP_PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE.
#define BF_PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE) & BM_PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE)
#else
//! @brief Format value for bitfield PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE.
#define BF_PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE(v)   (((v) << BP_PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE) & BM_PCIE_PMCSR_BUS_POWER_CLOCK_CONTROL_ENABLE)
#endif
...
#define BG_PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION(r)   (((r) & BM_PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION) >> BP_PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION.
#define BF_PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION(v)   ((((reg32_t) v) << BP_PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION) & BM_PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION)
#else
//! @brief Format value for bitfield PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION.
#define BF_PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION(v)   (((v) << BP_PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION) & BM_PCIE_PMCSR_DATA_REGISTER_FOR_ADDITIONAL_INFORMATION)
#endif
...
#define BG_PCIE_CIDR_PCI_EXPRESS_CAPABILITY_ID(r)   (((r) & BM_PCIE_CIDR_PCI_EXPRESS_CAPABILITY_ID) >> BP_PCIE_CIDR_PCI_EXPRESS_CAPABILITY_ID)
...
#define BG_PCIE_CIDR_NEXT_CAPABILITY_POINTER(r)   (((r) & BM_PCIE_CIDR_NEXT_CAPABILITY_POINTER) >> BP_PCIE_CIDR_NEXT_CAPABILITY_POINTER)
...
#define BG_PCIE_CIDR_PCI_EXPRESS_CAPABILITY_VERSION(r)   (((r) & BM_PCIE_CIDR_PCI_EXPRESS_CAPABILITY_VERSION) >> BP_PCIE_CIDR_PCI_EXPRESS_CAPABILITY_VERSION)
...
#define BG_PCIE_CIDR_DEVICE_PORT_TYPE(r)   (((r) & BM_PCIE_CIDR_DEVICE_PORT_TYPE) >> BP_PCIE_CIDR_DEVICE_PORT_TYPE)
...
#define BG_PCIE_CIDR_SLOT_IMPLEMENTED(r)   (((r) & BM_PCIE_CIDR_SLOT_IMPLEMENTED) >> BP_PCIE_CIDR_SLOT_IMPLEMENTED)
...
#define BG_PCIE_CIDR_INTERRUPT_MESSAGE_NUMBER(r)   (((r) & BM_PCIE_CIDR_INTERRUPT_MESSAGE_NUMBER) >> BP_PCIE_CIDR_INTERRUPT_MESSAGE_NUMBER)
...
#define BG_PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED(r)   (((r) & BM_PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED) >> BP_PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED.
#define BF_PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED(v)   ((((reg32_t) v) << BP_PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED) & BM_PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED)
#else
//! @brief Format value for bitfield PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED.
#define BF_PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED(v)   (((v) << BP_PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED) & BM_PCIE_DCR_MAX_PAYLOAD_SIZE_SUPPORTED)
#endif
...
#define BG_PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED(r)   (((r) & BM_PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED) >> BP_PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED.
#define BF_PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED(v)   ((((reg32_t) v) << BP_PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED) & BM_PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED)
#else
//! @brief Format value for bitfield PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED.
#define BF_PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED(v)   (((v) << BP_PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED) & BM_PCIE_DCR_PHANTOM_FUNCTION_SUPPORTED)
#endif
...
#define BG_PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED(r)   (((r) & BM_PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED) >> BP_PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED.
#define BF_PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED(v)   ((((reg32_t) v) << BP_PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED) & BM_PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED)
#else
//! @brief Format value for bitfield PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED.
#define BF_PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED(v)   (((v) << BP_PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED) & BM_PCIE_DCR_EXTENDED_TAG_FIELD_SUPPORTED)
#endif
...
#define BG_PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY(r)   (((r) & BM_PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY) >> BP_PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY.
#define BF_PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY(v)   ((((reg32_t) v) << BP_PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY) & BM_PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY)
#else
//! @brief Format value for bitfield PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY.
#define BF_PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY(v)   (((v) << BP_PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY) & BM_PCIE_DCR_ENDPOINT_L0S_ACCEPTABLE_LATENCY)
#endif
...
#define BG_PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY(r)   (((r) & BM_PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY) >> BP_PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY.
#define BF_PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY(v)   ((((reg32_t) v) << BP_PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY) & BM_PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY)
#else
//! @brief Format value for bitfield PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY.
#define BF_PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY(v)   (((v) << BP_PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY) & BM_PCIE_DCR_ENDPOINT_L1_ACCEPTABLE_LATENCY)
#endif
...
#define BG_PCIE_DCR_ROLE_BASED_ERROR_REPORTING(r)   (((r) & BM_PCIE_DCR_ROLE_BASED_ERROR_REPORTING) >> BP_PCIE_DCR_ROLE_BASED_ERROR_REPORTING)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCR_ROLE_BASED_ERROR_REPORTING.
#define BF_PCIE_DCR_ROLE_BASED_ERROR_REPORTING(v)   ((((reg32_t) v) << BP_PCIE_DCR_ROLE_BASED_ERROR_REPORTING) & BM_PCIE_DCR_ROLE_BASED_ERROR_REPORTING)
#else
//! @brief Format value for bitfield PCIE_DCR_ROLE_BASED_ERROR_REPORTING.
#define BF_PCIE_DCR_ROLE_BASED_ERROR_REPORTING(v)   (((v) << BP_PCIE_DCR_ROLE_BASED_ERROR_REPORTING) & BM_PCIE_DCR_ROLE_BASED_ERROR_REPORTING)
#endif
...
#define BG_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE(r)   (((r) & BM_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE) >> BP_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE.
#define BF_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE(v)   ((((reg32_t) v) << BP_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE) & BM_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE)
#else
//! @brief Format value for bitfield PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE.
#define BF_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE(v)   (((v) << BP_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE) & BM_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_VALUE)
#endif
...
#define BG_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE(r)   (((r) & BM_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE) >> BP_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE.
#define BF_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE(v)   ((((reg32_t) v) << BP_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE) & BM_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE)
#else
//! @brief Format value for bitfield PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE.
#define BF_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE(v)   (((v) << BP_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE) & BM_PCIE_DCR_CAPTURED_SLOT_POWER_LIMIT_SCALE)
#endif
...
#define BG_PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE(r)   (((r) & BM_PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE) >> BP_PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE.
#define BF_PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE) & BM_PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE)
#else
//! @brief Format value for bitfield PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE.
#define BF_PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE(v)   (((v) << BP_PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE) & BM_PCIE_DCONR_CORRECTABLE_ERROR_REPORTING_ENABLE)
#endif
...
#define BG_PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE(r)   (((r) & BM_PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE) >> BP_PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE.
#define BF_PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE) & BM_PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE)
#else
//! @brief Format value for bitfield PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE.
#define BF_PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE(v)   (((v) << BP_PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE) & BM_PCIE_DCONR_NON_FATAL_ERROR_REPORTING_ENABLE)
#endif
...
#define BG_PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE(r)   (((r) & BM_PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE) >> BP_PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE.
#define BF_PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE) & BM_PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE)
#else
//! @brief Format value for bitfield PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE.
#define BF_PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE(v)   (((v) << BP_PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE) & BM_PCIE_DCONR_FATAL_ERROR_REPORTING_ENABLE)
#endif
...
#define BG_PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE(r)   (((r) & BM_PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE) >> BP_PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE.
#define BF_PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE) & BM_PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE)
#else
//! @brief Format value for bitfield PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE.
#define BF_PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE(v)   (((v) << BP_PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE) & BM_PCIE_DCONR_UNSUPPORTED_REQUEST_REPORTING_ENABLE)
#endif
...
#define BG_PCIE_DCONR_ENABLE_RELAXED_ORDERING(r)   (((r) & BM_PCIE_DCONR_ENABLE_RELAXED_ORDERING) >> BP_PCIE_DCONR_ENABLE_RELAXED_ORDERING)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_ENABLE_RELAXED_ORDERING.
#define BF_PCIE_DCONR_ENABLE_RELAXED_ORDERING(v)   ((((reg32_t) v) << BP_PCIE_DCONR_ENABLE_RELAXED_ORDERING) & BM_PCIE_DCONR_ENABLE_RELAXED_ORDERING)
#else
//! @brief Format value for bitfield PCIE_DCONR_ENABLE_RELAXED_ORDERING.
#define BF_PCIE_DCONR_ENABLE_RELAXED_ORDERING(v)   (((v) << BP_PCIE_DCONR_ENABLE_RELAXED_ORDERING) & BM_PCIE_DCONR_ENABLE_RELAXED_ORDERING)
#endif
...
#define BG_PCIE_DCONR_MAX_PAYLOAD_SIZE(r)   (((r) & BM_PCIE_DCONR_MAX_PAYLOAD_SIZE) >> BP_PCIE_DCONR_MAX_PAYLOAD_SIZE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_MAX_PAYLOAD_SIZE.
#define BF_PCIE_DCONR_MAX_PAYLOAD_SIZE(v)   ((((reg32_t) v) << BP_PCIE_DCONR_MAX_PAYLOAD_SIZE) & BM_PCIE_DCONR_MAX_PAYLOAD_SIZE)
#else
//! @brief Format value for bitfield PCIE_DCONR_MAX_PAYLOAD_SIZE.
#define BF_PCIE_DCONR_MAX_PAYLOAD_SIZE(v)   (((v) << BP_PCIE_DCONR_MAX_PAYLOAD_SIZE) & BM_PCIE_DCONR_MAX_PAYLOAD_SIZE)
#endif
...
#define BG_PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE(r)   (((r) & BM_PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE) >> BP_PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE.
#define BF_PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE) & BM_PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE)
#else
//! @brief Format value for bitfield PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE.
#define BF_PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE(v)   (((v) << BP_PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE) & BM_PCIE_DCONR_EXTENDED_TAG_FIELD_ENABLE)
#endif
...
#define BG_PCIE_DCONR_PHANTOM_FUNCTION_ENABLE(r)   (((r) & BM_PCIE_DCONR_PHANTOM_FUNCTION_ENABLE) >> BP_PCIE_DCONR_PHANTOM_FUNCTION_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_PHANTOM_FUNCTION_ENABLE.
#define BF_PCIE_DCONR_PHANTOM_FUNCTION_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_DCONR_PHANTOM_FUNCTION_ENABLE) & BM_PCIE_DCONR_PHANTOM_FUNCTION_ENABLE)
#else
//! @brief Format value for bitfield PCIE_DCONR_PHANTOM_FUNCTION_ENABLE.
#define BF_PCIE_DCONR_PHANTOM_FUNCTION_ENABLE(v)   (((v) << BP_PCIE_DCONR_PHANTOM_FUNCTION_ENABLE) & BM_PCIE_DCONR_PHANTOM_FUNCTION_ENABLE)
#endif
...
#define BG_PCIE_DCONR_AUX_POWER_PM_ENABLE(r)   (((r) & BM_PCIE_DCONR_AUX_POWER_PM_ENABLE) >> BP_PCIE_DCONR_AUX_POWER_PM_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_AUX_POWER_PM_ENABLE.
#define BF_PCIE_DCONR_AUX_POWER_PM_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_DCONR_AUX_POWER_PM_ENABLE) & BM_PCIE_DCONR_AUX_POWER_PM_ENABLE)
#else
//! @brief Format value for bitfield PCIE_DCONR_AUX_POWER_PM_ENABLE.
#define BF_PCIE_DCONR_AUX_POWER_PM_ENABLE(v)   (((v) << BP_PCIE_DCONR_AUX_POWER_PM_ENABLE) & BM_PCIE_DCONR_AUX_POWER_PM_ENABLE)
#endif
...
#define BG_PCIE_DCONR_ENABLE_NO_SNOOP(r)   (((r) & BM_PCIE_DCONR_ENABLE_NO_SNOOP) >> BP_PCIE_DCONR_ENABLE_NO_SNOOP)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_ENABLE_NO_SNOOP.
#define BF_PCIE_DCONR_ENABLE_NO_SNOOP(v)   ((((reg32_t) v) << BP_PCIE_DCONR_ENABLE_NO_SNOOP) & BM_PCIE_DCONR_ENABLE_NO_SNOOP)
#else
//! @brief Format value for bitfield PCIE_DCONR_ENABLE_NO_SNOOP.
#define BF_PCIE_DCONR_ENABLE_NO_SNOOP(v)   (((v) << BP_PCIE_DCONR_ENABLE_NO_SNOOP) & BM_PCIE_DCONR_ENABLE_NO_SNOOP)
#endif
...
#define BG_PCIE_DCONR_MAX_READ_REQUEST_SIZE(r)   (((r) & BM_PCIE_DCONR_MAX_READ_REQUEST_SIZE) >> BP_PCIE_DCONR_MAX_READ_REQUEST_SIZE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_MAX_READ_REQUEST_SIZE.
#define BF_PCIE_DCONR_MAX_READ_REQUEST_SIZE(v)   ((((reg32_t) v) << BP_PCIE_DCONR_MAX_READ_REQUEST_SIZE) & BM_PCIE_DCONR_MAX_READ_REQUEST_SIZE)
#else
//! @brief Format value for bitfield PCIE_DCONR_MAX_READ_REQUEST_SIZE.
#define BF_PCIE_DCONR_MAX_READ_REQUEST_SIZE(v)   (((v) << BP_PCIE_DCONR_MAX_READ_REQUEST_SIZE) & BM_PCIE_DCONR_MAX_READ_REQUEST_SIZE)
#endif
...
#define BG_PCIE_DCONR_CORRECTABLE_ERROR_DETECTED(r)   (((r) & BM_PCIE_DCONR_CORRECTABLE_ERROR_DETECTED) >> BP_PCIE_DCONR_CORRECTABLE_ERROR_DETECTED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_CORRECTABLE_ERROR_DETECTED.
#define BF_PCIE_DCONR_CORRECTABLE_ERROR_DETECTED(v)   ((((reg32_t) v) << BP_PCIE_DCONR_CORRECTABLE_ERROR_DETECTED) & BM_PCIE_DCONR_CORRECTABLE_ERROR_DETECTED)
#else
//! @brief Format value for bitfield PCIE_DCONR_CORRECTABLE_ERROR_DETECTED.
#define BF_PCIE_DCONR_CORRECTABLE_ERROR_DETECTED(v)   (((v) << BP_PCIE_DCONR_CORRECTABLE_ERROR_DETECTED) & BM_PCIE_DCONR_CORRECTABLE_ERROR_DETECTED)
#endif
...
#define BG_PCIE_DCONR_NON_FATAL_ERROR_DETECTED(r)   (((r) & BM_PCIE_DCONR_NON_FATAL_ERROR_DETECTED) >> BP_PCIE_DCONR_NON_FATAL_ERROR_DETECTED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_NON_FATAL_ERROR_DETECTED.
#define BF_PCIE_DCONR_NON_FATAL_ERROR_DETECTED(v)   ((((reg32_t) v) << BP_PCIE_DCONR_NON_FATAL_ERROR_DETECTED) & BM_PCIE_DCONR_NON_FATAL_ERROR_DETECTED)
#else
//! @brief Format value for bitfield PCIE_DCONR_NON_FATAL_ERROR_DETECTED.
#define BF_PCIE_DCONR_NON_FATAL_ERROR_DETECTED(v)   (((v) << BP_PCIE_DCONR_NON_FATAL_ERROR_DETECTED) & BM_PCIE_DCONR_NON_FATAL_ERROR_DETECTED)
#endif
...
#define BG_PCIE_DCONR_FATAL_ERROR_DETECTED(r)   (((r) & BM_PCIE_DCONR_FATAL_ERROR_DETECTED) >> BP_PCIE_DCONR_FATAL_ERROR_DETECTED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_FATAL_ERROR_DETECTED.
#define BF_PCIE_DCONR_FATAL_ERROR_DETECTED(v)   ((((reg32_t) v) << BP_PCIE_DCONR_FATAL_ERROR_DETECTED) & BM_PCIE_DCONR_FATAL_ERROR_DETECTED)
#else
//! @brief Format value for bitfield PCIE_DCONR_FATAL_ERROR_DETECTED.
#define BF_PCIE_DCONR_FATAL_ERROR_DETECTED(v)   (((v) << BP_PCIE_DCONR_FATAL_ERROR_DETECTED) & BM_PCIE_DCONR_FATAL_ERROR_DETECTED)
#endif
...
#define BG_PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED(r)   (((r) & BM_PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED) >> BP_PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED.
#define BF_PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED(v)   ((((reg32_t) v) << BP_PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED) & BM_PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED)
#else
//! @brief Format value for bitfield PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED.
#define BF_PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED(v)   (((v) << BP_PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED) & BM_PCIE_DCONR_UNSUPPORTED_REQUEST_DETECTED)
#endif
...
#define BG_PCIE_DCONR_AUX_POWER_DETECTED(r)   (((r) & BM_PCIE_DCONR_AUX_POWER_DETECTED) >> BP_PCIE_DCONR_AUX_POWER_DETECTED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_AUX_POWER_DETECTED.
#define BF_PCIE_DCONR_AUX_POWER_DETECTED(v)   ((((reg32_t) v) << BP_PCIE_DCONR_AUX_POWER_DETECTED) & BM_PCIE_DCONR_AUX_POWER_DETECTED)
#else
//! @brief Format value for bitfield PCIE_DCONR_AUX_POWER_DETECTED.
#define BF_PCIE_DCONR_AUX_POWER_DETECTED(v)   (((v) << BP_PCIE_DCONR_AUX_POWER_DETECTED) & BM_PCIE_DCONR_AUX_POWER_DETECTED)
#endif
...
#define BG_PCIE_DCONR_TRANSACTION_PENDING(r)   (((r) & BM_PCIE_DCONR_TRANSACTION_PENDING) >> BP_PCIE_DCONR_TRANSACTION_PENDING)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCONR_TRANSACTION_PENDING.
#define BF_PCIE_DCONR_TRANSACTION_PENDING(v)   ((((reg32_t) v) << BP_PCIE_DCONR_TRANSACTION_PENDING) & BM_PCIE_DCONR_TRANSACTION_PENDING)
#else
//! @brief Format value for bitfield PCIE_DCONR_TRANSACTION_PENDING.
#define BF_PCIE_DCONR_TRANSACTION_PENDING(v)   (((v) << BP_PCIE_DCONR_TRANSACTION_PENDING) & BM_PCIE_DCONR_TRANSACTION_PENDING)
#endif
...
#define BG_PCIE_LCR_MAX_LINK_SPEEDS(r)   (((r) & BM_PCIE_LCR_MAX_LINK_SPEEDS) >> BP_PCIE_LCR_MAX_LINK_SPEEDS)
...
#define BG_PCIE_LCR_MAXIMUM_LINK_WIDTH(r)   (((r) & BM_PCIE_LCR_MAXIMUM_LINK_WIDTH) >> BP_PCIE_LCR_MAXIMUM_LINK_WIDTH)
...
#define BG_PCIE_LCR_ACTIVE_STATE_LINK_PM_SUPPORT(r)   (((r) & BM_PCIE_LCR_ACTIVE_STATE_LINK_PM_SUPPORT) >> BP_PCIE_LCR_ACTIVE_STATE_LINK_PM_SUPPORT)
...
#define BG_PCIE_LCR_L0S_EXIT_LATENCY(r)   (((r) & BM_PCIE_LCR_L0S_EXIT_LATENCY) >> BP_PCIE_LCR_L0S_EXIT_LATENCY)
...
#define BG_PCIE_LCR_L1_EXIT_LATENCY(r)   (((r) & BM_PCIE_LCR_L1_EXIT_LATENCY) >> BP_PCIE_LCR_L1_EXIT_LATENCY)
...
#define BG_PCIE_LCR_CLOCK_POWER_MANAGEMENT(r)   (((r) & BM_PCIE_LCR_CLOCK_POWER_MANAGEMENT) >> BP_PCIE_LCR_CLOCK_POWER_MANAGEMENT)
...
#define BG_PCIE_LCR_SURPRISE_DOWN_ERROR_REPORTING_CAPABLE(r)   (((r) & BM_PCIE_LCR_SURPRISE_DOWN_ERROR_REPORTING_CAPABLE) >> BP_PCIE_LCR_SURPRISE_DOWN_ERROR_REPORTING_CAPABLE)
...
#define BG_PCIE_LCR_DATA_LINK_LAYER_ACTIVE_REPORTING_CAPABLE(r)   (((r) & BM_PCIE_LCR_DATA_LINK_LAYER_ACTIVE_REPORTING_CAPABLE) >> BP_PCIE_LCR_DATA_LINK_LAYER_ACTIVE_REPORTING_CAPABLE)
...
#define BG_PCIE_LCR_LINK_BANDWIDTH_NOTIFICATION_CAPABILITY(r)   (((r) & BM_PCIE_LCR_LINK_BANDWIDTH_NOTIFICATION_CAPABILITY) >> BP_PCIE_LCR_LINK_BANDWIDTH_NOTIFICATION_CAPABILITY)
...
#define BG_PCIE_LCR_PORT_NUMBER(r)   (((r) & BM_PCIE_LCR_PORT_NUMBER) >> BP_PCIE_LCR_PORT_NUMBER)
...
#define BG_PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL(r)   (((r) & BM_PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL) >> BP_PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL.
#define BF_PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL(v)   ((((reg32_t) v) << BP_PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL) & BM_PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL)
#else
//! @brief Format value for bitfield PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL.
#define BF_PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL(v)   (((v) << BP_PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL) & BM_PCIE_LCSR_ACTIVE_STATE_LINK_PM_CONTROL)
#endif
...
#define BG_PCIE_LCSR_RCB(r)   (((r) & BM_PCIE_LCSR_RCB) >> BP_PCIE_LCSR_RCB)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_RCB.
#define BF_PCIE_LCSR_RCB(v)   ((((reg32_t) v) << BP_PCIE_LCSR_RCB) & BM_PCIE_LCSR_RCB)
#else
//! @brief Format value for bitfield PCIE_LCSR_RCB.
#define BF_PCIE_LCSR_RCB(v)   (((v) << BP_PCIE_LCSR_RCB) & BM_PCIE_LCSR_RCB)
#endif
...
#define BG_PCIE_LCSR_LINK_DISABLE(r)   (((r) & BM_PCIE_LCSR_LINK_DISABLE) >> BP_PCIE_LCSR_LINK_DISABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_LINK_DISABLE.
#define BF_PCIE_LCSR_LINK_DISABLE(v)   ((((reg32_t) v) << BP_PCIE_LCSR_LINK_DISABLE) & BM_PCIE_LCSR_LINK_DISABLE)
#else
//! @brief Format value for bitfield PCIE_LCSR_LINK_DISABLE.
#define BF_PCIE_LCSR_LINK_DISABLE(v)   (((v) << BP_PCIE_LCSR_LINK_DISABLE) & BM_PCIE_LCSR_LINK_DISABLE)
#endif
...
#define BG_PCIE_LCSR_RETRAIN_LINK(r)   (((r) & BM_PCIE_LCSR_RETRAIN_LINK) >> BP_PCIE_LCSR_RETRAIN_LINK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_RETRAIN_LINK.
#define BF_PCIE_LCSR_RETRAIN_LINK(v)   ((((reg32_t) v) << BP_PCIE_LCSR_RETRAIN_LINK) & BM_PCIE_LCSR_RETRAIN_LINK)
#else
//! @brief Format value for bitfield PCIE_LCSR_RETRAIN_LINK.
#define BF_PCIE_LCSR_RETRAIN_LINK(v)   (((v) << BP_PCIE_LCSR_RETRAIN_LINK) & BM_PCIE_LCSR_RETRAIN_LINK)
#endif
...
#define BG_PCIE_LCSR_COMMON_CLOCK_CONFIGURATION(r)   (((r) & BM_PCIE_LCSR_COMMON_CLOCK_CONFIGURATION) >> BP_PCIE_LCSR_COMMON_CLOCK_CONFIGURATION)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_COMMON_CLOCK_CONFIGURATION.
#define BF_PCIE_LCSR_COMMON_CLOCK_CONFIGURATION(v)   ((((reg32_t) v) << BP_PCIE_LCSR_COMMON_CLOCK_CONFIGURATION) & BM_PCIE_LCSR_COMMON_CLOCK_CONFIGURATION)
#else
//! @brief Format value for bitfield PCIE_LCSR_COMMON_CLOCK_CONFIGURATION.
#define BF_PCIE_LCSR_COMMON_CLOCK_CONFIGURATION(v)   (((v) << BP_PCIE_LCSR_COMMON_CLOCK_CONFIGURATION) & BM_PCIE_LCSR_COMMON_CLOCK_CONFIGURATION)
#endif
...
#define BG_PCIE_LCSR_EXTENDED_SYNCH(r)   (((r) & BM_PCIE_LCSR_EXTENDED_SYNCH) >> BP_PCIE_LCSR_EXTENDED_SYNCH)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_EXTENDED_SYNCH.
#define BF_PCIE_LCSR_EXTENDED_SYNCH(v)   ((((reg32_t) v) << BP_PCIE_LCSR_EXTENDED_SYNCH) & BM_PCIE_LCSR_EXTENDED_SYNCH)
#else
//! @brief Format value for bitfield PCIE_LCSR_EXTENDED_SYNCH.
#define BF_PCIE_LCSR_EXTENDED_SYNCH(v)   (((v) << BP_PCIE_LCSR_EXTENDED_SYNCH) & BM_PCIE_LCSR_EXTENDED_SYNCH)
#endif
...
#define BG_PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT(r)   (((r) & BM_PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT) >> BP_PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT.
#define BF_PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT(v)   ((((reg32_t) v) << BP_PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT) & BM_PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT)
#else
//! @brief Format value for bitfield PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT.
#define BF_PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT(v)   (((v) << BP_PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT) & BM_PCIE_LCSR_ENABLE_CLOCK_POWER_MANAGEMENT)
#endif
...
#define BG_PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE(r)   (((r) & BM_PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE) >> BP_PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE.
#define BF_PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE(v)   ((((reg32_t) v) << BP_PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE) & BM_PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE)
#else
//! @brief Format value for bitfield PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE.
#define BF_PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE(v)   (((v) << BP_PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE) & BM_PCIE_LCSR_HARDWARE_AUTONOMOUS_WIDTH_DISABLE)
#endif
...
#define BG_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE(r)   (((r) & BM_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE) >> BP_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE.
#define BF_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE) & BM_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE)
#else
//! @brief Format value for bitfield PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE.
#define BF_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE(v)   (((v) << BP_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE) & BM_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_INTERRUPT_ENABLE)
#endif
...
#define BG_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE(r)   (((r) & BM_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE) >> BP_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE.
#define BF_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE) & BM_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE)
#else
//! @brief Format value for bitfield PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE.
#define BF_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE(v)   (((v) << BP_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE) & BM_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_INTERRUPT_ENABLE)
#endif
...
#define BG_PCIE_LCSR_LINK_SPEED(r)   (((r) & BM_PCIE_LCSR_LINK_SPEED) >> BP_PCIE_LCSR_LINK_SPEED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_LINK_SPEED.
#define BF_PCIE_LCSR_LINK_SPEED(v)   ((((reg32_t) v) << BP_PCIE_LCSR_LINK_SPEED) & BM_PCIE_LCSR_LINK_SPEED)
#else
//! @brief Format value for bitfield PCIE_LCSR_LINK_SPEED.
#define BF_PCIE_LCSR_LINK_SPEED(v)   (((v) << BP_PCIE_LCSR_LINK_SPEED) & BM_PCIE_LCSR_LINK_SPEED)
#endif
...
#define BG_PCIE_LCSR_NEGOTIATED_LINK_WIDTH(r)   (((r) & BM_PCIE_LCSR_NEGOTIATED_LINK_WIDTH) >> BP_PCIE_LCSR_NEGOTIATED_LINK_WIDTH)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_NEGOTIATED_LINK_WIDTH.
#define BF_PCIE_LCSR_NEGOTIATED_LINK_WIDTH(v)   ((((reg32_t) v) << BP_PCIE_LCSR_NEGOTIATED_LINK_WIDTH) & BM_PCIE_LCSR_NEGOTIATED_LINK_WIDTH)
#else
//! @brief Format value for bitfield PCIE_LCSR_NEGOTIATED_LINK_WIDTH.
#define BF_PCIE_LCSR_NEGOTIATED_LINK_WIDTH(v)   (((v) << BP_PCIE_LCSR_NEGOTIATED_LINK_WIDTH) & BM_PCIE_LCSR_NEGOTIATED_LINK_WIDTH)
#endif
...
#define BG_PCIE_LCSR_LINK_TRAINING(r)   (((r) & BM_PCIE_LCSR_LINK_TRAINING) >> BP_PCIE_LCSR_LINK_TRAINING)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_LINK_TRAINING.
#define BF_PCIE_LCSR_LINK_TRAINING(v)   ((((reg32_t) v) << BP_PCIE_LCSR_LINK_TRAINING) & BM_PCIE_LCSR_LINK_TRAINING)
#else
//! @brief Format value for bitfield PCIE_LCSR_LINK_TRAINING.
#define BF_PCIE_LCSR_LINK_TRAINING(v)   (((v) << BP_PCIE_LCSR_LINK_TRAINING) & BM_PCIE_LCSR_LINK_TRAINING)
#endif
...
#define BG_PCIE_LCSR_SLOT_CLOCK_CONFIGURATION(r)   (((r) & BM_PCIE_LCSR_SLOT_CLOCK_CONFIGURATION) >> BP_PCIE_LCSR_SLOT_CLOCK_CONFIGURATION)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_SLOT_CLOCK_CONFIGURATION.
#define BF_PCIE_LCSR_SLOT_CLOCK_CONFIGURATION(v)   ((((reg32_t) v) << BP_PCIE_LCSR_SLOT_CLOCK_CONFIGURATION) & BM_PCIE_LCSR_SLOT_CLOCK_CONFIGURATION)
#else
//! @brief Format value for bitfield PCIE_LCSR_SLOT_CLOCK_CONFIGURATION.
#define BF_PCIE_LCSR_SLOT_CLOCK_CONFIGURATION(v)   (((v) << BP_PCIE_LCSR_SLOT_CLOCK_CONFIGURATION) & BM_PCIE_LCSR_SLOT_CLOCK_CONFIGURATION)
#endif
...
#define BG_PCIE_LCSR_DATA_LINK_LAYER_ACTIVE(r)   (((r) & BM_PCIE_LCSR_DATA_LINK_LAYER_ACTIVE) >> BP_PCIE_LCSR_DATA_LINK_LAYER_ACTIVE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_DATA_LINK_LAYER_ACTIVE.
#define BF_PCIE_LCSR_DATA_LINK_LAYER_ACTIVE(v)   ((((reg32_t) v) << BP_PCIE_LCSR_DATA_LINK_LAYER_ACTIVE) & BM_PCIE_LCSR_DATA_LINK_LAYER_ACTIVE)
#else
//! @brief Format value for bitfield PCIE_LCSR_DATA_LINK_LAYER_ACTIVE.
#define BF_PCIE_LCSR_DATA_LINK_LAYER_ACTIVE(v)   (((v) << BP_PCIE_LCSR_DATA_LINK_LAYER_ACTIVE) & BM_PCIE_LCSR_DATA_LINK_LAYER_ACTIVE)
#endif
...
#define BG_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS(r)   (((r) & BM_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS) >> BP_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS.
#define BF_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS(v)   ((((reg32_t) v) << BP_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS) & BM_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS)
#else
//! @brief Format value for bitfield PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS.
#define BF_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS(v)   (((v) << BP_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS) & BM_PCIE_LCSR_LINK_BANDWIDTH_MANAGEMENT_STATUS)
#endif
...
#define BG_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS(r)   (((r) & BM_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS) >> BP_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS.
#define BF_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS(v)   ((((reg32_t) v) << BP_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS) & BM_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS)
#else
//! @brief Format value for bitfield PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS.
#define BF_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS(v)   (((v) << BP_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS) & BM_PCIE_LCSR_LINK_AUTONOMOUS_BANDWIDTH_STATUS)
#endif
...
#define BG_PCIE_SCR_ATTENTION_INDICATOR_PRESENT(r)   (((r) & BM_PCIE_SCR_ATTENTION_INDICATOR_PRESENT) >> BP_PCIE_SCR_ATTENTION_INDICATOR_PRESENT)
...
#define BG_PCIE_SCR_POWER_CONTROLLER_PRESENT(r)   (((r) & BM_PCIE_SCR_POWER_CONTROLLER_PRESENT) >> BP_PCIE_SCR_POWER_CONTROLLER_PRESENT)
...
#define BG_PCIE_SCR_MRL_SENSOR_PRESENT(r)   (((r) & BM_PCIE_SCR_MRL_SENSOR_PRESENT) >> BP_PCIE_SCR_MRL_SENSOR_PRESENT)
...
#define BG_PCIE_SCR_ATTENTION_INDICATOR_PRESENT1(r)   (((r) & BM_PCIE_SCR_ATTENTION_INDICATOR_PRESENT1) >> BP_PCIE_SCR_ATTENTION_INDICATOR_PRESENT1)
...
#define BG_PCIE_SCR_POWER_INDICATOR_PRESENT(r)   (((r) & BM_PCIE_SCR_POWER_INDICATOR_PRESENT) >> BP_PCIE_SCR_POWER_INDICATOR_PRESENT)
...
#define BG_PCIE_SCR_HOT_PLUG_SURPRISE(r)   (((r) & BM_PCIE_SCR_HOT_PLUG_SURPRISE) >> BP_PCIE_SCR_HOT_PLUG_SURPRISE)
...
#define BG_PCIE_SCR_HOT_PLUG_CAPABLE(r)   (((r) & BM_PCIE_SCR_HOT_PLUG_CAPABLE) >> BP_PCIE_SCR_HOT_PLUG_CAPABLE)
...
#define BG_PCIE_SCR_SLOT_POWER_LIMIT_VALUE(r)   (((r) & BM_PCIE_SCR_SLOT_POWER_LIMIT_VALUE) >> BP_PCIE_SCR_SLOT_POWER_LIMIT_VALUE)
...
#define BG_PCIE_SCR_SLOT_POWER_LIMIT_SCALE(r)   (((r) & BM_PCIE_SCR_SLOT_POWER_LIMIT_SCALE) >> BP_PCIE_SCR_SLOT_POWER_LIMIT_SCALE)
...
#define BG_PCIE_SCR_ELECTROMECHANICAL_INTERLOCK_PRESENT(r)   (((r) & BM_PCIE_SCR_ELECTROMECHANICAL_INTERLOCK_PRESENT) >> BP_PCIE_SCR_ELECTROMECHANICAL_INTERLOCK_PRESENT)
...
#define BG_PCIE_SCR_NO_COMMAND_COMPLETE_SUPPORT(r)   (((r) & BM_PCIE_SCR_NO_COMMAND_COMPLETE_SUPPORT) >> BP_PCIE_SCR_NO_COMMAND_COMPLETE_SUPPORT)
...
#define BG_PCIE_SCR_PHYSICAL_SLOT_NUMBER(r)   (((r) & BM_PCIE_SCR_PHYSICAL_SLOT_NUMBER) >> BP_PCIE_SCR_PHYSICAL_SLOT_NUMBER)
...
#define BG_PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE(r)   (((r) & BM_PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE) >> BP_PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE.
#define BF_PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE) & BM_PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE)
#else
//! @brief Format value for bitfield PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE.
#define BF_PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE(v)   (((v) << BP_PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE) & BM_PCIE_SCSR_ATTENTION_BUTTON_PRESSED_ENABLE)
#endif
...
#define BG_PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE(r)   (((r) & BM_PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE) >> BP_PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE.
#define BF_PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE) & BM_PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE)
#else
//! @brief Format value for bitfield PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE.
#define BF_PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE(v)   (((v) << BP_PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE) & BM_PCIE_SCSR_POWER_FAULT_DETECTED_ENABLE)
#endif
...
#define BG_PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE(r)   (((r) & BM_PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE) >> BP_PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE.
#define BF_PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE) & BM_PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE)
#else
//! @brief Format value for bitfield PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE.
#define BF_PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE(v)   (((v) << BP_PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE) & BM_PCIE_SCSR_MRL_SENSOR_CHANGED_ENABLE)
#endif
...
#define BG_PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE(r)   (((r) & BM_PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE) >> BP_PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE.
#define BF_PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE) & BM_PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE)
#else
//! @brief Format value for bitfield PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE.
#define BF_PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE(v)   (((v) << BP_PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE) & BM_PCIE_SCSR_PRESENCE_DETECT_CHANGED_ENABLE)
#endif
...
#define BG_PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE(r)   (((r) & BM_PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE) >> BP_PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE.
#define BF_PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE) & BM_PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE)
#else
//! @brief Format value for bitfield PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE.
#define BF_PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE(v)   (((v) << BP_PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE) & BM_PCIE_SCSR_COMMAND_COMPLETED_INTERRUPT_ENABLE)
#endif
...
#define BG_PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE(r)   (((r) & BM_PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE) >> BP_PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE.
#define BF_PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE) & BM_PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE)
#else
//! @brief Format value for bitfield PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE.
#define BF_PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE(v)   (((v) << BP_PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE) & BM_PCIE_SCSR_HOT_PLUG_INTERRUPT_ENABLE)
#endif
...
#define BG_PCIE_SCSR_ATTENTION_INDICATOR_CONTROL(r)   (((r) & BM_PCIE_SCSR_ATTENTION_INDICATOR_CONTROL) >> BP_PCIE_SCSR_ATTENTION_INDICATOR_CONTROL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_ATTENTION_INDICATOR_CONTROL.
#define BF_PCIE_SCSR_ATTENTION_INDICATOR_CONTROL(v)   ((((reg32_t) v) << BP_PCIE_SCSR_ATTENTION_INDICATOR_CONTROL) & BM_PCIE_SCSR_ATTENTION_INDICATOR_CONTROL)
#else
//! @brief Format value for bitfield PCIE_SCSR_ATTENTION_INDICATOR_CONTROL.
#define BF_PCIE_SCSR_ATTENTION_INDICATOR_CONTROL(v)   (((v) << BP_PCIE_SCSR_ATTENTION_INDICATOR_CONTROL) & BM_PCIE_SCSR_ATTENTION_INDICATOR_CONTROL)
#endif
...
#define BG_PCIE_SCSR_POWER_INDICATOR_CONTROL(r)   (((r) & BM_PCIE_SCSR_POWER_INDICATOR_CONTROL) >> BP_PCIE_SCSR_POWER_INDICATOR_CONTROL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_POWER_INDICATOR_CONTROL.
#define BF_PCIE_SCSR_POWER_INDICATOR_CONTROL(v)   ((((reg32_t) v) << BP_PCIE_SCSR_POWER_INDICATOR_CONTROL) & BM_PCIE_SCSR_POWER_INDICATOR_CONTROL)
#else
//! @brief Format value for bitfield PCIE_SCSR_POWER_INDICATOR_CONTROL.
#define BF_PCIE_SCSR_POWER_INDICATOR_CONTROL(v)   (((v) << BP_PCIE_SCSR_POWER_INDICATOR_CONTROL) & BM_PCIE_SCSR_POWER_INDICATOR_CONTROL)
#endif
...
#define BG_PCIE_SCSR_POWER_CONTROLLER_CONTROL(r)   (((r) & BM_PCIE_SCSR_POWER_CONTROLLER_CONTROL) >> BP_PCIE_SCSR_POWER_CONTROLLER_CONTROL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_POWER_CONTROLLER_CONTROL.
#define BF_PCIE_SCSR_POWER_CONTROLLER_CONTROL(v)   ((((reg32_t) v) << BP_PCIE_SCSR_POWER_CONTROLLER_CONTROL) & BM_PCIE_SCSR_POWER_CONTROLLER_CONTROL)
#else
//! @brief Format value for bitfield PCIE_SCSR_POWER_CONTROLLER_CONTROL.
#define BF_PCIE_SCSR_POWER_CONTROLLER_CONTROL(v)   (((v) << BP_PCIE_SCSR_POWER_CONTROLLER_CONTROL) & BM_PCIE_SCSR_POWER_CONTROLLER_CONTROL)
#endif
...
#define BG_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL(r)   (((r) & BM_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL) >> BP_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL.
#define BF_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL(v)   ((((reg32_t) v) << BP_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL) & BM_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL)
#else
//! @brief Format value for bitfield PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL.
#define BF_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL(v)   (((v) << BP_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL) & BM_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_CONTROL)
#endif
...
#define BG_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE(r)   (((r) & BM_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE) >> BP_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE.
#define BF_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE) & BM_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE)
#else
//! @brief Format value for bitfield PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE.
#define BF_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE(v)   (((v) << BP_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE) & BM_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED_ENABLE)
#endif
...
#define BG_PCIE_SCSR_ATTENTION_BUTTON_PRESSED(r)   (((r) & BM_PCIE_SCSR_ATTENTION_BUTTON_PRESSED) >> BP_PCIE_SCSR_ATTENTION_BUTTON_PRESSED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_ATTENTION_BUTTON_PRESSED.
#define BF_PCIE_SCSR_ATTENTION_BUTTON_PRESSED(v)   ((((reg32_t) v) << BP_PCIE_SCSR_ATTENTION_BUTTON_PRESSED) & BM_PCIE_SCSR_ATTENTION_BUTTON_PRESSED)
#else
//! @brief Format value for bitfield PCIE_SCSR_ATTENTION_BUTTON_PRESSED.
#define BF_PCIE_SCSR_ATTENTION_BUTTON_PRESSED(v)   (((v) << BP_PCIE_SCSR_ATTENTION_BUTTON_PRESSED) & BM_PCIE_SCSR_ATTENTION_BUTTON_PRESSED)
#endif
...
#define BG_PCIE_SCSR_POWER_FAULT_DETECTED(r)   (((r) & BM_PCIE_SCSR_POWER_FAULT_DETECTED) >> BP_PCIE_SCSR_POWER_FAULT_DETECTED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_POWER_FAULT_DETECTED.
#define BF_PCIE_SCSR_POWER_FAULT_DETECTED(v)   ((((reg32_t) v) << BP_PCIE_SCSR_POWER_FAULT_DETECTED) & BM_PCIE_SCSR_POWER_FAULT_DETECTED)
#else
//! @brief Format value for bitfield PCIE_SCSR_POWER_FAULT_DETECTED.
#define BF_PCIE_SCSR_POWER_FAULT_DETECTED(v)   (((v) << BP_PCIE_SCSR_POWER_FAULT_DETECTED) & BM_PCIE_SCSR_POWER_FAULT_DETECTED)
#endif
...
#define BG_PCIE_SCSR_MRL_SENSOR_CHANGED(r)   (((r) & BM_PCIE_SCSR_MRL_SENSOR_CHANGED) >> BP_PCIE_SCSR_MRL_SENSOR_CHANGED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_MRL_SENSOR_CHANGED.
#define BF_PCIE_SCSR_MRL_SENSOR_CHANGED(v)   ((((reg32_t) v) << BP_PCIE_SCSR_MRL_SENSOR_CHANGED) & BM_PCIE_SCSR_MRL_SENSOR_CHANGED)
#else
//! @brief Format value for bitfield PCIE_SCSR_MRL_SENSOR_CHANGED.
#define BF_PCIE_SCSR_MRL_SENSOR_CHANGED(v)   (((v) << BP_PCIE_SCSR_MRL_SENSOR_CHANGED) & BM_PCIE_SCSR_MRL_SENSOR_CHANGED)
#endif
...
#define BG_PCIE_SCSR_PRESENCE_DETECT_CHANGED(r)   (((r) & BM_PCIE_SCSR_PRESENCE_DETECT_CHANGED) >> BP_PCIE_SCSR_PRESENCE_DETECT_CHANGED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_PRESENCE_DETECT_CHANGED.
#define BF_PCIE_SCSR_PRESENCE_DETECT_CHANGED(v)   ((((reg32_t) v) << BP_PCIE_SCSR_PRESENCE_DETECT_CHANGED) & BM_PCIE_SCSR_PRESENCE_DETECT_CHANGED)
#else
//! @brief Format value for bitfield PCIE_SCSR_PRESENCE_DETECT_CHANGED.
#define BF_PCIE_SCSR_PRESENCE_DETECT_CHANGED(v)   (((v) << BP_PCIE_SCSR_PRESENCE_DETECT_CHANGED) & BM_PCIE_SCSR_PRESENCE_DETECT_CHANGED)
#endif
...
#define BG_PCIE_SCSR_COMMAND_COMPLETED(r)   (((r) & BM_PCIE_SCSR_COMMAND_COMPLETED) >> BP_PCIE_SCSR_COMMAND_COMPLETED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_COMMAND_COMPLETED.
#define BF_PCIE_SCSR_COMMAND_COMPLETED(v)   ((((reg32_t) v) << BP_PCIE_SCSR_COMMAND_COMPLETED) & BM_PCIE_SCSR_COMMAND_COMPLETED)
#else
//! @brief Format value for bitfield PCIE_SCSR_COMMAND_COMPLETED.
#define BF_PCIE_SCSR_COMMAND_COMPLETED(v)   (((v) << BP_PCIE_SCSR_COMMAND_COMPLETED) & BM_PCIE_SCSR_COMMAND_COMPLETED)
#endif
...
#define BG_PCIE_SCSR_MRL_SENSOR_STATE(r)   (((r) & BM_PCIE_SCSR_MRL_SENSOR_STATE) >> BP_PCIE_SCSR_MRL_SENSOR_STATE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_MRL_SENSOR_STATE.
#define BF_PCIE_SCSR_MRL_SENSOR_STATE(v)   ((((reg32_t) v) << BP_PCIE_SCSR_MRL_SENSOR_STATE) & BM_PCIE_SCSR_MRL_SENSOR_STATE)
#else
//! @brief Format value for bitfield PCIE_SCSR_MRL_SENSOR_STATE.
#define BF_PCIE_SCSR_MRL_SENSOR_STATE(v)   (((v) << BP_PCIE_SCSR_MRL_SENSOR_STATE) & BM_PCIE_SCSR_MRL_SENSOR_STATE)
#endif
...
#define BG_PCIE_SCSR_PRESENCE_DETECT_STATE(r)   (((r) & BM_PCIE_SCSR_PRESENCE_DETECT_STATE) >> BP_PCIE_SCSR_PRESENCE_DETECT_STATE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_PRESENCE_DETECT_STATE.
#define BF_PCIE_SCSR_PRESENCE_DETECT_STATE(v)   ((((reg32_t) v) << BP_PCIE_SCSR_PRESENCE_DETECT_STATE) & BM_PCIE_SCSR_PRESENCE_DETECT_STATE)
#else
//! @brief Format value for bitfield PCIE_SCSR_PRESENCE_DETECT_STATE.
#define BF_PCIE_SCSR_PRESENCE_DETECT_STATE(v)   (((v) << BP_PCIE_SCSR_PRESENCE_DETECT_STATE) & BM_PCIE_SCSR_PRESENCE_DETECT_STATE)
#endif
...
#define BG_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS(r)   (((r) & BM_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS) >> BP_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS.
#define BF_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS(v)   ((((reg32_t) v) << BP_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS) & BM_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS)
#else
//! @brief Format value for bitfield PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS.
#define BF_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS(v)   (((v) << BP_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS) & BM_PCIE_SCSR_ELECTROMECHANICAL_INTERLOCK_STATUS)
#endif
...
#define BG_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED(r)   (((r) & BM_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED) >> BP_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED.
#define BF_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED(v)   ((((reg32_t) v) << BP_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED) & BM_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED)
#else
//! @brief Format value for bitfield PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED.
#define BF_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED(v)   (((v) << BP_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED) & BM_PCIE_SCSR_DATA_LINK_LAYER_STATE_CHANGED)
#endif
...
#define BG_PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE(r)   (((r) & BM_PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE) >> BP_PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE.
#define BF_PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE) & BM_PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE)
#else
//! @brief Format value for bitfield PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE.
#define BF_PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE(v)   (((v) << BP_PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE) & BM_PCIE_RCCR_SYSTEM_ERROR_ON_CORRECTABLE_ERROR_ENABLE)
#endif
...
#define BG_PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE(r)   (((r) & BM_PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE) >> BP_PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE.
#define BF_PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE) & BM_PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE)
#else
//! @brief Format value for bitfield PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE.
#define BF_PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE(v)   (((v) << BP_PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE) & BM_PCIE_RCCR_SYSTEM_ERROR_ON_NON_FATAL_ERROR_ENABLE)
#endif
...
#define BG_PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE(r)   (((r) & BM_PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE) >> BP_PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE.
#define BF_PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE) & BM_PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE)
#else
//! @brief Format value for bitfield PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE.
#define BF_PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE(v)   (((v) << BP_PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE) & BM_PCIE_RCCR_SYSTEM_ERROR_ON_FATAL_ERROR_ENABLE)
#endif
...
#define BG_PCIE_RCCR_PME_INTERRUPT_ENABLE(r)   (((r) & BM_PCIE_RCCR_PME_INTERRUPT_ENABLE) >> BP_PCIE_RCCR_PME_INTERRUPT_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RCCR_PME_INTERRUPT_ENABLE.
#define BF_PCIE_RCCR_PME_INTERRUPT_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_RCCR_PME_INTERRUPT_ENABLE) & BM_PCIE_RCCR_PME_INTERRUPT_ENABLE)
#else
//! @brief Format value for bitfield PCIE_RCCR_PME_INTERRUPT_ENABLE.
#define BF_PCIE_RCCR_PME_INTERRUPT_ENABLE(v)   (((v) << BP_PCIE_RCCR_PME_INTERRUPT_ENABLE) & BM_PCIE_RCCR_PME_INTERRUPT_ENABLE)
#endif
...
#define BG_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE(r)   (((r) & BM_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE) >> BP_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE.
#define BF_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE) & BM_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE)
#else
//! @brief Format value for bitfield PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE.
#define BF_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE(v)   (((v) << BP_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE) & BM_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY_ENABLE)
#endif
...
#define BG_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY(r)   (((r) & BM_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY) >> BP_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RCCR_CRS_SOFTWARE_VISIBILITY.
#define BF_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY(v)   ((((reg32_t) v) << BP_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY) & BM_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY)
#else
//! @brief Format value for bitfield PCIE_RCCR_CRS_SOFTWARE_VISIBILITY.
#define BF_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY(v)   (((v) << BP_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY) & BM_PCIE_RCCR_CRS_SOFTWARE_VISIBILITY)
#endif
...
#define BG_PCIE_RSR_PME_REQUESTER_ID(r)   (((r) & BM_PCIE_RSR_PME_REQUESTER_ID) >> BP_PCIE_RSR_PME_REQUESTER_ID)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RSR_PME_REQUESTER_ID.
#define BF_PCIE_RSR_PME_REQUESTER_ID(v)   ((((reg32_t) v) << BP_PCIE_RSR_PME_REQUESTER_ID) & BM_PCIE_RSR_PME_REQUESTER_ID)
#else
//! @brief Format value for bitfield PCIE_RSR_PME_REQUESTER_ID.
#define BF_PCIE_RSR_PME_REQUESTER_ID(v)   (((v) << BP_PCIE_RSR_PME_REQUESTER_ID) & BM_PCIE_RSR_PME_REQUESTER_ID)
#endif
...
#define BG_PCIE_RSR_PME_STATUS(r)   (((r) & BM_PCIE_RSR_PME_STATUS) >> BP_PCIE_RSR_PME_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RSR_PME_STATUS.
#define BF_PCIE_RSR_PME_STATUS(v)   ((((reg32_t) v) << BP_PCIE_RSR_PME_STATUS) & BM_PCIE_RSR_PME_STATUS)
#else
//! @brief Format value for bitfield PCIE_RSR_PME_STATUS.
#define BF_PCIE_RSR_PME_STATUS(v)   (((v) << BP_PCIE_RSR_PME_STATUS) & BM_PCIE_RSR_PME_STATUS)
#endif
...
#define BG_PCIE_RSR_PME_PENDING(r)   (((r) & BM_PCIE_RSR_PME_PENDING) >> BP_PCIE_RSR_PME_PENDING)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RSR_PME_PENDING.
#define BF_PCIE_RSR_PME_PENDING(v)   ((((reg32_t) v) << BP_PCIE_RSR_PME_PENDING) & BM_PCIE_RSR_PME_PENDING)
#else
//! @brief Format value for bitfield PCIE_RSR_PME_PENDING.
#define BF_PCIE_RSR_PME_PENDING(v)   (((v) << BP_PCIE_RSR_PME_PENDING) & BM_PCIE_RSR_PME_PENDING)
#endif
...
#define BG_PCIE_DCR2_COMPLETION_TIMEOUT_RANGES_SUPPORTED(r)   (((r) & BM_PCIE_DCR2_COMPLETION_TIMEOUT_RANGES_SUPPORTED) >> BP_PCIE_DCR2_COMPLETION_TIMEOUT_RANGES_SUPPORTED)
...
#define BG_PCIE_DCR2_COMPLETION_TIMEOUT_DISABLE_SUPPORTED(r)   (((r) & BM_PCIE_DCR2_COMPLETION_TIMEOUT_DISABLE_SUPPORTED) >> BP_PCIE_DCR2_COMPLETION_TIMEOUT_DISABLE_SUPPORTED)
...
#define BG_PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE(r)   (((r) & BM_PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE) >> BP_PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE.
#define BF_PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE(v)   ((((reg32_t) v) << BP_PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE) & BM_PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE)
#else
//! @brief Format value for bitfield PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE.
#define BF_PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE(v)   (((v) << BP_PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE) & BM_PCIE_DCSR2_COMPLETION_TIMEOUT_VALUE)
#endif
...
#define BG_PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE(r)   (((r) & BM_PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE) >> BP_PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE.
#define BF_PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE(v)   ((((reg32_t) v) << BP_PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE) & BM_PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE)
#else
//! @brief Format value for bitfield PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE.
#define BF_PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE(v)   (((v) << BP_PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE) & BM_PCIE_DCSR2_COMPLETION_TIMEOUT_DISABLE)
#endif
...
#define BG_PCIE_LCR2_SUPPORTED_LINK_SPEEDS_VECTOR(r)   (((r) & BM_PCIE_LCR2_SUPPORTED_LINK_SPEEDS_VECTOR) >> BP_PCIE_LCR2_SUPPORTED_LINK_SPEEDS_VECTOR)
...
#define BG_PCIE_LCR2_CROSSLINK_SUPPORTED(r)   (((r) & BM_PCIE_LCR2_CROSSLINK_SUPPORTED) >> BP_PCIE_LCR2_CROSSLINK_SUPPORTED)
...
#define BG_PCIE_LCSR2_TARGET_LINK_SPEED(r)   (((r) & BM_PCIE_LCSR2_TARGET_LINK_SPEED) >> BP_PCIE_LCSR2_TARGET_LINK_SPEED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_TARGET_LINK_SPEED.
#define BF_PCIE_LCSR2_TARGET_LINK_SPEED(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_TARGET_LINK_SPEED) & BM_PCIE_LCSR2_TARGET_LINK_SPEED)
#else
//! @brief Format value for bitfield PCIE_LCSR2_TARGET_LINK_SPEED.
#define BF_PCIE_LCSR2_TARGET_LINK_SPEED(v)   (((v) << BP_PCIE_LCSR2_TARGET_LINK_SPEED) & BM_PCIE_LCSR2_TARGET_LINK_SPEED)
#endif
...
#define BG_PCIE_LCSR2_ENTER_COMPLIANCE(r)   (((r) & BM_PCIE_LCSR2_ENTER_COMPLIANCE) >> BP_PCIE_LCSR2_ENTER_COMPLIANCE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_ENTER_COMPLIANCE.
#define BF_PCIE_LCSR2_ENTER_COMPLIANCE(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_ENTER_COMPLIANCE) & BM_PCIE_LCSR2_ENTER_COMPLIANCE)
#else
//! @brief Format value for bitfield PCIE_LCSR2_ENTER_COMPLIANCE.
#define BF_PCIE_LCSR2_ENTER_COMPLIANCE(v)   (((v) << BP_PCIE_LCSR2_ENTER_COMPLIANCE) & BM_PCIE_LCSR2_ENTER_COMPLIANCE)
#endif
...
#define BG_PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE(r)   (((r) & BM_PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE) >> BP_PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE.
#define BF_PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE) & BM_PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE)
#else
//! @brief Format value for bitfield PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE.
#define BF_PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE(v)   (((v) << BP_PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE) & BM_PCIE_LCSR2_HARDWARE_AUTONOMOUS_SPEED_DISABLE)
#endif
...
#define BG_PCIE_LCSR2_SELECTABLE_DEEMPHASIS(r)   (((r) & BM_PCIE_LCSR2_SELECTABLE_DEEMPHASIS) >> BP_PCIE_LCSR2_SELECTABLE_DEEMPHASIS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_SELECTABLE_DEEMPHASIS.
#define BF_PCIE_LCSR2_SELECTABLE_DEEMPHASIS(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_SELECTABLE_DEEMPHASIS) & BM_PCIE_LCSR2_SELECTABLE_DEEMPHASIS)
#else
//! @brief Format value for bitfield PCIE_LCSR2_SELECTABLE_DEEMPHASIS.
#define BF_PCIE_LCSR2_SELECTABLE_DEEMPHASIS(v)   (((v) << BP_PCIE_LCSR2_SELECTABLE_DEEMPHASIS) & BM_PCIE_LCSR2_SELECTABLE_DEEMPHASIS)
#endif
...
#define BG_PCIE_LCSR2_TRANSMIT_MARGIN(r)   (((r) & BM_PCIE_LCSR2_TRANSMIT_MARGIN) >> BP_PCIE_LCSR2_TRANSMIT_MARGIN)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_TRANSMIT_MARGIN.
#define BF_PCIE_LCSR2_TRANSMIT_MARGIN(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_TRANSMIT_MARGIN) & BM_PCIE_LCSR2_TRANSMIT_MARGIN)
#else
//! @brief Format value for bitfield PCIE_LCSR2_TRANSMIT_MARGIN.
#define BF_PCIE_LCSR2_TRANSMIT_MARGIN(v)   (((v) << BP_PCIE_LCSR2_TRANSMIT_MARGIN) & BM_PCIE_LCSR2_TRANSMIT_MARGIN)
#endif
...
#define BG_PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE(r)   (((r) & BM_PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE) >> BP_PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE.
#define BF_PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE) & BM_PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE)
#else
//! @brief Format value for bitfield PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE.
#define BF_PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE(v)   (((v) << BP_PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE) & BM_PCIE_LCSR2_ENTER_MODIFIED_COMPLIANCE)
#endif
...
#define BG_PCIE_LCSR2_COMPLIANCE_SOS(r)   (((r) & BM_PCIE_LCSR2_COMPLIANCE_SOS) >> BP_PCIE_LCSR2_COMPLIANCE_SOS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_COMPLIANCE_SOS.
#define BF_PCIE_LCSR2_COMPLIANCE_SOS(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_COMPLIANCE_SOS) & BM_PCIE_LCSR2_COMPLIANCE_SOS)
#else
//! @brief Format value for bitfield PCIE_LCSR2_COMPLIANCE_SOS.
#define BF_PCIE_LCSR2_COMPLIANCE_SOS(v)   (((v) << BP_PCIE_LCSR2_COMPLIANCE_SOS) & BM_PCIE_LCSR2_COMPLIANCE_SOS)
#endif
...
#define BG_PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS(r)   (((r) & BM_PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS) >> BP_PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS.
#define BF_PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS) & BM_PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS)
#else
//! @brief Format value for bitfield PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS.
#define BF_PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS(v)   (((v) << BP_PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS) & BM_PCIE_LCSR2_COMPLIANCE_PRE_SET_DEEMPHASIS)
#endif
...
#define BG_PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL(r)   (((r) & BM_PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL) >> BP_PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL.
#define BF_PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL) & BM_PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL)
#else
//! @brief Format value for bitfield PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL.
#define BF_PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL(v)   (((v) << BP_PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL) & BM_PCIE_LCSR2_CURRENT_DEEMPHASIS_LEVEL)
#endif
...
#define BG_PCIE_LCSR2_EQUALIZATION_COMPLETE(r)   (((r) & BM_PCIE_LCSR2_EQUALIZATION_COMPLETE) >> BP_PCIE_LCSR2_EQUALIZATION_COMPLETE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_EQUALIZATION_COMPLETE.
#define BF_PCIE_LCSR2_EQUALIZATION_COMPLETE(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_EQUALIZATION_COMPLETE) & BM_PCIE_LCSR2_EQUALIZATION_COMPLETE)
#else
//! @brief Format value for bitfield PCIE_LCSR2_EQUALIZATION_COMPLETE.
#define BF_PCIE_LCSR2_EQUALIZATION_COMPLETE(v)   (((v) << BP_PCIE_LCSR2_EQUALIZATION_COMPLETE) & BM_PCIE_LCSR2_EQUALIZATION_COMPLETE)
#endif
...
#define BG_PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL(r)   (((r) & BM_PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL) >> BP_PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL.
#define BF_PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL) & BM_PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL)
#else
//! @brief Format value for bitfield PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL.
#define BF_PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL(v)   (((v) << BP_PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL) & BM_PCIE_LCSR2_EQUALIZATION_PHASE_1_SUCCESSFUL)
#endif
...
#define BG_PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL(r)   (((r) & BM_PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL) >> BP_PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL.
#define BF_PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL) & BM_PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL)
#else
//! @brief Format value for bitfield PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL.
#define BF_PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL(v)   (((v) << BP_PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL) & BM_PCIE_LCSR2_EQUALIZATION_PHASE_2_SUCCESSFUL)
#endif
...
#define BG_PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL(r)   (((r) & BM_PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL) >> BP_PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL.
#define BF_PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL) & BM_PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL)
#else
//! @brief Format value for bitfield PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL.
#define BF_PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL(v)   (((v) << BP_PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL) & BM_PCIE_LCSR2_EQUALIZATION_PHASE_3_SUCCESSFUL)
#endif
...
#define BG_PCIE_LCSR2_LINK_EQUALIZATION_REQUEST(r)   (((r) & BM_PCIE_LCSR2_LINK_EQUALIZATION_REQUEST) >> BP_PCIE_LCSR2_LINK_EQUALIZATION_REQUEST)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_LCSR2_LINK_EQUALIZATION_REQUEST.
#define BF_PCIE_LCSR2_LINK_EQUALIZATION_REQUEST(v)   ((((reg32_t) v) << BP_PCIE_LCSR2_LINK_EQUALIZATION_REQUEST) & BM_PCIE_LCSR2_LINK_EQUALIZATION_REQUEST)
#else
//! @brief Format value for bitfield PCIE_LCSR2_LINK_EQUALIZATION_REQUEST.
#define BF_PCIE_LCSR2_LINK_EQUALIZATION_REQUEST(v)   (((v) << BP_PCIE_LCSR2_LINK_EQUALIZATION_REQUEST) & BM_PCIE_LCSR2_LINK_EQUALIZATION_REQUEST)
#endif
...
#define BG_PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID(r)   (((r) & BM_PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID) >> BP_PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID.
#define BF_PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID(v)   ((((reg32_t) v) << BP_PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID) & BM_PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID)
#else
//! @brief Format value for bitfield PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID.
#define BF_PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID(v)   (((v) << BP_PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID) & BM_PCIE_AER_PCI_EXPRESS_EXTENDED_CAPABILITY_ID)
#endif
...
#define BG_PCIE_AER_CAPABILITY_VERSION(r)   (((r) & BM_PCIE_AER_CAPABILITY_VERSION) >> BP_PCIE_AER_CAPABILITY_VERSION)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_AER_CAPABILITY_VERSION.
#define BF_PCIE_AER_CAPABILITY_VERSION(v)   ((((reg32_t) v) << BP_PCIE_AER_CAPABILITY_VERSION) & BM_PCIE_AER_CAPABILITY_VERSION)
#else
//! @brief Format value for bitfield PCIE_AER_CAPABILITY_VERSION.
#define BF_PCIE_AER_CAPABILITY_VERSION(v)   (((v) << BP_PCIE_AER_CAPABILITY_VERSION) & BM_PCIE_AER_CAPABILITY_VERSION)
#endif
...
#define BG_PCIE_AER_NEXT_CAPABILITY_OFFSET(r)   (((r) & BM_PCIE_AER_NEXT_CAPABILITY_OFFSET) >> BP_PCIE_AER_NEXT_CAPABILITY_OFFSET)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_AER_NEXT_CAPABILITY_OFFSET.
#define BF_PCIE_AER_NEXT_CAPABILITY_OFFSET(v)   ((((reg32_t) v) << BP_PCIE_AER_NEXT_CAPABILITY_OFFSET) & BM_PCIE_AER_NEXT_CAPABILITY_OFFSET)
#else
//! @brief Format value for bitfield PCIE_AER_NEXT_CAPABILITY_OFFSET.
#define BF_PCIE_AER_NEXT_CAPABILITY_OFFSET(v)   (((v) << BP_PCIE_AER_NEXT_CAPABILITY_OFFSET) & BM_PCIE_AER_NEXT_CAPABILITY_OFFSET)
#endif
...
#define BG_PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS(r)   (((r) & BM_PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS) >> BP_PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS.
#define BF_PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS) & BM_PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS.
#define BF_PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS(v)   (((v) << BP_PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS) & BM_PCIE_UESR_DATA_LINK_PROTOCOL_ERROR_STATUS)
#endif
...
#define BG_PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS(r)   (((r) & BM_PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS) >> BP_PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS.
#define BF_PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS) & BM_PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS.
#define BF_PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS(v)   (((v) << BP_PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS) & BM_PCIE_UESR_SURPRISE_DOWN_ERROR_STATUS)
#endif
...
#define BG_PCIE_UESR_POISONED_TLP_STATUS(r)   (((r) & BM_PCIE_UESR_POISONED_TLP_STATUS) >> BP_PCIE_UESR_POISONED_TLP_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_POISONED_TLP_STATUS.
#define BF_PCIE_UESR_POISONED_TLP_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_POISONED_TLP_STATUS) & BM_PCIE_UESR_POISONED_TLP_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_POISONED_TLP_STATUS.
#define BF_PCIE_UESR_POISONED_TLP_STATUS(v)   (((v) << BP_PCIE_UESR_POISONED_TLP_STATUS) & BM_PCIE_UESR_POISONED_TLP_STATUS)
#endif
...
#define BG_PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS(r)   (((r) & BM_PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS) >> BP_PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS.
#define BF_PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS) & BM_PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS.
#define BF_PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS(v)   (((v) << BP_PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS) & BM_PCIE_UESR_FLOW_CONTROL_PROTOCOL_ERROR_STATUS)
#endif
...
#define BG_PCIE_UESR_COMPLETION_TIMEOUT_STATUS(r)   (((r) & BM_PCIE_UESR_COMPLETION_TIMEOUT_STATUS) >> BP_PCIE_UESR_COMPLETION_TIMEOUT_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_COMPLETION_TIMEOUT_STATUS.
#define BF_PCIE_UESR_COMPLETION_TIMEOUT_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_COMPLETION_TIMEOUT_STATUS) & BM_PCIE_UESR_COMPLETION_TIMEOUT_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_COMPLETION_TIMEOUT_STATUS.
#define BF_PCIE_UESR_COMPLETION_TIMEOUT_STATUS(v)   (((v) << BP_PCIE_UESR_COMPLETION_TIMEOUT_STATUS) & BM_PCIE_UESR_COMPLETION_TIMEOUT_STATUS)
#endif
...
#define BG_PCIE_UESR_COMPLETER_ABORT_STATUS(r)   (((r) & BM_PCIE_UESR_COMPLETER_ABORT_STATUS) >> BP_PCIE_UESR_COMPLETER_ABORT_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_COMPLETER_ABORT_STATUS.
#define BF_PCIE_UESR_COMPLETER_ABORT_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_COMPLETER_ABORT_STATUS) & BM_PCIE_UESR_COMPLETER_ABORT_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_COMPLETER_ABORT_STATUS.
#define BF_PCIE_UESR_COMPLETER_ABORT_STATUS(v)   (((v) << BP_PCIE_UESR_COMPLETER_ABORT_STATUS) & BM_PCIE_UESR_COMPLETER_ABORT_STATUS)
#endif
...
#define BG_PCIE_UESR_UNEXPECTED_COMPLETION_STATUS(r)   (((r) & BM_PCIE_UESR_UNEXPECTED_COMPLETION_STATUS) >> BP_PCIE_UESR_UNEXPECTED_COMPLETION_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_UNEXPECTED_COMPLETION_STATUS.
#define BF_PCIE_UESR_UNEXPECTED_COMPLETION_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_UNEXPECTED_COMPLETION_STATUS) & BM_PCIE_UESR_UNEXPECTED_COMPLETION_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_UNEXPECTED_COMPLETION_STATUS.
#define BF_PCIE_UESR_UNEXPECTED_COMPLETION_STATUS(v)   (((v) << BP_PCIE_UESR_UNEXPECTED_COMPLETION_STATUS) & BM_PCIE_UESR_UNEXPECTED_COMPLETION_STATUS)
#endif
...
#define BG_PCIE_UESR_RECEIVER_OVERFLOW_STATUS(r)   (((r) & BM_PCIE_UESR_RECEIVER_OVERFLOW_STATUS) >> BP_PCIE_UESR_RECEIVER_OVERFLOW_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_RECEIVER_OVERFLOW_STATUS.
#define BF_PCIE_UESR_RECEIVER_OVERFLOW_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_RECEIVER_OVERFLOW_STATUS) & BM_PCIE_UESR_RECEIVER_OVERFLOW_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_RECEIVER_OVERFLOW_STATUS.
#define BF_PCIE_UESR_RECEIVER_OVERFLOW_STATUS(v)   (((v) << BP_PCIE_UESR_RECEIVER_OVERFLOW_STATUS) & BM_PCIE_UESR_RECEIVER_OVERFLOW_STATUS)
#endif
...
#define BG_PCIE_UESR_MALFORMED_TLP_STATUS(r)   (((r) & BM_PCIE_UESR_MALFORMED_TLP_STATUS) >> BP_PCIE_UESR_MALFORMED_TLP_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_MALFORMED_TLP_STATUS.
#define BF_PCIE_UESR_MALFORMED_TLP_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_MALFORMED_TLP_STATUS) & BM_PCIE_UESR_MALFORMED_TLP_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_MALFORMED_TLP_STATUS.
#define BF_PCIE_UESR_MALFORMED_TLP_STATUS(v)   (((v) << BP_PCIE_UESR_MALFORMED_TLP_STATUS) & BM_PCIE_UESR_MALFORMED_TLP_STATUS)
#endif
...
#define BG_PCIE_UESR_ECRC_ERROR_STATUS(r)   (((r) & BM_PCIE_UESR_ECRC_ERROR_STATUS) >> BP_PCIE_UESR_ECRC_ERROR_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_ECRC_ERROR_STATUS.
#define BF_PCIE_UESR_ECRC_ERROR_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_ECRC_ERROR_STATUS) & BM_PCIE_UESR_ECRC_ERROR_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_ECRC_ERROR_STATUS.
#define BF_PCIE_UESR_ECRC_ERROR_STATUS(v)   (((v) << BP_PCIE_UESR_ECRC_ERROR_STATUS) & BM_PCIE_UESR_ECRC_ERROR_STATUS)
#endif
...
#define BG_PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS(r)   (((r) & BM_PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS) >> BP_PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS.
#define BF_PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS(v)   ((((reg32_t) v) << BP_PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS) & BM_PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS)
#else
//! @brief Format value for bitfield PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS.
#define BF_PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS(v)   (((v) << BP_PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS) & BM_PCIE_UESR_UNSUPPORTED_REQUEST_ERROR_STATUS)
#endif
...
#define BG_PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK(r)   (((r) & BM_PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK) >> BP_PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK.
#define BF_PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK) & BM_PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK.
#define BF_PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK(v)   (((v) << BP_PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK) & BM_PCIE_UEMR_DATA_LINK_PROTOCOL_ERROR_MASK)
#endif
...
#define BG_PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK(r)   (((r) & BM_PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK) >> BP_PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK.
#define BF_PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK) & BM_PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK.
#define BF_PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK(v)   (((v) << BP_PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK) & BM_PCIE_UEMR_SURPRISE_DOWN_ERROR_MASK)
#endif
...
#define BG_PCIE_UEMR_POISONED_TLP_MASK(r)   (((r) & BM_PCIE_UEMR_POISONED_TLP_MASK) >> BP_PCIE_UEMR_POISONED_TLP_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_POISONED_TLP_MASK.
#define BF_PCIE_UEMR_POISONED_TLP_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_POISONED_TLP_MASK) & BM_PCIE_UEMR_POISONED_TLP_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_POISONED_TLP_MASK.
#define BF_PCIE_UEMR_POISONED_TLP_MASK(v)   (((v) << BP_PCIE_UEMR_POISONED_TLP_MASK) & BM_PCIE_UEMR_POISONED_TLP_MASK)
#endif
...
#define BG_PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK(r)   (((r) & BM_PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK) >> BP_PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK.
#define BF_PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK) & BM_PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK.
#define BF_PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK(v)   (((v) << BP_PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK) & BM_PCIE_UEMR_FLOW_CONTROL_PROTOCOL_ERROR_MASK)
#endif
...
#define BG_PCIE_UEMR_COMPLETION_TIMEOUT_MASK(r)   (((r) & BM_PCIE_UEMR_COMPLETION_TIMEOUT_MASK) >> BP_PCIE_UEMR_COMPLETION_TIMEOUT_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_COMPLETION_TIMEOUT_MASK.
#define BF_PCIE_UEMR_COMPLETION_TIMEOUT_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_COMPLETION_TIMEOUT_MASK) & BM_PCIE_UEMR_COMPLETION_TIMEOUT_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_COMPLETION_TIMEOUT_MASK.
#define BF_PCIE_UEMR_COMPLETION_TIMEOUT_MASK(v)   (((v) << BP_PCIE_UEMR_COMPLETION_TIMEOUT_MASK) & BM_PCIE_UEMR_COMPLETION_TIMEOUT_MASK)
#endif
...
#define BG_PCIE_UEMR_COMPLETER_ABORT_MASK(r)   (((r) & BM_PCIE_UEMR_COMPLETER_ABORT_MASK) >> BP_PCIE_UEMR_COMPLETER_ABORT_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_COMPLETER_ABORT_MASK.
#define BF_PCIE_UEMR_COMPLETER_ABORT_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_COMPLETER_ABORT_MASK) & BM_PCIE_UEMR_COMPLETER_ABORT_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_COMPLETER_ABORT_MASK.
#define BF_PCIE_UEMR_COMPLETER_ABORT_MASK(v)   (((v) << BP_PCIE_UEMR_COMPLETER_ABORT_MASK) & BM_PCIE_UEMR_COMPLETER_ABORT_MASK)
#endif
...
#define BG_PCIE_UEMR_UNEXPECTED_COMPLETION_MASK(r)   (((r) & BM_PCIE_UEMR_UNEXPECTED_COMPLETION_MASK) >> BP_PCIE_UEMR_UNEXPECTED_COMPLETION_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_UNEXPECTED_COMPLETION_MASK.
#define BF_PCIE_UEMR_UNEXPECTED_COMPLETION_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_UNEXPECTED_COMPLETION_MASK) & BM_PCIE_UEMR_UNEXPECTED_COMPLETION_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_UNEXPECTED_COMPLETION_MASK.
#define BF_PCIE_UEMR_UNEXPECTED_COMPLETION_MASK(v)   (((v) << BP_PCIE_UEMR_UNEXPECTED_COMPLETION_MASK) & BM_PCIE_UEMR_UNEXPECTED_COMPLETION_MASK)
#endif
...
#define BG_PCIE_UEMR_RECEIVER_OVERFLOW_MASK(r)   (((r) & BM_PCIE_UEMR_RECEIVER_OVERFLOW_MASK) >> BP_PCIE_UEMR_RECEIVER_OVERFLOW_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_RECEIVER_OVERFLOW_MASK.
#define BF_PCIE_UEMR_RECEIVER_OVERFLOW_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_RECEIVER_OVERFLOW_MASK) & BM_PCIE_UEMR_RECEIVER_OVERFLOW_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_RECEIVER_OVERFLOW_MASK.
#define BF_PCIE_UEMR_RECEIVER_OVERFLOW_MASK(v)   (((v) << BP_PCIE_UEMR_RECEIVER_OVERFLOW_MASK) & BM_PCIE_UEMR_RECEIVER_OVERFLOW_MASK)
#endif
...
#define BG_PCIE_UEMR_MALFORMED_TLP_MASK(r)   (((r) & BM_PCIE_UEMR_MALFORMED_TLP_MASK) >> BP_PCIE_UEMR_MALFORMED_TLP_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_MALFORMED_TLP_MASK.
#define BF_PCIE_UEMR_MALFORMED_TLP_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_MALFORMED_TLP_MASK) & BM_PCIE_UEMR_MALFORMED_TLP_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_MALFORMED_TLP_MASK.
#define BF_PCIE_UEMR_MALFORMED_TLP_MASK(v)   (((v) << BP_PCIE_UEMR_MALFORMED_TLP_MASK) & BM_PCIE_UEMR_MALFORMED_TLP_MASK)
#endif
...
#define BG_PCIE_UEMR_ECRC_ERROR_MASK(r)   (((r) & BM_PCIE_UEMR_ECRC_ERROR_MASK) >> BP_PCIE_UEMR_ECRC_ERROR_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_ECRC_ERROR_MASK.
#define BF_PCIE_UEMR_ECRC_ERROR_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_ECRC_ERROR_MASK) & BM_PCIE_UEMR_ECRC_ERROR_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_ECRC_ERROR_MASK.
#define BF_PCIE_UEMR_ECRC_ERROR_MASK(v)   (((v) << BP_PCIE_UEMR_ECRC_ERROR_MASK) & BM_PCIE_UEMR_ECRC_ERROR_MASK)
#endif
...
#define BG_PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK(r)   (((r) & BM_PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK) >> BP_PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK.
#define BF_PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK(v)   ((((reg32_t) v) << BP_PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK) & BM_PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK)
#else
//! @brief Format value for bitfield PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK.
#define BF_PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK(v)   (((v) << BP_PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK) & BM_PCIE_UEMR_UNSUPPORTED_REQUEST_ERROR_MASK)
#endif
...
#define BG_PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY) >> BP_PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY) & BM_PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY) & BM_PCIE_UESEVR_DATA_LINK_PROTOCOL_ERROR_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY) >> BP_PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY) & BM_PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY) & BM_PCIE_UESEVR_SURPRISE_DOWN_ERROR_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_POISONED_TLP_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_POISONED_TLP_SEVERITY) >> BP_PCIE_UESEVR_POISONED_TLP_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_POISONED_TLP_SEVERITY.
#define BF_PCIE_UESEVR_POISONED_TLP_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_POISONED_TLP_SEVERITY) & BM_PCIE_UESEVR_POISONED_TLP_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_POISONED_TLP_SEVERITY.
#define BF_PCIE_UESEVR_POISONED_TLP_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_POISONED_TLP_SEVERITY) & BM_PCIE_UESEVR_POISONED_TLP_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY) >> BP_PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY) & BM_PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY) & BM_PCIE_UESEVR_FLOW_CONTROL_PROTOCOL_ERROR_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY) >> BP_PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY.
#define BF_PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY) & BM_PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY.
#define BF_PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY) & BM_PCIE_UESEVR_COMPLETION_TIMEOUT_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_COMPLETER_ABORT_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_COMPLETER_ABORT_SEVERITY) >> BP_PCIE_UESEVR_COMPLETER_ABORT_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_COMPLETER_ABORT_SEVERITY.
#define BF_PCIE_UESEVR_COMPLETER_ABORT_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_COMPLETER_ABORT_SEVERITY) & BM_PCIE_UESEVR_COMPLETER_ABORT_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_COMPLETER_ABORT_SEVERITY.
#define BF_PCIE_UESEVR_COMPLETER_ABORT_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_COMPLETER_ABORT_SEVERITY) & BM_PCIE_UESEVR_COMPLETER_ABORT_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY) >> BP_PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY.
#define BF_PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY) & BM_PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY.
#define BF_PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY) & BM_PCIE_UESEVR_UNEXPECTED_COMPLETION_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY) >> BP_PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY.
#define BF_PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY) & BM_PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY.
#define BF_PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY) & BM_PCIE_UESEVR_RECEIVER_OVERFLOW_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_MALFORMED_TLP_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_MALFORMED_TLP_SEVERITY) >> BP_PCIE_UESEVR_MALFORMED_TLP_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_MALFORMED_TLP_SEVERITY.
#define BF_PCIE_UESEVR_MALFORMED_TLP_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_MALFORMED_TLP_SEVERITY) & BM_PCIE_UESEVR_MALFORMED_TLP_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_MALFORMED_TLP_SEVERITY.
#define BF_PCIE_UESEVR_MALFORMED_TLP_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_MALFORMED_TLP_SEVERITY) & BM_PCIE_UESEVR_MALFORMED_TLP_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_ECRC_ERROR_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_ECRC_ERROR_SEVERITY) >> BP_PCIE_UESEVR_ECRC_ERROR_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_ECRC_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_ECRC_ERROR_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_ECRC_ERROR_SEVERITY) & BM_PCIE_UESEVR_ECRC_ERROR_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_ECRC_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_ECRC_ERROR_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_ECRC_ERROR_SEVERITY) & BM_PCIE_UESEVR_ECRC_ERROR_SEVERITY)
#endif
...
#define BG_PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY(r)   (((r) & BM_PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY) >> BP_PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY(v)   ((((reg32_t) v) << BP_PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY) & BM_PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY)
#else
//! @brief Format value for bitfield PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY.
#define BF_PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY(v)   (((v) << BP_PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY) & BM_PCIE_UESEVR_UNSUPPORTED_REQUEST_ERROR_SEVERITY)
#endif
...
#define BG_PCIE_CESR_RECEIVER_ERROR_STATUS(r)   (((r) & BM_PCIE_CESR_RECEIVER_ERROR_STATUS) >> BP_PCIE_CESR_RECEIVER_ERROR_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CESR_RECEIVER_ERROR_STATUS.
#define BF_PCIE_CESR_RECEIVER_ERROR_STATUS(v)   ((((reg32_t) v) << BP_PCIE_CESR_RECEIVER_ERROR_STATUS) & BM_PCIE_CESR_RECEIVER_ERROR_STATUS)
#else
//! @brief Format value for bitfield PCIE_CESR_RECEIVER_ERROR_STATUS.
#define BF_PCIE_CESR_RECEIVER_ERROR_STATUS(v)   (((v) << BP_PCIE_CESR_RECEIVER_ERROR_STATUS) & BM_PCIE_CESR_RECEIVER_ERROR_STATUS)
#endif
...
#define BG_PCIE_CESR_BAD_TLP_STATUS(r)   (((r) & BM_PCIE_CESR_BAD_TLP_STATUS) >> BP_PCIE_CESR_BAD_TLP_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CESR_BAD_TLP_STATUS.
#define BF_PCIE_CESR_BAD_TLP_STATUS(v)   ((((reg32_t) v) << BP_PCIE_CESR_BAD_TLP_STATUS) & BM_PCIE_CESR_BAD_TLP_STATUS)
#else
//! @brief Format value for bitfield PCIE_CESR_BAD_TLP_STATUS.
#define BF_PCIE_CESR_BAD_TLP_STATUS(v)   (((v) << BP_PCIE_CESR_BAD_TLP_STATUS) & BM_PCIE_CESR_BAD_TLP_STATUS)
#endif
...
#define BG_PCIE_CESR_BAD_DLLP_STATUS(r)   (((r) & BM_PCIE_CESR_BAD_DLLP_STATUS) >> BP_PCIE_CESR_BAD_DLLP_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CESR_BAD_DLLP_STATUS.
#define BF_PCIE_CESR_BAD_DLLP_STATUS(v)   ((((reg32_t) v) << BP_PCIE_CESR_BAD_DLLP_STATUS) & BM_PCIE_CESR_BAD_DLLP_STATUS)
#else
//! @brief Format value for bitfield PCIE_CESR_BAD_DLLP_STATUS.
#define BF_PCIE_CESR_BAD_DLLP_STATUS(v)   (((v) << BP_PCIE_CESR_BAD_DLLP_STATUS) & BM_PCIE_CESR_BAD_DLLP_STATUS)
#endif
...
#define BG_PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS(r)   (((r) & BM_PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS) >> BP_PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS.
#define BF_PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS(v)   ((((reg32_t) v) << BP_PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS) & BM_PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS)
#else
//! @brief Format value for bitfield PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS.
#define BF_PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS(v)   (((v) << BP_PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS) & BM_PCIE_CESR_REPLAY_NUM_ROLLOVER_STATUS)
#endif
...
#define BG_PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS(r)   (((r) & BM_PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS) >> BP_PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS.
#define BF_PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS(v)   ((((reg32_t) v) << BP_PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS) & BM_PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS)
#else
//! @brief Format value for bitfield PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS.
#define BF_PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS(v)   (((v) << BP_PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS) & BM_PCIE_CESR_REPLY_TIMER_TIMEOUT_STATUS)
#endif
...
#define BG_PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS(r)   (((r) & BM_PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS) >> BP_PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS.
#define BF_PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS(v)   ((((reg32_t) v) << BP_PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS) & BM_PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS)
#else
//! @brief Format value for bitfield PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS.
#define BF_PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS(v)   (((v) << BP_PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS) & BM_PCIE_CESR_ADVISORY_NON_FATAL_ERROR_STATUS)
#endif
...
#define BG_PCIE_CEMR_RECEIVER_ERROR_MASK(r)   (((r) & BM_PCIE_CEMR_RECEIVER_ERROR_MASK) >> BP_PCIE_CEMR_RECEIVER_ERROR_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CEMR_RECEIVER_ERROR_MASK.
#define BF_PCIE_CEMR_RECEIVER_ERROR_MASK(v)   ((((reg32_t) v) << BP_PCIE_CEMR_RECEIVER_ERROR_MASK) & BM_PCIE_CEMR_RECEIVER_ERROR_MASK)
#else
//! @brief Format value for bitfield PCIE_CEMR_RECEIVER_ERROR_MASK.
#define BF_PCIE_CEMR_RECEIVER_ERROR_MASK(v)   (((v) << BP_PCIE_CEMR_RECEIVER_ERROR_MASK) & BM_PCIE_CEMR_RECEIVER_ERROR_MASK)
#endif
...
#define BG_PCIE_CEMR_BAD_TLP_MASK(r)   (((r) & BM_PCIE_CEMR_BAD_TLP_MASK) >> BP_PCIE_CEMR_BAD_TLP_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CEMR_BAD_TLP_MASK.
#define BF_PCIE_CEMR_BAD_TLP_MASK(v)   ((((reg32_t) v) << BP_PCIE_CEMR_BAD_TLP_MASK) & BM_PCIE_CEMR_BAD_TLP_MASK)
#else
//! @brief Format value for bitfield PCIE_CEMR_BAD_TLP_MASK.
#define BF_PCIE_CEMR_BAD_TLP_MASK(v)   (((v) << BP_PCIE_CEMR_BAD_TLP_MASK) & BM_PCIE_CEMR_BAD_TLP_MASK)
#endif
...
#define BG_PCIE_CEMR_BAD_DLLP_MASK(r)   (((r) & BM_PCIE_CEMR_BAD_DLLP_MASK) >> BP_PCIE_CEMR_BAD_DLLP_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CEMR_BAD_DLLP_MASK.
#define BF_PCIE_CEMR_BAD_DLLP_MASK(v)   ((((reg32_t) v) << BP_PCIE_CEMR_BAD_DLLP_MASK) & BM_PCIE_CEMR_BAD_DLLP_MASK)
#else
//! @brief Format value for bitfield PCIE_CEMR_BAD_DLLP_MASK.
#define BF_PCIE_CEMR_BAD_DLLP_MASK(v)   (((v) << BP_PCIE_CEMR_BAD_DLLP_MASK) & BM_PCIE_CEMR_BAD_DLLP_MASK)
#endif
...
#define BG_PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK(r)   (((r) & BM_PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK) >> BP_PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK.
#define BF_PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK(v)   ((((reg32_t) v) << BP_PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK) & BM_PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK)
#else
//! @brief Format value for bitfield PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK.
#define BF_PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK(v)   (((v) << BP_PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK) & BM_PCIE_CEMR_REPLAY_NUM_ROLLOVER_MASK)
#endif
...
#define BG_PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK(r)   (((r) & BM_PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK) >> BP_PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK.
#define BF_PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK(v)   ((((reg32_t) v) << BP_PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK) & BM_PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK)
#else
//! @brief Format value for bitfield PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK.
#define BF_PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK(v)   (((v) << BP_PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK) & BM_PCIE_CEMR_REPLY_TIMER_TIMEOUT_MASK)
#endif
...
#define BG_PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK(r)   (((r) & BM_PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK) >> BP_PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK.
#define BF_PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK(v)   ((((reg32_t) v) << BP_PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK) & BM_PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK)
#else
//! @brief Format value for bitfield PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK.
#define BF_PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK(v)   (((v) << BP_PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK) & BM_PCIE_CEMR_ADVISORY_NON_FATAL_ERROR_MASK)
#endif
...
#define BG_PCIE_ACCR_FIRST_ERROR_POINTER(r)   (((r) & BM_PCIE_ACCR_FIRST_ERROR_POINTER) >> BP_PCIE_ACCR_FIRST_ERROR_POINTER)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_ACCR_FIRST_ERROR_POINTER.
#define BF_PCIE_ACCR_FIRST_ERROR_POINTER(v)   ((((reg32_t) v) << BP_PCIE_ACCR_FIRST_ERROR_POINTER) & BM_PCIE_ACCR_FIRST_ERROR_POINTER)
#else
//! @brief Format value for bitfield PCIE_ACCR_FIRST_ERROR_POINTER.
#define BF_PCIE_ACCR_FIRST_ERROR_POINTER(v)   (((v) << BP_PCIE_ACCR_FIRST_ERROR_POINTER) & BM_PCIE_ACCR_FIRST_ERROR_POINTER)
#endif
...
#define BG_PCIE_ACCR_ECRC_GENERATION_CAPABILITY(r)   (((r) & BM_PCIE_ACCR_ECRC_GENERATION_CAPABILITY) >> BP_PCIE_ACCR_ECRC_GENERATION_CAPABILITY)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_ACCR_ECRC_GENERATION_CAPABILITY.
#define BF_PCIE_ACCR_ECRC_GENERATION_CAPABILITY(v)   ((((reg32_t) v) << BP_PCIE_ACCR_ECRC_GENERATION_CAPABILITY) & BM_PCIE_ACCR_ECRC_GENERATION_CAPABILITY)
#else
//! @brief Format value for bitfield PCIE_ACCR_ECRC_GENERATION_CAPABILITY.
#define BF_PCIE_ACCR_ECRC_GENERATION_CAPABILITY(v)   (((v) << BP_PCIE_ACCR_ECRC_GENERATION_CAPABILITY) & BM_PCIE_ACCR_ECRC_GENERATION_CAPABILITY)
#endif
...
#define BG_PCIE_ACCR_ECRC_GENERATION_ENABLE(r)   (((r) & BM_PCIE_ACCR_ECRC_GENERATION_ENABLE) >> BP_PCIE_ACCR_ECRC_GENERATION_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_ACCR_ECRC_GENERATION_ENABLE.
#define BF_PCIE_ACCR_ECRC_GENERATION_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_ACCR_ECRC_GENERATION_ENABLE) & BM_PCIE_ACCR_ECRC_GENERATION_ENABLE)
#else
//! @brief Format value for bitfield PCIE_ACCR_ECRC_GENERATION_ENABLE.
#define BF_PCIE_ACCR_ECRC_GENERATION_ENABLE(v)   (((v) << BP_PCIE_ACCR_ECRC_GENERATION_ENABLE) & BM_PCIE_ACCR_ECRC_GENERATION_ENABLE)
#endif
...
#define BG_PCIE_ACCR_ECRC_CHECK_CAPABLE(r)   (((r) & BM_PCIE_ACCR_ECRC_CHECK_CAPABLE) >> BP_PCIE_ACCR_ECRC_CHECK_CAPABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_ACCR_ECRC_CHECK_CAPABLE.
#define BF_PCIE_ACCR_ECRC_CHECK_CAPABLE(v)   ((((reg32_t) v) << BP_PCIE_ACCR_ECRC_CHECK_CAPABLE) & BM_PCIE_ACCR_ECRC_CHECK_CAPABLE)
#else
//! @brief Format value for bitfield PCIE_ACCR_ECRC_CHECK_CAPABLE.
#define BF_PCIE_ACCR_ECRC_CHECK_CAPABLE(v)   (((v) << BP_PCIE_ACCR_ECRC_CHECK_CAPABLE) & BM_PCIE_ACCR_ECRC_CHECK_CAPABLE)
#endif
...
#define BG_PCIE_ACCR_ECRC_CHECK_ENABLE(r)   (((r) & BM_PCIE_ACCR_ECRC_CHECK_ENABLE) >> BP_PCIE_ACCR_ECRC_CHECK_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_ACCR_ECRC_CHECK_ENABLE.
#define BF_PCIE_ACCR_ECRC_CHECK_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_ACCR_ECRC_CHECK_ENABLE) & BM_PCIE_ACCR_ECRC_CHECK_ENABLE)
#else
//! @brief Format value for bitfield PCIE_ACCR_ECRC_CHECK_ENABLE.
#define BF_PCIE_ACCR_ECRC_CHECK_ENABLE(v)   (((v) << BP_PCIE_ACCR_ECRC_CHECK_ENABLE) & BM_PCIE_ACCR_ECRC_CHECK_ENABLE)
#endif
...
#define BG_PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE(r)   (((r) & BM_PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE) >> BP_PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE.
#define BF_PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE) & BM_PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE)
#else
//! @brief Format value for bitfield PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE.
#define BF_PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE(v)   (((v) << BP_PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE) & BM_PCIE_RECR_CORRECTABLE_ERROR_REPORTING_ENABLE)
#endif
...
#define BG_PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE(r)   (((r) & BM_PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE) >> BP_PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE.
#define BF_PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE) & BM_PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE)
#else
//! @brief Format value for bitfield PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE.
#define BF_PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE(v)   (((v) << BP_PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE) & BM_PCIE_RECR_NON_FATAL_ERROR_REPORTING_ENABLE)
#endif
...
#define BG_PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE(r)   (((r) & BM_PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE) >> BP_PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE.
#define BF_PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE) & BM_PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE)
#else
//! @brief Format value for bitfield PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE.
#define BF_PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE(v)   (((v) << BP_PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE) & BM_PCIE_RECR_FATAL_ERROR_REPORTING_ENABLE)
#endif
...
#define BG_PCIE_RESR_ERR_COR_RECEIVED(r)   (((r) & BM_PCIE_RESR_ERR_COR_RECEIVED) >> BP_PCIE_RESR_ERR_COR_RECEIVED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RESR_ERR_COR_RECEIVED.
#define BF_PCIE_RESR_ERR_COR_RECEIVED(v)   ((((reg32_t) v) << BP_PCIE_RESR_ERR_COR_RECEIVED) & BM_PCIE_RESR_ERR_COR_RECEIVED)
#else
//! @brief Format value for bitfield PCIE_RESR_ERR_COR_RECEIVED.
#define BF_PCIE_RESR_ERR_COR_RECEIVED(v)   (((v) << BP_PCIE_RESR_ERR_COR_RECEIVED) & BM_PCIE_RESR_ERR_COR_RECEIVED)
#endif
...
#define BG_PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED(r)   (((r) & BM_PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED) >> BP_PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED.
#define BF_PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED(v)   ((((reg32_t) v) << BP_PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED) & BM_PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED)
#else
//! @brief Format value for bitfield PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED.
#define BF_PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED(v)   (((v) << BP_PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED) & BM_PCIE_RESR_MULTIPLE_ERR_COR_RECEIVED)
#endif
...
#define BG_PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED(r)   (((r) & BM_PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED) >> BP_PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED.
#define BF_PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED(v)   ((((reg32_t) v) << BP_PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED) & BM_PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED)
#else
//! @brief Format value for bitfield PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED.
#define BF_PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED(v)   (((v) << BP_PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED) & BM_PCIE_RESR_ERR_FATAL_NONFATAL_RECEIVED)
#endif
...
#define BG_PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED(r)   (((r) & BM_PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED) >> BP_PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED.
#define BF_PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED(v)   ((((reg32_t) v) << BP_PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED) & BM_PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED)
#else
//! @brief Format value for bitfield PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED.
#define BF_PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED(v)   (((v) << BP_PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED) & BM_PCIE_RESR_MULTIPLE_ERR_FATAL_NONFATAL_RECEIVED)
#endif
...
#define BG_PCIE_RESR_FIRST_UNCORRECTABLE_FATAL(r)   (((r) & BM_PCIE_RESR_FIRST_UNCORRECTABLE_FATAL) >> BP_PCIE_RESR_FIRST_UNCORRECTABLE_FATAL)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RESR_FIRST_UNCORRECTABLE_FATAL.
#define BF_PCIE_RESR_FIRST_UNCORRECTABLE_FATAL(v)   ((((reg32_t) v) << BP_PCIE_RESR_FIRST_UNCORRECTABLE_FATAL) & BM_PCIE_RESR_FIRST_UNCORRECTABLE_FATAL)
#else
//! @brief Format value for bitfield PCIE_RESR_FIRST_UNCORRECTABLE_FATAL.
#define BF_PCIE_RESR_FIRST_UNCORRECTABLE_FATAL(v)   (((v) << BP_PCIE_RESR_FIRST_UNCORRECTABLE_FATAL) & BM_PCIE_RESR_FIRST_UNCORRECTABLE_FATAL)
#endif
...
#define BG_PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED(r)   (((r) & BM_PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED) >> BP_PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED.
#define BF_PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED(v)   ((((reg32_t) v) << BP_PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED) & BM_PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED)
#else
//! @brief Format value for bitfield PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED.
#define BF_PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED(v)   (((v) << BP_PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED) & BM_PCIE_RESR_NON_FATAL_ERROR_MESSAGES_RECEIVED)
#endif
...
#define BG_PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED(r)   (((r) & BM_PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED) >> BP_PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED.
#define BF_PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED(v)   ((((reg32_t) v) << BP_PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED) & BM_PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED)
#else
//! @brief Format value for bitfield PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED.
#define BF_PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED(v)   (((v) << BP_PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED) & BM_PCIE_RESR_FATAL_ERROR_MESSAGES_RECEIVED)
#endif
...
#define BG_PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER(r)   (((r) & BM_PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER) >> BP_PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER.
#define BF_PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER(v)   ((((reg32_t) v) << BP_PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER) & BM_PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER)
#else
//! @brief Format value for bitfield PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER.
#define BF_PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER(v)   (((v) << BP_PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER) & BM_PCIE_RESR_ADVANCED_ERROR_INTERRUPT_MESSAGE_NUMBER)
#endif
...
#define BG_PCIE_ESIR_ERR_COR_SID(r)   (((r) & BM_PCIE_ESIR_ERR_COR_SID) >> BP_PCIE_ESIR_ERR_COR_SID)
...
#define BG_PCIE_ESIR_ERR_FATAL_NONFATAL_SID(r)   (((r) & BM_PCIE_ESIR_ERR_FATAL_NONFATAL_SID) >> BP_PCIE_ESIR_ERR_FATAL_NONFATAL_SID)
...
#define BG_PCIE_VCECHR_EXTENDED_CAPABILITY(r)   (((r) & BM_PCIE_VCECHR_EXTENDED_CAPABILITY) >> BP_PCIE_VCECHR_EXTENDED_CAPABILITY)
...
#define BG_PCIE_VCECHR_CAPABILITY_VERSION(r)   (((r) & BM_PCIE_VCECHR_CAPABILITY_VERSION) >> BP_PCIE_VCECHR_CAPABILITY_VERSION)
...
#define BG_PCIE_VCECHR_NEXT_CAPABILITY_OFFSET(r)   (((r) & BM_PCIE_VCECHR_NEXT_CAPABILITY_OFFSET) >> BP_PCIE_VCECHR_NEXT_CAPABILITY_OFFSET)
...
#define BG_PCIE_PVCCR1_EXTENDED_VC_COUNT(r)   (((r) & BM_PCIE_PVCCR1_EXTENDED_VC_COUNT) >> BP_PCIE_PVCCR1_EXTENDED_VC_COUNT)
...
#define BG_PCIE_PVCCR1_LOW_PRIORITY_EXTENDED_VC_COUNT(r)   (((r) & BM_PCIE_PVCCR1_LOW_PRIORITY_EXTENDED_VC_COUNT) >> BP_PCIE_PVCCR1_LOW_PRIORITY_EXTENDED_VC_COUNT)
...
#define BG_PCIE_PVCCR1_REFERENCE_CLOCK(r)   (((r) & BM_PCIE_PVCCR1_REFERENCE_CLOCK) >> BP_PCIE_PVCCR1_REFERENCE_CLOCK)
...
#define BG_PCIE_PVCCR1_PORT_ARBITRATION_TABLE_ENTRY_SIZE(r)   (((r) & BM_PCIE_PVCCR1_PORT_ARBITRATION_TABLE_ENTRY_SIZE) >> BP_PCIE_PVCCR1_PORT_ARBITRATION_TABLE_ENTRY_SIZE)
...
#define BG_PCIE_PVCCR2_VC_ARBITRATION_CAPABILITY(r)   (((r) & BM_PCIE_PVCCR2_VC_ARBITRATION_CAPABILITY) >> BP_PCIE_PVCCR2_VC_ARBITRATION_CAPABILITY)
...
#define BG_PCIE_PVCCR2_VC_ARBITRATION_TABLE_OFFSET(r)   (((r) & BM_PCIE_PVCCR2_VC_ARBITRATION_TABLE_OFFSET) >> BP_PCIE_PVCCR2_VC_ARBITRATION_TABLE_OFFSET)
...
#define BG_PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE(r)   (((r) & BM_PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE) >> BP_PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE.
#define BF_PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE(v)   ((((reg32_t) v) << BP_PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE) & BM_PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE)
#else
//! @brief Format value for bitfield PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE.
#define BF_PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE(v)   (((v) << BP_PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE) & BM_PCIE_PVCCSR_LOAD_VC_ARBITRATION_TABLE)
#endif
...
#define BG_PCIE_PVCCSR_VC_ARBITRATION_SELECT(r)   (((r) & BM_PCIE_PVCCSR_VC_ARBITRATION_SELECT) >> BP_PCIE_PVCCSR_VC_ARBITRATION_SELECT)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PVCCSR_VC_ARBITRATION_SELECT.
#define BF_PCIE_PVCCSR_VC_ARBITRATION_SELECT(v)   ((((reg32_t) v) << BP_PCIE_PVCCSR_VC_ARBITRATION_SELECT) & BM_PCIE_PVCCSR_VC_ARBITRATION_SELECT)
#else
//! @brief Format value for bitfield PCIE_PVCCSR_VC_ARBITRATION_SELECT.
#define BF_PCIE_PVCCSR_VC_ARBITRATION_SELECT(v)   (((v) << BP_PCIE_PVCCSR_VC_ARBITRATION_SELECT) & BM_PCIE_PVCCSR_VC_ARBITRATION_SELECT)
#endif
...
#define BG_PCIE_PVCCSR_ARBITRATION_TABLE_STATUS(r)   (((r) & BM_PCIE_PVCCSR_ARBITRATION_TABLE_STATUS) >> BP_PCIE_PVCCSR_ARBITRATION_TABLE_STATUS)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_PVCCSR_ARBITRATION_TABLE_STATUS.
#define BF_PCIE_PVCCSR_ARBITRATION_TABLE_STATUS(v)   ((((reg32_t) v) << BP_PCIE_PVCCSR_ARBITRATION_TABLE_STATUS) & BM_PCIE_PVCCSR_ARBITRATION_TABLE_STATUS)
#else
//! @brief Format value for bitfield PCIE_PVCCSR_ARBITRATION_TABLE_STATUS.
#define BF_PCIE_PVCCSR_ARBITRATION_TABLE_STATUS(v)   (((v) << BP_PCIE_PVCCSR_ARBITRATION_TABLE_STATUS) & BM_PCIE_PVCCSR_ARBITRATION_TABLE_STATUS)
#endif
...
#define BG_PCIE_VCRCR_PORT_ARBITRATION_CAPABILITY(r)   (((r) & BM_PCIE_VCRCR_PORT_ARBITRATION_CAPABILITY) >> BP_PCIE_VCRCR_PORT_ARBITRATION_CAPABILITY)
...
#define BG_PCIE_VCRCR_REJECT_SNOOP_TRANSACTIONS(r)   (((r) & BM_PCIE_VCRCR_REJECT_SNOOP_TRANSACTIONS) >> BP_PCIE_VCRCR_REJECT_SNOOP_TRANSACTIONS)
...
#define BG_PCIE_VCRCR_MAXIMUM_TIME_SLOTS(r)   (((r) & BM_PCIE_VCRCR_MAXIMUM_TIME_SLOTS) >> BP_PCIE_VCRCR_MAXIMUM_TIME_SLOTS)
...
#define BG_PCIE_VCRCR_PORT_ARBITRATION_TABLE_OFFSET(r)   (((r) & BM_PCIE_VCRCR_PORT_ARBITRATION_TABLE_OFFSET) >> BP_PCIE_VCRCR_PORT_ARBITRATION_TABLE_OFFSET)
...
#define BG_PCIE_VCRCONR_TC_VC_MAP(r)   (((r) & BM_PCIE_VCRCONR_TC_VC_MAP) >> BP_PCIE_VCRCONR_TC_VC_MAP)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_VCRCONR_TC_VC_MAP.
#define BF_PCIE_VCRCONR_TC_VC_MAP(v)   ((((reg32_t) v) << BP_PCIE_VCRCONR_TC_VC_MAP) & BM_PCIE_VCRCONR_TC_VC_MAP)
#else
//! @brief Format value for bitfield PCIE_VCRCONR_TC_VC_MAP.
#define BF_PCIE_VCRCONR_TC_VC_MAP(v)   (((v) << BP_PCIE_VCRCONR_TC_VC_MAP) & BM_PCIE_VCRCONR_TC_VC_MAP)
#endif
...
#define BG_PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE(r)   (((r) & BM_PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE) >> BP_PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE.
#define BF_PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE(v)   ((((reg32_t) v) << BP_PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE) & BM_PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE)
#else
//! @brief Format value for bitfield PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE.
#define BF_PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE(v)   (((v) << BP_PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE) & BM_PCIE_VCRCONR_LOAD_PORT_ARBITRATION_TABLE)
#endif
...
#define BG_PCIE_VCRCONR_PORT_ARBITRATION_SELECT(r)   (((r) & BM_PCIE_VCRCONR_PORT_ARBITRATION_SELECT) >> BP_PCIE_VCRCONR_PORT_ARBITRATION_SELECT)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_VCRCONR_PORT_ARBITRATION_SELECT.
#define BF_PCIE_VCRCONR_PORT_ARBITRATION_SELECT(v)   ((((reg32_t) v) << BP_PCIE_VCRCONR_PORT_ARBITRATION_SELECT) & BM_PCIE_VCRCONR_PORT_ARBITRATION_SELECT)
#else
//! @brief Format value for bitfield PCIE_VCRCONR_PORT_ARBITRATION_SELECT.
#define BF_PCIE_VCRCONR_PORT_ARBITRATION_SELECT(v)   (((v) << BP_PCIE_VCRCONR_PORT_ARBITRATION_SELECT) & BM_PCIE_VCRCONR_PORT_ARBITRATION_SELECT)
#endif
...
#define BG_PCIE_VCRCONR_VC_ID(r)   (((r) & BM_PCIE_VCRCONR_VC_ID) >> BP_PCIE_VCRCONR_VC_ID)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_VCRCONR_VC_ID.
#define BF_PCIE_VCRCONR_VC_ID(v)   ((((reg32_t) v) << BP_PCIE_VCRCONR_VC_ID) & BM_PCIE_VCRCONR_VC_ID)
#else
//! @brief Format value for bitfield PCIE_VCRCONR_VC_ID.
#define BF_PCIE_VCRCONR_VC_ID(v)   (((v) << BP_PCIE_VCRCONR_VC_ID) & BM_PCIE_VCRCONR_VC_ID)
#endif
...
#define BG_PCIE_VCRCONR_VC_ENABLE(r)   (((r) & BM_PCIE_VCRCONR_VC_ENABLE) >> BP_PCIE_VCRCONR_VC_ENABLE)

#ifndef __LANGUAGE_ASM__
//! @brief Format value for bitfield PCIE_VCRCONR_VC_ENABLE.
#define BF_PCIE_VCRCONR_VC_ENABLE(v)   ((((reg32_t) v) << BP_PCIE_VCRCONR_VC_ENABLE) & BM_PCIE_VCRCONR_VC_ENABLE)
#else
//! @brief Format value for bitfield PCIE_VCRCONR_VC_ENABLE.
#define BF_PCIE_VCRCONR_VC_ENABLE(v)   (((v) << BP_PCIE_VCRCONR_VC_ENABLE) & BM_PCIE_VCRCONR_VC_ENABLE)
#endif
...
#define BG_PCIE_VCRSR_PORT_ARBITRATION_TABLE_STATUS(r)   (((r) & BM_PCIE_VCRSR_PORT_ARBITRATION_TABLE_STATUS) >> BP_PCIE_VCRSR_PORT_ARBITRATION_TABLE_STATUS)
...
#define BG_PCIE_VCRSR_VC_NEGOTIATION_PENDING(r)   (((r) & BM_PCIE_VCRSR_VC_NEGOTIATION_PENDING) >> BP_PCIE_VCRSR_VC_NEGOTIATION_PENDING)
