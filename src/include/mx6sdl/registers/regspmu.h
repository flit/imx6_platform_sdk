...
/* --- Register HW_PMU_REG_1P1, field ENABLE_LINREG[0:0] (RW)
 *
...
/* --- Register HW_PMU_REG_1P1, field ENABLE_BO[1:1] (RW)
 *
...
/* --- Register HW_PMU_REG_1P1, field ENABLE_ILIMIT[2:2] (RW)
 *
...
/* --- Register HW_PMU_REG_1P1, field ENABLE_PULLDOWN[3:3] (RW)
 *
...
/* --- Register HW_PMU_REG_1P1, field BO_VDD1P1[16:16] (RO)
 *
...
/* --- Register HW_PMU_REG_1P1, field OK_VDD1P1[17:17] (RO)
 *
...
/* --- Register HW_PMU_REG_3P0, field ENABLE_LINREG[0:0] (RW)
 *
 * Control bit to enable the regulator output.
 */
...
/* --- Register HW_PMU_REG_3P0, field ENABLE_BO[1:1] (RW)
 *
 * Control bit to enable the brown-out circuitry in the regulator.
 */
...
/* --- Register HW_PMU_REG_3P0, field ENABLE_ILIMIT[2:2] (RW)
 *
 * Control bit to enable the current-limit circuitry in the regulator.
 */
...
/* --- Register HW_PMU_REG_3P0, field REG_3P0_VBUS_SEL[7:7] (RW)
 *
 * Reserved.
 *
 * Values:
...
/* --- Register HW_PMU_REG_3P0, field BO_VDD3P0[16:16] (RO)
 *
 * Status bit that signals when a brown-out is detected on the regulator output.
 */
...
/* --- Register HW_PMU_REG_3P0, field OK_VDD3P0[17:17] (RO)
 *
 * Status bit that signals when the regulator output is ok.
 */
...
/* --- Register HW_PMU_REG_2P5, field ENABLE_LINREG[0:0] (RW)
 *
 * Control bit to enable the regulator output.
 */
...
/* --- Register HW_PMU_REG_2P5, field ENABLE_BO[1:1] (RW)
 *
 * Control bit to enable the brown-out circuitry in the regulator.
 */
...
/* --- Register HW_PMU_REG_2P5, field ENABLE_ILIMIT[2:2] (RW)
 *
 * Control bit to enable the current-limit circuitry in the regulator.
 */
...
/* --- Register HW_PMU_REG_2P5, field ENABLE_PULLDOWN[3:3] (RW)
 *
 * Control bit to enable the pull-down circuitry in the regulator
 */
...
/* --- Register HW_PMU_REG_2P5, field BO_VDD2P5[16:16] (RO)
 *
 * Status bit that signals when a brown-out is detected on the regulator output.
 */
...
/* --- Register HW_PMU_REG_2P5, field OK_VDD2P5[17:17] (RO)
 *
 * Status bit that signals when the regulator output is ok.
 */
...
/* --- Register HW_PMU_REG_2P5, field ENABLE_WEAK_LINREG[18:18] (RW)
 *
...
/* --- Register HW_PMU_REG_CORE, field FET_ODRIVE[29:29] (RW)
 *
...
/* --- Register HW_PMU_MISC0, field REFTOP_PWD[0:0] (RW)
 *
...
/* --- Register HW_PMU_MISC0, field REFTOP_SELFBIASOFF[3:3] (RW)
 *
...
/* --- Register HW_PMU_MISC0, field REFTOP_VBGUP[7:7] (RW)
 *
...
/* --- Register HW_PMU_MISC0, field STOP_MODE_CONFIG[12:12] (RW)
 *
...
/* --- Register HW_PMU_MISC0, field OSC_XTALOK[16:16] (RO)
 *
...
/* --- Register HW_PMU_MISC0, field OSC_XTALOK_EN[17:17] (RW)
 *
 * Not related to PMU.
 */
...
/* --- Register HW_PMU_MISC0, field CLKGATE_CTRL[25:25] (RW)
 *
...
#define HW_GPMI_CTRL0_SET(v)    ((*(volatile reg32_t *) HW_PMU_REG_MISC1_SET_ADDR) = (v))
...
/* --- Register HW_PMU_REG_MISC1, field LVDSCLK1_OBEN[10:10] (RW)
 *
...
/* --- Register HW_PMU_REG_MISC1, field LVDSCLK2_OBEN[11:11] (RW)
 *
...
/* --- Register HW_PMU_REG_MISC1, field LVDSCLK1_IBEN[12:12] (RW)
 *
...
/* --- Register HW_PMU_REG_MISC1, field LVDSCLK2_IBEN[13:13] (RW)
 *
...
/* --- Register HW_PMU_REG_MISC1, field IRQ_TEMPSENSE[29:29] (W1C)
 *
...
/* --- Register HW_PMU_REG_MISC1, field IRQ_ANA_BO[30:30] (W1C)
 *
...
/* --- Register HW_PMU_REG_MISC1, field IRQ_DIG_BO[31:31] (W1C)
 *
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned REG0_BO_STATUS : 1; //!< Reg0 brownout status bit.
        unsigned RESERVED0 : 1; //!< Reserved.
        ...
        unsigned REG1_BO_STATUS : 1; //!< Reg1 brownout status bit.
        unsigned RESERVED2 : 1; //!< Reserved.
...
/* --- Register HW_PMU_REG_MISC2, field REG0_BO_STATUS[3:3] (RO)
 *
...
#define BP_PMU_REG_MISC2_REG0_BO_STATUS      (3)
#define BM_PMU_REG_MISC2_REG0_BO_STATUS      (0x00000008)


/* --- Register HW_PMU_REG_MISC2, field REG0_ENABLE_BO[5:5] (RW)
 *
...
/* --- Register HW_PMU_REG_MISC2, field CONTROL0[7:7] (RW)
 *
...
/* --- Register HW_PMU_REG_MISC2, field REG1_BO_STATUS[11:11] (RO)
 *
...
/* --- Register HW_PMU_REG_MISC2, field REG1_ENABLE_BO[13:13] (RW)
 *
 * Enables the brownout detection.
 */
...
/* --- Register HW_PMU_REG_MISC2, field REG2_BO_STATUS[19:19] (RO)
 *
...
/* --- Register HW_PMU_REG_MISC2, field REG2_ENABLE_BO[21:21] (RW)
 *
 * Enables the brownout detection.
 */
...
/* --- Register HW_PMU_REG_MISC2, field REG2_OK[22:22] (RO)
 *
