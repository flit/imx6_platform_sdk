...
/* --- Register HW_SATAPHY_CLOCK_CRCMP_CTL, field HOLD_SCRATCH0[0:0] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CRCMP_CTL, field HOLD_SCRATCH1[1:1] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CRCMP_STAT, field S0_LOW[0:0] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CRCMP_STAT, field S0_HIGH[1:1] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CRCMP_STAT, field S1_S0_LOW[2:2] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CRCMP_STAT, field S1_S0_HIGH[3:3] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CRCMP_STAT, field S0_OUTSIDE[4:4] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CRCMP_STAT, field S1_S0_OUTSIDE[5:5] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_DAC_CTL, field OVRD_RTUNE_TX[10:10] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_DAC_CTL, field OVRD_RTUNE_RX[11:11] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RTUNE_CTL, field FRC_PWRON[2:2] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RTUNE_CTL, field PWRON_LCL[3:3] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RTUNE_CTL, field SEL_ATBP[4:4] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RTUNE_CTL, field RSC_X4[5:5] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RTUNE_CTL, field DAC_CHOP[6:6] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RTUNE_CTL, field CMP_INVERT[7:7] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RTUNE_CTL, field RTUNE_DIS[8:8] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RTUNE_CTL, field RTUNE_TRIG[9:9] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RTUNE_CTL, field ADC_TRIG[10:10] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_ADC_OUT, field FRESH[10:10] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_SS_PHASE, field ZERO_FREQ[12:12] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_STAT, field USE_REFCLK_ALT[0:0] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_STAT, field MPLL_CLK_OFF[1:1] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_STAT, field MPLL_PWRON[2:2] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_STAT, field MPLL_SS_EN[3:3] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_STAT, field RTUNE_DO_TUNE[10:10] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_STAT, field WIDE_XFACE[11:11] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_STAT, field VPH_IS_3P3[12:12] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_STAT, field VP_IS_1P2[13:13] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_STAT, field FAST_TECH[14:14] (RO)
 *
 * Technology is fast
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_STAT, field CR_READ[0:0] (RO)
 *
 * Read request
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_STAT, field CR_WRITE[1:1] (RO)
 *
 * Write request
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_STAT, field CR_CAP_DATA[2:2] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CREG_STAT, field CR_CAP_ADDR[3:3] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CREG_STAT, field CR_ACK[5:5] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CREG_STAT, field POWER_GOOD[6:6] (RO)
 *
 * Power good output
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_STAT, field OP_DONE[7:7] (RO)
 *
...
/* --- Register HW_SATAPHY_CLOCK_FREW_OVRD, field OVRD[15:15] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field USE_REFCLK_ALT[0:0] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field MPLL_CLK_OFF[1:1] (RW)
 *
 * Reference clock is off
 */
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field MPLL_PWRON[2:2] (RW)
 *
 * MPLL power-on control
 */
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field MPLL_SS_EN[3:3] (RW)
 *
 * Spread spectrum enable
 */
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field OVRD_CLK[9:9] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field RTUNE_DO_TUNE[10:10] (RW)
 *
 * Manual resistor tune control
 */
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field WIDE_XFACE[11:11] (RW)
 *
 * Wide interface control
 */
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field VPH_IS_3P3[12:12] (RW)
 *
 * High-voltage supply is 3.3 V
 */
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field VP_IS_1P2[13:13] (RW)
 *
 * Low-voltage supply is 1.2 V
 */
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field FAST_TECH[14:14] (RW)
 *
 * Technology is fast
 */
...
/* --- Register HW_SATAPHY_CLOCK_CTL_OVRD, field OVRD_STATIC[15:15] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_LVL_OVRD, field OVRD[15:15] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CREG_OVRD, field CR_READ[0:0] (RW)
 *
 * Reads request
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_OVRD, field CR_WRITE[1:1] (RW)
 *
 * Writes request
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_OVRD, field CR_CAP_DATA[2:2] (RW)
 *
 * Captures data request
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_OVRD, field CR_CAP_ADDR[3:3] (RW)
 *
 * Captures address request
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_OVRD, field OVRD_IN[4:4] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_CREG_OVRD, field CR_ACK[5:5] (RW)
 *
 * Creg request acknowledgement
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_OVRD, field POWER_GOOD[6:6] (RW)
 *
 * Power good output
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_OVRD, field OP_DONE[7:7] (RW)
 *
 * Operation is complete output
 */
...
/* --- Register HW_SATAPHY_CLOCK_CREG_OVRD, field OVRD_OUT[8:8] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_CTL, field CLKDRV_ANA[0:0] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_CTL, field CLKDRV_DIG[1:1] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_CTL, field OVRD_CLKDRV[2:2] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_CTL, field DIS_PARA_CREG[3:3] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_CTL, field REFCLK_DELAY[4:4] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_TEST, field ATB_SENSE[0:0] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_TEST, field MEAS_GD[1:1] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_TEST, field RESET_VAL[13:13] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_TEST, field GEARSHIFT_VAL[14:14] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_MPLL_TEST, field OVRD_CTL[15:15] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_SS_FREQ, field FREQ_REG_OVRD[14:14] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_SEL_OVRD, field CLK_SEL_OVRD[10:10] (RW)
 *
...
/* --- Register HW_SATAPHY_CLOCK_RESET, field RESET[0:0] (WO)
 *
