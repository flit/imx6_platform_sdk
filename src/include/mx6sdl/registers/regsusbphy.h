...
/*
 * i.MX6SDL USB_PHY registers defined in this header file.
 *
...
#define BG_USB_PHY_PWD_TXPWDFS(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_PWD_TXPWDFS) >> BP_USB_PHY_PWD_TXPWDFS)

//! @brief Format value for bitfield USB_PHY_PWD_TXPWDFS.
#define BF_USB_PHY_PWD_TXPWDFS(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_PWD_TXPWDFS) & BM_USB_PHY_PWD_TXPWDFS)
...
#define BG_USB_PHY_PWD_TXPWDIBIAS(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_PWD_TXPWDIBIAS) >> BP_USB_PHY_PWD_TXPWDIBIAS)

//! @brief Format value for bitfield USB_PHY_PWD_TXPWDIBIAS.
#define BF_USB_PHY_PWD_TXPWDIBIAS(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_PWD_TXPWDIBIAS) & BM_USB_PHY_PWD_TXPWDIBIAS)
...
#define BG_USB_PHY_PWD_TXPWDV2I(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_PWD_TXPWDV2I) >> BP_USB_PHY_PWD_TXPWDV2I)

//! @brief Format value for bitfield USB_PHY_PWD_TXPWDV2I.
#define BF_USB_PHY_PWD_TXPWDV2I(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_PWD_TXPWDV2I) & BM_USB_PHY_PWD_TXPWDV2I)
...
#define BG_USB_PHY_PWD_RXPWDENV(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_PWD_RXPWDENV) >> BP_USB_PHY_PWD_RXPWDENV)

//! @brief Format value for bitfield USB_PHY_PWD_RXPWDENV.
#define BF_USB_PHY_PWD_RXPWDENV(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_PWD_RXPWDENV) & BM_USB_PHY_PWD_RXPWDENV)
...
#define BG_USB_PHY_PWD_RXPWD1PT1(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_PWD_RXPWD1PT1) >> BP_USB_PHY_PWD_RXPWD1PT1)

//! @brief Format value for bitfield USB_PHY_PWD_RXPWD1PT1.
#define BF_USB_PHY_PWD_RXPWD1PT1(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_PWD_RXPWD1PT1) & BM_USB_PHY_PWD_RXPWD1PT1)
...
#define BG_USB_PHY_PWD_RXPWDDIFF(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_PWD_RXPWDDIFF) >> BP_USB_PHY_PWD_RXPWDDIFF)

//! @brief Format value for bitfield USB_PHY_PWD_RXPWDDIFF.
#define BF_USB_PHY_PWD_RXPWDDIFF(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_PWD_RXPWDDIFF) & BM_USB_PHY_PWD_RXPWDDIFF)
...
#define BG_USB_PHY_PWD_RXPWDRX(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_PWD_RXPWDRX) >> BP_USB_PHY_PWD_RXPWDRX)

//! @brief Format value for bitfield USB_PHY_PWD_RXPWDRX.
#define BF_USB_PHY_PWD_RXPWDRX(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_PWD_RXPWDRX) & BM_USB_PHY_PWD_RXPWDRX)
...
#define BG_USB_PHY_TX_D_CAL(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_TX_D_CAL) >> BP_USB_PHY_TX_D_CAL)

//! @brief Format value for bitfield USB_PHY_TX_D_CAL.
#define BF_USB_PHY_TX_D_CAL(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_TX_D_CAL) & BM_USB_PHY_TX_D_CAL)
...
#define BG_USB_PHY_TX_TXCAL45DN(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_TX_TXCAL45DN) >> BP_USB_PHY_TX_TXCAL45DN)

//! @brief Format value for bitfield USB_PHY_TX_TXCAL45DN.
#define BF_USB_PHY_TX_TXCAL45DN(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_TX_TXCAL45DN) & BM_USB_PHY_TX_TXCAL45DN)
...
#define BG_USB_PHY_TX_TXCAL45DP(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_TX_TXCAL45DP) >> BP_USB_PHY_TX_TXCAL45DP)

//! @brief Format value for bitfield USB_PHY_TX_TXCAL45DP.
#define BF_USB_PHY_TX_TXCAL45DP(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_TX_TXCAL45DP) & BM_USB_PHY_TX_TXCAL45DP)
...
typedef union _hw_usb_phy_rx
{
    ...
    {
        unsigned ENVADJ : 3; //!< [2:0] The ENVADJ field adjusts the trip point for the envelope detector. 000 = Trip-Level Voltage is 0.12500 V 001 = Trip-Level Voltage is 0.10000 V 010 = Trip-Level Voltage is 0.13750 V 011 = Trip-Level Voltage is 0.15000 V 1XX = Reserved
        unsigned RESERVED0 : 1; //!< [3] Reserved.
        unsigned DISCONADJ : 3; //!< [6:4] The DISCONADJ field adjusts the trip point for the disconnect detector: 000 = Trip-Level Voltage is 0.57500 V 001 = Trip-Level Voltage is 0.56875 V 010 = Trip-Level Voltage is 0.58125 V 011 = Trip-Level Voltage is 0.58750 V 1XX = Reserved
...
#define BG_USB_PHY_RX_ENVADJ(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_RX_ENVADJ) >> BP_USB_PHY_RX_ENVADJ)

//! @brief Format value for bitfield USB_PHY_RX_ENVADJ.
#define BF_USB_PHY_RX_ENVADJ(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_RX_ENVADJ) & BM_USB_PHY_RX_ENVADJ)
...
#define BG_USB_PHY_RX_DISCONADJ(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_RX_DISCONADJ) >> BP_USB_PHY_RX_DISCONADJ)

//! @brief Format value for bitfield USB_PHY_RX_DISCONADJ.
#define BF_USB_PHY_RX_DISCONADJ(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_RX_DISCONADJ) & BM_USB_PHY_RX_DISCONADJ)
...
#define BG_USB_PHY_RX_RXDBYPASS(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_RX_RXDBYPASS) >> BP_USB_PHY_RX_RXDBYPASS)

//! @brief Format value for bitfield USB_PHY_RX_RXDBYPASS.
#define BF_USB_PHY_RX_RXDBYPASS(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_RX_RXDBYPASS) & BM_USB_PHY_RX_RXDBYPASS)
...
#define BG_USB_PHY_CTRL_ENOTG_ID_CHG_IRQ(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENOTG_ID_CHG_IRQ) >> BP_USB_PHY_CTRL_ENOTG_ID_CHG_IRQ)

//! @brief Format value for bitfield USB_PHY_CTRL_ENOTG_ID_CHG_IRQ.
#define BF_USB_PHY_CTRL_ENOTG_ID_CHG_IRQ(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENOTG_ID_CHG_IRQ) & BM_USB_PHY_CTRL_ENOTG_ID_CHG_IRQ)
...
#define BG_USB_PHY_CTRL_ENHOSTDISCONDETECT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENHOSTDISCONDETECT) >> BP_USB_PHY_CTRL_ENHOSTDISCONDETECT)

//! @brief Format value for bitfield USB_PHY_CTRL_ENHOSTDISCONDETECT.
#define BF_USB_PHY_CTRL_ENHOSTDISCONDETECT(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENHOSTDISCONDETECT) & BM_USB_PHY_CTRL_ENHOSTDISCONDETECT)
...
#define BG_USB_PHY_CTRL_ENIRQHOSTDISCON(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENIRQHOSTDISCON) >> BP_USB_PHY_CTRL_ENIRQHOSTDISCON)

//! @brief Format value for bitfield USB_PHY_CTRL_ENIRQHOSTDISCON.
#define BF_USB_PHY_CTRL_ENIRQHOSTDISCON(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENIRQHOSTDISCON) & BM_USB_PHY_CTRL_ENIRQHOSTDISCON)
...
#define BG_USB_PHY_CTRL_HOSTDISCONDETECT_IRQ(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_HOSTDISCONDETECT_IRQ) >> BP_USB_PHY_CTRL_HOSTDISCONDETECT_IRQ)

//! @brief Format value for bitfield USB_PHY_CTRL_HOSTDISCONDETECT_IRQ.
#define BF_USB_PHY_CTRL_HOSTDISCONDETECT_IRQ(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_HOSTDISCONDETECT_IRQ) & BM_USB_PHY_CTRL_HOSTDISCONDETECT_IRQ)
...
#define BG_USB_PHY_CTRL_ENDEVPLUGINDETECT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENDEVPLUGINDETECT) >> BP_USB_PHY_CTRL_ENDEVPLUGINDETECT)

//! @brief Format value for bitfield USB_PHY_CTRL_ENDEVPLUGINDETECT.
#define BF_USB_PHY_CTRL_ENDEVPLUGINDETECT(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENDEVPLUGINDETECT) & BM_USB_PHY_CTRL_ENDEVPLUGINDETECT)
...
#define BG_USB_PHY_CTRL_DEVPLUGIN_POLARITY(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_DEVPLUGIN_POLARITY) >> BP_USB_PHY_CTRL_DEVPLUGIN_POLARITY)

//! @brief Format value for bitfield USB_PHY_CTRL_DEVPLUGIN_POLARITY.
#define BF_USB_PHY_CTRL_DEVPLUGIN_POLARITY(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_DEVPLUGIN_POLARITY) & BM_USB_PHY_CTRL_DEVPLUGIN_POLARITY)
...
#define BG_USB_PHY_CTRL_OTG_ID_CHG_IRQ(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_OTG_ID_CHG_IRQ) >> BP_USB_PHY_CTRL_OTG_ID_CHG_IRQ)

//! @brief Format value for bitfield USB_PHY_CTRL_OTG_ID_CHG_IRQ.
#define BF_USB_PHY_CTRL_OTG_ID_CHG_IRQ(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_OTG_ID_CHG_IRQ) & BM_USB_PHY_CTRL_OTG_ID_CHG_IRQ)
...
#define BG_USB_PHY_CTRL_ENOTGIDDETECT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENOTGIDDETECT) >> BP_USB_PHY_CTRL_ENOTGIDDETECT)

//! @brief Format value for bitfield USB_PHY_CTRL_ENOTGIDDETECT.
#define BF_USB_PHY_CTRL_ENOTGIDDETECT(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENOTGIDDETECT) & BM_USB_PHY_CTRL_ENOTGIDDETECT)
...
#define BG_USB_PHY_CTRL_RESUMEIRQSTICKY(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_RESUMEIRQSTICKY) >> BP_USB_PHY_CTRL_RESUMEIRQSTICKY)

//! @brief Format value for bitfield USB_PHY_CTRL_RESUMEIRQSTICKY.
#define BF_USB_PHY_CTRL_RESUMEIRQSTICKY(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_RESUMEIRQSTICKY) & BM_USB_PHY_CTRL_RESUMEIRQSTICKY)
...
#define BG_USB_PHY_CTRL_ENIRQRESUMEDETECT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENIRQRESUMEDETECT) >> BP_USB_PHY_CTRL_ENIRQRESUMEDETECT)

//! @brief Format value for bitfield USB_PHY_CTRL_ENIRQRESUMEDETECT.
#define BF_USB_PHY_CTRL_ENIRQRESUMEDETECT(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENIRQRESUMEDETECT) & BM_USB_PHY_CTRL_ENIRQRESUMEDETECT)
...
#define BG_USB_PHY_CTRL_RESUME_IRQ(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_RESUME_IRQ) >> BP_USB_PHY_CTRL_RESUME_IRQ)

//! @brief Format value for bitfield USB_PHY_CTRL_RESUME_IRQ.
#define BF_USB_PHY_CTRL_RESUME_IRQ(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_RESUME_IRQ) & BM_USB_PHY_CTRL_RESUME_IRQ)
...
#define BG_USB_PHY_CTRL_ENIRQDEVPLUGIN(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENIRQDEVPLUGIN) >> BP_USB_PHY_CTRL_ENIRQDEVPLUGIN)

//! @brief Format value for bitfield USB_PHY_CTRL_ENIRQDEVPLUGIN.
#define BF_USB_PHY_CTRL_ENIRQDEVPLUGIN(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENIRQDEVPLUGIN) & BM_USB_PHY_CTRL_ENIRQDEVPLUGIN)
...
#define BG_USB_PHY_CTRL_DEVPLUGIN_IRQ(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_DEVPLUGIN_IRQ) >> BP_USB_PHY_CTRL_DEVPLUGIN_IRQ)

//! @brief Format value for bitfield USB_PHY_CTRL_DEVPLUGIN_IRQ.
#define BF_USB_PHY_CTRL_DEVPLUGIN_IRQ(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_DEVPLUGIN_IRQ) & BM_USB_PHY_CTRL_DEVPLUGIN_IRQ)
...
#define BG_USB_PHY_CTRL_DATA_ON_LRADC(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_DATA_ON_LRADC) >> BP_USB_PHY_CTRL_DATA_ON_LRADC)

//! @brief Format value for bitfield USB_PHY_CTRL_DATA_ON_LRADC.
#define BF_USB_PHY_CTRL_DATA_ON_LRADC(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_DATA_ON_LRADC) & BM_USB_PHY_CTRL_DATA_ON_LRADC)
...
#define BG_USB_PHY_CTRL_ENUTMILEVEL2(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENUTMILEVEL2) >> BP_USB_PHY_CTRL_ENUTMILEVEL2)

//! @brief Format value for bitfield USB_PHY_CTRL_ENUTMILEVEL2.
#define BF_USB_PHY_CTRL_ENUTMILEVEL2(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENUTMILEVEL2) & BM_USB_PHY_CTRL_ENUTMILEVEL2)
...
#define BG_USB_PHY_CTRL_ENUTMILEVEL3(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENUTMILEVEL3) >> BP_USB_PHY_CTRL_ENUTMILEVEL3)

//! @brief Format value for bitfield USB_PHY_CTRL_ENUTMILEVEL3.
#define BF_USB_PHY_CTRL_ENUTMILEVEL3(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENUTMILEVEL3) & BM_USB_PHY_CTRL_ENUTMILEVEL3)
...
#define BG_USB_PHY_CTRL_ENIRQWAKEUP(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENIRQWAKEUP) >> BP_USB_PHY_CTRL_ENIRQWAKEUP)

//! @brief Format value for bitfield USB_PHY_CTRL_ENIRQWAKEUP.
#define BF_USB_PHY_CTRL_ENIRQWAKEUP(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENIRQWAKEUP) & BM_USB_PHY_CTRL_ENIRQWAKEUP)
...
#define BG_USB_PHY_CTRL_WAKEUP_IRQ(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_WAKEUP_IRQ) >> BP_USB_PHY_CTRL_WAKEUP_IRQ)

//! @brief Format value for bitfield USB_PHY_CTRL_WAKEUP_IRQ.
#define BF_USB_PHY_CTRL_WAKEUP_IRQ(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_WAKEUP_IRQ) & BM_USB_PHY_CTRL_WAKEUP_IRQ)
...
#define BG_USB_PHY_CTRL_ENAUTOCLR_CLKGATE(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENAUTOCLR_CLKGATE) >> BP_USB_PHY_CTRL_ENAUTOCLR_CLKGATE)

//! @brief Format value for bitfield USB_PHY_CTRL_ENAUTOCLR_CLKGATE.
#define BF_USB_PHY_CTRL_ENAUTOCLR_CLKGATE(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENAUTOCLR_CLKGATE) & BM_USB_PHY_CTRL_ENAUTOCLR_CLKGATE)
...
#define BG_USB_PHY_CTRL_ENAUTOCLR_PHY_PWD(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENAUTOCLR_PHY_PWD) >> BP_USB_PHY_CTRL_ENAUTOCLR_PHY_PWD)

//! @brief Format value for bitfield USB_PHY_CTRL_ENAUTOCLR_PHY_PWD.
#define BF_USB_PHY_CTRL_ENAUTOCLR_PHY_PWD(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENAUTOCLR_PHY_PWD) & BM_USB_PHY_CTRL_ENAUTOCLR_PHY_PWD)
...
#define BG_USB_PHY_CTRL_ENDPDMCHG_WKUP(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENDPDMCHG_WKUP) >> BP_USB_PHY_CTRL_ENDPDMCHG_WKUP)

//! @brief Format value for bitfield USB_PHY_CTRL_ENDPDMCHG_WKUP.
#define BF_USB_PHY_CTRL_ENDPDMCHG_WKUP(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENDPDMCHG_WKUP) & BM_USB_PHY_CTRL_ENDPDMCHG_WKUP)
...
#define BG_USB_PHY_CTRL_ENIDCHG_WKUP(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENIDCHG_WKUP) >> BP_USB_PHY_CTRL_ENIDCHG_WKUP)

//! @brief Format value for bitfield USB_PHY_CTRL_ENIDCHG_WKUP.
#define BF_USB_PHY_CTRL_ENIDCHG_WKUP(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENIDCHG_WKUP) & BM_USB_PHY_CTRL_ENIDCHG_WKUP)
...
#define BG_USB_PHY_CTRL_ENVBUSCHG_WKUP(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_ENVBUSCHG_WKUP) >> BP_USB_PHY_CTRL_ENVBUSCHG_WKUP)

//! @brief Format value for bitfield USB_PHY_CTRL_ENVBUSCHG_WKUP.
#define BF_USB_PHY_CTRL_ENVBUSCHG_WKUP(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_ENVBUSCHG_WKUP) & BM_USB_PHY_CTRL_ENVBUSCHG_WKUP)
...
#define BG_USB_PHY_CTRL_FSDLL_RST_EN(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_FSDLL_RST_EN) >> BP_USB_PHY_CTRL_FSDLL_RST_EN)

//! @brief Format value for bitfield USB_PHY_CTRL_FSDLL_RST_EN.
#define BF_USB_PHY_CTRL_FSDLL_RST_EN(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_FSDLL_RST_EN) & BM_USB_PHY_CTRL_FSDLL_RST_EN)
...
#define BG_USB_PHY_CTRL_OTG_ID_VALUE(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_OTG_ID_VALUE) >> BP_USB_PHY_CTRL_OTG_ID_VALUE)
...
#define BG_USB_PHY_CTRL_HOST_FORCE_LS_SE0(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_HOST_FORCE_LS_SE0) >> BP_USB_PHY_CTRL_HOST_FORCE_LS_SE0)

//! @brief Format value for bitfield USB_PHY_CTRL_HOST_FORCE_LS_SE0.
#define BF_USB_PHY_CTRL_HOST_FORCE_LS_SE0(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_HOST_FORCE_LS_SE0) & BM_USB_PHY_CTRL_HOST_FORCE_LS_SE0)
...
#define BG_USB_PHY_CTRL_UTMI_SUSPENDM(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_UTMI_SUSPENDM) >> BP_USB_PHY_CTRL_UTMI_SUSPENDM)
...
#define BG_USB_PHY_CTRL_CLKGATE(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_CLKGATE) >> BP_USB_PHY_CTRL_CLKGATE)

//! @brief Format value for bitfield USB_PHY_CTRL_CLKGATE.
#define BF_USB_PHY_CTRL_CLKGATE(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_CLKGATE) & BM_USB_PHY_CTRL_CLKGATE)
...
#define BG_USB_PHY_CTRL_SFTRST(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_CTRL_SFTRST) >> BP_USB_PHY_CTRL_SFTRST)

//! @brief Format value for bitfield USB_PHY_CTRL_SFTRST.
#define BF_USB_PHY_CTRL_SFTRST(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_CTRL_SFTRST) & BM_USB_PHY_CTRL_SFTRST)
...
#define BG_USB_PHY_STATUS_HOSTDISCONDETECT_STATUS(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_STATUS_HOSTDISCONDETECT_STATUS) >> BP_USB_PHY_STATUS_HOSTDISCONDETECT_STATUS)
...
#define BG_USB_PHY_STATUS_DEVPLUGIN_STATUS(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_STATUS_DEVPLUGIN_STATUS) >> BP_USB_PHY_STATUS_DEVPLUGIN_STATUS)
...
#define BG_USB_PHY_STATUS_OTGID_STATUS(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_STATUS_OTGID_STATUS) >> BP_USB_PHY_STATUS_OTGID_STATUS)

//! @brief Format value for bitfield USB_PHY_STATUS_OTGID_STATUS.
#define BF_USB_PHY_STATUS_OTGID_STATUS(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_STATUS_OTGID_STATUS) & BM_USB_PHY_STATUS_OTGID_STATUS)
...
#define BG_USB_PHY_STATUS_RESUME_STATUS(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_STATUS_RESUME_STATUS) >> BP_USB_PHY_STATUS_RESUME_STATUS)
...
#define BG_USB_PHY_DEBUG_OTGIDPIOLOCK(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_OTGIDPIOLOCK) >> BP_USB_PHY_DEBUG_OTGIDPIOLOCK)

//! @brief Format value for bitfield USB_PHY_DEBUG_OTGIDPIOLOCK.
#define BF_USB_PHY_DEBUG_OTGIDPIOLOCK(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_OTGIDPIOLOCK) & BM_USB_PHY_DEBUG_OTGIDPIOLOCK)
...
#define BG_USB_PHY_DEBUG_DEBUG_INTERFACE_HOLD(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_DEBUG_INTERFACE_HOLD) >> BP_USB_PHY_DEBUG_DEBUG_INTERFACE_HOLD)

//! @brief Format value for bitfield USB_PHY_DEBUG_DEBUG_INTERFACE_HOLD.
#define BF_USB_PHY_DEBUG_DEBUG_INTERFACE_HOLD(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_DEBUG_INTERFACE_HOLD) & BM_USB_PHY_DEBUG_DEBUG_INTERFACE_HOLD)
...
#define BG_USB_PHY_DEBUG_HSTPULLDOWN(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_HSTPULLDOWN) >> BP_USB_PHY_DEBUG_HSTPULLDOWN)

//! @brief Format value for bitfield USB_PHY_DEBUG_HSTPULLDOWN.
#define BF_USB_PHY_DEBUG_HSTPULLDOWN(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_HSTPULLDOWN) & BM_USB_PHY_DEBUG_HSTPULLDOWN)
...
#define BG_USB_PHY_DEBUG_ENHSTPULLDOWN(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_ENHSTPULLDOWN) >> BP_USB_PHY_DEBUG_ENHSTPULLDOWN)

//! @brief Format value for bitfield USB_PHY_DEBUG_ENHSTPULLDOWN.
#define BF_USB_PHY_DEBUG_ENHSTPULLDOWN(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_ENHSTPULLDOWN) & BM_USB_PHY_DEBUG_ENHSTPULLDOWN)
...
#define BG_USB_PHY_DEBUG_TX2RXCOUNT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_TX2RXCOUNT) >> BP_USB_PHY_DEBUG_TX2RXCOUNT)

//! @brief Format value for bitfield USB_PHY_DEBUG_TX2RXCOUNT.
#define BF_USB_PHY_DEBUG_TX2RXCOUNT(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_TX2RXCOUNT) & BM_USB_PHY_DEBUG_TX2RXCOUNT)
...
#define BG_USB_PHY_DEBUG_ENTX2RXCOUNT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_ENTX2RXCOUNT) >> BP_USB_PHY_DEBUG_ENTX2RXCOUNT)

//! @brief Format value for bitfield USB_PHY_DEBUG_ENTX2RXCOUNT.
#define BF_USB_PHY_DEBUG_ENTX2RXCOUNT(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_ENTX2RXCOUNT) & BM_USB_PHY_DEBUG_ENTX2RXCOUNT)
...
#define BG_USB_PHY_DEBUG_SQUELCHRESETCOUNT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_SQUELCHRESETCOUNT) >> BP_USB_PHY_DEBUG_SQUELCHRESETCOUNT)

//! @brief Format value for bitfield USB_PHY_DEBUG_SQUELCHRESETCOUNT.
#define BF_USB_PHY_DEBUG_SQUELCHRESETCOUNT(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_SQUELCHRESETCOUNT) & BM_USB_PHY_DEBUG_SQUELCHRESETCOUNT)
...
#define BG_USB_PHY_DEBUG_ENSQUELCHRESET(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_ENSQUELCHRESET) >> BP_USB_PHY_DEBUG_ENSQUELCHRESET)

//! @brief Format value for bitfield USB_PHY_DEBUG_ENSQUELCHRESET.
#define BF_USB_PHY_DEBUG_ENSQUELCHRESET(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_ENSQUELCHRESET) & BM_USB_PHY_DEBUG_ENSQUELCHRESET)
...
#define BG_USB_PHY_DEBUG_SQUELCHRESETLENGTH(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_SQUELCHRESETLENGTH) >> BP_USB_PHY_DEBUG_SQUELCHRESETLENGTH)

//! @brief Format value for bitfield USB_PHY_DEBUG_SQUELCHRESETLENGTH.
#define BF_USB_PHY_DEBUG_SQUELCHRESETLENGTH(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_SQUELCHRESETLENGTH) & BM_USB_PHY_DEBUG_SQUELCHRESETLENGTH)
...
#define BG_USB_PHY_DEBUG_HOST_RESUME_DEBUG(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_HOST_RESUME_DEBUG) >> BP_USB_PHY_DEBUG_HOST_RESUME_DEBUG)

//! @brief Format value for bitfield USB_PHY_DEBUG_HOST_RESUME_DEBUG.
#define BF_USB_PHY_DEBUG_HOST_RESUME_DEBUG(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_HOST_RESUME_DEBUG) & BM_USB_PHY_DEBUG_HOST_RESUME_DEBUG)
...
#define BG_USB_PHY_DEBUG_CLKGATE(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG_CLKGATE) >> BP_USB_PHY_DEBUG_CLKGATE)

//! @brief Format value for bitfield USB_PHY_DEBUG_CLKGATE.
#define BF_USB_PHY_DEBUG_CLKGATE(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG_CLKGATE) & BM_USB_PHY_DEBUG_CLKGATE)
...
#define BG_USB_PHY_DEBUG0_STATUS_LOOP_BACK_FAIL_COUNT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG0_STATUS_LOOP_BACK_FAIL_COUNT) >> BP_USB_PHY_DEBUG0_STATUS_LOOP_BACK_FAIL_COUNT)
...
#define BG_USB_PHY_DEBUG0_STATUS_UTMI_RXERROR_FAIL_COUNT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG0_STATUS_UTMI_RXERROR_FAIL_COUNT) >> BP_USB_PHY_DEBUG0_STATUS_UTMI_RXERROR_FAIL_COUNT)
...
#define BG_USB_PHY_DEBUG0_STATUS_SQUELCH_COUNT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG0_STATUS_SQUELCH_COUNT) >> BP_USB_PHY_DEBUG0_STATUS_SQUELCH_COUNT)
...
#define BG_USB_PHY_DEBUG1_ENTAILADJVD(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_DEBUG1_ENTAILADJVD) >> BP_USB_PHY_DEBUG1_ENTAILADJVD)

//! @brief Format value for bitfield USB_PHY_DEBUG1_ENTAILADJVD.
#define BF_USB_PHY_DEBUG1_ENTAILADJVD(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USB_PHY_DEBUG1_ENTAILADJVD) & BM_USB_PHY_DEBUG1_ENTAILADJVD)
...
#define BG_USB_PHY_VERSION_STEP(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_VERSION_STEP) >> BP_USB_PHY_VERSION_STEP)
...
#define BG_USB_PHY_VERSION_MINOR(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_VERSION_MINOR) >> BP_USB_PHY_VERSION_MINOR)
...
#define BG_USB_PHY_VERSION_MAJOR(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USB_PHY_VERSION_MAJOR) >> BP_USB_PHY_VERSION_MAJOR)
