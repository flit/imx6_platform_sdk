...
/* --- Register HW_SJC_GPUSR1, field A_DBG[0:0] (RO)
 *
...
/* --- Register HW_SJC_GPUSR1, field A_WFI[1:1] (RO)
 *
...
/* --- Register HW_SJC_GPUSR1, field PLL_LOCK[8:8] (RO)
 *
...
/* --- Register HW_SJC_GPUSR3, field IPG_WAIT[0:0] (RO)
 *
...
/* --- Register HW_SJC_GPUSR3, field IPG_STOP[1:1] (RO)
 *
...
/* --- Register HW_SJC_GPUSR3, field SYS_WAIT[2:2] (RO)
 *
...
/* --- Register HW_SJC_DCR, field DE_TO_ARM[0:0] (RW)
 *
...
/* --- Register HW_SJC_DCR, field DE_TO_SDMA[1:1] (RW)
 *
...
/* --- Register HW_SJC_DCR, field DEBUG_OBS[3:3] (RW)
 *
...
/* --- Register HW_SJC_DCR, field DIRECT_SDMA_REQ_EN[5:5] (RW)
 *
...
/* --- Register HW_SJC_DCR, field DIRECT_ARM_REQ_EN[6:6] (RW)
 *
...
/* --- Register HW_SJC_SSR, field KTF[0:0] (RO)
 *
...
/* --- Register HW_SJC_SSR, field KTA[1:1] (RO)
 *
...
/* --- Register HW_SJC_SSR, field SWF[2:2] (RO)
 *
...
/* --- Register HW_SJC_SSR, field SWE[3:3] (RO)
 *
...
/* --- Register HW_SJC_SSR, field EBF[4:4] (RO)
 *
...
/* --- Register HW_SJC_SSR, field EBG[5:5] (RO)
 *
...
/* --- Register HW_SJC_SSR, field FT[8:8] (RO)
 *
...
/* --- Register HW_SJC_SSR, field BOOTIND[14:14] (RO)
 *
...
/* --- Register HW_SJC_GPCCR, field SCLKR[0:0] (RW)
 *
...
/* --- Register HW_SJC_GPCCR, field ACLKOFFDIS[1:1] (RW)
 *
