...
#define HW_GPMI_CTRL0_SET(x, v)    ((*(volatile reg32_t *) HW_USB_PHY_PWD_SET_ADDR(x)) = (v))
...
/* --- Register HW_USB_PHY_PWD, field TXPWDFS[10:10] (RW)
 *
...
/* --- Register HW_USB_PHY_PWD, field TXPWDIBIAS[11:11] (RW)
 *
...
/* --- Register HW_USB_PHY_PWD, field TXPWDV2I[12:12] (RW)
 *
...
/* --- Register HW_USB_PHY_PWD, field RXPWDENV[17:17] (RW)
 *
...
/* --- Register HW_USB_PHY_PWD, field RXPWD1PT1[18:18] (RW)
 *
...
/* --- Register HW_USB_PHY_PWD, field RXPWDDIFF[19:19] (RW)
 *
...
/* --- Register HW_USB_PHY_PWD, field RXPWDRX[20:20] (RW)
 *
...
#define HW_GPMI_CTRL0_SET(x, v)    ((*(volatile reg32_t *) HW_USB_PHY_TX_SET_ADDR(x)) = (v))
...
#define HW_GPMI_CTRL0_SET(x, v)    ((*(volatile reg32_t *) HW_USB_PHY_RX_SET_ADDR(x)) = (v))
...
/* --- Register HW_USB_PHY_RX, field RXDBYPASS[22:22] (RW)
 *
...
#define HW_GPMI_CTRL0_SET(x, v)    ((*(volatile reg32_t *) HW_USB_PHY_CTRL_SET_ADDR(x)) = (v))
...
/* --- Register HW_USB_PHY_CTRL, field ENOTG_ID_CHG_IRQ[0:0] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENHOSTDISCONDETECT[1:1] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENIRQHOSTDISCON[2:2] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field HOSTDISCONDETECT_IRQ[3:3] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENDEVPLUGINDETECT[4:4] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field DEVPLUGIN_POLARITY[5:5] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field OTG_ID_CHG_IRQ[6:6] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENOTGIDDETECT[7:7] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field RESUMEIRQSTICKY[8:8] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENIRQRESUMEDETECT[9:9] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field RESUME_IRQ[10:10] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENIRQDEVPLUGIN[11:11] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field DEVPLUGIN_IRQ[12:12] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field DATA_ON_LRADC[13:13] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENUTMILEVEL2[14:14] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENUTMILEVEL3[15:15] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENIRQWAKEUP[16:16] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field WAKEUP_IRQ[17:17] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENAUTOCLR_CLKGATE[19:19] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENAUTOCLR_PHY_PWD[20:20] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENDPDMCHG_WKUP[21:21] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENIDCHG_WKUP[22:22] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field ENVBUSCHG_WKUP[23:23] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field FSDLL_RST_EN[24:24] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field OTG_ID_VALUE[27:27] (RO)
 *
...
/* --- Register HW_USB_PHY_CTRL, field HOST_FORCE_LS_SE0[28:28] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field UTMI_SUSPENDM[29:29] (RO)
 *
...
/* --- Register HW_USB_PHY_CTRL, field CLKGATE[30:30] (RW)
 *
...
/* --- Register HW_USB_PHY_CTRL, field SFTRST[31:31] (RW)
 *
...
/* --- Register HW_USB_PHY_STATUS, field HOSTDISCONDETECT_STATUS[3:3] (RO)
 *
...
/* --- Register HW_USB_PHY_STATUS, field DEVPLUGIN_STATUS[6:6] (RO)
 *
...
/* --- Register HW_USB_PHY_STATUS, field OTGID_STATUS[8:8] (RW)
 *
...
/* --- Register HW_USB_PHY_STATUS, field RESUME_STATUS[10:10] (RO)
 *
...
#define HW_GPMI_CTRL0_SET(x, v)    ((*(volatile reg32_t *) HW_USB_PHY_DEBUG_SET_ADDR(x)) = (v))
...
/* --- Register HW_USB_PHY_DEBUG, field OTGIDPIOLOCK[0:0] (RW)
 *
...
/* --- Register HW_USB_PHY_DEBUG, field DEBUG_INTERFACE_HOLD[1:1] (RW)
 *
...
/* --- Register HW_USB_PHY_DEBUG, field ENTX2RXCOUNT[12:12] (RW)
 *
...
/* --- Register HW_USB_PHY_DEBUG, field ENSQUELCHRESET[24:24] (RW)
 *
...
/* --- Register HW_USB_PHY_DEBUG, field HOST_RESUME_DEBUG[29:29] (RW)
 *
...
/* --- Register HW_USB_PHY_DEBUG, field CLKGATE[30:30] (RW)
 *
...
#define HW_GPMI_CTRL0_SET(x, v)    ((*(volatile reg32_t *) HW_USB_PHY_DEBUG1_SET_ADDR(x)) = (v))
