...
typedef union _hw_usdhc_sys_ctrl
{
    ...
    struct _hw_usdhc_sys_ctrl_bitfields
    {
        ...
        unsigned RSTT : 1; //!< [28] Reset Tuning: When set this bit to 1, it will reset tuning circuit.
...
#define BG_USDHC_SYS_CTRL_RSTT(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USDHC_SYS_CTRL_RSTT) >> BP_USDHC_SYS_CTRL_RSTT)

//! @brief Format value for bitfield USDHC_SYS_CTRL_RSTT.
#define BF_USDHC_SYS_CTRL_RSTT(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USDHC_SYS_CTRL_RSTT) & BM_USDHC_SYS_CTRL_RSTT)
...
typedef union _hw_usdhc_autocmd12_err_status
{
    ...
    struct _hw_usdhc_autocmd12_err_status_bitfields
    {
        ...
        unsigned EXECUTE_TUNING : 1; //!< [22] Execute Tuning: When std_tuning_en bit is set, this bit is used to start tuning procedure.
        unsigned SMP_CLK_SEL : 1; //!< [23] Sample Clock Select: When std_tuning_en bit is set, this bit is used to select sampling clock to receive CMD and DAT.
...
typedef union _hw_usdhc_host_ctrl_cap
{
    ...
    struct _hw_usdhc_host_ctrl_cap_bitfields
    {
        ...
        unsigned USE_TUNING_SDR50 : 1; //!< [13] Use Tuning for SDR50: This bit is set to 1.
...
typedef union _hw_usdhc_mix_ctrl
{
    ...
    struct _hw_usdhc_mix_ctrl_bitfields
    {
        ...
        unsigned EXE_TUNE : 1; //!< [22] Execute Tuning: (Only used for SD3.0, SDR104 mode) When std_tuning_en is 0, this bit is set to 1 to indicate the Host Driver is starting tuning procedure.
        unsigned SMP_CLK_SEL : 1; //!< [23] When std_tuning_en is 0, this bit is used to select Tuned clock or Fixed clock to sample data/cmd (Only used for SD3.0, SDR104 mode)
 ...
 *
 * Execute Tuning: (Only used for SD3.0, SDR104 mode) When std_tuning_en is 0, this bit is set to 1
 * to indicate the Host Driver is starting tuning procedure. Tuning procedure is aborted by writing
 * 0.
 *
 * Values:
...
#define BG_USDHC_TUNING_CTRL_TUNING_START_TAP(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USDHC_TUNING_CTRL_TUNING_START_TAP) >> BP_USDHC_TUNING_CTRL_TUNING_START_TAP)

//! @brief Format value for bitfield USDHC_TUNING_CTRL_TUNING_START_TAP.
#define BF_USDHC_TUNING_CTRL_TUNING_START_TAP(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USDHC_TUNING_CTRL_TUNING_START_TAP) & BM_USDHC_TUNING_CTRL_TUNING_START_TAP)
...
#define BG_USDHC_TUNING_CTRL_TUNING_COUNTER(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USDHC_TUNING_CTRL_TUNING_COUNTER) >> BP_USDHC_TUNING_CTRL_TUNING_COUNTER)

//! @brief Format value for bitfield USDHC_TUNING_CTRL_TUNING_COUNTER.
#define BF_USDHC_TUNING_CTRL_TUNING_COUNTER(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USDHC_TUNING_CTRL_TUNING_COUNTER) & BM_USDHC_TUNING_CTRL_TUNING_COUNTER)
...
#define BG_USDHC_TUNING_CTRL_TUNING_STEP(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USDHC_TUNING_CTRL_TUNING_STEP) >> BP_USDHC_TUNING_CTRL_TUNING_STEP)

//! @brief Format value for bitfield USDHC_TUNING_CTRL_TUNING_STEP.
#define BF_USDHC_TUNING_CTRL_TUNING_STEP(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USDHC_TUNING_CTRL_TUNING_STEP) & BM_USDHC_TUNING_CTRL_TUNING_STEP)
...
#define BG_USDHC_TUNING_CTRL_TUNING_WINDOW(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USDHC_TUNING_CTRL_TUNING_WINDOW) >> BP_USDHC_TUNING_CTRL_TUNING_WINDOW)

//! @brief Format value for bitfield USDHC_TUNING_CTRL_TUNING_WINDOW.
#define BF_USDHC_TUNING_CTRL_TUNING_WINDOW(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USDHC_TUNING_CTRL_TUNING_WINDOW) & BM_USDHC_TUNING_CTRL_TUNING_WINDOW)
...
#define BG_USDHC_TUNING_CTRL_STD_TUNING_EN(r)   ((__REG_VALUE_TYPE((r), reg32_t) & BM_USDHC_TUNING_CTRL_STD_TUNING_EN) >> BP_USDHC_TUNING_CTRL_STD_TUNING_EN)

//! @brief Format value for bitfield USDHC_TUNING_CTRL_STD_TUNING_EN.
#define BF_USDHC_TUNING_CTRL_STD_TUNING_EN(v)   ((__REG_VALUE_TYPE((v), reg32_t) << BP_USDHC_TUNING_CTRL_STD_TUNING_EN) & BM_USDHC_TUNING_CTRL_STD_TUNING_EN)
