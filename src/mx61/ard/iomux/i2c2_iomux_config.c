...
{
    // Config i2c2_SCL to pad EIM_EB2(E22)
    // Mux Register:
    ...
    writel((SION_ENABLED & 0x1) << 4 | (ALT6 & 0x7), IOMUXC_SW_MUX_CTL_PAD_EIM_EB2);
    ...
    //                NOTE: - Config Register IOMUXC_ASRC_ASRCK_CLOCK_6_SELECT_INPUT for mode ALT1.
    //     ALT2 (2) - Select mux mode: ALT2 mux port: DDC_SDA of instance: hdmi_tx.
    //                NOTE: - Config Register IOMUXC_HDMI_TX_II2C_MSTH13TDDC_SDAIN_SELECT_INPUT for mode ALT2.
