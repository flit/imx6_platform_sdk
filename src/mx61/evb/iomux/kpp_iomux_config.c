...
{
    // Config kpp_COL[5] to pad SD2_CLK(C21)
    // Mux Register:
    ...
    // Config kpp_COL[6] to pad SD2_DAT3(B22)
    // Mux Register:
    ...
    // Config kpp_COL[7] to pad SD2_DAT1(E20)
    // Mux Register:
    ...
    // Config kpp_ROW[5] to pad SD2_CMD(F19)
    // Mux Register:
    ...
    // Config kpp_ROW[6] to pad SD2_DAT2(A23)
    // Mux Register:
    ...
    // Config kpp_ROW[7] to pad SD2_DAT0(A22)
    // Mux Register:
