...
{
    // Config rawnand_ALE to pad NANDF_ALE(A16)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0x7), IOMUXC_SW_MUX_CTL_PAD_NANDF_ALE);
    ...
    // Config rawnand_CE0N to pad NANDF_CS0(F15)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0x7), IOMUXC_SW_MUX_CTL_PAD_NANDF_CS0);
    // Pad Control Register:
    ...
    // Config rawnand_CE1N to pad NANDF_CS1(C16)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0x7), IOMUXC_SW_MUX_CTL_PAD_NANDF_CS1);
    // Pad Control Register:
    ...
    // Config rawnand_CE2N to pad NANDF_CS2(A17)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0x7), IOMUXC_SW_MUX_CTL_PAD_NANDF_CS2);
    // Pad Control Register:
    ...
    // Config rawnand_CE3N to pad NANDF_CS3(D16)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0x7), IOMUXC_SW_MUX_CTL_PAD_NANDF_CS3);
    // Pad Control Register:
    ...
    // Config rawnand_CLE to pad NANDF_CLE(C15)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0x7), IOMUXC_SW_MUX_CTL_PAD_NANDF_CLE);
    // Pad Control Register:
    ...
    // Config rawnand_D0 to pad NANDF_D0(A18)
    // Mux Register:
    ...
    // Config rawnand_D1 to pad NANDF_D1(C17)
    // Mux Register:
    ...
    // Config rawnand_D2 to pad NANDF_D2(F16)
    // Mux Register:
    ...
    // Config rawnand_D3 to pad NANDF_D3(D17)
    // Mux Register:
    ...
    // Config rawnand_D4 to pad NANDF_D4(A19)
    // Mux Register:
    ...
    // Config rawnand_D5 to pad NANDF_D5(B18)
    // Mux Register:
    ...
    // Config rawnand_D6 to pad NANDF_D6(E17)
    // Mux Register:
    ...
    // Config rawnand_D7 to pad NANDF_D7(C18)
    // Mux Register:
    ...
    // Config rawnand_DQS to pad SD4_DAT0(D18)
    // Mux Register:
    ...
    // Config rawnand_RDN to pad SD4_CMD(B17)
    // Mux Register:
    ...
    // Config rawnand_READY0 to pad NANDF_RB0(B16)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0x7), IOMUXC_SW_MUX_CTL_PAD_NANDF_RB0);
    // Pad Control Register:
    ...
    // Config rawnand_RESETN to pad NANDF_WP_B(E15)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0x7), IOMUXC_SW_MUX_CTL_PAD_NANDF_WP_B);
    // Pad Control Register:
    ...
    // Config rawnand_WRN to pad SD4_CLK(E16)
    // Mux Register:
