...
{
    // Config gpio2_GPIO[11] to pad SD4_DAT3(A20)
    // Mux Register:
    ...
    // Config gpio2_GPIO[12] to pad SD4_DAT4(E18)
    // Mux Register:
    ...
    // Config gpio2_GPIO[15] to pad SD4_DAT7(D19)
    // Mux Register:
    ...
    // Config gpio2_GPIO[24] to pad EIM_CS1(J23)
    // Mux Register:
