...
{
    // Config mlb_MLBCLK to pad ENET_TXD1(W20)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0x7), IOMUXC_SW_MUX_CTL_PAD_ENET_TXD1);
    ...
    // Config mlb_MLBDAT to pad GPIO_2(T1)
    // Mux Register:
    ...
    // Config mlb_MLBSIG to pad GPIO_6(T3)
    // Mux Register:
