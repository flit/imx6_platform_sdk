...
{
    // Config uart2_CTS to pad SD4_DAT6(B20)
    // Mux Register:
    ...
    // Config uart2_RTS to pad SD4_DAT5(C19)
    // Mux Register:
    ...
    // Config uart2_RXD_MUX to pad GPIO_8(R5)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT4 & 0x7), IOMUXC_SW_MUX_CTL_PAD_GPIO_8);
    ...
    // Config uart2_TXD_MUX to pad GPIO_7(R3)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT4 & 0x7), IOMUXC_SW_MUX_CTL_PAD_GPIO_7);
