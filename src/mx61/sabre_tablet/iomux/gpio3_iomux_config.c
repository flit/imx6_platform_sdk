...
void gpio3_iomux_config(void)
{
    ...
    // Config gpio3_GPIO[16] to pad EIM_D16(C25)
    // GPS_CLK_EN
    // Mux Register:
    ...
    // Config gpio3_GPIO[18] to pad EIM_D18(D24)
    // GPS_PPS
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT5 & 0x7), IOMUXC_SW_MUX_CTL_PAD_EIM_D18);
    // Pad Control Register:
    ...
    // Config gpio3_GPIO[19] to pad EIM_D19(G21)
    // LVDS_PWR_EN
    // Mux Register:
    ...
    // Config gpio3_GPIO[20] to pad EIM_D20(G20)
    // LED_FLASH_EN
    // Mux Register:
    ...
    // Config gpio3_GPIO[21] to pad EIM_D21(H20)
    // USB_OTG_OC
    // Mux Register:
    ...
    // Config gpio3_GPIO[22] to pad EIM_D22(E23)
    // USB_OTG_PWR_EN
    // Mux Register:
    ...
    // Config gpio3_GPIO[26] to pad EIM_D26(E24)
    // Mux Register:
    ...
    // Config gpio3_GPIO[28] to pad EIM_D28(G23)
    // Mux Register:
    ...
    // Config gpio3_GPIO[29] to pad EIM_D29(J19)
    // Mux Register:
    ...
    // Config gpio3_GPIO[30] to pad EIM_D30(J20)
    // USB_H1_OC
    // Mux Register:
