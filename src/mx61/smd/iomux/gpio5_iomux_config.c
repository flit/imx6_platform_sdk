...
{
    // Config gpio5_GPIO[22] to pad CSI0_DAT4(N1)
    // Mux Register:
    ...
    // Config gpio5_GPIO[23] to pad CSI0_DAT5(P2)
    // Mux Register:
    ...
    // Config gpio5_GPIO[24] to pad CSI0_DAT6(N4)
    // Mux Register:
    ...
    // Config gpio5_GPIO[25] to pad CSI0_DAT7(N3)
    // Mux Register:
