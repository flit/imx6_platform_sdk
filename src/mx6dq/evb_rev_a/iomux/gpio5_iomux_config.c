...
void gpio5_iomux_config(void)
{
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT5 & 0x7), IOMUXC_SW_MUX_CTL_PAD_CSI0_DAT4);
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT5 & 0x7), IOMUXC_SW_MUX_CTL_PAD_CSI0_DAT5);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT5 & 0x7), IOMUXC_SW_MUX_CTL_PAD_CSI0_DAT6);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT5 & 0x7), IOMUXC_SW_MUX_CTL_PAD_CSI0_DAT7);
    // Pad Control Register:
