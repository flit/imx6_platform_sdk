...
void ecspi1_iomux_config(void)
{
    ...
    writel((SEL_KEY_COL1_ALT0 & 0x3), IOMUXC_ECSPI1_IPP_IND_MISO_SELECT_INPUT);
    ...
    writel((SEL_KEY_ROW0_ALT0 & 0x3), IOMUXC_ECSPI1_IPP_IND_MOSI_SELECT_INPUT);
    // Pad Control Register:
    ...
    writel((SEL_KEY_COL0_ALT0 & 0x3), IOMUXC_ECSPI1_IPP_CSPI_CLK_IN_SELECT_INPUT);
    // Pad Control Register:
    ...
    writel((SEL_KEY_ROW1_ALT0 & 0x3), IOMUXC_ECSPI1_IPP_IND_SS_B_0_SELECT_INPUT);
    // Pad Control Register:
