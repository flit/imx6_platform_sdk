...
void usdhc4_iomux_config(void)
{
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD4_DAT5(0x020E0330)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    //     SION_ENABLED (1) - Force input path of pad SD4_DAT5.
    //   MUX_MODE (2-0) - MUX Mode Select Field Reset: ALT5
    //                    Select 1 of 8 iomux modes to be used for pad: SD4_DAT5.
    ...
    //     ALT3 (3) - Select mux mode: ALT3 mux port: UH2_DFD_OUT[29] of instance: usboh3.
    //     ALT4 (4) - Select mux mode: ALT4 mux port: UH3_DFD_OUT[29] of instance: usboh3.
    //     ALT5 (5) - Select mux mode: ALT5 mux port: GPIO[13] of instance: gpio2.
    //     ALT6 (6) - Select mux mode: ALT6 mux port: IPU_DIAG_BUS[13] of instance: ipu1.
    //     ALT7 (7) - Select mux mode: ALT7 mux port: IPU_DIAG_BUS[13] of instance: ipu2.
    writel((SION_DISABLED & 0x1) << 4 | (ALT1 & 0x7), IOMUXC_SW_MUX_CTL_PAD_SD4_DAT5);
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD4_DAT5(0x020E0718)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD4_DAT6(0x020E0334)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    //     SION_ENABLED (1) - Force input path of pad SD4_DAT6.
    //   MUX_MODE (2-0) - MUX Mode Select Field Reset: ALT5
    //                    Select 1 of 8 iomux modes to be used for pad: SD4_DAT6.
    ...
    //                NOTE: - Config Register IOMUXC_UART2_IPP_UART_RTS_B_SELECT_INPUT for mode ALT2.
    //     ALT3 (3) - Select mux mode: ALT3 mux port: UH2_DFD_OUT[30] of instance: usboh3.
    //     ALT4 (4) - Select mux mode: ALT4 mux port: UH3_DFD_OUT[30] of instance: usboh3.
    //     ALT5 (5) - Select mux mode: ALT5 mux port: GPIO[14] of instance: gpio2.
    //     ALT6 (6) - Select mux mode: ALT6 mux port: IPU_DIAG_BUS[14] of instance: ipu1.
    //     ALT7 (7) - Select mux mode: ALT7 mux port: IPU_DIAG_BUS[14] of instance: ipu2.
    writel((SION_DISABLED & 0x1) << 4 | (ALT1 & 0x7), IOMUXC_SW_MUX_CTL_PAD_SD4_DAT6);
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD4_DAT6(0x020E071C)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
