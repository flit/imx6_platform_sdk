...
void weim_iomux_config(void)
{
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_A16);
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_A17);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_A18);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_A19);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_A20);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_A21);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_A22);
    // Pad Control Register:
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_EIM_A23(0x020E012C)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    ...
    //     ALT2 (2) - Select mux mode: ALT2 mux port: CSI1_D[18] of instance: ipu1.
    //                NOTE: - Config IOMUXC_IPU1_IPP_IND_SENS1_DATA_18_SELECT_INPUT for mode ALT2.
    ...
    //     ALT8 (8) - Select mux mode: ALT8 mux port: GDOE of instance: epdc.
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_A23);
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_EIM_A23(0x020E04FC)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_DISABLED
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_A24);
    // Pad Control Register:
    ...
    //   MUX_MODE (3-0) - MUX Mode Select Field Reset: ALT0
    //                    Select 1 of 7 iomux modes to be used for pad: EIM_CS0.
    ...
    //     ALT8 (8) - Select mux mode: ALT8 mux port: SDDO[6] of instance: epdc.
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_CS0);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D16);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D17);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D18);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D19);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D22);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D23);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D24);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D25);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D26);
    // Pad Control Register:
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_EIM_D27(0x020E0170)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    //     SION_ENABLED (1) - Force input path of pad EIM_D27.
    //   MUX_MODE (3-0) - MUX Mode Select Field Reset: ALT5
    //                    Select 1 of 9 iomux modes to be used for pad: EIM_D27.
    ...
    //     ALT3 (3) - Select mux mode: ALT3 mux port: CSI1_D[13] of instance: ipu1.
    //                NOTE: - Config IOMUXC_IPU1_IPP_IND_SENS1_DATA_13_SELECT_INPUT for mode ALT3.
    ...
    //     ALT8 (8) - Select mux mode: ALT8 mux port: SDOE of instance: epdc.
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D27);
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_EIM_D27(0x020E0540)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D28);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D29);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D30);
    // Pad Control Register:
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_EIM_D31(0x020E0180)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    //     SION_ENABLED (1) - Force input path of pad EIM_D31.
    //   MUX_MODE (3-0) - MUX Mode Select Field Reset: ALT5
    //                    Select 1 of 10 iomux modes to be used for pad: EIM_D31.
    ...
    //     ALT8 (8) - Select mux mode: ALT8 mux port: SDCLK of instance: epdc.
    //     ALT9 (9) - Select mux mode: ALT9 mux port: ACLK_FREERUN of instance: weim.
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D31);
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_EIM_D31(0x020E0550)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA0);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA1);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA10);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA11);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA12);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA13);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA14);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA15);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA2);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA3);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA4);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA5);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA6);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA7);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA8);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_DA9);
    // Pad Control Register:
    ...
    //   MUX_MODE (3-0) - MUX Mode Select Field Reset: ALT0
    //                    Select 1 of 7 iomux modes to be used for pad: EIM_OE.
    ...
    //     ALT8 (8) - Select mux mode: ALT8 mux port: PWRIRQ of instance: epdc.
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_OE);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT0 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_RW);
    // Pad Control Register:
