...
{
    // Config enet.MDC to pad KEY_COL2(W6)
    // Mux Register:
    ...
    // Config enet.MDIO to pad KEY_COL1(U7)
    // Mux Register:
    ...
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           (DDR_INPUT_CMOS & 0x1) << 17 | (HYS_ENABLED & 0x1) << 16 | (PUS_100KOHM_PU & 0x3) << 14 |
           (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 | (DSE_40OHM &
                                                                                        0x7) << 3,
    ...
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           ...
           (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 | (DSE_40OHM &
                                                                                        0x7) << 3,
           IOMUXC_SW_PAD_CTL_PAD_RGMII_RD1);
    // Pad Group Control Register:
    // IOMUXC_SW_PAD_CTL_GRP_DDR_TYPE_RGMII(0x020E0768)
    //   DDR_SEL (19-18) - DDR Select Field Reset: DDR_SEL_LPDDR2
    //                     Select one out of next values for group: DDR_TYPE_RGMII (Pads: RGMII_RD0 RGMII_RD1 RGMII_RD2 RGMII_RD3 RGMII_RXC
    ...
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           ...
           (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 | (DSE_40OHM &
                                                                                        0x7) << 3,
           IOMUXC_SW_PAD_CTL_PAD_RGMII_RD2);
    // Pad Group Control Register:
    // IOMUXC_SW_PAD_CTL_GRP_DDR_TYPE_RGMII(0x020E0768)
    //   DDR_SEL (19-18) - DDR Select Field Reset: DDR_SEL_LPDDR2
    //                     Select one out of next values for group: DDR_TYPE_RGMII (Pads: RGMII_RD0 RGMII_RD1 RGMII_RD2 RGMII_RD3 RGMII_RXC
    ...
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           ...
           (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 | (DSE_40OHM &
                                                                                        0x7) << 3,
           IOMUXC_SW_PAD_CTL_PAD_RGMII_RD3);
    // Pad Group Control Register:
    // IOMUXC_SW_PAD_CTL_GRP_DDR_TYPE_RGMII(0x020E0768)
    //   DDR_SEL (19-18) - DDR Select Field Reset: DDR_SEL_LPDDR2
    //                     Select one out of next values for group: DDR_TYPE_RGMII (Pads: RGMII_RD0 RGMII_RD1 RGMII_RD2 RGMII_RD3 RGMII_RXC
    ...
    //     DSE_34OHM (7) - 34 Ohm
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           (DDR_INPUT_CMOS & 0x1) << 17 | (HYS_ENABLED & 0x1) << 16 | (PUS_100KOHM_PD & 0x3) << 14 |
           (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 | (DSE_40OHM &
                                                                                        0x7) << 3,
    ...
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           ...
           (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 | (DSE_40OHM &
                                                                                        0x7) << 3,
           IOMUXC_SW_PAD_CTL_PAD_RGMII_TD0);
    // Pad Group Control Register:
    // IOMUXC_SW_PAD_CTL_GRP_DDR_TYPE_RGMII(0x020E0768)
    //   DDR_SEL (19-18) - DDR Select Field Reset: DDR_SEL_LPDDR2
    //                     Select one out of next values for group: DDR_TYPE_RGMII (Pads: RGMII_RD0 RGMII_RD1 RGMII_RD2 RGMII_RD3 RGMII_RXC
    ...
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           ...
           (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 | (DSE_40OHM &
                                                                                        0x7) << 3,
           IOMUXC_SW_PAD_CTL_PAD_RGMII_TD1);
    // Pad Group Control Register:
    // IOMUXC_SW_PAD_CTL_GRP_DDR_TYPE_RGMII(0x020E0768)
    //   DDR_SEL (19-18) - DDR Select Field Reset: DDR_SEL_LPDDR2
    //                     Select one out of next values for group: DDR_TYPE_RGMII (Pads: RGMII_RD0 RGMII_RD1 RGMII_RD2 RGMII_RD3 RGMII_RXC
    ...
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           ...
           (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 | (DSE_40OHM &
                                                                                        0x7) << 3,
           IOMUXC_SW_PAD_CTL_PAD_RGMII_TD2);
    // Pad Group Control Register:
    // IOMUXC_SW_PAD_CTL_GRP_DDR_TYPE_RGMII(0x020E0768)
    //   DDR_SEL (19-18) - DDR Select Field Reset: DDR_SEL_LPDDR2
    //                     Select one out of next values for group: DDR_TYPE_RGMII (Pads: RGMII_RD0 RGMII_RD1 RGMII_RD2 RGMII_RD3 RGMII_RXC
    ...
    writel((DO_TRIM_RES0 & 0x3) << 20 | (DDR_SEL_LPDDR1_DDR3_DDR2_ODT & 0x3) << 18 |
           ...
           (PUE_PULL & 0x1) << 13 | (PKE_ENABLED & 0x1) << 12 | (ODT_OFF & 0x7) << 8 | (DSE_40OHM &
                                                                                        0x7) << 3,
           IOMUXC_SW_PAD_CTL_PAD_RGMII_TD3);
    // Pad Group Control Register:
    // IOMUXC_SW_PAD_CTL_GRP_DDR_TYPE_RGMII(0x020E0768)
    //   DDR_SEL (19-18) - DDR Select Field Reset: DDR_SEL_LPDDR2
    //                     Select one out of next values for group: DDR_TYPE_RGMII (Pads: RGMII_RD0 RGMII_RD1 RGMII_RD2 RGMII_RD3 RGMII_RXC
