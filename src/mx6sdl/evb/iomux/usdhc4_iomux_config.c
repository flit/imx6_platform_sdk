...
void usdhc4_iomux_config(void)
{
    ...
    // IOMUXC_USDHC4_IPP_CARD_CLK_IN_SELECT_INPUT(0x020E0938)
    //   DAISY (0) Reset: SEL_NANDF_RB0_ALT8
    //               Selecting Pads Involved in Daisy Chain.
    //               NOTE: Instance: usdhc4,   In Pin: ipp_card_clk_in
    //     SEL_NANDF_RB0_ALT8 (0) - Selecting Pad: NANDF_RB0 for Mode: ALT8.
    //     SEL_SD4_CLK_ALT0 (1) - Selecting Pad: SD4_CLK for Mode: ALT0.
    writel((SEL_NANDF_RB0_ALT8 & 0x1), IOMUXC_USDHC4_IPP_CARD_CLK_IN_SELECT_INPUT);
    ...
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD4_DAT3(0x020E034C)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    //     SION_ENABLED (1) - Force input path of pad SD4_DAT3.
    //   MUX_MODE (2-0) - MUX Mode Select Field Reset: ALT5
    //                    Select 1 of 6 iomux modes to be used for pad: SD4_DAT3.
    ...
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD4_DAT3(0x020E0734)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    // Config usdhc4.DAT4 to pad SD4_DAT4(E18)
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD4_DAT4(0x020E0350)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    //     SION_ENABLED (1) - Force input path of pad SD4_DAT4.
    //   MUX_MODE (2-0) - MUX Mode Select Field Reset: ALT5
    //                    Select 1 of 7 iomux modes to be used for pad: SD4_DAT4.
    ...
    //                NOTE: - Config IOMUXC_UART2_IPP_UART_RXD_MUX_SELECT_INPUT for mode ALT2.
    //     ALT5 (5) - Select mux mode: ALT5 mux port: GPIO[12] of instance: gpio2.
    writel((SION_DISABLED & 0x1) << 4 | (ALT1 & 0x7), IOMUXC_SW_MUX_CTL_PAD_SD4_DAT4);
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD4_DAT4(0x020E0738)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
    ...
    // Config usdhc4.DAT5 to pad SD4_DAT5(C19)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT1 & 0x7), IOMUXC_SW_MUX_CTL_PAD_SD4_DAT5);
    // Pad Control Register:
    ...
    // Config usdhc4.DAT6 to pad SD4_DAT6(B20)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT1 & 0x7), IOMUXC_SW_MUX_CTL_PAD_SD4_DAT6);
    // Pad Control Register:
    ...
    // Config usdhc4.DAT7 to pad SD4_DAT7(D19)
    // Mux Register:
    // IOMUXC_SW_MUX_CTL_PAD_SD4_DAT7(0x020E035C)
    //   SION (4) - Software Input On Field Reset: SION_DISABLED
    //              Force the selected mux mode Input path no matter of MUX_MODE functionality.
    //     SION_DISABLED (0) - Input Path is determined by functionality of the selected mux mode (regular).
    //     SION_ENABLED (1) - Force input path of pad SD4_DAT7.
    //   MUX_MODE (2-0) - MUX Mode Select Field Reset: ALT5
    //                    Select 1 of 7 iomux modes to be used for pad: SD4_DAT7.
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT1 & 0x7), IOMUXC_SW_MUX_CTL_PAD_SD4_DAT7);
    // Pad Control Register:
    // IOMUXC_SW_PAD_CTL_PAD_SD4_DAT7(0x020E0744)
    //   HYS (16) - Hysteresis Enable Field Reset: HYS_ENABLED
