...
{
    // Config uart2.CTS to pad EIM_D28(G23)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT4 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D28);
    ...
    // Config uart2.RTS to pad EIM_D29(J19)
    // Mux Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT4 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D29);
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT4 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D27);
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT4 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D26);
