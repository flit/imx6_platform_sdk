...
void uart3_iomux_config(void)
{
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT4 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_D30);
    ...
    writel((SEL_EIM_D30_ALT4 & 0x7), IOMUXC_UART3_IPP_UART_RTS_B_SELECT_INPUT);
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT2 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_EB3);
    ...
    writel((SEL_SD4_CMD_ALT2 & 0x3), IOMUXC_UART3_IPP_UART_RXD_MUX_SELECT_INPUT);
    // Pad Control Register:
