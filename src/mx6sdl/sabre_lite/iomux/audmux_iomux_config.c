...
void audmux_iomux_config(void)
{
    ...
    writel((SEL_DISP0_DAT23_ALT3 & 0x1), IOMUXC_AUDMUX_P4_INPUT_DA_AMX_SELECT_INPUT);
    ...
    writel((SEL_DISP0_DAT21_ALT3 & 0x1), IOMUXC_AUDMUX_P4_INPUT_DB_AMX_SELECT_INPUT);
    // Pad Control Register:
    ...
    writel((SEL_DISP0_DAT22_ALT3 & 0x1), IOMUXC_AUDMUX_P4_INPUT_TXFS_AMX_SELECT_INPUT);
    // Pad Control Register:
