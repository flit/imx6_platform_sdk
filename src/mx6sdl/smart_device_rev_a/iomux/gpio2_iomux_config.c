...
void gpio2_iomux_config(void)
{
    ...
    //   MUX_MODE (3-0) - MUX Mode Select Field Reset: ALT0
    //                    Select 1 of 7 iomux modes to be used for pad: EIM_CS1.
    ...
    //     ALT8 (8) - Select mux mode: ALT8 mux port: SDDO[8] of instance: epdc.
    writel((SION_DISABLED & 0x1) << 4 | (ALT5 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_CS1);
    // Pad Control Register:
    ...
    writel((SION_DISABLED & 0x1) << 4 | (ALT5 & 0xF), IOMUXC_SW_MUX_CTL_PAD_EIM_OE);
    // Pad Control Register:
