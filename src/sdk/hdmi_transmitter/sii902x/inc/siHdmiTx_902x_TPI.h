...
//====================================================
// Video mode define
#define SHDMI_480I60_4X3	1
#define SHDMI_576I50_4X3	2
#define SHDMI_480P60_4X3	3
#define SHDMI_576P50_4X3	4
#define SHDMI_720P60			5
#define SHDMI_720P50			6
#define SHDMI_1080I60		7
#define SHDMI_1080I50		8
#define SHDMI_1080P60		9
#define SHDMI_1080P50		10
#define SHDMI_1080P24		11
#define SHDMI_1080P30		12
...
#if (CONF__TPI_TRACE_PRINT == DEBUG_ENABLE)
#define TPI_TRACE_PRINT(x) printf x
#else
...
#if (CONF__TPI_DEBUG_PRINT == DEBUG_ENABLE)
#define TPI_DEBUG_PRINT(x)	printf x
#else
...
#define TPI_EDID_PRINT(x)		printf x
#else
...
#if (CONF__CPI_DEBUG_PRINT == DEBUG_ENABLE)
#define CPI_DEBUG_PRINT(x)	printf x
#else
