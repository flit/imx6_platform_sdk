...
int usdhc_test(void)
{
    ...
    do {
#if defined(MX6DQ_SABRE_AI)||defined(MX6SDL_ARD)||defined(MX6DQ_SMART_DEVICE)||defined(MX6SDL_SMART_DEVICE)||defined(MX6DQ_SABRE_LITE)||defined(MX6SDL_SABRE_LITE)||defined(MX6DQ_EVB)||defined(MX6SDL_EVB)
